...
```mermaid
flowchart LR
    control[" Optimization method "] -->|OnClick| handler["FUN_0136f110"]
    handler --> call1["FUN_006d8180"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/000000000136F110__FUN_0136f110.c](../../../DecompiledSources/Tina16/functions/000000000136F110__FUN_0136f110.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: Opt_W.Panel1.method.OnClick.
