/* Ghidra address: 01cc8d10 */
/* Ghidra symbol: FUN_01cc8d10 */


void FUN_01cc8d10(longlong *param_1,double param_2,double *param_3,double *param_4)

{
  ...
  *(int *)((longlong)param_1 + 0x24) = (int)param_1[4] + 1;
  ...
  dVar3 = (double)FUN_00c42800(param_2 / local_40[0]);
  dVar4 = (double)FUN_00c42800(local_48 / local_40[0]);
  *param_3 = (dVar3 / dVar4) * (local_58 - local_50) + local_50;
