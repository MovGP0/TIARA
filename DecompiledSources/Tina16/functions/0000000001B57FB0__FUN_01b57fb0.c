/* Ghidra address: 01b57fb0 */
/* Ghidra symbol: FUN_01b57fb0 */


void FUN_01b57fb0(longlong *param_1,longlong param_2)

{
  ...
  if (cVar1 != '\0') {
    ...
    if ((cVar1 == '\0') && (*(char *)(lVar2 + 0x5b) != '\0')) {
      ...
      cVar1 = FUN_00f83630(param_2,(longlong)param_1 + 0xd2a);
      if (cVar1 != '\0') {
        if (*(char *)(param_1[0x1ab] + 0x59) == '\0') {
