/* Ghidra address: 005911d0 */
/* Ghidra symbol: FUN_005911d0 */


undefined8 FUN_005911d0(undefined8 param_1,undefined8 param_2,longlong *param_3,longlong param_4)

{
  ...
  if (((ulonglong)pcVar1 & 0xff00000000000000) == 0xff00000000000000) {
    FUN_00414ad0(param_2,*(undefined8 *)((longlong)param_3 + ((ulonglong)pcVar1 & 0xffffffffffffff))
                );
  }
  else {
