/* Ghidra address: 00ec7d60 */
/* Ghidra symbol: FUN_00ec7d60 */


void FUN_00ec7d60(longlong param_1,undefined8 param_2)

{
  ...
  if (cVar2 != '\0') {
    ...
    (**(code **)(*plVar6 + 0x90))(plVar6,L"DigitalICs",*(undefined8 *)(plVar7[0xda] + 0x4a0));
      ...
      if (-1 < iVar4 + -1) {
        do {
          ...
          if (cVar2 != '\0') {
            ...
            (**(code **)(*plVar6 + 0x10))(plVar6,&local_38,L"DigitalICs",local_30,0);
            sVar3 = FUN_00eab320(*(undefined8 *)(param_1 + 0x850),L"DigitalICs",&local_30);
            if (sVar3 == 6) {
              (**(code **)(**(longlong **)(param_1 + 0x850) + 0x18))
                        (*(longlong **)(param_1 + 0x850),L"DigitalICs",local_30,local_38);
