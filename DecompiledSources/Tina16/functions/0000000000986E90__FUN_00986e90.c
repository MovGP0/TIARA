/* Ghidra address: 00986e90 */
/* Ghidra symbol: FUN_00986e90 */


undefined8 FUN_00986e90(undefined8 param_1,undefined4 param_2,undefined4 param_3,longlong param_4)

{
  ...
  if (iVar3 == 0) {
    ...
    plVar5 = (longlong *)(**(code **)(*local_20 + 0x110))(local_20,0);
    (**(code **)(*plVar5 + 0x120))(plVar5,&local_48);
