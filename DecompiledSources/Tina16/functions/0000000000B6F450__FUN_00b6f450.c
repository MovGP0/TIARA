/* Ghidra address: 00b6f450 */
/* Ghidra symbol: FUN_00b6f450 */


ulonglong FUN_00b6f450(longlong *param_1,longlong param_2,wchar_t *param_3,uint param_4)

{
  ...
  for (uVar4 = param_4 / 8; uVar4 != 0; uVar4 = uVar4 - 1) {
    ...
    FUN_00b6e420(param_1);
    FUN_00409a70(param_2,param_3,8);
    FUN_00b6d090(param_3,local_40,8);
    param_2 = param_2 + 8;
    param_3 = param_3 + 4;
  }
  ...
  if ((int)uVar1 != 0) {
    ...
    uVar3 = FUN_00b6d090(param_3,local_40,uVar1);
  }
  return uVar3;
}
