/* Ghidra address: 007973c0 */
/* Ghidra symbol: FUN_007973c0 */


longlong * FUN_007973c0(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_00770710,1,(longlong)param_3);
  local_res18 = 0;
