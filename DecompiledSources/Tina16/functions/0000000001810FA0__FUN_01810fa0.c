/* Ghidra address: 01810fa0 */
/* Ghidra symbol: FUN_01810fa0 */


longlong FUN_01810fa0(longlong param_1,char param_2,undefined8 param_3)

{
  ...
  *(undefined1 *)(*(longlong *)(local_res8 + 8) + 0x49) = 0;
  ...
  *(undefined1 *)(local_res8 + 0x79) = 0;
  uVar2 = FUN_004baeb0(&PTR_FUN_0047f878,1,*(undefined8 *)(local_res8 + 0x28),0x1000);
