/* Ghidra address: 01c3bac0 */
/* Ghidra symbol: FUN_01c3bac0 */


void FUN_01c3bac0(longlong param_1)
  ...
  if (1 < local_64) {
    ...
    if (-1 < iVar4 + -1) {
      do {
        ...
        FUN_0084e320(uVar2,&local_70,iVar3,local_64);
        FUN_0084e3e0(uVar2,iVar3,local_64 + -1,local_70);
    ...
    uVar1 = *(undefined4 *)(*(longlong *)(param_1 + 0x988) + (longlong)(local_64 + -2) * 4);
    iVar4 = local_64 + -1;
    *(undefined4 *)(*(longlong *)(param_1 + 0x988) + (longlong)(local_64 + -2) * 4) =
