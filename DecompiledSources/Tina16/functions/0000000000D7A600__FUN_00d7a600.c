/* Ghidra address: 00d7a600 */
/* Ghidra symbol: FUN_00d7a600 */


void FUN_00d7a600(longlong param_1)

{
  ...
  FUN_00d7a1f0(param_1);
  if (*(longlong *)(param_1 + 0x90) != 0) {
    lVar2 = FUN_00d5a350(*(longlong *)(param_1 + 0x90),
                         *(undefined8 *)(*(longlong *)(param_1 + 0x150) + 0x20),
                         *(longlong *)(param_1 + 0x150) + 0x10);
    if (lVar2 != 0) {
      local_20 = (undefined8 *)(param_1 + 0x150);
      uVar1 = *local_20;
      *local_20 = 0;
      FUN_00410f20(uVar1);
    ...
    if (lVar2 != 0) {
      local_28 = (undefined8 *)(param_1 + 0x148);
      uVar1 = *local_28;
      *local_28 = 0;
      FUN_00410f20(uVar1);
