/* Ghidra address: 00b0c820 */
/* Ghidra symbol: FUN_00b0c820 */


void FUN_00b0c820(longlong *param_1,int param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  local_40 = param_2;
  if (cVar1 == '\x01') {
    iVar2 = FUN_00b0cc40(param_1,param_4);
