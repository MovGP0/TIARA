# TestAndMeasurementOptions scenarios

Window key: `TestAndMeasurementOptions`.

Implementation: [test_and_measurement_options](../../../crates/tiara-ui/src/test_and_measurement_options/mod.rs).
