/* Ghidra address: 01ae35c0 */
/* Ghidra symbol: FUN_01ae35c0 */


void FUN_01ae35c0(longlong param_1)
  ...
  if (cVar1 == '\x01') {
    ...
    if (iVar2 == 1) {
      ...
      if (iVar2 == 1) {
        ...
        if (*(longlong *)(lVar4 + 0x118) != 0) {
          ...
          FUN_01cd3ef0(*(undefined8 *)(lVar4 + 0x118),*(undefined8 *)(param_1 + 0x80));
          lVar4 = (**(code **)(*plVar5 + 0x30))(plVar5,0);
          lVar4 = (**(code **)(**(longlong **)(lVar4 + 0x78) + 0x30))
                            (*(longlong **)(lVar4 + 0x78),0);
    ...
    if (cVar1 != '\0') {
      ...
      if (bVar6) {
        ...
        FUN_01cd3ef0(*(undefined8 *)(lVar4 + 0x100),*(undefined8 *)(param_1 + 0x80));
        lVar4 = FUN_004aeac0(local_20,0);
        FUN_01a8dee0(*(undefined8 *)(param_1 + 0xe8),*(undefined8 *)(lVar4 + 0x100));
      }
      else {
        lVar4 = FUN_004aeac0(local_20,0);
        FUN_01cd3ef0(*(undefined8 *)(lVar4 + 0xf0),*(undefined8 *)(param_1 + 0x80));
        lVar4 = FUN_004aeac0(local_20,0);
...
LAB_01ae38c6:
    if (local_28 == 0) goto LAB_01ae3965;
  }
  else {
    uVar3 = FUN_004aeac0(local_20,0);
    cVar1 = FUN_01ad1090(param_1,uVar3,&local_28);
    if (cVar1 == '\0') goto LAB_01ae38c6;
  }
