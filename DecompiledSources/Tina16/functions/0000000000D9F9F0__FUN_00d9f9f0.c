/* Ghidra address: 00d9f9f0 */
/* Ghidra symbol: FUN_00d9f9f0 */


longlong * FUN_00d9f9f0(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_00d536b0,1,(longlong)param_3);
  local_res18 = 0;
