...
| Component path | SchematicEditor.MainMenu.mnTM.NetworkAnalyzer1.Virtual1 |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.mnTM.NetworkAnalyzer1.Virtual1` |
...
```mermaid
flowchart TD
    Control["Click Simulated"] --> Handler["mnNAVirtualClick<br/>01c90650"]
