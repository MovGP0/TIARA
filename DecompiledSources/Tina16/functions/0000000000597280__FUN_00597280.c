/* Ghidra address: 00597280 */
/* Ghidra symbol: FUN_00597280 */


void FUN_00597280(longlong *param_1,uint param_2,undefined8 *param_3)

{
  ...
  *(undefined8 *)(lVar1 + (longlong)(int)param_2 * 8) = 0;
  FUN_0041b840(lVar1 + (longlong)(int)param_2 * 8,*param_3);
