/* Ghidra address: 017518a0 */
/* Ghidra symbol: FUN_017518a0 */


void FUN_017518a0(longlong param_1,longlong *param_2,longlong param_3,undefined8 param_4)

{
  ...
  if ((((param_2 != (longlong *)0x0) && (cVar2 = FUN_0175ad40(param_1,param_2), cVar2 != '\0')) ||
    ...
    FUN_01d048c0(*(undefined8 *)(param_1 + 0x28),0xfffffff8,0xfffffff0,local_40,local_3c,
                 local_res18 == 0,1);
    FUN_01d048c0(*(undefined8 *)(param_1 + 0x28),0,0xffffffe8,local_38,local_34,local_res18 == 0,1);
    FUN_01d048c0(*(undefined8 *)(param_1 + 0x28),8,0xfffffff0,local_30,local_2c,local_res18 == 0,1);
