/* Ghidra address: 01cee3e0 */
/* Ghidra symbol: FUN_01cee3e0 */


undefined8 FUN_01cee3e0(longlong param_1,int param_2)
...
LAB_01cee530:
                  ...
                  else if (uVar8 == 1) goto LAB_01cee5ac;
                }
                else if (uVar8 - 3 < 2) {
LAB_01cee5ac:
                  lVar9 = (**(code **)(**(longlong **)(lVar7 + 0x80) + 0x30))
                ...
                else if (uVar8 - 5 < 2) goto LAB_01cee530;
                local_34 = local_34 + 1;
                iVar4 = iVar4 + -1;
              } while (iVar4 != 0);
            }
