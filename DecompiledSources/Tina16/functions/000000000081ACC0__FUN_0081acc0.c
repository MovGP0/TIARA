/* Ghidra address: 0081acc0 */
/* Ghidra symbol: FUN_0081acc0 */


void FUN_0081acc0(longlong param_1)
  ...
  if (bVar5) {
    ...
    if (0 < iVar1) {
      ...
      if (*(int *)(param_1 + 0x134) < iVar1) {
        if (*(int *)(*(longlong *)(param_1 + 0x170) + 0x140) < 1) {
          FUN_00423b50(param_1 + 0x130,-local_30,iVar1 - *(int *)(param_1 + 0x134));
          ...
          iVar2 = FUN_004230c0(param_1 + 0x130);
          FUN_00423b50(param_1 + 0x130,-local_30,0);
          iVar3 = (**(code **)(**(longlong **)(param_1 + 0x118) + 0x48))
                            (*(longlong **)(param_1 + 0x118));
