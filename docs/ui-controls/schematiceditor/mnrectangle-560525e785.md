...
| Component path | SchematicEditor.MainMenu.Insert.mnShape.mnRectangle |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Insert.mnShape.mnRectangle` |
...
```mermaid
flowchart TD
    control["&Rectangle"] -->|"OnClick"| handler["InsertShape (01c97500)"]
