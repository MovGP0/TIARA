...
```mermaid
flowchart LR
    control["Fourier Spectrum"] -->|OnClick| handler["FUN_0146c880"]
...
- Source: [DecompiledSources/Tina16/functions/000000000146C880__FUN_0146c880.c](../../../DecompiledSources/Tina16/functions/000000000146C880__FUN_0146c880.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: CSysTextDlg.DeepLinkPopUpMnu.FourierSpectrumMnu.OnClick.
