/* Ghidra address: 01ae8380 */
/* Ghidra symbol: FUN_01ae8380 */


void FUN_01ae8380(longlong param_1,byte param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (param_2 < 5) {
    if (param_2 == 4) {
      ...
      (**(code **)(*plVar2 + 0xa0))(plVar2,*(undefined8 *)(param_1 + 0x80));
    }
    else if (param_2 == 0) {
      lVar1 = (**(code **)(**(longlong **)(param_1 + 0xd8) + 0x30))
                        (*(longlong **)(param_1 + 0xd8),param_3);
