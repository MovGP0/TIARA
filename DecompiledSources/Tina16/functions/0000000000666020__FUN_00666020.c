/* Ghidra address: 00666020 */
/* Ghidra symbol: FUN_00666020 */


longlong FUN_00666020(longlong param_1,char param_2,undefined8 param_3)

{
  ...
  FUN_0064cbf0(local_res8,0);
  FUN_0064cc50(local_res8,0);
  if (param_2 != '\0') {
