/* Ghidra address: 01b58560 */
/* Ghidra symbol: FUN_01b58560 */


void FUN_01b58560(longlong *param_1)

{
  ...
  if (iVar3 != -1) {
    ...
    (**(code **)(*(longlong *)param_1[0x1ab] + 0xb8))
              ((longlong *)param_1[0x1ab],uVar4,*(undefined1 *)(param_1[0xfa] + 0x328));
    lVar2 = param_1[0x10e];
