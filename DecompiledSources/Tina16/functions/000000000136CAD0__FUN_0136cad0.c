/* Ghidra address: 0136cad0 */
/* Ghidra symbol: FUN_0136cad0 */


undefined1 FUN_0136cad0(longlong param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (*(char *)(param_1 + 0x18) == '\0') {
    *(undefined1 *)(param_1 + 0x18) = 1;
    plVar3 = (longlong *)FUN_017b8a10(0,&PTR_FUN_017b8668,0x65);
    puVar4 = (undefined4 *)FUN_004095c0(0x28);
    *puVar4 = 0x65;
    puVar4[1] = 0x105;
    puVar4[2] = 0x1c;
    uVar2 = FUN_00b95b20(0,0,0,0);
    *(undefined8 *)(puVar4 + 3) = uVar2;
    puVar4[5] = 0x800000;
    *(undefined2 *)(puVar4 + 6) = 1;
    *(undefined1 *)((longlong)puVar4 + 0x1a) = 0;
    *(undefined2 *)((longlong)puVar4 + 0x1b) = 100;
    *(undefined4 *)((longlong)puVar4 + 0x1d) = 0xfffffffe;
    if (*(char *)(param_1 + 0x19) == '\0') {
      *(undefined1 *)((longlong)puVar4 + 0x21) = 0;
    }
    else {
      *(undefined1 *)((longlong)puVar4 + 0x21) = 3;
    }
    *(undefined2 *)((longlong)puVar4 + 0x22) = 100;
    puVar4[9] = 0xfffffffe;
    FUN_004ae7e0(plVar3[8],puVar4);
    FUN_019aba00(plVar3);
    lVar5 = FUN_004aeac0(plVar3[8],0);
    uVar2 = FUN_00b95b20(0,0,0,0);
    *(undefined8 *)(lVar5 + 0xc) = uVar2;
    if (*(char *)(param_1 + 0x19) == '\0') {
      *(undefined1 *)(lVar5 + 0x1a) = 0;
      *(undefined1 *)(lVar5 + 0x21) = 0;
    }
    else if ((*(char *)(lVar5 + 0x1a) == '\0') && (*(char *)(lVar5 + 0x21) == '\0')) {
      *(undefined1 *)(lVar5 + 0x1a) = 0;
      *(undefined1 *)(lVar5 + 0x21) = 3;
    }
