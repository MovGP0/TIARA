/* Ghidra address: 01d09d60 */
/* Ghidra symbol: FUN_01d09d60 */


void FUN_01d09d60(undefined8 param_1,longlong *param_2)

{
  ...
  if (*(longlong *)PTR_DAT_02001d08 != 0) {
    ...
    if (cVar1 != '\0') {
      ...
      if (local_20 != 0) {
        FUN_00416cd0(&local_18,4,L"SetParameters(",local_10,&DAT_01d09fec,local_20);
        plVar3 = &local_20;
        puVar5 = &local_24;
