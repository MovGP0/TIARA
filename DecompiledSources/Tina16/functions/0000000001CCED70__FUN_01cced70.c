/* Ghidra address: 01cced70 */
/* Ghidra symbol: FUN_01cced70 */


double FUN_01cced70(longlong param_1,undefined8 param_2)

{
  ...
  uVar2 = FUN_01d1b660(*(undefined8 *)(lVar3 + 0x90),
                       *(undefined8 *)(*(longlong *)(param_1 + 0x60) + 0x80));
