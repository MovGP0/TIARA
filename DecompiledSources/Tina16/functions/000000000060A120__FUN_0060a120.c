/* Ghidra address: 0060a120 */
/* Ghidra symbol: FUN_0060a120 */


void FUN_0060a120(longlong param_1)
  ...
  if (*(short *)(*(longlong *)(param_1 + 0x60) + 0x6e) == 0x20) {
    ...
    if (puVar4 != (undefined1 *)0x0) {
      for (; puVar4 < (undefined1 *)
          ...
          puVar4 = puVar4 + 4) {
        uVar3 = puVar4[3];
        uVar2 = thunk_FUN_03f3ed25(*puVar4,uVar3,0xff);
        *puVar4 = uVar2;
        uVar2 = thunk_FUN_03f3ed25(puVar4[1],uVar3,0xff);
        puVar4[1] = uVar2;
        uVar3 = thunk_FUN_03f3ed25(puVar4[2],uVar3,0xff);
        puVar4[2] = uVar3;
      }
    }
  }
