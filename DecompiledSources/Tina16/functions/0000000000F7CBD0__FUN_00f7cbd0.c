/* Ghidra address: 00f7cbd0 */
/* Ghidra symbol: FUN_00f7cbd0 */


void FUN_00f7cbd0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  *(undefined2 *)((longlong)plVar2 + 0x2c) = 0x23;
  ...
  if (iVar1 < 3) {
    FUN_015fcf20(L"StringToStrings",0,0,0);
  }
