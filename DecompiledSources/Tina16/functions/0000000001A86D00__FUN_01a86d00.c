/* Ghidra address: 01a86d00 */
/* Ghidra symbol: FUN_01a86d00 */


void FUN_01a86d00(undefined8 param_1,longlong *param_2)

{
  ...
  local_20[0] = 0;
  local_28 = 0;
  FUN_00724270(param_2,&local_30);
  FUN_00441640(local_20,local_30);
  FUN_00724270(param_2,&local_38);
  FUN_00441920(&local_28,local_38);
  iVar1 = FUN_00724300(param_2);
  if (iVar1 < 4) {
    if (iVar1 == 3) {
