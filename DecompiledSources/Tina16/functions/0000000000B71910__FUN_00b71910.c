/* Ghidra address: 00b71910 */
/* Ghidra symbol: FUN_00b71910 */


void FUN_00b71910(longlong param_1,uint *param_2,wchar_t *param_3)

{
  ...
  if (*(char *)(param_1 + 0x78) == '\0') {
    ...
    param_3 = u_Cipher_not_initialized_00b720b0;
  ...
  uVar2 = (uVar2 >> 0x18 | uVar2 >> 8 & 0xff00 | (uVar2 & 0xff00) << 8 | uVar2 << 0x18) ^
          ...
          *(int *)(param_1 + 0xc98 + (ulonglong)(uVar1 & 0xff) * 4) ^ *(uint *)(param_1 + 0x10d8);
  ...
  uVar1 = uVar1 ^ (*(int *)(param_1 + 0x98 + (ulonglong)(uVar2 >> 0x18) * 4) +
                  ...
                  *(int *)(param_1 + 0xc98 + (ulonglong)(uVar2 & 0xff) * 4) ^
          *(uint *)(param_1 + 0x109c);
  uVar2 = uVar2 ^ *(uint *)(param_1 + 0x1098);
  *(uint *)param_3 = uVar2 >> 0x18 | uVar2 >> 8 & 0xff00 | (uVar2 & 0xff00) << 8 | uVar2 << 0x18;
  *(uint *)(param_3 + 2) =
