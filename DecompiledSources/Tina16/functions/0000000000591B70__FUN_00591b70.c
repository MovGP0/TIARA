/* Ghidra address: 00591b70 */
/* Ghidra symbol: FUN_00591b70 */


undefined8 FUN_00591b70(undefined8 param_1,undefined8 param_2,longlong *param_3,longlong param_4)

{
  ...
  if (((ulonglong)pcVar1 & 0xff00000000000000) == 0xff00000000000000) {
    FUN_00461840(param_2,(longlong)param_3 + ((ulonglong)pcVar1 & 0xffffffffffffff));
  }
  else {
