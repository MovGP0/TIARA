/* Ghidra address: 00ab2ac0 */
/* Ghidra symbol: FUN_00ab2ac0 */


undefined8
FUN_00ab2ac0(longlong param_1,int param_2,int param_3,undefined8 param_4,undefined8 param_5,
        ...
        do {
          ...
          if ((((cVar1 != '\0') && (lVar4 = FUN_004aeac0(lVar2,local_30), iVar5 <= param_2)) &&
             ...
             (((*(int *)(*(longlong *)(lVar4 + 0x80) + 0x58) <= param_3 &&
              ...
              (uVar3 = FUN_00a9bd50(*(undefined8 *)(lVar4 + 0x80),*(undefined8 *)(param_1 + 0x58),
