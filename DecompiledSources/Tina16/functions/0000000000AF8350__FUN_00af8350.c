/* Ghidra address: 00af8350 */
/* Ghidra symbol: FUN_00af8350 */


longlong *
FUN_00af8350(longlong param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5)

{
  ...
  if ((cVar1 == '\0') && (*(int *)(*(longlong *)(param_1 + 0x8b0) + 0x10) != 0)) {
    ...
    local_28 = FUN_006056e0(&PTR_FUN_005f7f40,1,local_20,0);
    local_40 = param_5;
    local_48 = param_4;
    FUN_00af79f0(param_1,local_28,param_2,param_3);
