/* Ghidra address: 00ec6620 */
/* Ghidra symbol: FUN_00ec6620 */


void FUN_00ec6620(longlong param_1)

{
  ...
  iVar3 = FUN_004170c0(local_30,*(undefined8 *)(param_1 + 0x868),1);
  if (0 < iVar3) {
    iVar4 = 0;
    if (local_30 != 0) {
      iVar4 = *(int *)(local_30 + -4);
    }
    FUN_00416e20(param_1 + 0x868,iVar3,iVar4 + 1);
  }
  plVar1 = *(longlong **)(param_1 + 0x6c8);
  uVar2 = (**(code **)(*plVar1 + 0x260))(plVar1);
  ...
  if (local_20 != 0) {
    ...
    if (iVar4 == -1) {
      FUN_00416ba0(&local_78,local_20,&DAT_00ec6a84);
      FUN_00416ea0(local_78,param_1 + 0x868,iVar3);
      iVar3 = FUN_00416db0(local_30,*(undefined8 *)(param_1 + 0x860));
      if (iVar3 == 0) {
        FUN_00414ad0(param_1 + 0x860,local_20);
      }
