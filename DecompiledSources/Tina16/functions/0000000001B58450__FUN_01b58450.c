/* Ghidra address: 01b58450 */
/* Ghidra symbol: FUN_01b58450 */


void FUN_01b58450(longlong param_1)

{
  ...
  if (iVar2 != -1) {
    ...
    ;
    (**(code **)(**(longlong **)(param_1 + 0xd58) + 0x58))(*(longlong **)(param_1 + 0xd58),uVar3);
    ...
    *(undefined8 *)(param_1 + 0x870) = uVar4;
    ...
    (**(code **)(**(longlong **)(param_1 + 0xd58) + 0xa8))
              (*(longlong **)(param_1 + 0xd58),*(undefined1 *)(lVar5 + 0x2a));
    FUN_00b90440(*(undefined8 *)(param_1 + 0xc60),*(undefined8 *)(lVar5 + 0x118));
    uVar4 = FUN_00b90440(*(undefined8 *)(param_1 + 0xc70),*(undefined8 *)(lVar5 + 0x150));
    *(undefined1 *)(lVar5 + 0x11) = 1;
    FUN_0082a6c0(*(undefined8 *)(param_1 + 2000),
                 CONCAT71((int7)((ulonglong)uVar4 >> 8),1) & 0xffffffff);
    FUN_01b58560(param_1,param_1);
  }
  return;
}
