/* Ghidra address: 00b90a50 */
/* Ghidra symbol: FUN_00b90a50 */


undefined1 * FUN_00b90a50(undefined8 param_1,undefined1 *param_2,undefined1 *param_3)

{
  ...
  *param_2 = 0;
  ...
  iVar1 = FUN_004170c0(&DAT_00b90d54,local_20,1);
  if (0 < iVar1) {
    FUN_004169a0(&local_28,param_3);
    iVar1 = FUN_004170c0(&LAB_00b90d64,local_28,1);
    if (0 < iVar1) {
      FUN_004169a0(&local_30,param_3);
      iVar1 = FUN_004170c0(&DAT_00b90d54,local_30,1);
      FUN_004169a0(&local_38,param_3);
      iVar2 = FUN_004170c0(&LAB_00b90d64,local_38,1);
      if (iVar1 < iVar2) {
        FUN_004169a0(&local_98,param_3);
        iVar1 = FUN_004170c0(&DAT_00b90d54,local_98,1);
        FUN_004169a0(&local_a0,param_3);
        iVar2 = FUN_004170c0(&LAB_00b90d64,local_a0,1);
        FUN_004169a0(&local_a8,param_3);
        iVar3 = FUN_004170c0(&DAT_00b90d54,local_a8,1);
        FUN_004151b0(local_90,param_3,iVar1 + 1,(iVar2 - iVar3) + -1);
        FUN_00415020(param_2,local_90,0x50);
        FUN_004169a0(&local_b0,param_3);
        uVar4 = FUN_004170c0(&DAT_00b90d54,local_b0,1);
