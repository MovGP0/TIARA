/* Ghidra address: 013de3f0 */
/* Ghidra symbol: FUN_013de3f0 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_013de3f0(undefined8 *param_1,longlong param_2)

{
  ...
  if (param_2 == 0) goto LAB_013de9c6;
  FUN_013d2e70();
...
LAB_013de4b5:
  ...
  *(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x798) = uVar5;
  ...
  FUN_00f16900(uVar6,param_2,0,local_278,2,1,CONCAT44(uVar3,2),local_280,0,1,2,&local_270,uVar5,1,0)
  ;
