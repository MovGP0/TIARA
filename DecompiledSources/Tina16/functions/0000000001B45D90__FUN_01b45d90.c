/* Ghidra address: 01b45d90 */
/* Ghidra symbol: FUN_01b45d90 */


uint FUN_01b45d90(longlong *param_1,int param_2,int param_3,undefined8 param_4)

{
  ...
  uVar4 = FUN_007ffaf0(plVar3);
  iVar1 = FUN_008077f0(uVar4);
  if (param_2 + (int)plVar3[0x13] < iVar1) {
    FUN_00806af0(plVar3,param_2);
  }
  else {
    FUN_00806af0(plVar3,(param_2 - (int)plVar3[0x13]) + 0x1d);
  }
