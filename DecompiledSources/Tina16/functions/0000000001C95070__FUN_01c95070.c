/* Ghidra address: 01c95070 */
/* Ghidra symbol: FUN_01c95070 */


void FUN_01c95070(longlong param_1)

{
  ...
  FUN_00414ad0(PTR_DAT_02004c08,L"\\PROTEL.PCB");
  FUN_00414ad0(PTR_DAT_02004008,L"PROTEL");
  ...
  FUN_007e2d20(*(undefined8 *)(param_1 + 0x1008),1);
  (**(code **)(**(longlong **)(param_1 + 0x24b8) + 0x18))
            (*(longlong **)(param_1 + 0x24b8),L"Schematic Editor",L"PCBRootDir",L"PROTEL");
  FUN_00ec0300();
  FUN_00ecbc20();
