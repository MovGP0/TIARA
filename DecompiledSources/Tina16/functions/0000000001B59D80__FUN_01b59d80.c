/* Ghidra address: 01b59d80 */
/* Ghidra symbol: FUN_01b59d80 */


void FUN_01b59d80(longlong param_1)

{
    ...
    do {
      ...
      if ((*(longlong *)(lVar4 + 0x40) != 0) && (*(longlong *)(lVar4 + 0x98) != 0)) {
        ...
        if (*(char *)(param_1 + 0xd6c) == '\0') {
          ...
          *(undefined8 *)(param_1 + 0xd30) = uVar3;
        }
        else {
          uVar3 = FUN_01cc6f70(&PTR_FUN_010ff630,1,*(undefined8 *)(lVar4 + 0x98));
          *(undefined8 *)(param_1 + 0xd30) = uVar3;
        }
        plVar1 = *(longlong **)(param_1 + 0xd30);
        ...
        (**(code **)(**(longlong **)(param_1 + 0xd58) + 0x88))
                  (*(longlong **)(param_1 + 0xd58),&local_91,local_90,0);
        *(undefined1 *)(lVar4 + 0x2a) = local_91;
        *(undefined8 *)(lVar4 + 0x150) = 0;
        *(double *)(lVar4 + 0x118) = local_90[0];
        FUN_00410f20(*(undefined8 *)(param_1 + 0xd30));
        *(undefined8 *)(param_1 + 0xd30) = 0;
        if (lVar4 == *(longlong *)(param_1 + 0x870)) {
          FUN_00b90440(*(undefined8 *)(param_1 + 0xc60),*(undefined8 *)(lVar4 + 0x118));
          FUN_00b90440(*(undefined8 *)(param_1 + 0xc70),*(undefined8 *)(lVar4 + 0x150));
        }
      }
      iVar5 = iVar5 + 1;
      iVar2 = iVar2 + -1;
  ...
  if (*(char *)(param_1 + 0xd6c) != '\0') {
    *(double *)(param_1 + 0xd38) = dVar9 / 5.0;
    (**(code **)(**(longlong **)(param_1 + 0xd58) + 0x88))
              (*(longlong **)(param_1 + 0xd58),param_1 + 0xd50,param_1 + 0xd38,0);
    *(undefined8 *)(param_1 + 0xd48) = 0;
    FUN_00b90440(*(undefined8 *)(param_1 + 0xca0),*(undefined8 *)(param_1 + 0xd38));
    FUN_00b90440(*(undefined8 *)(param_1 + 0xcc0),*(undefined8 *)(param_1 + 0xd48));
  }
  FUN_01b581d0(param_1,0);
