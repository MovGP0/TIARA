/* Ghidra address: 017de390 */
/* Ghidra symbol: FUN_017de390 */


void FUN_017de390(longlong param_1,double param_2,longlong param_3,char param_4,int *param_5)

{
  ...
  if (*(char *)(lVar1 + 0xe) != '\0') {
    FUN_01663140(lVar1,param_3,*param_5,1);
  }
