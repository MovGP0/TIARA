/* Ghidra address: 00acd400 */
/* Ghidra symbol: FUN_00acd400 */


longlong FUN_00acd400(longlong param_1,char param_2,undefined8 param_3,longlong param_4)

{
  ...
  *(undefined4 *)(local_res8 + 0x150) = *(undefined4 *)(param_4 + 0x150);
