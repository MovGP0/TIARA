/* Ghidra address: 01374440 */
/* Ghidra symbol: FUN_01374440 */


void FUN_01374440(longlong param_1,char param_2,undefined8 param_3,longlong *param_4)

{
  ...
  local_88 = local_28;
  local_71 = param_2;
  local_29 = FUN_00f534d0(param_1,param_2,param_3,local_res20);
  if (local_29 == '\0') {
    if (param_2 == '\0') {
      local_88 = (longlong *)CONCAT71(local_88._1_7_,4);
      local_38 = (longlong *)
    ...
    if (local_29 == '\0') {
      FUN_013738b0(local_28[0],4);
      local_88 = local_res20;
      FUN_013738c0(local_28[0],4,local_71,param_3);
      FUN_00f53970(local_28[0],0);
      FUN_00f53fb0(*(undefined8 *)(local_28[0] + 0x1440));
      FUN_01373a10(local_28[0]);
      FUN_00410f20(local_28[0]);
    }
    else {
      FUN_00f53970(local_28[0],1);
    }
  }
  else {
    FUN_00f53970(local_28[0],1);
