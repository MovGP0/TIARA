/* Ghidra address: 0183bc90 */
/* Ghidra symbol: FUN_0183bc90 */


void FUN_0183bc90(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  lVar4 = FUN_0184f010(&PTR_FUN_01841f20,1,param_3,*(undefined8 *)(param_1 + 0x50),local_20);
...
LAB_0183bdb5:
  ...
  *(undefined8 *)(lVar4 + 0x30) = uVar5;
  ...
  if (3 < iVar3) {
    lVar6 = FUN_0181e3c0(param_2,3);
    iVar3 = FUN_0043e420(*(undefined8 *)(lVar6 + 0x18),L"expr");
    if (iVar3 == 0) {
      uVar5 = FUN_0181e3c0(param_2,3);
      uVar5 = FUN_0183a030(param_1,uVar5,param_3);
