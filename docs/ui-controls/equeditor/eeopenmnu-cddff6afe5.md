...
```mermaid
flowchart LR
    control["&Open..."] -->|OnClick| handler["FUN_01463b00"]
    handler --> call1["Delphi UnicodeString clear and finalization helper"]
    handler --> call2["Delphi UnicodeString assignment helper"]
    handler --> call3["FUN_00724270"]
    handler --> call4["FUN_00724380"]
    handler --> call5["FUN_00724420"]
    handler --> call6["FUN_01463140"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001463B00__FUN_01463b00.c](../../../DecompiledSources/Tina16/functions/0000000001463B00__FUN_01463b00.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: EquEditor.EEMenu.EEFileMnu.EEOpenMnu.OnClick.
