/* Ghidra address: 004ee370 */
/* Ghidra symbol: FUN_004ee370 */


longlong * FUN_004ee370(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_004a7708,1,(longlong)param_3);
  local_res18 = 0;
