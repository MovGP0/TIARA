/* Ghidra address: 008e9220 */
/* Ghidra symbol: FUN_008e9220 */


void FUN_008e9220(longlong param_1,byte *param_2,int param_3,byte *param_4,int param_5,int *param_6,
                 int *param_7)
      ...
      while( true ) {
        while( true ) {
          while( true ) {
            while( true ) {
              iVar5 = (int)param_2;
              if (pbVar1 < param_2) goto code_r0x008e94f5;
              uVar4 = (uint)*param_2 * 0x1000000 + (uint)param_2[1] * 0x10000 +
                      (uint)param_2[2] * 0x100 + (uint)param_2[3];
              if (((0xd7ff < uVar4) && (uVar4 < 0xe000)) || (0x10ffff < uVar4)) break;
              if (uVar4 < 0x10000) {
                if (param_5 <= iVar6) goto code_r0x008e94f5;
                *param_4 = param_2[3];
                param_4[1] = param_2[2];
                param_4 = param_4 + 2;
                param_2 = param_2 + 4;
                ...
                if (param_5 <= iVar6 + 1) goto code_r0x008e94f5;
                *param_4 = param_2[1] * '@' + (param_2[2] >> 2);
                param_4[1] = (param_2[1] >> 2) - 0x28;
                param_4[2] = param_2[3];
                param_4[3] = (param_2[2] & 3) - 0x24;
                param_4 = param_4 + 4;
                param_2 = param_2 + 4;
                iVar6 = iVar6 + 2;
              }
