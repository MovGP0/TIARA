/* Ghidra address: 017d2c00 */
/* Ghidra symbol: FUN_017d2c00 */


void FUN_017d2c00(longlong param_1,char param_2)
    ...
    do {
      ...
      if (cVar1 == '\x04') {
        if (param_2 == '\x06') {
          ...
          if (!bVar6) goto LAB_017d2c95;
LAB_017d2ccc:
          FUN_01755d20(plVar3[0x33]);
        }
        else {
LAB_017d2c95:
          if (param_2 == '\b') {
