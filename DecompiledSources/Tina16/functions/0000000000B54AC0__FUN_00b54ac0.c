/* Ghidra address: 00b54ac0 */
/* Ghidra symbol: FUN_00b54ac0 */


void FUN_00b54ac0(longlong param_1,undefined8 param_2)
          ...
          if (local_3c <= local_43) {
            ...
            do {
              uVar3 = FUN_00b4fb40(*(undefined8 *)(*(longlong *)(param_1 + 0x10) + 0x10),local_4a,
                                   bVar4);
              FUN_00b4f2c0(uVar3,local_res10[0]);
              if (cVar1 != '\0') goto LAB_00b54c00;
              bVar4 = bVar4 + 1;
              cVar6 = cVar6 + -1;
            } while (cVar6 != '\0');
          }
