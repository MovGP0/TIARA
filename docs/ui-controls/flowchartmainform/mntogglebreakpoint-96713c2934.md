...
```mermaid
flowchart LR
    control["mnToggleBreakPoint"] -->|OnClick| handler["FUN_01053cd0"]
    handler --> call1["FUN_01053ce0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001053CD0__FUN_01053cd0.c](../../../DecompiledSources/Tina16/functions/0000000001053CD0__FUN_01053cd0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: FlowChartMainForm.pcMain.tsEditorAndCode.pnEditor2.Editor2.mnPopupEditor.mnToggleBreakPoint.OnClick.
