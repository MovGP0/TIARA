/* Ghidra address: 01cc00e0 */
/* Ghidra symbol: FUN_01cc00e0 */


longlong FUN_01cc00e0(longlong param_1,char param_2,longlong param_3)

{
  ...
  if (*(longlong *)(param_3 + 0x68) == 0) {
    FUN_00416ba0(&local_38,*(undefined8 *)PTR_DAT_020030c8,&DAT_01cc02cc);
  ...
  thunk_FUN_041b7910(local_res8 + 0x20,&LAB_01cc02d0,0,local_res8 + 0x22a);
