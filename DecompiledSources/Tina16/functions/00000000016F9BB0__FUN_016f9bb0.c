/* Ghidra address: 016f9bb0 */
/* Ghidra symbol: FUN_016f9bb0 */


undefined8 FUN_016f9bb0(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  iVar1 = FUN_00b6cb20(plVar3);
  FUN_016f9b20(local_30,local_res18[0],(longlong)iVar1 / 8 & 0xffffffff);
  ...
  (**(code **)(*plVar3 + 0x120))(plVar3,uVar4,uVar5,uVar2);
  FUN_00410f20(plVar3);
  uVar4 = FUN_00414df0(&local_38);
  iVar1 = 0;
  if (local_38 != 0) {
