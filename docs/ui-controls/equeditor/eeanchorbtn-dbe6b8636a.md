...
```mermaid
flowchart LR
    control["Anchor"] -->|OnClick| handler["FUN_01464530"]
    handler --> call1["FUN_014641a0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001464530__FUN_01464530.c](../../../DecompiledSources/Tina16/functions/0000000001464530__FUN_01464530.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: EquEditor.EETPanel.EEAnchorBtn.OnClick.
