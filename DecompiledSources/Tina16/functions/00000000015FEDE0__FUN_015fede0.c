/* Ghidra address: 015fede0 */
/* Ghidra symbol: FUN_015fede0 */


char FUN_015fede0(undefined8 param_1)

{
  ...
  FUN_015fecc0(&local_30,L"\\Software",L"\\Microchip\\MPLAB X",local_10);
  cVar1 = FUN_005ea880(local_10,local_30,0);
  if (cVar1 != '\0') {
    local_11 = FUN_005ebec0(local_10,L"InstallDir");
    if (local_11 != '\0') {
