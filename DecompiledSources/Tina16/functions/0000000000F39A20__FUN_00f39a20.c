/* Ghidra address: 00f39a20 */
/* Ghidra symbol: FUN_00f39a20 */


void FUN_00f39a20(longlong param_1,int param_2,undefined8 *param_3)

{
  ...
  cVar1 = FUN_004113d0(param_3,&PTR_FUN_00f3be28);
  if (cVar1 == '\0') {
    ...
    local_40 = local_48;
    local_38 = param_3;
    FUN_00f39890(param_1,param_2,local_48,local_50 + -1);
  }
