/* Ghidra address: 00590270 */
/* Ghidra symbol: FUN_00590270 */


ulonglong FUN_00590270(undefined8 param_1,longlong *param_2,longlong param_3)

{
  ...
  if (((ulonglong)pcVar2 & 0xff00000000000000) == 0xff00000000000000) {
    uVar1 = (ulonglong)*(byte *)((longlong)param_2 + ((ulonglong)pcVar2 & 0xffffffffffffff));
  }
  else {
