/* Ghidra address: 00d2a220 */
/* Ghidra symbol: FUN_00d2a220 */


longlong * FUN_00d2a220(undefined8 param_1,longlong *param_2,int param_3)

{
  ...
  if (param_3 == 0) {
    ...
    if (-1 < iVar1) {
      ...
      uVar2 = FUN_004170c0(&DAT_00d2a3e8,local_30,1);
    ...
    if (0 < iVar1) {
      FUN_004155b0(param_2,&DAT_00d2a3f8);
    }
    FUN_00416880(&local_40,*param_2);
    iVar1 = FUN_00d2a4d0(param_1);
    FUN_0043f750(&local_48,iVar1 << 3);
    FUN_00416cd0(&local_38,3,local_40,local_48,L"bit Digestsize");
