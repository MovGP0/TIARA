/* Ghidra address: 00ded3b0 */
/* Ghidra symbol: FUN_00ded3b0 */


void FUN_00ded3b0(undefined8 param_1,longlong param_2,undefined2 param_3)

{
  ...
  if (cVar1 == '\0') {
    uVar3 = 0;
    FUN_016ee260(param_1,local_70,0x50,0);
    ...
    if (local_71 == '\x01') {
      *(undefined1 *)(local_70[0] + 0x40) = 0;
    }
    else {
      *(undefined1 *)(local_70[0] + 0x40) = 1;
    }
    ...
    *(undefined8 *)(local_70[0] + 0x38) = uVar11;
    uVar11 = FUN_016eb0a0(param_1,10);
    *(undefined8 *)(local_70[0] + 0x30) = uVar11;
    FUN_00dec4a0(param_1,1,CONCAT11(uVar3,2),
                 dVar5 * dVar4 * (dVar9 * dVar8 + dVar10 * dVar8 * dVar8 + 1.0),uVar7,uVar6,0,
                 local_70[0]);
