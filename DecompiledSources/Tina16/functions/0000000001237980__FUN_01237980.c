/* Ghidra address: 01237980 */
/* Ghidra symbol: FUN_01237980 */


undefined8 FUN_01237980(longlong *param_1,double param_2,double param_3)

{
  ...
  *(int *)(*param_1 + 0x1fa0) = iVar8 * 2;
  ...
  bVar9 = iVar8 % 2 == 1;
  if (bVar9) {
    puVar3[0x3ea] = puVar3[1];
    puVar3[0x3eb] = param_2 * (double)puVar3[2];
    puVar3[0x3ec] = (double)puVar3[1] * param_3 * param_3;
    puVar3[0x5df] = puVar3[0x1f6];
    puVar3[0x5e0] = param_2 * (double)puVar3[0x1f7];
    puVar3[0x5e1] = (double)puVar3[0x1f6] * param_3 * param_3;
  }
  uVar5 = (uint)bVar9;
  iVar8 = (iVar8 + 1) / 2 + -1;
  if ((int)uVar5 <= iVar8) {
    ...
    do {
      ...
      if ((double)puVar3[iVar1] == 0.0) {
        puVar3[(longlong)iVar2 + 0x3ea] = 0;
        dVar10 = (double)FUN_0040c760(puVar3[iVar1 + 2]);
        puVar3[(longlong)(iVar2 + 1) + 0x3ea] = dVar10 * param_2;
        puVar3[(longlong)(iVar2 + 2) + 0x3ea] = 0;
        puVar3[(longlong)(iVar2 + 3) + 0x3ea] = 0;
        dVar10 = (double)FUN_0040c760(puVar3[iVar1 + 2]);
        puVar3[(longlong)(iVar2 + 4) + 0x3ea] = dVar10 * param_2;
        puVar3[(longlong)(iVar2 + 5) + 0x3ea] = 0;
      }
      else {
        FUN_01236c30(local_58,puVar3[iVar1],0);
        FUN_01236c30(local_68,puVar3[iVar1 + 1],0);
        FUN_01236c30(local_78,puVar3[iVar1 + 2],0);
        FUN_01236d30(local_58,local_68,local_78,local_88,local_98);
        FUN_01236c30(local_58,0x3ff0000000000000,0);
        FUN_01236cd0(local_a8,local_88);
      ...
      FUN_01236c30(local_78,puVar3[(longlong)(iVar1 + 2) + 0x1f5],0);
      FUN_01236d30(local_58,local_68,local_78,local_88,local_98);
      FUN_01236c30(local_58,0x3ff0000000000000,0);
      FUN_01236cd0(local_a8,local_88);
      FUN_01236c30(local_b8,param_2,0);
