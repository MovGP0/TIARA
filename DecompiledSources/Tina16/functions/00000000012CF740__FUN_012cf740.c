/* Ghidra address: 012cf740 */
/* Ghidra symbol: FUN_012cf740 */


longlong FUN_012cf740(longlong param_1,char param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  *(undefined1 *)(local_res8 + 0x10) = param_8;
  ...
  iVar3 = FUN_004170c0(&DAT_012cfeac,local_40,1);
  if (0 < iVar3) {
    iVar3 = FUN_004170c0(&DAT_012cfeac,local_40,1);
  ...
  uVar4 = FUN_00418560(0x40,&DAT_012cd2b8);
