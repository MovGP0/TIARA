/* Ghidra address: 01c6d1a0 */
/* Ghidra symbol: FUN_01c6d1a0 */


void FUN_01c6d1a0(longlong param_1,longlong param_2)

{
  ...
  if ((cVar2 == '\0') &&
    ...
    FUN_0041ddd0(local_20,PTR_PTR_020021a8);
    ...
    FUN_01994be0(*(undefined8 *)(param_1 + 0x27a8),0);
