/* Ghidra address: 01d81ae0 */
/* Ghidra symbol: FUN_01d81ae0 */


undefined4 FUN_01d81ae0(longlong param_1,uint *param_2,undefined8 param_3)

{
  ...
  local_50 = (double)FUN_00b90090(*(undefined8 *)(param_1 + 0xa00));
  local_50 = local_50 + *(double *)(param_1 + 0xa78);
  ...
  local_30 = 0xffffffff;
  local_34 = 0xffffffff;
  local_35 = (**(code **)(**(longlong **)(param_1 + 0xa88) + 0x40))
                       (*(longlong **)(param_1 + 0xa88),&DAT_01d82154,&local_30);
  if (local_35 == '\0') {
    local_35 = (**(code **)(**(longlong **)(param_1 + 0xa88) + 0x40))
                         (*(longlong **)(param_1 + 0xa88),L"Chn1",&local_30);
  }
  if (local_35 != '\0') {
    plVar1 = *(longlong **)(*(longlong *)(param_1 + 0x918) + 0x4f0);
    uVar4 = (**(code **)(*plVar1 + 0x30))(plVar1,local_30);
  ...
  local_36 = (**(code **)(**(longlong **)(param_1 + 0xa88) + 0x40))
                       (*(longlong **)(param_1 + 0xa88),&DAT_01d8217c,&local_34);
  if (local_36 == '\0') {
    local_36 = (**(code **)(**(longlong **)(param_1 + 0xa88) + 0x40))
                         (*(longlong **)(param_1 + 0xa88),L"Chn2",&local_34);
  }
  if (local_36 != '\0') {
    plVar1 = *(longlong **)(*(longlong *)(param_1 + 0x918) + 0x4f0);
    uVar4 = (**(code **)(*plVar1 + 0x30))(plVar1,local_34);
