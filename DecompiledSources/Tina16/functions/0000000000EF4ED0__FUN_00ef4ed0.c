/* Ghidra address: 00ef4ed0 */
/* Ghidra symbol: FUN_00ef4ed0 */


void FUN_00ef4ed0(longlong param_1,undefined8 *param_2,undefined8 param_3)

{
  ...
  *(char *)(param_1 + 0x9e) = *(char *)(param_1 + 0x9e) + '\x01';
  ...
  FUN_00ef4950(param_1,cVar1 + *(char *)(param_1 + 0x9d) + *(char *)(param_1 + 0x9c) + '\x01',cVar1,
               local_9c,param_3);
