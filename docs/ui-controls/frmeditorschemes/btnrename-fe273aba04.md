...
```mermaid
flowchart LR
    control["&Rename..."] -->|OnClick| handler["FUN_01b74e50"]
    handler --> call1["Delphi UnicodeString clear and finalization helper"]
    handler --> call2["FUN_01b74860"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001B74E50__FUN_01b74e50.c](../../../DecompiledSources/Tina16/functions/0000000001B74E50__FUN_01b74e50.c)
...
- Rank 1:  Sc&hemes at distance 308.
