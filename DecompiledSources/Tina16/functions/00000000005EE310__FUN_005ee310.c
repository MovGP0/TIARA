/* Ghidra address: 005ee310 */
/* Ghidra symbol: FUN_005ee310 */


void FUN_005ee310(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (local_20 != 0) {
    ...
    FUN_005ebad0(local_10,param_3,param_4);
