...
```mermaid
flowchart LR
    control["&Diagram Window"] -->|OnClick| handler["FUN_01a7f990"]
    handler --> call1["Delphi UnicodeString array finalization helper"]
    handler --> call2["FUN_00416cd0"]
    handler --> call3["FUN_01aed550"]
    handler --> call4["FUN_01aee720"]
    handler --> call5["FUN_01b1def0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001A7F990__FUN_01a7f990.c](../../../DecompiledSources/Tina16/functions/0000000001A7F990__FUN_01a7f990.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFMainMenu.DFHelpMnu.DFDiagramViewerMnu.OnClick.
