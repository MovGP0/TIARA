/* Ghidra address: 008ea620 */
/* Ghidra symbol: FUN_008ea620 */


undefined8 *
FUN_008ea620(undefined8 param_1,undefined8 *param_2,ushort *param_3,int param_4,int *param_5)
      ...
      do {
        if ((ushort)(*param_3 + 0x2800) < 0x400) {
          ...
          if ((ushort)(uVar2 + 0x2400) < 0x301) {
            *puVar3 = (char)(uVar1 - 0xd7c0 >> 6);
            puVar3[1] = 0;
            puVar3[2] = (char)uVar2;
            puVar3[3] = (char)uVar1 * '\x04' + (char)(uVar2 - 0xdc00 >> 8);
            puVar5 = param_3 + 2;
            puVar3 = puVar3 + 4;
          }
          else {
