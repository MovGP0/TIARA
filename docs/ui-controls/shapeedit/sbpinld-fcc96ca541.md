...
> Analysis status: Source reviewed for TIARA-diz.6.7.1574.
...
This control shares the recovered handler with `ShapeEdit.PartsPanel.PinPanel.sbPinLC`, `ShapeEdit.PartsPanel.PinPanel.sbPinLDC`, `ShapeEdit.PartsPanel.PinPanel.sbPinLN`, `ShapeEdit.PartsPanel.PinPanel.sbPinMini`, `ShapeEdit.PartsPanel.PinPanel.sbPinNC`, `ShapeEdit.PartsPanel.PinPanel.sbPinND`, `ShapeEdit.PartsPanel.PinPanel.sbPinNDC`, `ShapeEdit.PartsPanel.PinPanel.sbPinNN`, `ShapeEdit.PartsPanel.PinPanel.sbPinX`. This article keeps the resource evidence for this control separate.

## Click flow

```mermaid
flowchart TD
    control["Long inverted pin"] --> handler["sbPinNDClick at 01797fc0"]
...
- Extracted glyph 1: [0428_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLD_Glyph_Data.png](../../../glyph/0428_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLD_Glyph_Data.png)
...
- Resource context: The recovered TSpeedButton resource uses caption `Long inverted pin` and hint `Long inverted pin`. The extracted glyph was visually inspected. It agrees with the recovered resource intent, but the source path remains the behavior proof.
