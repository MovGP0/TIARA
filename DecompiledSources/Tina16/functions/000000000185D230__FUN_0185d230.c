/* Ghidra address: 0185d230 */
/* Ghidra symbol: FUN_0185d230 */


void FUN_0185d230(longlong param_1)

{
  ...
  FUN_0185dbf0(param_1,2,lVar1);
  FUN_0185dbf0(param_1,2,lVar1 + 4);
  ...
  *(bool *)(lVar1 + 0x10) = (local_1c & 8) != 0;
  ...
  FUN_0185dbf0(param_1,1,lVar1 + 0x18);
  FUN_0185dbf0(param_1,1,lVar1 + 0x1c);
  *(undefined4 *)(lVar1 + 0x20) = 0xffffffff;
  if (*(char *)(lVar1 + 8) != '\0') {
    FUN_0185d370(param_1,*(undefined4 *)(lVar1 + 0x14),lVar1 + 0x20);
  }
  return;
}
