/* Ghidra address: 01820dd0 */
/* Ghidra symbol: FUN_01820dd0 */


void FUN_01820dd0(longlong param_1,undefined8 param_2)

{
  ...
  FUN_004b4b10(plVar2,*(undefined8 *)(param_1 + 0x28));
  ...
  if (1 < iVar1) {
    ...
    FUN_00414ad0(param_1 + 0x38,local_28);
  }
  FUN_00410f20(plVar2);
