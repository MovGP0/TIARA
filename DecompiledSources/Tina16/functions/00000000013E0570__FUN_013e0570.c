/* Ghidra address: 013e0570 */
/* Ghidra symbol: FUN_013e0570 */


void FUN_013e0570(longlong param_1)

{
  ...
  local_40 = 0;
  local_28 = 0;
  if (param_1 == 0) goto LAB_013e0999;
  FUN_013d2e70();
...
LAB_013e0624:
    ...
    if ((byte)uVar4 < 8) {
      bVar7 = ((int)CONCAT71((int7)((ulonglong)uVar4 >> 8),1) << ((byte)uVar4 & 0x1f) & 6U) != 0;
    }
    else {
      bVar7 = false;
    }
    if (bVar7) goto LAB_013e0624;
  }
  local_30 = FUN_00498310(0,0);
  puVar8 = &local_30;
  uVar4 = FUN_01acd9b0(&PTR_FUN_01ac9770,1,*(undefined8 *)PTR_DAT_02001e00,0,
                       *(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x780),puVar8);
  uVar9 = (undefined4)((ulonglong)puVar8 >> 0x20);
  *(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x798) = uVar4;
  FUN_0043f750(&local_40,DAT_01f45450);
  FUN_00416ba0(&local_38,L"Phasor",local_40);
  FUN_01cec150(*(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x7a0),uVar4,local_38,
               *(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0xa68));
  DAT_01f45450 = DAT_01f45450 + 1;
  local_20 = 0;
  uVar5 = FUN_01cc6f70(&PTR_FUN_01cb9c30,1,param_1);
  uVar6 = FUN_00b89270();
  FUN_00b8e520(uVar6,&local_48,0x11d);
  uVar6 = FUN_00b89270();
  FUN_00b8e520(uVar6,&local_50,0x11e);
  FUN_00f1d6e0(param_1,uVar5,local_48,0,1,CONCAT44(uVar9,2),local_50,0,1,2,&local_20,uVar4);
  *(undefined1 *)(local_20 + 0x68) = 1;
