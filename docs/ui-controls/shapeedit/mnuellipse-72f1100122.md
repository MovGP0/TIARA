...
> Analysis status: Source reviewed for TIARA-diz.6.7.1557.
...
| --- | --- |
| Form | ShapeEdit |
| Component path | ShapeEdit.MainMenu.mnDraw.mnuEllipse |
| Control class | TMenuItem |
| Caption | &Ellipse |
| Hint | Not present in the recovered resource. |
| Handler name | sbEllipseClick |
| Handler address | 01795ae0 |
| Graph node | `resource:dfm:ShapeEdit/ShapeEdit.MainMenu.mnDraw.mnuEllipse` |
...
This control shares the recovered handler with `ShapeEdit.TopToolBar.EditorTools.sbEllipse`. This article keeps the resource evidence for this control separate.
...
- Resource context: The recovered TMenuItem resource uses caption `&Ellipse`.
