/* Ghidra address: 00deca70 */
/* Ghidra symbol: FUN_00deca70 */


void FUN_00deca70(undefined8 param_1,longlong param_2,undefined2 param_3)

{
  ...
  if (cVar1 == '\0') {
    uVar3 = 0;
    FUN_016ee260(param_1,local_30,0x40,0);
    uVar4 = FUN_016eb0a0(param_1,1);
    uVar5 = FUN_016ea920(param_1,2,CONCAT11(uVar3,2),&local_31);
    if (local_31 == '\x01') {
      *(undefined1 *)(local_30[0] + 0x30) = 0;
    }
    else {
      *(undefined1 *)(local_30[0] + 0x30) = 1;
    }
    FUN_00deb390(param_1,1,2,uVar4,uVar5,0x46293e5939a08cea,local_30[0]);
