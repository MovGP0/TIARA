/* Ghidra address: 006d4890 */
/* Ghidra symbol: FUN_006d4890 */


void FUN_006d4890(longlong param_1,int param_2,undefined8 param_3)

{
  ...
  local_30[0] = *(uint *)(&DAT_01dfdbe4 + (uVar1 & 0xff) * 4) | 3;
  ...
  lVar3 = FUN_004701a0(uVar2,0x133e,(longlong)param_2,local_30);
  if (lVar3 < 0) {
