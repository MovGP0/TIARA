/* Ghidra address: 0160d060 */
/* Ghidra symbol: FUN_0160d060 */


undefined1
FUN_0160d060(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  local_858 = param_10;
  cVar1 = _PMBUS_ReadDataFile(local_res18,uVar2,local_res20,param_5);
  if (cVar1 == '\0') {
    FUN_0160ce00(auStack_898,&local_830);
    uVar2 = FUN_00b89270();
    FUN_00b8e520(uVar2,&local_838,0x3e5);
    FUN_0043f750(&local_840,*param_7);
    local_878 = &DAT_0160d2d0;
    local_870 = local_838;
    local_868 = &LAB_0160d2e4;
    local_860 = local_840;
