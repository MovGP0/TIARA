/* Ghidra address: 01a32310 */
/* Ghidra symbol: FUN_01a32310 */


void FUN_01a32310(longlong *param_1,undefined4 param_2,undefined8 param_3)

{
  ...
  if (cVar1 == '\x03') {
    ...
    local_79 = FUN_01a31de0(local_40[0]);
    if (local_79 != '\0') {
      *local_20[0] = param_3;
      FUN_01a321c0(local_20[0]);
    }
  }
  if (cVar1 == '\x06') {
    FUN_00415430(&local_48,local_20[0][1],0);
    local_79 = FUN_01a31de0(local_48);
    if (local_79 != '\0') {
      *local_20[0] = param_3;
    }
  }
