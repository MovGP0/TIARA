...
```mermaid
flowchart LR
    control["Special character"] -->|OnClick| handler["FUN_014644e0"]
    handler --> call1["FUN_014641a0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000014644E0__FUN_014644e0.c](../../../DecompiledSources/Tina16/functions/00000000014644E0__FUN_014644e0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: EquEditor.EETPanel.EESpecBtn.OnClick.
