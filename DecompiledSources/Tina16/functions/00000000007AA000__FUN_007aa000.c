/* Ghidra address: 007aa000 */
/* Ghidra symbol: FUN_007aa000 */


void FUN_007aa000(longlong param_1,int param_2,undefined8 *param_3)

{
  ...
  cVar1 = FUN_004113d0(param_3,&PTR_FUN_007c3770);
  if (cVar1 == '\0') {
    ...
    local_48 = local_50;
    local_40 = param_3;
    FUN_007a9e70(param_1,param_2,local_50,local_58 + -1);
  }
