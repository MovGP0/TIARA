...
| Component path | SchematicEditor.MainMenu.Help.mnDesignSoftontheWeb.wwwedisonlabcom |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Help.mnDesignSoftontheWeb.wwwedisonlabcom` |
...
```mermaid
flowchart TD
    control["www.edisonlab.com"] -->|"OnClick"| handler["OnTheWeb (01c8f060)"]
