/* Ghidra address: 0059a1a0 */
/* Ghidra symbol: FUN_0059a1a0 */


void FUN_0059a1a0(longlong *param_1,uint param_2,undefined8 param_3)

{
  ...
  FUN_00409a70(param_3,*param_1 + (int)param_2 * lVar1,lVar1);
