...
| Component path | SchematicEditor.MainMenu.mnInteractive.mnIntAC |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.mnInteractive.mnIntAC` |
...
```mermaid
flowchart TD
    control["AC"] -->|"OnClick"| handler["pmIntDigitalClick (01c89820)"]
