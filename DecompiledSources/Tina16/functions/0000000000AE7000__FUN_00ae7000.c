/* Ghidra address: 00ae7000 */
/* Ghidra symbol: FUN_00ae7000 */


void FUN_00ae7000(longlong param_1,int param_2,char param_3)

{
  ...
  if ((param_2 - 9U < 2) || (param_2 == 0xd)) {
    FUN_00414ad0(*(undefined8 *)(param_1 + 0x78),&DAT_00ae70d0);
  }
  else if (param_2 < 0x20) {
    FUN_00414ad0(*(undefined8 *)(param_1 + 0x78),&DAT_00ae70e0);
  }
    ...
    iVar2 = thunk_FUN_04139c29(*(undefined4 *)(param_1 + 0x80),0,local_res10,1,local_2e,0x16);
    if (iVar2 == 0) {
