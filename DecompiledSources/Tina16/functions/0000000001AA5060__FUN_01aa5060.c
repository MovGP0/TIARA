/* Ghidra address: 01aa5060 */
/* Ghidra symbol: FUN_01aa5060 */


bool FUN_01aa5060(byte *param_1,undefined8 param_2)

{
  ...
  if (param_1[0x564] == 0) {
    if (1 < *param_1) {
      ...
      do {
        pbVar1 = pbVar1 + 1;
        local_f0[0] = (&DAT_01fce3fd)[(ulonglong)*pbVar1 + (ulonglong)local_f0[0] * 4];
        cVar5 = cVar5 + -1;
      } while (cVar5 != '\0');
    }
