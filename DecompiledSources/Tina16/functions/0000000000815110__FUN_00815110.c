/* Ghidra address: 00815110 */
/* Ghidra symbol: FUN_00815110 */


int FUN_00815110(longlong param_1,longlong param_2,longlong param_3)

{
  ...
  if (param_2 == 0) {
    ...
    if (param_3 == 0) {
      ...
      FUN_00419260(*(longlong *)(param_1 + 0xa0) + 0x40,&DAT_007f7990,1,(longlong)local_2c);
      iVar3 = 0;
      iVar2 = local_2c;
      if (-1 < local_2c + -1) {
        do {
          ...
          *(undefined8 *)
           (*(longlong *)(*(longlong *)(param_1 + 0xa0) + 0x40) + 8 + (longlong)iVar3 * 0x20) =
               uVar4;
          iVar3 = iVar3 + 1;
          iVar2 = iVar2 + -1;
        } while (iVar2 != 0);
      ...
      FUN_00419260(*(longlong *)(param_1 + 0xa0) + 0x40,&DAT_007f7990,1,(longlong)(iVar2 + iVar3));
      ...
      if (-1 < iVar2) {
        do {
          ...
          cVar1 = FUN_00815080(auStack_68,uVar4);
          if (cVar1 != '\0') {
            iVar6 = 0;
            iVar3 = local_2c;
            iVar7 = -1;
            if (-1 < local_2c + -1) {
              do {
                ...
                if (*(byte *)(lVar5 + 0x87) <=
                    *(byte *)(*(longlong *)
                               (*(longlong *)(*(longlong *)(param_1 + 0xa0) + 0x40) + 8 +
            ...
            uVar4 = FUN_007e2f10(*(undefined8 *)(local_40 + 0x80),iVar2);
            FUN_00814fc0(auStack_68,iVar7,&local_2c,uVar4);
          }
          iVar2 = iVar2 + -1;
        } while (iVar2 != -1);
      }
