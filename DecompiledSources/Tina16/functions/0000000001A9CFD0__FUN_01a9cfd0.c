/* Ghidra address: 01a9cfd0 */
/* Ghidra symbol: FUN_01a9cfd0 */


void FUN_01a9cfd0(longlong param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5)

{
  ...
  if (*(char *)(param_1 + 0x12d) == '\0') {
    thunk_FUN_041cd445(*(undefined8 *)(param_1 + 0x148),(int)local_20 - *(int *)(param_1 + 0x188),
