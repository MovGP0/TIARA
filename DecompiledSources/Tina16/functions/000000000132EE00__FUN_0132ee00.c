/* Ghidra address: 0132ee00 */
/* Ghidra symbol: FUN_0132ee00 */


void FUN_0132ee00(ushort *param_1,ushort param_2,ushort param_3,undefined8 param_4)

{
  ...
  *(undefined8 *)
   (*(longlong *)(param_1 + 4) + (ulonglong)((uint)param_2 * (uint)param_1[2] + (uint)param_3) * 8)
       = param_4;
