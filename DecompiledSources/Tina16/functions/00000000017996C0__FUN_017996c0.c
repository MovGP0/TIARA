/* Ghidra address: 017996c0 */
/* Ghidra symbol: FUN_017996c0 */


void FUN_017996c0(undefined8 param_1,undefined8 param_2,ulonglong *param_3,longlong param_4)

{
  ...
  local_30 = param_3[1];
  local_59 = 0;
  sVar2 = FUN_00c3f420(param_4,0,0,&local_59);
  if (sVar2 != -1) {
    ...
    FUN_00c3cbb0(lVar5,puVar7,0,0,0x80,0,0,0);
    uVar6 = FUN_005ffa40(param_2);
