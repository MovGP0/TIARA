/* Ghidra address: 00d3e7f0 */
/* Ghidra symbol: FUN_00d3e7f0 */


ulonglong FUN_00d3e7f0(longlong param_1,ulonglong param_2)

{
  ...
  if ((uVar4 & 1) != 0) {
    uVar4 = FUN_00d3efa0(param_1);
    if ((((uVar4 & 4) != 0) || (uVar4 = FUN_00d3efa0(param_1), (uVar4 & 2) != 0)) &&
       (cVar1 = FUN_00d3f270(param_1), cVar1 != '\x03')) {
      return param_2;
    }
    uVar8 = (undefined7)((ulonglong)unaff_RDI >> 8);
    if ((*(int *)(param_1 + 0xc4) == 0x15) && (*(int *)(param_1 + 200) == 0x15)) {
      uVar7 = (undefined4)CONCAT71(uVar8,0x4a);
    }
    else if (*(int *)(param_1 + 200) == 0x15) {
      uVar7 = (undefined4)CONCAT71(uVar8,0x49);
    }
    else if (*(char *)(param_1 + 0xc0) == '\0') {
      uVar7 = (undefined4)CONCAT71(uVar8,0x4b);
    }
    else {
      uVar7 = (undefined4)CONCAT71(uVar8,0x48);
    }
    ...
    if ((0 < *(int *)(param_1 + 0x114)) && (iVar2 = FUN_004230c0(param_2), 0 < iVar2)) {
