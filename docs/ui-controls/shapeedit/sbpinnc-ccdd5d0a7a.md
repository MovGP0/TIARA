...
> Analysis status: Source reviewed for TIARA-diz.6.7.1578.
...
| --- | --- |
| Form | ShapeEdit |
| Component path | ShapeEdit.PartsPanel.PinPanel.sbPinNC |
| Control class | TSpeedButton |
| Caption | Normal clock pin |
| Hint | Normal clock pin |
| Handler name | sbPinNDClick |
| Handler address | 01797fc0 |
| Graph node | `resource:dfm:ShapeEdit/ShapeEdit.PartsPanel.PinPanel.sbPinNC` |
...
This control shares the recovered handler with `ShapeEdit.PartsPanel.PinPanel.sbPinLC`, `ShapeEdit.PartsPanel.PinPanel.sbPinLD`, `ShapeEdit.PartsPanel.PinPanel.sbPinLDC`, `ShapeEdit.PartsPanel.PinPanel.sbPinLN`, `ShapeEdit.PartsPanel.PinPanel.sbPinMini`, `ShapeEdit.PartsPanel.PinPanel.sbPinND`, `ShapeEdit.PartsPanel.PinPanel.sbPinNDC`, `ShapeEdit.PartsPanel.PinPanel.sbPinNN`, `ShapeEdit.PartsPanel.PinPanel.sbPinX`. This article keeps the resource evidence for this control separate.

## Click flow

```mermaid
flowchart TD
    control["Normal clock pin"] --> handler["sbPinNDClick at 01797fc0"]
...
- Extracted glyph 1: [0430_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNC_Glyph_Data.png](../../../glyph/0430_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNC_Glyph_Data.png)
...
- Resource context: The recovered TSpeedButton resource uses caption `Normal clock pin` and hint `Normal clock pin`. The extracted glyph was visually inspected. It agrees with the recovered resource intent, but the source path remains the behavior proof.
