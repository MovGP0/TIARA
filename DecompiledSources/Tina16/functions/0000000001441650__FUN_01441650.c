/* Ghidra address: 01441650 */
/* Ghidra symbol: FUN_01441650 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_01441650(longlong *param_1,longlong *param_2,longlong param_3)

{
  ...
  if (puVar5 == (undefined2 *)0x0) {
    ...
    *puVar5 = *(undefined2 *)(param_3 + 0x10);
    if (((*(char *)*param_1 == '\v') && (*local_168 != 0.0)) ||
       ((*(char *)*param_1 == '\n' && (*local_168 / _DAT_0210e4d0 < 0.9999999999)))) {
      ...
      if (lVar6 == 0) {
        ...
        *(char *)(*param_1 + 0xa4) = *(char *)(*param_1 + 0xa4) + '\x01';
        ...
        if (*(char *)*param_1 == '\v') {
          ...
          *(undefined4 *)(puVar2 + 4) = *(undefined4 *)(param_3 + 0x40);
          ...
          *(double *)(puVar7 + 4) = *local_168;
          ...
          if (cVar3 == '\0') {
            *(undefined1 *)(puVar7 + 8) = 0;
            ...
            FUN_00414ff0(local_160,&LAB_014419bc);
