/* Ghidra address: 00d787d0 */
/* Ghidra symbol: FUN_00d787d0 */


void FUN_00d787d0(longlong param_1)

{
  ...
  FUN_00d75af0(param_1);
  if (*(longlong *)(param_1 + 0x90) != 0) {
    lVar2 = FUN_00d5a350(*(longlong *)(param_1 + 0x90),
                         *(undefined8 *)(*(longlong *)(param_1 + 0x120) + 0x20),
                         *(longlong *)(param_1 + 0x120) + 0x10);
    if (lVar2 != 0) {
      local_20 = (undefined8 *)(param_1 + 0x120);
      uVar1 = *local_20;
      *local_20 = 0;
      FUN_00410f20(uVar1);
