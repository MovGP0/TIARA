/* Ghidra address: 01aa4e10 */
/* Ghidra symbol: FUN_01aa4e10 */


bool FUN_01aa4e10(char *param_1,undefined8 param_2)

{
  ...
  if (param_1[0x564] == '\0') {
    local_8c[0] = (&DAT_01fce3e8)
                  [(byte)(&DAT_01fce41d)[(ulonglong)local_f0[1] + (ulonglong)local_f0[0] * 4]];
  }
  else {
  ...
  bVar1 = (&DAT_01fce3e8)
          [(byte)(&DAT_01fce41d)
                 [(ulonglong)(byte)param_1[0x569] + (ulonglong)(byte)param_1[0x568] * 4]];
  if (bVar1 != local_8c[0]) {
