/* Ghidra address: 019acb60 */
/* Ghidra symbol: FUN_019acb60 */


void FUN_019acb60(longlong param_1,longlong param_2)
  ...
  if (-1 < iVar8 + -1) {
    do {
      ...
      if ((((cVar1 == '\x04') && (sVar2 = (**(code **)(*plVar4 + 0xf8))(plVar4), sVar2 != 0x3a)) &&
        ...
        if (((cVar1 == '\0') || (*(char *)(plVar4[0x35] + 0xb0) != '\0')) ||
...
LAB_019acca8:
          ...
          if (local_50[0] != 0) {
            ...
            if (iVar3 < 1) goto LAB_019acca8;
          }
          FUN_019acb60(param_1,*(undefined8 *)(plVar4[0x35] + 8));
        }
      }
      iVar7 = iVar7 + 1;
      iVar8 = iVar8 + -1;
