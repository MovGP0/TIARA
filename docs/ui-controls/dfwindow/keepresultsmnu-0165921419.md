...
```mermaid
flowchart LR
    control["Keep results"] -->|OnClick| handler["FUN_01a78d60"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A78D60__FUN_01a78d60.c](../../../DecompiledSources/Tina16/functions/0000000001A78D60__FUN_01a78d60.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFMainMenu.DFViewMnu.KeepResultsMnu.OnClick.
