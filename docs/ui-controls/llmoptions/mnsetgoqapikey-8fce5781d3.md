...
```mermaid
flowchart LR
    control["Set GROQ API Key"] -->|OnClick| handler["FUN_019db340"]
    handler --> call1["FUN_019db260"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000019DB340__FUN_019db340.c](../../../DecompiledSources/Tina16/functions/00000000019DB340__FUN_019db340.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: LLMOptions.pmSetAPIKey.mnSetGoqAPIKey.OnClick.
