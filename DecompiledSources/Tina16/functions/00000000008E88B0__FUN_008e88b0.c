/* Ghidra address: 008e88b0 */
/* Ghidra symbol: FUN_008e88b0 */


void FUN_008e88b0(undefined8 param_1,uint param_2,undefined1 *param_3,int param_4,
                 undefined4 *param_5)

{
      ...
      if (param_2 - 0x10000 < 0x100000) {
        *param_5 = 4;
        if ((param_3 != (undefined1 *)0x0) && (0 < param_4)) {
          ...
          *param_3 = (char)((ushort)sVar2 >> 8);
          if ((1 < param_4) && (param_3[1] = (char)sVar2, 2 < param_4)) {
            uVar3 = (ushort)param_2 & 0x3ff;
            param_3[2] = (byte)(uVar3 >> 8) ^ 0xdc;
            if (3 < param_4) {
  ...
  *param_5 = 2;
  if (((param_3 != (undefined1 *)0x0) && (0 < param_4)) &&
     (*param_3 = (char)(param_2 >> 8), 1 < param_4)) {
