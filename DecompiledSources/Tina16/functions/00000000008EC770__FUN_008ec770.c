/* Ghidra address: 008ec770 */
/* Ghidra symbol: FUN_008ec770 */


undefined8 FUN_008ec770(undefined8 param_1,byte param_2)
...
LAB_008ec81e:
      ...
      uVar3 = uVar1 - 0xa6;
      if ((uVar1 - 0xa6 < 4) || (uVar3 = uVar1 - 0xab, uVar1 - 0xab < 3)) goto LAB_008ec81e;
      lVar2 = uVar1 - 0xaf;
      if (lVar2 == 0) {
        return 0x2015;
      }
