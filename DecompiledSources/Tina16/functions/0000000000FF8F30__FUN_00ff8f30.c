/* Ghidra address: 00ff8f30 */
/* Ghidra symbol: FUN_00ff8f30 */


void FUN_00ff8f30(longlong param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4)

{
  ...
  uVar2 = FUN_00ff87b0(param_1,local_res18[0]);
  iVar3 = FUN_00ff8e20(param_1,uVar2);
  FUN_00ff8e30(param_1,iVar3);
  *(undefined4 *)(param_1 + 0x44 + (longlong)iVar3 * 4) = param_4;
  FUN_00ff8aa0(param_1,local_20,iVar3);
  FUN_00ff8c60(param_1,&local_28,iVar3);
  ...
  if (cVar1 == '\0') {
    ...
    FUN_00416cd0(&local_70,3,L"TRIS  ",local_78,local_res18[0]);
    ...
    FUN_00ff8e40(param_1,param_2,local_48,local_20[0],0);
  }
