...
impl Window {
    ...
    pub fn view(&self) -> Element<'_, Message> {
        ...
        let body: Element<'_, Message> = container(scrollable(
            column![
                row![
                    text("Angle").width(Length::FillPortion(2)),
                    pick_list(
                ...
                row![
                    text("Complex format").width(Length::FillPortion(2)),
                    pick_list(
                        ["Default", "Option 1", "Option 2"],
                        self.selections[1],
                ...
                .align_y(Alignment::Center),
                row![
                    text("Imaginary").width(Length::FillPortion(2)),
                    pick_list(
                        ["Default", "Option 1", "Option 2"],
                        self.selections[2],
                ...
                .align_y(Alignment::Center),
                row![
                    text("Numerical format").width(Length::FillPortion(2)),
                    pick_list(
                        ["Default", "Option 1", "Option 2"],
                        self.selections[3],
                ...
                .spacing(8)
                .align_y(Alignment::Center),
                checkbox("Enable modifying component values", self.checks[0])
                    .on_toggle(move |value| Message::Toggle(0, value)),
                row![
                    text("Step").width(Length::FillPortion(2)),
                ...
                .align_y(Alignment::Center),
                row![
                    text("Interval subdivision").width(Length::FillPortion(2)),
                ...
                .align_y(Alignment::Center),
                row![
                    text("Displayed precision").width(Length::FillPortion(2)),
