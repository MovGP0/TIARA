/* Ghidra address: 017de670 */
/* Ghidra symbol: FUN_017de670 */


void FUN_017de670(longlong param_1,double param_2,longlong param_3,int *param_4)

{
  ...
  if (*(char *)(lVar1 + 0xe) != '\0') {
    FUN_01663140(lVar1,param_3,*param_4,2);
  }
