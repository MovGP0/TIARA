...
```mermaid
flowchart LR
    control["A"] -->|OnClick| handler["FUN_01b68810"]
    handler --> call1["FUN_010f7e00"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001B68810__FUN_01b68810.c](../../../DecompiledSources/Tina16/functions/0000000001B68810__FUN_01b68810.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DC_CharMeasWin.CursorBox.FCursorASelectBtn.OnClick.
