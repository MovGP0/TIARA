/* Ghidra address: 0056ed60 */
/* Ghidra symbol: FUN_0056ed60 */


void FUN_0056ed60(longlong param_1,int param_2,undefined8 *param_3)

{
  ...
  cVar1 = FUN_004113d0(param_3,&PTR_FUN_0057a148);
  if (cVar1 == '\0') {
    ...
    local_40 = local_48;
    local_38 = param_3;
    FUN_0056ebd0(param_1,param_2,local_48,local_50 + -1);
  }
