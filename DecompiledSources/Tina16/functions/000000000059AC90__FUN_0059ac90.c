/* Ghidra address: 0059ac90 */
/* Ghidra symbol: FUN_0059ac90 */


void FUN_0059ac90(longlong *param_1,uint param_2,uint param_3)
  ...
  if (param_2 != param_3) {
    ...
    *(undefined8 *)(*param_1 + lVar2 * 8) = 0;
    if ((int)param_2 < (int)param_3) {
      FUN_00409a70(*param_1 + (longlong)(int)(param_2 + 1) * 8,*param_1 + lVar2 * 8,
