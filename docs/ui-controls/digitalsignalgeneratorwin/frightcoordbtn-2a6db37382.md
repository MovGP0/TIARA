...
```mermaid
flowchart LR
    control["Right"] -->|OnClick| handler["FUN_015109e0"]
    handler --> call1["FUN_015073a0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000015109E0__FUN_015109e0.c](../../../DecompiledSources/Tina16/functions/00000000015109E0__FUN_015109e0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DigitalSignalGeneratorWin.DisplayGroupBox.FRightCoordBtn.OnClick.
