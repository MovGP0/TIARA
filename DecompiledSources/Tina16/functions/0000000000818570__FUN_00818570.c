/* Ghidra address: 00818570 */
/* Ghidra symbol: FUN_00818570 */


void FUN_00818570(longlong param_1,int param_2)
  ...
  if (-1 < iVar1 + -1) {
    do {
      ...
      if (*(char *)(lVar4 + 0xa9) != '\0') {
        ...
        iVar2 = FUN_007fd800(uVar5);
        FUN_00806b40(uVar3,iVar2 + param_2);
      }
      local_1c = local_1c + 1;
      iVar1 = iVar1 + -1;
    } while (iVar1 != 0);
