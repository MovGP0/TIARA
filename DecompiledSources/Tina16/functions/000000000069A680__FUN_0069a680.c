/* Ghidra address: 0069a680 */
/* Ghidra symbol: FUN_0069a680 */


void FUN_0069a680(longlong param_1)

{
  ...
  uVar2 = FUN_00779380(uVar3,(&DAT_01dfbcae)[uVar4 & 0xff]);
  ...
  if ((*(byte *)(plVar1 + 0x59) & 1) == 0) {
    *(undefined4 *)(param_1 + 0x1c) = *(undefined4 *)(plVar1[0x17] + 0x28);
    ...
    uVar2 = FUN_007793a0(uVar3,(&DAT_01dfbcb0)[uVar4 & 0xff]);
