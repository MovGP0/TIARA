/* Ghidra address: 00ed2b60 */
/* Ghidra symbol: FUN_00ed2b60 */


void FUN_00ed2b60(longlong param_1)

{
  ...
  uVar2 = FUN_004170c0(local_30,*(undefined8 *)(param_1 + 0x8b0),1);
  plVar1 = *(longlong **)(param_1 + 0x750);
  ...
  if (local_20 != 0) {
    ...
    if (iVar4 == -1) {
      FUN_00416ba0(&local_78,local_20,&DAT_00ed2f50);
      FUN_00416ea0(local_78,param_1 + 0x8b0,uVar2);
