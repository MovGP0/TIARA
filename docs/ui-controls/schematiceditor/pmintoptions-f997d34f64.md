...
| Component path | SchematicEditor.PopupInteract.pmIntOptions |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.PopupInteract.pmIntOptions` |
...
```mermaid
flowchart LR
    control["Options..."] -->|OnClick| handler["FUN_01c89910"]
