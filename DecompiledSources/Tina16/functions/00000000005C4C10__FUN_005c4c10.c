/* Ghidra address: 005c4c10 */
/* Ghidra symbol: FUN_005c4c10 */


void FUN_005c4c10(longlong param_1,int param_2,longlong *param_3)

{
  ...
  while( true ) {
    ...
    if (cVar1 == '\0') break;
    (**(code **)(*local_20[0] + 0x30))(local_20[0],local_58);
    local_60 = local_58;
