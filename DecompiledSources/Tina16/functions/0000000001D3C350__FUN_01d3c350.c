/* Ghidra address: 01d3c350 */
/* Ghidra symbol: FUN_01d3c350 */


double FUN_01d3c350(longlong *param_1,double param_2)

{
  ...
  if (-1 < local_50) {
    do {
      ...
      cVar2 = FUN_01d3c330(auStack_98,uVar3);
      if (cVar2 != '\0') {
  ...
  if (local_58 != 0) {
    ...
    if (local_4c < (int)param_1[2] + -1) {
      ...
      local_38 = *local_60;
      local_28 = *(double *)(lVar4 + 0x10);
      lVar4 = FUN_00b94e60(param_1,local_4c + 1);
      local_48 = local_28 +
                 ((*(double *)(lVar4 + 0x10) - local_28) * (param_2 - local_38)) /
                 (*(double *)(lVar4 + 8) - local_38);
    }
    else {
      local_48 = *(double *)(local_20 + 0x10);
    }
  }
  return local_48;
}
