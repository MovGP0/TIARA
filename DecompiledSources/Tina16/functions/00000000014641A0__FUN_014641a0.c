/* Ghidra address: 014641a0 */
/* Ghidra symbol: FUN_014641a0 */


void FUN_014641a0(longlong param_1,longlong param_2)

{
  ...
  iVar4 = 0;
  iVar5 = 0;
  iVar2 = (**(code **)(**(longlong **)(param_1 + 0x750) + 0x278))(*(longlong **)(param_1 + 0x750));
  while( true ) {
  ...
  (**(code **)(**(longlong **)(param_1 + 0x750) + 0x290))
            (*(longlong **)(param_1 + 0x750),iVar2 + iVar4);
