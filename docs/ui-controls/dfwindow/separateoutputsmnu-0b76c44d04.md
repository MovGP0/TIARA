...
```mermaid
flowchart LR
    control["Separate outputs"] -->|OnClick| handler["FUN_01a78f10"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A78F10__FUN_01a78f10.c](../../../DecompiledSources/Tina16/functions/0000000001A78F10__FUN_01a78f10.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFMainMenu.DFViewMnu.SeparateOutputsMnu.OnClick.
