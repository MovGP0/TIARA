...
```mermaid
flowchart LR
    control["Annotate curve point ..."] -->|OnClick| handler["FUN_01a8a700"]
    handler --> call1["FUN_00410e60"]
    handler --> call2["Nil-safe Delphi object destruction helper"]
    handler --> call3["FUN_004aeac0"]
    handler --> call4["FUN_01a8a3c0"]
    handler --> call5["FUN_01acff30"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001A8A700__FUN_01a8a700.c](../../../DecompiledSources/Tina16/functions/0000000001A8A700__FUN_01a8a700.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFPopupMnu.DFAnnotatecurvepointMnu.OnClick.
