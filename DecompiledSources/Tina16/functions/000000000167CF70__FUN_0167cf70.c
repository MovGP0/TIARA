/* Ghidra address: 0167cf70 */
/* Ghidra symbol: FUN_0167cf70 */


void FUN_0167cf70(undefined8 param_1,longlong param_2,undefined4 param_3)

{
  ...
  FUN_016ebb00(param_1,1,local_5e8,0x538);
  uVar2 = FUN_01b05c20(param_1,1);
  FUN_016ee260(param_1,&local_5f0,0x13c0,0);
  if (local_30 == '\0') {
    cVar1 = FUN_016e9de0(param_1,4);
    if (cVar1 == '\0') {
      FUN_01665f90(param_1,param_2,param_3,1,2,3,3,&local_b0,local_5e8,uVar2,local_5f0);
    }
    else {
      FUN_01665f90(param_1,param_2,param_3,1,2,3,4,&local_b0,local_5e8,uVar2,local_5f0);
    }
    FUN_016e9f40(param_1,FUN_0167cf10);
    FUN_016e9f60(param_1,FUN_01664840);
    FUN_016e9fb0(param_1,FUN_016648d0);
    FUN_016e9fd0(param_1,FUN_016649d0);
    FUN_016ea010(param_1,FUN_01664d20);
    FUN_016ea020(param_1,FUN_01664ea0);
    FUN_016e9fc0(param_1,FUN_01664930);
    FUN_016e9f50(param_1,FUN_016697d0);
  }
  return;
}
