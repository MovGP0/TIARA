...
| Component path | SchematicEditor.MainMenu.Insert.mnShape.mnArrow.mnArrowLinear |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Insert.mnShape.mnArrow.mnArrowLinear` |
...
```mermaid
flowchart TD
    control["&Linear"] -->|"OnClick"| handler["InsertShape (01c97500)"]
