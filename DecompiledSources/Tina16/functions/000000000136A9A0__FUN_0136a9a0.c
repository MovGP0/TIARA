/* Ghidra address: 0136a9a0 */
/* Ghidra symbol: FUN_0136a9a0 */


void FUN_0136a9a0(longlong param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if (lVar4 != 0) {
    ...
    if (cVar2 == '\x04') {
      ...
      uVar7 = CONCAT44(uVar8,local_34);
      (**(code **)(*plVar5 + 0x30))(plVar5,local_40,local_3c,local_38,uVar7);
      *(undefined1 *)(lVar4 + 0x540) = *(undefined1 *)(param_1 + 0x18);
      uVar3 = FUN_0198d430(plVar1);
      uVar7 = CONCAT71((int7)((ulonglong)uVar7 >> 8),PTR_DAT_02004010[0x814]);
      FUN_017be0e0(lVar4,uVar3,&local_40,PTR_DAT_02004010[0x816],uVar7,*PTR_DAT_020037e8,
                   PTR_DAT_02004010[0x815],*PTR_DAT_02005310);
      uVar8 = (undefined4)((ulonglong)uVar7 >> 0x20);
      plVar5 = (longlong *)FUN_0198d430(plVar1);
