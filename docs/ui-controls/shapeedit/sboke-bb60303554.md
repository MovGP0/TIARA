...
```mermaid
flowchart LR
    control["OK|Apply changes"] -->|OnClick| handler["FUN_0179cea0"]
...
- Extracted glyph: [`0422_ShapeEdit_ShapeEdit_TopToolBar_GeneralTools_sbOKE_Glyph_Data.png`](../../../glyph/0422_ShapeEdit_ShapeEdit_TopToolBar_GeneralTools_sbOKE_Glyph_Data.png)
