/* Ghidra address: 0138a0c0 */
/* Ghidra symbol: FUN_0138a0c0 */


void FUN_0138a0c0(longlong param_1,char param_2)

{
  double *pdVar1;
  double local_20;
  
  local_20 = (double)FUN_00b90090(*(undefined8 *)(param_1 + 0xc30));
  if (param_2 == '\0') {
  ...
  if (*(char *)(param_1 + 0xe4a) == '\0') {
    *(double *)(param_1 + 0xe50) = *(double *)(param_1 + 0xe60) - local_20 / 2.0;
    *(double *)(param_1 + 0xe58) = *(double *)(param_1 + 0xe60) + local_20 / 2.0;
  }
  else {
    *(double *)(param_1 + 0xe58) = local_20;
  }
