...
| Component path | SchematicEditor.MainMenu.Help.mnDesignSoftontheWeb.wwwdesignsoftwarecom |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Help.mnDesignSoftontheWeb.wwwdesignsoftwarecom` |
...
```mermaid
flowchart TD
    control["www.designsoftware.com"] -->|"OnClick"| handler["OnTheWeb (01c8f060)"]
