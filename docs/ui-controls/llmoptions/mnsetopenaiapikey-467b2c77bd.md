...
```mermaid
flowchart LR
    control["Set OpenAI API Key..."] -->|OnClick| handler["FUN_019db3e0"]
    handler --> call1["FUN_019db260"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000019DB3E0__FUN_019db3e0.c](../../../DecompiledSources/Tina16/functions/00000000019DB3E0__FUN_019db3e0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: LLMOptions.pmSetAPIKey.mnSetOpenAIApiKey.OnClick.
