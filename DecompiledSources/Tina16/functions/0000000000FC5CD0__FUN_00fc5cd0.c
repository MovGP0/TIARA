/* Ghidra address: 00fc5cd0 */
/* Ghidra symbol: FUN_00fc5cd0 */


void FUN_00fc5cd0(longlong param_1)

{
  ...
  if (iVar1 < 0) {
    FUN_0064de00(*(undefined8 *)(param_1 + 0x6b8),&DAT_00fc5fc4);
  }
  if (iVar3 <= iVar1) {
  ...
  if (0.0 < dVar5) {
    ...
    FUN_00416cd0(&local_90,3,L"Time: ",local_98,&DAT_00fc6040);
