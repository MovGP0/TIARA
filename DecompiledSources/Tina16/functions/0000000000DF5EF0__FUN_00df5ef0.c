/* Ghidra address: 00df5ef0 */
/* Ghidra symbol: FUN_00df5ef0 */


void FUN_00df5ef0(longlong param_1,longlong param_2,char param_3,ulonglong param_4)

{
  ...
  if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
    ...
    FUN_01662860(*(longlong *)(param_2 + 0x110),4,0,*(undefined8 *)(lVar3 + 0x58),uVar5,0,0);
    uVar6 = (undefined4)((ulonglong)uVar5 >> 0x20);
  }
  FUN_017de460(*(undefined8 *)(param_2 + 0xd8),0x3ff0000000000000,*(undefined8 *)(lVar3 + 0x58),
               local_3c);
  if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
    FUN_01662860(*(longlong *)(param_2 + 0x110),1,*(longlong *)(lVar3 + 0x18) + 8,
                 *(undefined8 *)(lVar3 + 0x58),CONCAT44(uVar6,local_3c[0]),param_2 + 0x480,0);
  }
  ...
  if (((param_3 != '\b') && (*(char *)(param_2 + 0x325) == '\0')) &&
    ...
    if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
      FUN_01662860(*(longlong *)(param_2 + 0x110),0x101,*(double **)(lVar3 + 0x18),
                   *(undefined8 *)(lVar3 + 0x58),local_3c[0],param_2 + 0x480,1);
    }
