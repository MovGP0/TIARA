/* Ghidra address: 013b2a90 */
/* Ghidra symbol: FUN_013b2a90 */


void FUN_013b2a90(longlong param_1,byte *param_2,undefined8 *param_3)

{
  ...
  if (-1 < iVar1 + -1) {
    do {
      ...
      if (iVar2 == 0) {
        uVar6 = FUN_00daedf0(*(undefined8 *)(param_1 + 0x278),iVar4);
        *param_3 = uVar6;
        break;
      }
      iVar4 = iVar4 + 1;
