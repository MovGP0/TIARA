/* Ghidra address: 0141f360 */
/* Ghidra symbol: FUN_0141f360 */


void FUN_0141f360(undefined8 param_1,undefined8 param_2,undefined4 param_3)

{
  ...
  if ((cVar1 == '\x01') || ((byte)(cVar1 - 5U) < 2)) {
    ...
    FUN_016ed320(param_1,0xc,uVar6,0,0);
  }
    ...
    FUN_016ed320(param_1,0xc,uVar8,uVar9,0);
  }
  return;
}
