/* Ghidra address: 008111d0 */
/* Ghidra symbol: FUN_008111d0 */


void FUN_008111d0(longlong param_1,longlong param_2)
      ...
      if (0 < iVar2) {
        ...
        if (cVar1 != '\0') {
          ...
          if (0 < iVar2) {
            ...
            if (0 < iVar2) {
              plVar7 = (longlong *)FUN_00781840();
              (**(code **)(*plVar7 + 0x198))(plVar7,local_2c,0x23);
              uVar6 = FUN_00781840();
          ...
          FUN_00811f80(param_1,local_8c);
          iVar2 = FUN_004230c0(local_8c);
          if (0 < iVar2) {
            FUN_00811f80(param_1,local_9c);
            iVar2 = FUN_004230a0(local_9c);
            if (0 < iVar2) {
              plVar7 = (longlong *)FUN_00781840();
              (**(code **)(*plVar7 + 0x198))(plVar7,local_2c,*(undefined1 *)(param_1 + 0x50));
              uVar6 = FUN_00781840();
              uVar8 = FUN_00609e10(local_20);
              uVar8 = FUN_005ffa40(uVar8);
          ...
          FUN_00811f80(param_1,local_ac);
          iVar2 = FUN_004230c0(local_ac);
          if (iVar2 < 1) {
            plVar7 = (longlong *)FUN_00781840();
            (**(code **)(*plVar7 + 0x198))(plVar7,local_2c,0xd);
          }
          else {
            plVar7 = (longlong *)FUN_00781840();
            (**(code **)(*plVar7 + 0x198))(plVar7,local_2c,*(undefined1 *)(param_1 + 0x51));
          }
          uVar6 = FUN_00781840();
          uVar8 = FUN_00609e10(local_20);
          uVar8 = FUN_005ffa40(uVar8);
          ...
          local_130 = local_130 & 0xffffffff00000000;
          FUN_00778dc0(uVar6,uVar8,local_2c,local_f0);
          FUN_00811f80(param_1,local_bc);
          iVar2 = FUN_004230c0(local_bc);
          if (iVar2 < 1) {
            plVar7 = (longlong *)FUN_00781840();
            (**(code **)(*plVar7 + 0x198))(plVar7,local_2c,0x11);
          }
          else {
            plVar7 = (longlong *)FUN_00781840();
            (**(code **)(*plVar7 + 0x198))(plVar7,local_2c,*(undefined1 *)(param_1 + 0x40));
          }
          uVar6 = FUN_00781840();
          uVar8 = FUN_00609e10(local_20);
          uVar8 = FUN_005ffa40(uVar8);
