/* Ghidra address: 015b3aa0 */
/* Ghidra symbol: FUN_015b3aa0 */


void FUN_015b3aa0(longlong param_1)

{
  ...
  *(undefined4 *)(param_1 + 0x7c) = 0x76543210;
  *(undefined4 *)(param_1 + 0x80) = 0xfedcba98;
  *(undefined4 *)(param_1 + 0x84) = 0x89abcdef;
  *(undefined4 *)(param_1 + 0x88) = 0x1234567;
