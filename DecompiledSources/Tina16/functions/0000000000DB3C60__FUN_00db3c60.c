/* Ghidra address: 00db3c60 */
/* Ghidra symbol: FUN_00db3c60 */


void FUN_00db3c60(longlong param_1,longlong *param_2)

{
  ...
  if (-1 < local_8c) {
    do {
      ...
      FUN_00416ba0(&local_30,local_78,&LAB_00db3efc);
