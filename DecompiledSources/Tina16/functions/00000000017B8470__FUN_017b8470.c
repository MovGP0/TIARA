/* Ghidra address: 017b8470 */
/* Ghidra symbol: FUN_017b8470 */


void FUN_017b8470(longlong *param_1,longlong param_2,ulonglong param_3)

{
  ...
  if (param_2 != 0) {
    ...
    FUN_005fd4e0(*(undefined8 *)(param_2 + 0x78),0x800080);
    FUN_005fd670(*(undefined8 *)(param_2 + 0x78),4);
