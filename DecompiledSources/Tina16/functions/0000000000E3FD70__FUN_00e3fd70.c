/* Ghidra address: 00e3fd70 */
/* Ghidra symbol: FUN_00e3fd70 */


void FUN_00e3fd70(int *param_1,longlong param_2,longlong param_3,undefined4 param_4)

{
  ...
  if (bVar9) {
    ...
    *(double *)(param_1 + 0x2a) =
         *(double *)(param_1 + 0x2a) + (double)param_1[1] * *(double *)(param_1 + 0xba) * dVar10;
    ...
    *(double *)(lVar5 + (longlong)(iVar8 + 0x12) * 8) =
    ...
    lVar5 = *(longlong *)(param_3 + 0x1b8);
    *(undefined8 *)(lVar5 + (longlong)(iVar8 + 0x14) * 8) = *(undefined8 *)(param_1 + 0x8e);
    *(undefined8 *)(lVar5 + (longlong)(iVar8 + 0x15) * 8) = *(undefined8 *)(param_1 + 0x90);
