/* Ghidra address: 00df7320 */
/* Ghidra symbol: FUN_00df7320 */


void FUN_00df7320(longlong param_1,longlong param_2,undefined8 param_3,ulonglong param_4)

{
  ...
  uVar6 = FUN_01b05600(param_1,*(undefined1 *)(*(longlong *)(lVar1 + 8) + 4));
  uVar7 = FUN_01b05690(param_1,param_4 & 0xffffffff,1);
  uVar8 = FUN_01b05690(param_1,param_4 & 0xffffffff,2);
  *(undefined4 *)(lVar1 + 0x68) = 0;
  FUN_017ddc70(*(undefined8 *)(param_2 + 0xd8),uVar3,uVar2,uVar7,lVar1 + 0x58,lVar1 + 0x60,
               lVar1 + 0x68);
  FUN_017ddc70(*(undefined8 *)(param_2 + 0xd8),uVar3,uVar2,uVar8,lVar1 + 0x58,lVar1 + 0x60,
               lVar1 + 0x68);
  FUN_017ddc70(*(undefined8 *)(param_2 + 0xd8),uVar4,uVar5,uVar7,lVar1 + 0x58,lVar1 + 0x60,
               lVar1 + 0x68);
  FUN_017ddc70(*(undefined8 *)(param_2 + 0xd8),uVar5,uVar6,uVar8,lVar1 + 0x58,lVar1 + 0x60,
               lVar1 + 0x68);
  FUN_017ddb80(*(undefined8 *)(param_2 + 0xd8),uVar7,*(undefined4 *)(param_2 + 0x308),lVar1 + 0x58,
