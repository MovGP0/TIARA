...
| Handler | `btnSetupACCornerTestClick` at `012c62b0` |
...
```mermaid
flowchart TD
    control["Setup AC corner test"] --> handler["btnSetupACCornerTestClick at 012c62b0"]
...
- [Recovered btnSetupACCornerTestClick source](../../../DecompiledSources/Tina16/functions/00000000012C62B0__FUN_012c62b0.c)
