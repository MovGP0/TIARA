/* Ghidra address: 00b28390 */
/* Ghidra symbol: FUN_00b28390 */


void FUN_00b28390(longlong param_1,uint param_2)

{
  ...
  if (-1 < iVar3 + -1) {
    do {
      plVar1 = (longlong *)FUN_004aeac0(*(undefined8 *)(param_1 + 0x18),iVar2);
