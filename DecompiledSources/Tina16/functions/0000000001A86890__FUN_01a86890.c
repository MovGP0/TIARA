/* Ghidra address: 01a86890 */
/* Ghidra symbol: FUN_01a86890 */


void FUN_01a86890(longlong param_1)

{
  ...
  cVar1 = FUN_01ae6c10(*(undefined8 *)(param_1 + 0x798),(double)iVar2,local_30,&local_38);
  if (cVar1 == '\0') {
    uVar4 = FUN_00b89270();
    FUN_0041ddd0(&local_98,&PTR_PTR_01a860c0);
    FUN_00b8e650(uVar4,&local_90,L"DrawWind.PhaseMarginError",local_98);
    FUN_0072d440(local_90,1,4,0);
  }
  else {
    plVar3 = (longlong *)FUN_004b6930(&PTR_FUN_00478280,1);
    uVar4 = FUN_00b89270();
    FUN_0041ddd0(&local_68,&PTR_PTR_01a86080);
    FUN_00b8e650(uVar4,local_60,L"DrawWind.PhaseMargin",local_68);
