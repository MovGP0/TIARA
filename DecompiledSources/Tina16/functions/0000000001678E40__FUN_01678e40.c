/* Ghidra address: 01678e40 */
/* Ghidra symbol: FUN_01678e40 */


void FUN_01678e40(longlong param_1,longlong param_2,undefined4 param_3,undefined1 param_4,
...

{
  ...
  *(char *)(param_10 + 2) = cVar1;
  ...
  FUN_016ebfa0(param_1,*(char *)(param_10 + 2) + '\n',*(undefined1 *)((longlong)param_10 + 0x11),
               *(undefined1 *)((longlong)param_10 + 0x12),uVar5);
  uVar8 = (uint7)((ulonglong)uVar5 >> 8);
  if (*(char *)(param_2 + 0xed6) == '\0') {
    ...
    FUN_016ebfa0(param_1,*(char *)(param_10 + 2) + '\f',*(undefined1 *)((longlong)param_10 + 0x12),
                 *(undefined1 *)((longlong)param_10 + 0xf),uVar7 & 0xffffffffffffff00);
  }
  else {
    FUN_016ebfa0(param_1,*(char *)(param_10 + 2) + '\v',*(undefined1 *)((longlong)param_10 + 0x12),
                 *(undefined1 *)(param_10 + 4),CONCAT71(uVar8,1));
    FUN_016ebfa0(param_1,*(char *)(param_10 + 2) + '\f',*(undefined1 *)((longlong)param_10 + 0x12),
