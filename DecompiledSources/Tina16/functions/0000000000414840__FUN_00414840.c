/* Ghidra address: 00414840 */
/* Ghidra symbol: FUN_00414840 */


void FUN_00414840(undefined8 *param_1,undefined8 param_2,int param_3,undefined4 param_4)

{
  ...
  if (param_3 < 1) {
    ...
    if ((iVar2 < 0x7ff) &&
      ...
      FUN_00414740(param_1,local_1028,iVar1);
      return;
    }
