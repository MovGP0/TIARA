/* Ghidra address: 004dacc0 */
/* Ghidra symbol: FUN_004dacc0 */


undefined1 FUN_004dacc0(longlong param_1,undefined4 param_2)
  ...
  if (cVar1 != '\0') {
    ...
    if (-1 < iVar2 + -1) {
      do {
        ...
        cVar1 = FUN_00452340(local_40,&DAT_004dadf0,uVar3);
        if ((cVar1 != '\0') &&
