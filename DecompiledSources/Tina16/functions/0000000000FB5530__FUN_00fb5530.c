/* Ghidra address: 00fb5530 */
/* Ghidra symbol: FUN_00fb5530 */


double FUN_00fb5530(longlong param_1,double param_2,double param_3,double param_4)
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        iVar1 = FUN_004170c0(&LAB_00fb57d4,local_28,1);
        if (iVar1 == 0) {
          local_30 = (param_2 - 2.0) * 2.0 * param_3 * param_4;
          goto code_r0x00fb571b;
        }
      }
