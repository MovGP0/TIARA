/* Ghidra address: 0055dff0 */
/* Ghidra symbol: FUN_0055dff0 */


longlong * FUN_0055dff0(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_00531698,1,(longlong)param_3);
  local_res18 = 0;
