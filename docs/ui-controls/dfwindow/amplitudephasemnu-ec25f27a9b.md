...
```mermaid
flowchart LR
    control["Amplitude, Phase"] -->|OnClick| handler["FUN_01a87d20"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A87D20__FUN_01a87d20.c](../../../DecompiledSources/Tina16/functions/0000000001A87D20__FUN_01a87d20.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFMainMenu.DFViewMnu.Vectorlabelstyle1.AmplitudePhaseMnu.OnClick.
