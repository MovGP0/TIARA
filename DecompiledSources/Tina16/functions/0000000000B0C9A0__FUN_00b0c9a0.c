/* Ghidra address: 00b0c9a0 */
/* Ghidra symbol: FUN_00b0c9a0 */


void FUN_00b0c9a0(longlong *param_1,undefined8 *param_2,int param_3,undefined4 param_4,
                 undefined8 param_5)

{
  ...
  if ((*(uint *)(param_1 + 5) & 0x80) != 0) {
    ...
    if (cVar1 == '\x01') {
      iVar2 = FUN_00b0cc40(param_1,param_5);
      local_58 = param_3 + iVar2 + 1;
    }
  }
  FUN_00415dd0(local_50,param_1[0x14],0);
