/* Ghidra address: 013b2b90 */
/* Ghidra symbol: FUN_013b2b90 */


void FUN_013b2b90(longlong param_1,byte *param_2,undefined8 param_3,undefined4 param_4)

{
  ...
  if (-1 < iVar1 + -1) {
    do {
      ...
      if (iVar2 == 0) {
        FUN_00daee40(*(undefined8 *)(param_1 + 0x278),local_238,iVar4);
        FUN_00415020(param_3,local_238,param_4);
        break;
      }
      iVar4 = iVar4 + 1;
      iVar1 = iVar1 + -1;
