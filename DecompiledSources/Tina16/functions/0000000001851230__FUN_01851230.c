/* Ghidra address: 01851230 */
/* Ghidra symbol: FUN_01851230 */


void FUN_01851230(longlong param_1,undefined8 param_2)

{
  ...
  if (iVar1 == 1) {
    ...
    FUN_0046ccc0(uVar2,param_2,1,local_30);
  }
  else if (iVar1 == 2) {
    uVar2 = FUN_01847650(*(undefined8 *)(param_1 + 0x88));
    plVar3 = (longlong *)FUN_01847630(param_1,0);
    ...
    FUN_0046ccc0(uVar2,param_2,2,&local_50);
  }
  else if (iVar1 == 3) {
    uVar2 = FUN_01847650(*(undefined8 *)(param_1 + 0x88));
    plVar3 = (longlong *)FUN_01847630(param_1,0);
    ...
    FUN_0046ccc0(uVar2,param_2,3,&local_90);
  }
