/* Ghidra address: 01c17010 */
/* Ghidra symbol: FUN_01c17010 */


void FUN_01c17010(longlong *param_1,undefined4 *param_2,undefined4 *param_3,undefined8 param_4)

{
  ...
  if (*(char *)((longlong)param_1 + 0x344) != '\0') {
    ...
    if (cVar1 != '\0') {
      ...
      uVar8 = 0;
      FUN_00778dc0(uVar3,uVar4,local_48,param_1 + 0x76,0,0);
      goto LAB_01c1712a;
    }
  }
  if (*(char *)((longlong)param_1 + 0x344) != '\0') {
    ...
    uVar4 = FUN_005ffa40(param_1[0x62]);
    plVar5 = (longlong *)FUN_00781840();
    (**(code **)(*plVar5 + 0x158))(plVar5,local_48,0x1f);
    uVar8 = 0;
    FUN_00778dc0(uVar3,uVar4,local_48,param_1 + 0x76,0,0);
  }
LAB_01c1712a:
  ...
  lVar6 = *(longlong *)(param_1[0x62] + 0x70);
  uVar2 = (**(code **)(*param_1 + 0x288))(param_1);
  uVar2 = thunk_FUN_03f3ed25(*(undefined4 *)(*(longlong *)(lVar6 + 0x18) + 0x28),uVar2,
                             *(undefined4 *)(*(longlong *)PTR_DAT_02005950 + 0x98));
  FUN_005fcc80(lVar6,uVar2);
  if (*(char *)(param_1[100] + 0xb0) != '\0') {
    FUN_005fce70(*(longlong *)(param_1[0x62] + 0x70),
                 *(byte *)(*(longlong *)(*(longlong *)(param_1[0x62] + 0x70) + 0x18) + 0x31) | 1);
  }
  local_38 = param_1[0x76];
  uStack_30 = param_1[0x77];
  uVar3 = FUN_005ffa40(param_1[0x62]);
  uVar7 = CONCAT44(uVar8,*param_3) | 0x500;
  FUN_01c167d0(param_1,uVar3,local_res20,&local_38,uVar7);
  uVar8 = (undefined4)(uVar7 >> 0x20);
  FUN_00423b50(&local_38,*param_2,
               (longlong)
               ((*(int *)((longlong)param_1 + 0x3bc) - *(int *)((longlong)param_1 + 0x3b4)) -
               (uStack_30._4_4_ - local_38._4_4_)) / 2 & 0xffffffff);
  uVar3 = FUN_005ffa40(param_1[0x62]);
  uVar4 = CONCAT44(uVar8,*param_3);
  FUN_01c167d0(param_1,uVar3,local_res20,&local_38,uVar4);
  ...
  if ((cVar1 != '\0') && (param_1[100] != 0)) {
    ...
    if (cVar1 == '\0') {
      ...
      *param_3 = uVar2;
      ...
      FUN_00423010(&local_58,*(undefined4 *)((longlong)param_1 + 0x374),local_38._4_4_,
                   *(undefined4 *)((longlong)param_1 + 0x37c),uVar3);
      uVar8 = (undefined4)((ulonglong)uVar3 >> 0x20);
      local_38 = local_58;
      uStack_30 = lStack_50;
      FUN_00423400(&local_38,(int)param_1[0x13],0);
      uVar3 = FUN_005ffa40(param_1[0x62]);
      FUN_01c167d0(param_1,uVar3,*(undefined8 *)(param_1[100] + 0x98),&local_38,
