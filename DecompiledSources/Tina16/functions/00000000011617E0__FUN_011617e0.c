/* Ghidra address: 011617e0 */
/* Ghidra symbol: FUN_011617e0 */


void FUN_011617e0(int param_1,longlong *param_2)

{
  ...
  dVar3 = *(double *)(*param_2 + 0x1c48 + lVar4 * 8);
  ...
  *(double *)(PTR_DAT_02001ad0 + 0x30) = dVar3;
  if (dVar3 == 0.0) {
    FUN_0116da30(*(undefined8 *)PTR_DAT_020052d8,L"HIGHPASSFILTER1",
    ...
    FUN_0116da30(*(undefined8 *)PTR_DAT_020052d8,L"HIGHPASSFILTER",
                 *(undefined4 *)(PTR_DAT_02001ad0 + 0x50),*(undefined4 *)(PTR_DAT_02001ad0 + 0x54),
                 PTR_DAT_020011d0);
  }
  else {
