/* Ghidra address: 012fd8b0 */
/* Ghidra symbol: FUN_012fd8b0 */


void FUN_012fd8b0(longlong param_1)

{
  ...
  if (lVar2 != 0) {
    ...
    if ((-1 < iVar1 + -1) && (lVar2 = *(longlong *)(param_1 + 0xaf8), lVar2 != 0)) {
      ...
      FUN_0064dd90(*(undefined8 *)(param_1 + 0x860),local_20);
      uVar4 = FUN_00b8f030(local_20[0]);
      FUN_012e5740(uVar3,uVar4);
    }
  }
