/* Ghidra address: 00de7bd0 */
/* Ghidra symbol: FUN_00de7bd0 */


undefined8
FUN_00de7bd0(undefined8 param_1,longlong param_2,longlong param_3,undefined8 param_4,int param_5)

{
  ...
  if (local_res18 == 0) {
    ...
    if (cVar1 == '\0') {
      ...
      local_b8 = L"\"";
      FUN_00416cd0(&local_70,5,&DAT_00de8108,local_res18);
  ...
  while( true ) {
    ...
    FUN_0043e1a0(&local_88,*(undefined8 *)(lVar4 + 8));
    iVar2 = FUN_00416db0(local_88,local_40);
    if ((iVar2 == 0) && (param_5 + 1 <= local_38)) break;
    lVar4 = FUN_00de5bc0(*(undefined8 *)(local_30 + 0x10),local_34);
  ...
  if (local_34 < iVar2) {
    ...
    local_c8 = L"\" property is not in the \"";
    local_c0 = local_res18;
    local_b8 = L"\"\'s resource of \"";
    local_b0 = local_res10;
    local_a8 = &DAT_00de8108;
    FUN_00416cd0(&local_90,7,&DAT_00de8108,local_40);
    uVar3 = FUN_0044d490(&PTR_FUN_00de74c8,1,local_90);
    FUN_004134c0(uVar3);
  }
