/* Ghidra address: 00ea82d0 */
/* Ghidra symbol: FUN_00ea82d0 */


undefined8 FUN_00ea82d0(longlong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  local_11 = FUN_00ea4860(*(undefined8 *)(param_1 + 0x20));
  if (local_11 == '\0') {
