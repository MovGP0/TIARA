/* Ghidra address: 00d2b090 */
/* Ghidra symbol: FUN_00d2b090 */


void FUN_00d2b090(longlong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  *puVar1 = *(undefined8 *)(param_1 + 0xa0);
  ...
  (**(code **)(*plVar3 + 0x20))(plVar3,param_2,param_3,0);
