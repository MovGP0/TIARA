/* Ghidra address: 01abace0 */
/* Ghidra symbol: FUN_01abace0 */


void FUN_01abace0(longlong *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((lVar4 != 0) && (param_1[0x1e] != 0)) {
    ...
    (**(code **)(*(longlong *)param_1[9] + 0x80))((longlong *)param_1[9],L"Zero",lVar4);
    iVar6 = -5;
    do {
      FUN_00f05410((double)(local_2c + iVar6));
      uVar1 = FUN_0040c770();
      dVar7 = (double)FUN_0040c760((double)(0x19 - iVar6 * iVar6));
      FUN_00f05410(dVar7 + (double)local_30);
      uVar2 = FUN_0040c770();
