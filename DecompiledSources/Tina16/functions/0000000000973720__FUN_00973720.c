/* Ghidra address: 00973720 */
/* Ghidra symbol: FUN_00973720 */


void FUN_00973720(longlong param_1,longlong param_2,undefined1 *param_3,undefined8 param_4)
  ...
  if (iVar2 == -1) {
    *param_3 = 0x55;
    ...
    if (iVar3 == 0) {
      ...
      if (iVar2 == 0) {
        *(undefined1 *)(*(longlong *)(param_1 + 0x90) + 0x90) = 2;
      }
    }
    else {
      *param_3 = 0x55;
