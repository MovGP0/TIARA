/* Ghidra address: 00a0c9f0 */
/* Ghidra symbol: FUN_00a0c9f0 */


void FUN_00a0c9f0(longlong *param_1,int param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  *(undefined4 *)((longlong)puVar3 + 0x2c) = 0;
  puVar3[6] = *(undefined8 *)(lVar1 + 0x88);
  *(undefined8 **)(lVar1 + 0x88) = puVar3;
  return;
}
