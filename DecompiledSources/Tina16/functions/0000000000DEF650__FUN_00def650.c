/* Ghidra address: 00def650 */
/* Ghidra symbol: FUN_00def650 */


void FUN_00def650(ushort *param_1,undefined8 param_2,longlong param_3,undefined4 param_4,
...

{
  ...
  if (bVar2) {
    ...
    dVar3 = -dVar3 * *(double *)(param_1 + 4) - *(double *)(param_1 + 8) * dVar3 * dVar3;
    if (bVar1 == 6) {
