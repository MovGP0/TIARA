/* Ghidra address: 0112bd50 */
/* Ghidra symbol: FUN_0112bd50 */


char FUN_0112bd50(longlong param_1,undefined8 *param_2)

{
  ...
  if (param_1 == 0) {
    ...
    local_31 = FUN_0044b3d0(param_1,&local_40,PTR_DAT_02004830);
  }
  if (local_31 != '\0') {
    local_5c = 0;
    if (param_1 != 0) {
    ...
    *(undefined4 *)(param_2 + 2) = uStack_78;
    if (*(int *)((longlong)param_2 + 0xc) == 0) {
      uVar1 = FUN_0112b190(param_1,PTR_DAT_02004830);
