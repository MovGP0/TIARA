/* Ghidra address: 01029350 */
/* Ghidra symbol: FUN_01029350 */


void FUN_01029350(longlong param_1,undefined8 param_2,undefined *param_3,undefined4 param_4,
...

{
  ...
  iVar1 = FUN_00f794e0(param_1,local_res18[0],&DAT_01029a68);
  if (iVar1 == -1) {
    FUN_00416ba0(&local_d0,local_res18[0],L" addr error ------------------------------");
    FUN_01028360(param_1,local_d0);
    ...
    FUN_00416cd0(&local_d8,7,local_e0,local_e8,local_f0,local_f8,&DAT_01029a78,local_res18[0],
                 L" addr error ------------------------------");
    ...
    uVar5 = local_48;
    FUN_00416cd0(local_20,8,local_28,local_30,local_38,local_40,&DAT_01029a78,local_res18[0],
                 &DAT_01029a88,local_48);
    ...
    if ((param_5 == 100) || (param_5 == 0x44)) {
      ...
      puVar2 = local_68;
      puVar4 = param_6;
      FUN_00416cd0(&local_50,7,L"LDI ",local_58,L"R16, ",local_60,local_68,&DAT_01029a78,param_6);
      ...
      puVar2 = local_88;
      puVar4 = param_6;
      FUN_00416cd0(&local_70,7,L"LDI ",local_78,L"R16, ",local_80,local_88,&DAT_01029a78,param_6);
      FUN_00f787d0(param_1,param_2,local_70);
    }
    else if ((param_5 == 0x62) || (param_5 == 0x42)) {
      FUN_00416780(&local_98,*(undefined2 *)(param_1 + 0xb0));
      FUN_01027ce0(&local_a0,param_4);
      FUN_00416780(&local_a8,*(undefined2 *)(param_1 + 0xb0));
      puVar3 = &DAT_01029a78;
      puVar2 = local_a8;
      puVar4 = param_6;
      FUN_00416cd0(&local_90,7,L"LDI ",local_98,L"R16, ",local_a0,local_a8,&DAT_01029a78,param_6);
      FUN_00f787d0(param_1,param_2,local_90);
    }
    if (iVar1 < 0x40) {
      FUN_00416780(&local_c8,*(undefined2 *)(param_1 + 0xb0));
      FUN_00416cd0(&local_c0,4,L"OUT ",local_c8,local_res18[0],L", R16",puVar2,puVar3,puVar4,uVar5);
      FUN_00f787d0(param_1,param_2,local_c0);
    }
    else {
      FUN_00416780(&local_b8,*(undefined2 *)(param_1 + 0xb0));
      FUN_00416cd0(&local_b0,4,L"STS ",local_b8,local_res18[0],L", R16",puVar2,puVar3,puVar4,uVar5);
      FUN_00f787d0(param_1,param_2,local_b0);
    }
  }
  FUN_00414560(&local_f8,0x1c);
