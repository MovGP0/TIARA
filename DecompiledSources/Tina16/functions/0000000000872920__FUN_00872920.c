/* Ghidra address: 00872920 */
/* Ghidra symbol: FUN_00872920 */


longlong FUN_00872920(longlong param_1,undefined8 param_2,int param_3)

{
  ...
  if ((iVar2 < 0) || (iVar1 <= iVar2)) {
    ...
    local_18[0] = iVar2;
    param_1 = FUN_0044d8d0(&PTR_FUN_004334c0,param_2,PTR_DAT_02003bc8,local_18,0);
    param_3 = (int)puVar4;
