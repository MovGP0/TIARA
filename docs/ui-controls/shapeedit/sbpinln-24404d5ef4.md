...
```mermaid
flowchart LR
    control["Long pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0425_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLN_Glyph_Data.png`](../../../glyph/0425_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLN_Glyph_Data.png)
