/* Ghidra address: 00d1ccd0 */
/* Ghidra symbol: FUN_00d1ccd0 */


void FUN_00d1ccd0(longlong param_1,longlong param_2,uint param_3)

{
  ...
  if (0 < (int)param_3) {
    ...
    *(int *)(param_1 + 0x28) = *(int *)(param_1 + 0x28) + param_3;
    ...
    lVar3 = param_2 + iVar2;
    uVar1 = param_3 & 0xfffffff0;
    for (; 0xf < (int)param_3; param_3 = param_3 - 0x10) {
      FUN_00d1c5c0(param_1,lVar3);
      lVar3 = lVar3 + 0x10;
    }
