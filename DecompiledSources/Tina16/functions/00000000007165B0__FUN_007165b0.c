/* Ghidra address: 007165b0 */
/* Ghidra symbol: FUN_007165b0 */


void FUN_007165b0(longlong param_1,undefined8 param_2,longlong param_3)

{
  ...
  if (-1 < iVar4 + -1) {
    do {
      ...
      cVar2 = FUN_00452340(*(undefined8 *)(local_30 + 8),&DAT_007167c0,uVar3);
      if (cVar2 != '\0') {
  ...
  if (local_38 == 0) {
    uVar3 = FUN_0044d710(&PTR_FUN_00712030,1,PTR_PTR_02001950);
    FUN_004134c0(uVar3);
  }
  else {
    FUN_0041b890(&local_60,local_38,&DAT_007167c0);
    (**(code **)(*local_60 + 0x88))(local_60,param_2);
  }
