/* Ghidra address: 0167c1b0 */
/* Ghidra symbol: FUN_0167c1b0 */


void FUN_0167c1b0(undefined8 param_1,longlong param_2,undefined4 param_3)

{
  ...
  FUN_016ebb00(param_1,1,local_238,0x188);
  uVar3 = FUN_01b05c20(param_1,1);
  FUN_016ee260(param_1,&local_240,0x468,0);
  if (local_30 == '\0') {
    ...
    if (cVar1 == '\0') {
      ...
      FUN_00e377b0(param_1,param_2,param_3,1,2,3,uVar2,&local_b0,local_238,uVar3,local_240);
    }
    else {
      cVar1 = FUN_016e9de0(param_1,4);
      if (cVar1 == '\0') {
      ...
      FUN_00e35390(param_1,param_2,param_3,1,2,3,uVar2,&local_b0,local_238,uVar3,local_240);
    }
    FUN_016e9f40(param_1,FUN_0167c0f0);
    ...
    FUN_016e9fb0(param_1,FUN_00e2db20);
    FUN_016e9ff0(param_1,FUN_01672150);
    FUN_016ea040(param_1,FUN_01672670);
    FUN_016e9fd0(param_1,FUN_00e2dc50);
  }
  return;
}
