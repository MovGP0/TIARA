...
```mermaid
flowchart LR
    control["Normal pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0426_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNN_Glyph_Data.png`](../../../glyph/0426_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNN_Glyph_Data.png)
