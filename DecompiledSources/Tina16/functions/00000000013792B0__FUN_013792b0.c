/* Ghidra address: 013792b0 */
/* Ghidra symbol: FUN_013792b0 */


undefined8 FUN_013792b0(longlong param_1)

{
  ...
  *(undefined4 *)(param_1 + 0x128) = 0;
  if (*(longlong *)(param_1 + 8) != 0) {
    FUN_00e1a5e0(local_39,&local_48);
    (**(code **)(**(longlong **)(param_1 + 8) + 0x90))(*(longlong **)(param_1 + 8));
    if (local_39[0] != 0) {
      FUN_00e19670(&local_3a);
      local_81 = 0;
      bVar7 = local_39[0];
      do {
        lVar4 = FUN_01106eb0(&PTR_FUN_011051a8,1);
        FUN_004169a0(lVar4 + 8);
