...
```mermaid
flowchart LR
    control["PLA minterm"] -->|OnClick| handler["FUN_01221510"]
    handler --> call1["FUN_011d4970"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001221510__FUN_01221510.c](../../../DecompiledSources/Tina16/functions/0000000001221510__FUN_01221510.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: Func_diagram_form.GroupBox1.RadioButton2.OnClick.
