/* Ghidra address: 00621790 */
/* Ghidra symbol: FUN_00621790 */


undefined8 * FUN_00621790(undefined8 *param_1,char param_2,undefined8 param_3)

{
  ...
  *(undefined1 *)(local_res8 + 3) = 1;
  ...
  FUN_00621860(local_res8,0,uVar2,param_3);
  if (param_2 != '\0') {
