...
| Component path | SchematicEditor.MainMenu.mnTM.DigitalSignalGenerator1.mnDSGVirtual |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.mnTM.DigitalSignalGenerator1.mnDSGVirtual` |
...
```mermaid
flowchart TD
    Control["Click Simulated"] --> Handler["mnDSGVirtualClick<br/>01c906d0"]
