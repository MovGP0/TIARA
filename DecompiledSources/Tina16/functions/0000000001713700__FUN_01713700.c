/* Ghidra address: 01713700 */
/* Ghidra symbol: FUN_01713700 */


void FUN_01713700(longlong param_1,undefined8 param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  *(undefined8 *)(lVar4 + 0x10) = uVar5;
  ...
  if (local_res18 != 0) {
    iVar1 = FUN_004170c0(&DAT_01713be0,local_res18,1);
    if (0 < iVar1) {
      uVar2 = FUN_004170c0(&DAT_01713be0,local_res18,1);
  ...
  iVar1 = FUN_004170c0(&DAT_01713c08,local_58,1);
  if (0 < iVar1) {
    iVar3 = 0;
    if (*(longlong *)(lVar4 + 0x20) != 0) {
  ...
  *(undefined4 *)(lVar4 + 0x50) = 0;
  ...
  if (iVar1 != 0) {
    ...
    iVar3 = (**(code **)(**(longlong **)(param_1 + 0x60) + 0xb0))
                      (*(longlong **)(param_1 + 0x60),local_60);
    if (iVar3 == -1) {
      ...
      (**(code **)(**(longlong **)(param_1 + 0x60) + 0x80))
                (*(longlong **)(param_1 + 0x60),local_68,plVar6);
    }
    else {
      plVar6 = (longlong *)
  ...
  (**(code **)(**(longlong **)(param_1 + 0x10) + 0x80))
            (*(longlong **)(param_1 + 0x10),local_res10,lVar4);
  FUN_00414b50(&local_30,*(undefined8 *)(lVar4 + 0x40));
  if (iVar1 != 0) {
    iVar1 = (**(code **)(**(longlong **)(param_1 + 0x38) + 0xb8))
                      (*(longlong **)(param_1 + 0x38),local_30);
    if (iVar1 == -1) {
      FUN_00416880(&local_78,*(undefined8 *)(lVar4 + 0x20));
      FUN_00416cd0(&local_70,3,local_30,&DAT_01713c18,local_78);
      (**(code **)(**(longlong **)(param_1 + 0x38) + 0x78))(*(longlong **)(param_1 + 0x38),local_70)
      ;
    }
    else {
      FUN_004b5390(*(undefined8 *)(param_1 + 0x38),&local_38,iVar1);
      ...
      if (iVar3 == 0) {
        ...
        FUN_00416cd0(&local_38,3,local_38,&LAB_01713c28,local_88);
        FUN_004b5450(*(undefined8 *)(param_1 + 0x38),iVar1,local_38);
      }
    }
  }
