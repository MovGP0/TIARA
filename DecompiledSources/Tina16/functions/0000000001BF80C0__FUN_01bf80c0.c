/* Ghidra address: 01bf80c0 */
/* Ghidra symbol: FUN_01bf80c0 */


void FUN_01bf80c0(longlong param_1,longlong param_2)

{
  ...
  if (lVar2 != 0) {
    FUN_007d7c60(lVar2,*(undefined8 *)(param_1 + 0x130));
  }
  *(longlong *)(param_1 + 0x138) = param_2;
  if (param_2 != 0) {
    FUN_007d7c70(param_2,*(undefined8 *)(param_1 + 0x130));
    FUN_004d26c0(*(undefined8 *)(param_1 + 0x138),param_1);
  }
  if (bVar1) {
