...
| Component path | SchematicEditor.MainMenu.Insert.mnShape.mnArc |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Insert.mnShape.mnArc` |
...
```mermaid
flowchart TD
    control["&Arc"] -->|"OnClick"| handler["InsertShape (01c97500)"]
