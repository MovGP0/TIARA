...
```mermaid
flowchart LR
    control["Noise Analysis"] -->|OnClick| handler["FUN_0146bc30"]
...
- Source: [DecompiledSources/Tina16/functions/000000000146BC30__FUN_0146bc30.c](../../../DecompiledSources/Tina16/functions/000000000146BC30__FUN_0146bc30.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: CSysTextDlg.DeepLinkPopUpMnu.NoiseAnalysisMnu.OnClick.
