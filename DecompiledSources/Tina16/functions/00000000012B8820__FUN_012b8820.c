/* Ghidra address: 012b8820 */
/* Ghidra symbol: FUN_012b8820 */


void FUN_012b8820(longlong param_1)

{
  ...
  local_20 = uVar3;
  (**(code **)(**(longlong **)(param_1 + 0x6e0) + 0xa8))
            (*(longlong **)(param_1 + 0x6e0),iVar4,uVar2);
  return;
}
