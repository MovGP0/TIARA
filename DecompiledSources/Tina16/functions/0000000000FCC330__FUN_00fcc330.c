/* Ghidra address: 00fcc330 */
/* Ghidra symbol: FUN_00fcc330 */


double FUN_00fcc330(longlong param_1,double param_2)

{
  ...
  uStack_48 = 0;
  uStack_40 = 0;
  dVar2 = *(double *)(param_1 + 0xce8) / 6.0;
  if (param_2 <= (1.0 / dVar2) * 65536.0) {
    ...
    FUN_00f61040(&local_68,0x10000 - iVar1);
