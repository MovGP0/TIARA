/* Ghidra address: 01a54d10 */
/* Ghidra symbol: FUN_01a54d10 */


void FUN_01a54d10(longlong param_1)

{
  ...
  FUN_00414ad0(*(longlong *)(param_1 + 0x738) + 0x100,&DAT_01a54eb4);
  FUN_00414ad0(*(longlong *)(param_1 + 0x738) + 0xe0,L"Log file|*.log");
  FUN_00724380(*(undefined8 *)(param_1 + 0x738),L"file.log");
  local_48 = L"log_short.json";
  FUN_00416cd0(&local_28,3,*(undefined8 *)(*(longlong *)(param_1 + 0x2bc8) + 0x108),&DAT_01a54f14);
