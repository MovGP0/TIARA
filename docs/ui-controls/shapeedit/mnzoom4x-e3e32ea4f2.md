...
```mermaid
flowchart LR
    control["&4x"] -->|OnClick| handler["FUN_0179a580"]
    handler --> call1["FUN_017949a0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/000000000179A580__FUN_0179a580.c](../../../DecompiledSources/Tina16/functions/000000000179A580__FUN_0179a580.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: ShapeEdit.MainMenu.View.Zoom.mnZoom4x.OnClick.
