/* Ghidra address: 01113800 */
/* Ghidra symbol: FUN_01113800 */


void FUN_01113800(longlong param_1)

{
  ...
  if (*(char *)(param_1 + 0x617) != '\0') {
    ...
    *(uint *)(param_1 + 0x618) = *(uint *)(param_1 + 0x618) | 0x30000;
    local_1c = *(undefined4 *)(param_1 + 0x630);
    local_24 = FUN_0065b870(param_1);
    uVar1 = thunk_FUN_0418b35e(*(undefined2 *)(param_1 + 0x622),0x80e,
