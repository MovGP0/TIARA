...
```mermaid
flowchart LR
    control["Normal inverted clock pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0432_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNDC_Glyph_Data.png`](../../../glyph/0432_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNDC_Glyph_Data.png)
