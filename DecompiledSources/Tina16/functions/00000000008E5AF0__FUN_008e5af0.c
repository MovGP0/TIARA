/* Ghidra address: 008e5af0 */
/* Ghidra symbol: FUN_008e5af0 */


char FUN_008e5af0(ushort param_1,ushort *param_2,undefined8 param_3)

{
  ...
  if (param_1 < 0x80) {
    ...
    cVar1 = -0x80;
    do {
      if (*param_2 == param_1) goto LAB_008e5c05;
      param_2 = param_2 + 1;
      cVar1 = cVar1 + '\x01';
    } while (cVar1 != '\0');
