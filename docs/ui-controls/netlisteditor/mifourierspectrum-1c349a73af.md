...
```mermaid
flowchart LR
    control["Fourier Spectrum..."] -->|OnClick| handler["FUN_01533720"]
    handler --> call1["FUN_0114dc00"]
    handler --> call2["FUN_01349310"]
    handler --> call3["FUN_013d2f60"]
    handler --> call4["FUN_013d99f0"]
    handler --> call5["FUN_0152fca0"]
    handler --> call6["FUN_0152fd80"]
```
