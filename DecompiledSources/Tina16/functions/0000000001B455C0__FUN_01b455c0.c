/* Ghidra address: 01b455c0 */
/* Ghidra symbol: FUN_01b455c0 */


undefined8 FUN_01b455c0(longlong *param_1,undefined8 param_2,int param_3,undefined8 param_4)

{
  ...
  if (-1 < param_3) {
    ...
    if (param_3 < iVar1) {
      ...
      FUN_00450070(local_40,local_28,&DAT_01b45864,&DAT_01b45874,
                   in_stack_ffffffffffffff98 & 0xffffffffffffff00);
      FUN_00414b50(&local_28,local_40[0]);
      iVar1 = FUN_004170c0(&DAT_01b45874,local_28,1);
      uVar2 = 0;
      if (local_28 != 0) {
        uVar2 = *(undefined4 *)(local_28 + -4);
      }
      FUN_00416dc0(&local_30,local_28,iVar1 + 1,uVar2);
      iVar1 = FUN_004170c0(&DAT_01b45888,local_30,1);
      if (iVar1 == 0) {
        FUN_00414b50(&local_20,local_30);
      }
      else {
        iVar1 = FUN_004170c0(&DAT_01b45874,local_28,1);
        iVar3 = FUN_004170c0(&DAT_01b45888,local_28,1);
        iVar4 = FUN_004170c0(&DAT_01b45874,local_28,1);
        ...
        FUN_00416cd0(&local_20,3,local_28,&LAB_01b45898,local_20);
      }
