...
```mermaid
flowchart LR
    control["Normal clock pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0430_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNC_Glyph_Data.png`](../../../glyph/0430_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinNC_Glyph_Data.png)
