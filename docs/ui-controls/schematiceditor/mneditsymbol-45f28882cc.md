...
| Component path | SchematicEditor.MainMenu.Edit.mnEditSymbol |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Edit.mnEditSymbol` |
...
```mermaid
flowchart TD
    control["Symbol..."] -->|"OnClick"| handler["mnEditSymbolClick (01c931a0)"]
