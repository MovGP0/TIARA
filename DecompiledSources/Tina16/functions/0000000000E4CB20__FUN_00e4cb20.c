/* Ghidra address: 00e4cb20 */
/* Ghidra symbol: FUN_00e4cb20 */


void FUN_00e4cb20(longlong param_1,longlong param_2,undefined4 param_3)

{
  ...
  *(undefined4 *)(lVar1 + 0x30) = uVar2;
  ...
  uVar6 = FUN_017dcbd0(param_1,local_40,param_3,0);
