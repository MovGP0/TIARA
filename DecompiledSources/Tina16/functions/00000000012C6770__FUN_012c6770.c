/* Ghidra address: 012c6770 */
/* Ghidra symbol: FUN_012c6770 */


void FUN_012c6770(longlong param_1)

{
  ...
  if (lVar2 != 0) {
    ...
    if ((*(uint *)(*(longlong *)(lVar2 + 0x18) + 0x62c) & 0x20) == 0x20) {
      ...
      iVar1 = FUN_00416db0(*(undefined8 *)(lVar2 + 0x10),&DAT_012c6938);
      if (iVar1 == 0) {
        FUN_0064dd90(*(undefined8 *)(param_1 + 0x708),local_30);
        lVar2 = FUN_006e2530(*(undefined8 *)(param_1 + 0x748));
        FUN_00416cd0(local_20,4,local_30[0],&DAT_012c6938,*(undefined8 *)(lVar2 + 0x10),L".TSC");
      }
      else {
        ...
        FUN_00416cd0(local_20,6,local_38,&DAT_012c6938,*(undefined8 *)(lVar2 + 0x10),&DAT_012c6938,
