/* Ghidra address: 00957580 */
/* Ghidra symbol: FUN_00957580 */


undefined8 FUN_00957580(longlong param_1,undefined8 param_2)

{
  ...
  if (-1 < iVar5 + -1) {
    do {
      ...
      puVar2 = *(undefined8 **)(*(longlong *)(lVar1 + 8) + (longlong)(int)uVar4 * 8);
