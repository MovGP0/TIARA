/* Ghidra address: 013ab740 */
/* Ghidra symbol: FUN_013ab740 */


void FUN_013ab740(longlong param_1,undefined8 param_2,undefined8 param_3,undefined1 *param_4)

{
  ...
  if (((*(char *)(param_1 + 0x6d0) == '\0') && (*(char *)(param_1 + 0x6d1) == '\0')) &&
     (sVar3 != 0x10)) {
    uVar2 = 0;
  }
  else {
