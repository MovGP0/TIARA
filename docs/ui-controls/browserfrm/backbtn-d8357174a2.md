...
```mermaid
flowchart LR
    control["Go back"] -->|OnClick| handler["FUN_01c201c0"]
    handler --> call1["FUN_01bcccd0"]
```
...
- Current graph summary: Handles 1 Delphi UI event: BrowserFrm.TopPL.BackBtn.OnClick.
...
- `function:01bcccd0` — FUN_01bcccd0
