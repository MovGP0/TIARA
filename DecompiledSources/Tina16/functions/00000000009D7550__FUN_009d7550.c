/* Ghidra address: 009d7550 */
/* Ghidra symbol: FUN_009d7550 */


undefined4 FUN_009d7550(longlong param_1,undefined8 param_2,undefined8 *param_3)

{
  ...
  *param_3 = 0;
  ...
  uVar1 = (**(code **)(**(longlong **)(param_1 + 0x18) + 0x50))
                    (*(longlong **)(param_1 + 0x18),0,local_18);
