...
| Component path | SchematicEditor.MainMenu.Insert.mnShape.mnPolygon |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Insert.mnShape.mnPolygon` |
...
```mermaid
flowchart TD
    control["&Polygon"] -->|"OnClick"| handler["InsertShape (01c97500)"]
