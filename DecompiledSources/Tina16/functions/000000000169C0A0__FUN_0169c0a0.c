/* Ghidra address: 0169c0a0 */
/* Ghidra symbol: FUN_0169c0a0 */


undefined8 FUN_0169c0a0(longlong param_1)
...
LAB_0169c10c:
  ...
  do {
    if (((&DAT_01f8af5c)[iVar6] == 0) && (*(int *)(*(longlong *)(param_1 + 0x10) + 8) == -1)) {
    ...
    local_202c = (&DAT_01f8af5c)[iVar6];
    if (local_202c == 0) {
      cVar3 = FUN_0169bfe0(local_3058,iVar6,*(undefined4 *)(*(longlong *)(param_1 + 0x10) + 8),
                           &local_202c);
      if (cVar3 != '\0') {
        if (local_202c < 1) {
          if (-1 < local_202c) {
...
LAB_0169c48b:
      ...
      *(undefined1 *)(*(longlong *)(param_1 + 0x10) + 0x11) = 0;
      FUN_0169ae40(local_3058,-local_202c);
      uStack_2020._4_4_ = uStack_2020._4_4_ - *(int *)(&DAT_01f8ba30 + (longlong)-local_202c * 8);
      cVar3 = FUN_0169c040(local_3058,aiStack_3030[uStack_2020._4_4_],
                           *(undefined4 *)(&DAT_01f8ba34 + (longlong)-local_202c * 8),&local_202c);
      if (cVar3 != '\0') {
        iVar6 = local_202c;
      }
      ...
      if (cVar3 != '\x03') goto LAB_0169c10c;
    }
    if (*(int *)(*(longlong *)(param_1 + 0x10) + 0x14) == 0) {
  ...
  *(undefined4 *)(lVar2 + 0x14) = 3;
  while ((0 < uStack_2020._4_4_ &&
         ((cVar3 = FUN_0169bfe0(local_3058,aiStack_3030[uStack_2020._4_4_],0x100,&local_202c),
