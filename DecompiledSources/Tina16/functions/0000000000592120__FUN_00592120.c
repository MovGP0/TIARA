/* Ghidra address: 00592120 */
/* Ghidra symbol: FUN_00592120 */


undefined8 FUN_00592120(undefined8 param_1,undefined8 param_2,longlong *param_3,longlong param_4)

{
  ...
  if (((ulonglong)pcVar1 & 0xff00000000000000) == 0xff00000000000000) {
    FUN_004194b0(param_2,*(undefined8 *)((longlong)param_3 + ((ulonglong)pcVar1 & 0xffffffffffffff))
                 ,&DAT_0058fe20);
  }
  else {
