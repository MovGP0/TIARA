/* Ghidra address: 007afc50 */
/* Ghidra symbol: FUN_007afc50 */


void FUN_007afc50(longlong param_1,undefined4 param_2,longlong *param_3,int param_4,int param_5)
  ...
  if (param_4 < param_5) {
    do {
      ...
      if (param_5 - iVar7 < iVar4 - param_4) {
        ...
        iVar3 = iVar4;
        if (iVar7 < param_5) {
          FUN_007afc50(param_1,param_2,param_3,iVar7,param_5);
        }
      }
      else {
        iVar5 = iVar7;
        iVar3 = param_5;
        if (param_4 < iVar4) {
          FUN_007afc50(param_1,param_2,param_3,param_4,iVar4);
        }
      }
      param_5 = iVar3;
      param_4 = iVar5;
