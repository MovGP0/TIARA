/* Ghidra address: 0173eeb0 */
/* Ghidra symbol: FUN_0173eeb0 */


void FUN_0173eeb0(longlong *param_1,longlong *param_2,longlong *param_3,longlong *param_4,
...

{
  ...
  if ((((param_2 != (longlong *)0x0) && (cVar1 = FUN_0175ad40(param_1,param_2), cVar1 != '\0')) ||
    ...
    *(char *)((longlong)param_1 + 0x3a) = cVar1;
    ...
    if (param_6 == '\0') {
      uVar11 = CONCAT71((int7)((ulonglong)in_stack_ffffffffffffff10 >> 8),
                        local_res18 == (longlong *)0x0);
      FUN_01d048c0(param_1[5],0x22,7,&local_1c,&local_20,uVar11,1);
      if (param_2 != (longlong *)0x0) {
        uVar12 = (undefined7)(uVar11 >> 8);
        if (bVar9) {
          uVar8 = CONCAT71(uVar12,1);
          FUN_01d048c0(param_1[5],0xe,0xe,&local_24,&local_28,uVar8,1);
          uVar11 = CONCAT71((int7)((ulonglong)uVar8 >> 8),1);
          FUN_01d048c0(param_1[5],0xe,0xfffffffc,&local_2c,&local_30,uVar11,1);
        }
        else {
          uVar8 = CONCAT71(uVar12,1);
          FUN_01d048c0(param_1[5],0xe,0xfffffffc,&local_24,&local_28,uVar8,1);
          uVar11 = CONCAT71((int7)((ulonglong)uVar8 >> 8),1);
          FUN_01d048c0(param_1[5],0xe,0xe,&local_2c,&local_30,uVar11,1);
        }
      ...
      if (local_res18 != (longlong *)0x0) {
        ...
        uVar13 = (uint7)(uVar11 >> 8);
        if (cVar1 == '\0') {
          lVar6 = (ulonglong)uVar13 << 8;
          FUN_01d048c0(param_1[5],0xe,0xfffffffc,&local_24,&local_28,lVar6,1);
          uVar11 = CONCAT44((int)((ulonglong)lVar6 >> 0x20),local_24);
          FUN_01243890(&local_68,local_res18,local_res20,local_1c,local_20,uVar11,local_28,1,0x8000)
          ;
          (**(code **)(*local_68 + 0x108))(local_68,L"showif",&DAT_0173fa34);
          FUN_01d048c0(param_1[5],0xe,0xe,&local_24,&local_28,uVar11 & 0xffffffffffffff00,1);
          FUN_01243890(&local_68,local_res18,local_res20,local_1c,local_20,local_24,local_28,1,
                       0x8000);
          (**(code **)(*local_68 + 0x108))(local_68,L"showif",&DAT_0173fa48);
        }
        else {
          if (bVar9) {
            puVar10 = &local_28;
            lVar6 = (ulonglong)uVar13 << 8;
            FUN_01d048c0(param_1[5],0xe,0xe,&local_24,puVar10,lVar6,1);
            uVar4 = (undefined4)((ulonglong)lVar6 >> 0x20);
            uVar5 = (undefined4)((ulonglong)puVar10 >> 0x20);
          }
          else {
            puVar10 = &local_28;
            uVar11 = uVar11 & 0xffffffffffffff00;
            FUN_01d048c0(param_1[5],0xe,0xfffffffc,&local_24,puVar10,uVar11,1);
            uVar4 = (undefined4)(uVar11 >> 0x20);
            uVar5 = (undefined4)((ulonglong)puVar10 >> 0x20);
          }
          FUN_01243890(&local_b8,local_res18,local_res20,local_1c,CONCAT44(uVar5,local_20),
                       CONCAT44(uVar4,local_24),local_28,1,0x8000);
        }
      }
    }
    else {
      ...
      if (((param_1[8] != 0) && (cVar1 = FUN_01d07320(param_1[5]), -1 < cVar1)) &&
        ...
        iVar3 = FUN_00c3c520(local_41,local_40,local_3f);
        if (bVar9) {
        ...
        plVar7 = (longlong *)
                 FUN_01a9f060(local_41,local_40,local_3f,local_3e,CONCAT44(uVar5,local_3d),local_50,
                              (char)param_1[2]);
        (**(code **)(*(longlong *)param_1[4] + 0x10))((longlong *)param_1[4],plVar7);
        if (*(char *)((longlong)param_1 + 10) == '\0') {
          if (*(int *)((longlong)param_1 + 0x14) == (int)param_1[2]) {
            ...
            if (param_2 != (longlong *)0x0) {
              FUN_01a9f420(param_2,(longlong)local_45,(longlong)local_43,local_35,plVar7,0,1);
            }
          ...
          FUN_01a9f420(param_2,(longlong)local_45,(longlong)local_43,local_35,plVar7,local_60,1);
        }
        if (local_res18 != (longlong *)0x0) {
          (**(code **)(*local_res18 + 0x148))(local_res18,&local_68,L"shape");
          (**(code **)(*local_res20 + 0x98))(local_res20,&local_70,local_68);
          FUN_01b23e30(plVar7,local_res18,local_68);
          ...
          FUN_00416cd0(&local_78,3,local_80,&DAT_0173f9cc,local_88);
          (**(code **)(*local_68 + 0x108))(local_68,L"position",local_78);
          iVar3 = (**(code **)(*plVar7 + 0x60))(plVar7);
          uVar8 = FUN_0040c840((double)iVar3 / (double)local_35);
          FUN_0043f780(&local_98,uVar8);
          iVar3 = (**(code **)(*plVar7 + 0x48))(plVar7);
          uVar8 = FUN_0040c840((double)iVar3 / (double)local_35);
          FUN_0043f780(&local_a0,uVar8);
          FUN_00416cd0(&local_90,3,local_98,&DAT_0173f9cc,local_a0);
