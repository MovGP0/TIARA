/* Ghidra address: 01c959d0 */
/* Ghidra symbol: FUN_01c959d0 */


void FUN_01c959d0(longlong param_1)

{
  ...
  FUN_00414ad0(PTR_DAT_02004c08,L"\\ALTIUM.PCB");
  FUN_00414ad0(PTR_DAT_02004008,L"ALTIUM");
  ...
  FUN_007e2d20(*(undefined8 *)(param_1 + 0x1700),1);
  (**(code **)(**(longlong **)(param_1 + 0x24b8) + 0x18))
            (*(longlong **)(param_1 + 0x24b8),L"Schematic Editor",L"PCBRootDir",L"ALTIUM");
  FUN_00ec0300();
  FUN_00ecbc20();
