/* Ghidra address: 01c2cbc0 */
/* Ghidra symbol: FUN_01c2cbc0 */


void FUN_01c2cbc0(longlong *param_1)

{
  ...
  do {
    do {
      ...
      FUN_004169a0(&local_40,&DAT_02111b90 + (longlong)iVar5 * 0x41 + lVar8 * 0x4100);
      FUN_004169a0(&local_48,&DAT_02111b90 + lVar8 * 0x4100);
      FUN_01c2c4b0(auStack_108,local_40,local_48,local_31);
      iVar5 = iVar5 + 1;
    } while ((&DAT_02111b90)[(longlong)iVar5 * 0x41 + lVar8 * 0x4100] != '\0');
    iVar5 = 1;
    iVar4 = iVar4 + 1;
  } while ((&DAT_02111bd1)[(longlong)iVar4 * 0x4100] != '\0');
  ...
  if (DAT_03566762 != '\0') {
    ...
    if (-1 < iVar4 + -1) {
      do {
        ...
        local_e8 = local_60;
        local_e0 = &DAT_01c2d1f4;
        local_d8 = local_68;
        local_d0 = &DAT_01c2d204;
        local_c8 = local_70;
        local_c0 = &LAB_01c2d218;
        local_b8 = local_78;
            ...
            if ((bVar1 <= bVar2) || ((uint)bVar2 + (uint)*(byte *)(lVar8 + 0x4d) <= (uint)bVar1)) {
              ...
              if ((bVar1 != bVar2) ||
                 ((uint)bVar2 + (uint)*(byte *)(lVar7 + 0x4d) <=
                  (uint)bVar1 + (uint)*(byte *)(lVar8 + 0x4d))) goto LAB_01c2cfea;
            }
