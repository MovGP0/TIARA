...
```mermaid
flowchart LR
    control["Repeat"] -->|OnClick| handler["FUN_01512610"]
    handler --> call1["FUN_00f04d50"]
    handler --> call2["FUN_010f6920"]
    handler --> call3["FUN_01506c70"]
    handler --> call4["FUN_01512f00"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001512610__FUN_01512610.c](../../../DecompiledSources/Tina16/functions/0000000001512610__FUN_01512610.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DigitalSignalGeneratorWin.DataGroupBox.DataSetGroupBox.RepeatSpBtn.OnClick.
