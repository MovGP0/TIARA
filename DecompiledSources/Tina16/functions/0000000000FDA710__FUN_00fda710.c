/* Ghidra address: 00fda710 */
/* Ghidra symbol: FUN_00fda710 */


void FUN_00fda710(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  iVar1 = FUN_00f794e0(param_1,local_res18,&DAT_00fdad5c);
  uVar2 = FUN_0043fc00(local_res20);
  if (iVar1 == -1) {
    ...
    FUN_00416cd0(&local_c0,7,local_c8,local_d0,local_d8,local_e0,&DAT_00fdad6c,local_res18,
                 L" addr error ------------------------------");
