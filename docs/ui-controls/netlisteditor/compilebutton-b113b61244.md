...
| --- | --- |
| Form | NetlistEditor |
| Component path | NetlistEditor.BtnPanel.CompileButton |
...
| Graph node | `resource:dfm:NetlistEditor/NetlistEditor.BtnPanel.CompileButton` |
...
- Extracted glyph: [`0280_NetlistEditor_NetlistEditor_BtnPanel_CompileButton_Glyph_Data.png`](../../../glyph/0280_NetlistEditor_NetlistEditor_BtnPanel_CompileButton_Glyph_Data.png)
