/* Ghidra address: 01d4b7a0 */
/* Ghidra symbol: FUN_01d4b7a0 */


void FUN_01d4b7a0(undefined8 param_1,longlong param_2)

{
  ...
  FUN_016ebb00(param_1,4,local_200,0x20);
  ...
  FUN_00e7d1b0(param_1,cVar1 + '\x02',cVar4,2,4,3,local_200);
  return;
}
