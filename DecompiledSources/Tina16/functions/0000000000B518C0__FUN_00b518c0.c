/* Ghidra address: 00b518c0 */
/* Ghidra symbol: FUN_00b518c0 */


void FUN_00b518c0(longlong param_1,undefined4 param_2)
    ...
    if (-1 < iVar2 + -1) {
      do {
        ...
        if (*(short *)(lVar3 + 0x48) == *(short *)(param_1 + 0x3e)) {
          ...
          (**(code **)(*plVar4 + 200))(plVar4,param_2);
        }
        iVar5 = iVar5 + 1;
        iVar2 = iVar2 + -1;
      } while (iVar2 != 0);
