/* Ghidra address: 008fc130 */
/* Ghidra symbol: FUN_008fc130 */


undefined1 FUN_008fc130(longlong param_1)
    ...
    if (uVar4 != 0) {
      do {
        ...
        if (*(short *)(local_res8[0] + -2 + (longlong)(int)uVar3 * 2) == 0x25) {
          ...
          cVar1 = FUN_008fc260(*(undefined2 *)(local_res8[0] + -2 + (longlong)(int)uVar3 * 2));
          uVar2 = uVar3;
          if (cVar1 == '\0') {
            cVar1 = FUN_008fc2b0(*(undefined2 *)(local_res8[0] + -2 + (longlong)(int)uVar3 * 2));
            if (cVar1 == '\0') {
              local_29 = 0;
              break;
            }
