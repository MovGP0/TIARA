/* Ghidra address: 01027e00 */
/* Ghidra symbol: FUN_01027e00 */


undefined4 FUN_01027e00(undefined8 param_1,undefined8 param_2)
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            ...
            iVar1 = FUN_00416db0(local_10,&DAT_01028000);
            if (iVar1 == 0) {
              local_1c = 5;
            }
            else {
