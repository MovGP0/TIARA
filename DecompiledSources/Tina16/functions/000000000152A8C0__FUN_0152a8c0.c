/* Ghidra address: 0152a8c0 */
/* Ghidra symbol: FUN_0152a8c0 */


void FUN_0152a8c0(longlong *param_1)

{
  ...
  *PTR_DAT_02002ce0 = 0;
  ...
  pwVar1 = L"TINA.INI";
  FUN_00416cd0(local_20,3,*(undefined8 *)PTR_DAT_02005010,&DAT_0152a9a4,L"TINA.INI");
