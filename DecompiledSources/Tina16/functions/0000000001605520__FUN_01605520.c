/* Ghidra address: 01605520 */
/* Ghidra symbol: FUN_01605520 */


void FUN_01605520(undefined8 param_1,undefined8 param_2)

{
  ...
  if (cVar1 != '\0') {
    ...
    FUN_005eb630(local_10,L"DAVE_TEST_PRJ",local_res10);
  }
