...
| Component path | SchematicEditor.MainMenu.mnInteractive.mnIntTransientSingleShot |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.mnInteractive.mnIntTransientSingleShot` |
...
```mermaid
flowchart TD
    control["Transient Single Shot"] -->|"OnClick"| handler["pmIntDigitalClick (01c89820)"]
