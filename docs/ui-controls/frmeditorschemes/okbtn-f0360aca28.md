...
```mermaid
flowchart LR
    control["OK"] -->|OnClick| handler["FUN_01b746d0"]
    handler --> call1["Delphi UnicodeString array finalization helper"]
    handler --> call2["FUN_004169a0"]
    handler --> call3["FUN_01aa02c0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001B746D0__FUN_01b746d0.c](../../../DecompiledSources/Tina16/functions/0000000001B746D0__FUN_01b746d0.c)
