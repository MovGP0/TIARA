...
| --- | --- |
| Form | NetlistEditor |
| Component path | NetlistEditor.BtnPanel.PasteButton |
...
| Graph node | `resource:dfm:NetlistEditor/NetlistEditor.BtnPanel.PasteButton` |
...
- Extracted glyph: [`0282_NetlistEditor_NetlistEditor_BtnPanel_PasteButton_Glyph_Data.png`](../../../glyph/0282_NetlistEditor_NetlistEditor_BtnPanel_PasteButton_Glyph_Data.png)
