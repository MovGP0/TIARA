/* Ghidra address: 0179fb50 */
/* Ghidra symbol: FUN_0179fb50 */


void FUN_0179fb50(longlong param_1)

{
  ...
  if (iVar2 + 1 < iVar3) {
    ...
    iVar2 = (**(code **)(**(longlong **)(param_1 + 0x758) + 0x260))(*(longlong **)(param_1 + 0x758))
    ;
    uVar4 = (**(code **)(**(longlong **)(param_1 + 0x758) + 0x260))(*(longlong **)(param_1 + 0x758))
    ;
    (**(code **)(**(longlong **)(param_1 + 0xd18) + 0xa0))
              (*(longlong **)(param_1 + 0xd18),iVar2 + 1,uVar4);
    plVar1 = *(longlong **)(param_1 + 0x758);
    iVar2 = (**(code **)(*plVar1 + 0x260))(plVar1);
    uVar4 = (**(code **)(**(longlong **)(param_1 + 0x758) + 0x260))(*(longlong **)(param_1 + 0x758))
    ;
    (**(code **)(*(longlong *)plVar1[0x94] + 0xa0))((longlong *)plVar1[0x94],iVar2 + 1,uVar4);
