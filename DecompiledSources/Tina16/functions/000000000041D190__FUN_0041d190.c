/* Ghidra address: 0041d190 */
/* Ghidra symbol: FUN_0041d190 */


void FUN_0041d190(longlong param_1,undefined8 param_2,ulonglong param_3)

{
  ...
  if (*(char *)(param_1 + 0x1298) != '\0') {
    ...
    if (local_18 != 0) {
      local_20 = local_18;
      FUN_0041c5f0(local_18,local_18 + 0x108,param_2);
    }
  }
  return;
}
