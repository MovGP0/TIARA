/* Ghidra address: 00ef5350 */
/* Ghidra symbol: FUN_00ef5350 */


void FUN_00ef5350(longlong param_1,undefined8 *param_2,undefined2 param_3,undefined8 param_4)

{
  ...
  FUN_00ef4b30(param_1,*(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) +
                       *(char *)(param_1 + 0x9d) + *(char *)(param_1 + 0x9c),param_4);
  *(char *)(param_1 + 0x9c) = *(char *)(param_1 + 0x9c) + '\x01';
  ...
  if (-1 < local_78) {
    FUN_00ef4950(param_1,*(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) +
                         *(char *)(param_1 + 0x9d) + *(char *)(param_1 + 0x9c),(undefined1)local_78,
                 local_9c,param_4);
    FUN_00ef4950(param_1,(undefined1)local_78,
                 *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) + *(char *)(param_1 + 0x9d) +
                 *(char *)(param_1 + 0x9c),local_90,param_4);
  }
  if (-1 < local_74) {
    FUN_00ef4950(param_1,*(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) +
                         *(char *)(param_1 + 0x9d) + *(char *)(param_1 + 0x9c),(undefined1)local_74,
                 local_90,param_4);
    FUN_00ef4950(param_1,(undefined1)local_74,
                 *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) + *(char *)(param_1 + 0x9d) +
                 *(char *)(param_1 + 0x9c),local_9c,param_4);
  }
  return;
}
