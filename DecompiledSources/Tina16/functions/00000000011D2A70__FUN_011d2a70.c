/* Ghidra address: 011d2a70 */
/* Ghidra symbol: FUN_011d2a70 */


void FUN_011d2a70(longlong param_1)

{
  ...
  local_30[0] = 0;
  local_20[0] = 0;
  *(undefined4 *)PTR_DAT_02004708 = 0xc80;
  DAT_01f2a8d4 = 0;
  iVar1 = 0;
  if (*(longlong *)(*(longlong *)PTR_DAT_02003af0 + 0x798) != 0) {
    iVar1 = *(int *)(*(longlong *)(*(longlong *)PTR_DAT_02003af0 + 0x798) + -4);
  }
  FUN_00416dc0(local_30,*(undefined8 *)(*(longlong *)PTR_DAT_02003af0 + 0x798),1,iVar1 + -1);
  FUN_00b971a0(local_20,local_30[0]);
  FUN_00416cd0(&local_38,3,*(undefined8 *)PTR_DAT_02002860,&LAB_011d2bd8,local_20[0]);
