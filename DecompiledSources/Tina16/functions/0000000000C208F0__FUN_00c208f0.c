/* Ghidra address: 00c208f0 */
/* Ghidra symbol: FUN_00c208f0 */


longlong FUN_00c208f0(longlong param_1,char param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  for (; local_1c < 0x30; local_1c = local_1c + 1) {
    *(uint *)(local_res8 + 0x418 + (longlong)local_1c * 4) = (uint)local_1d;
    *(uint *)(local_res8 + 0x418 + (longlong)-local_1c * 4) = -(uint)local_1d;
