/* Ghidra address: 0111e030 */
/* Ghidra symbol: FUN_0111e030 */


void FUN_0111e030(longlong param_1)
    ...
    while( true ) {
      ...
      if (sVar1 == 0x22) {
        if ((*(short *)(*(longlong *)(param_1 + 0x120) +
                       (longlong)(*(int *)(param_1 + 0x150) + 1) * 2) == 0x22) &&
           (*(short *)(*(longlong *)(param_1 + 0x120) +
                      (longlong)(*(int *)(param_1 + 0x150) + 2) * 2) == 0x22)) {
    ...
    do {
      ...
      if ((sVar1 == 0) || ((sVar1 == 10 || (sVar1 == 0xd)))) {
        if (*(short *)(*(longlong *)(param_1 + 0x120) + (longlong)(iVar2 + -1) * 2) == 0x5c) {
          *(undefined2 *)(param_1 + 0x160) = 0x22;
          *(undefined1 *)(param_1 + 0x162) = 5;
        }
        break;
      }
      if (sVar1 == 0x5c) {
        if (*(short *)(*(longlong *)(param_1 + 0x120) + (longlong)(iVar2 + 1) * 2) == 0x22) {
          iVar2 = 1;
          while ((iVar2 < *(int *)(param_1 + 0x150) &&
                 (*(short *)(*(longlong *)(param_1 + 0x120) +
                            (longlong)(*(int *)(param_1 + 0x150) - iVar2) * 2) == 0x5c))) {
