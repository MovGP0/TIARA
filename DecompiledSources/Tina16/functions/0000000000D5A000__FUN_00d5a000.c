/* Ghidra address: 00d5a000 */
/* Ghidra symbol: FUN_00d5a000 */


void FUN_00d5a000(longlong param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (plVar1 != (longlong *)0x0) {
    ...
    if (((cVar2 == '\0') && (0 < *(int *)(param_1 + 0x18) - *(int *)(param_1 + 0x10))) &&
      ...
      FUN_005fead0(uVar3,local_38,param_2,param_1 + 0x10);
    }
  }
  return;
}
