/* Ghidra address: 0077a7d0 */
/* Ghidra symbol: FUN_0077a7d0 */


undefined1
FUN_0077a7d0(longlong *param_1,undefined8 param_2,ulonglong *param_3,undefined8 param_4,byte param_5
...

{
  ...
  if (bVar6) {
    uVar3 = (**(code **)(param_1[(uVar1 & 0xff) - 0x1d] + 0x40))
                      (param_1[(uVar1 & 0xff) - 0x1d],param_1,param_2,local_30,(int)uVar2,param_4,
                       param_5,param_6,param_7);
  }
  else {
    uVar5 = (**(code **)(*param_1 + 0xb0))(param_1,uVar1 & 0xff,param_7);
    iVar4 = (**(code **)PTR_DAT_02003488)
                      (uVar5,param_2,local_30,(int)uVar2,param_4,
                       CONCAT44(uVar7,*(undefined4 *)(&DAT_01e0863c + (ulonglong)param_5 * 4)),
                       param_6);
    uVar3 = iVar4 == 0;
  }
  return uVar3;
