/* Ghidra address: 0161c560 */
/* Ghidra symbol: FUN_0161c560 */


undefined8 FUN_0161c560(undefined8 param_1,undefined8 param_2)

{
  ...
  if ((((!bVar1) && (cVar2 = FUN_0161c060(param_1,param_2), cVar2 == '\0')) &&
     ...
     (((cVar2 = FUN_0161c0b0(param_1,param_2), cVar2 == '\0' &&
       (cVar2 = FUN_0161bbf0(param_1,1), cVar2 == '\0')) &&
      (cVar2 = FUN_0161bbb0(param_1), cVar2 == '\0')))) {
    return 0;
  }
  return 1;
}
