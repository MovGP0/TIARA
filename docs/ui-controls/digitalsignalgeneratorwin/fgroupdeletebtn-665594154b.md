...
```mermaid
flowchart LR
    control["Del"] -->|OnClick| handler["FUN_015120f0"]
    handler --> call1["FUN_01508a30"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000015120F0__FUN_015120f0.c](../../../DecompiledSources/Tina16/functions/00000000015120F0__FUN_015120f0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DigitalSignalGeneratorWin.ChannelGroupBox.FGroupDeleteBtn.OnClick.
