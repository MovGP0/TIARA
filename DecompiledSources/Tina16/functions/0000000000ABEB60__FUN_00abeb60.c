/* Ghidra address: 00abeb60 */
/* Ghidra symbol: FUN_00abeb60 */


longlong FUN_00abeb60(longlong param_1,char param_2,undefined8 param_3,longlong param_4)

{
  ...
  plVar3 = (longlong *)FUN_00a78060(&PTR_FUN_00a6cf08,1,0);
  *(longlong **)(local_res8 + 0x1a0) = plVar3;
  ...
  uVar2 = FUN_00a78160(*(undefined8 *)(param_4 + 0x1a0));
  FUN_00a78170(*(undefined8 *)(local_res8 + 0x1a0),uVar2);
