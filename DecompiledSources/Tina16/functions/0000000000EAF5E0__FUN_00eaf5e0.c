/* Ghidra address: 00eaf5e0 */
/* Ghidra symbol: FUN_00eaf5e0 */


undefined8 FUN_00eaf5e0(longlong *param_1,undefined8 param_2,undefined4 param_3,undefined1 param_4)

{
  ...
  local_20 = 0;
  iVar1 = FUN_00eaf2c0(param_1,param_2,param_3);
  if (iVar1 < 0) {
    local_30 = 0;
  }
  else {
