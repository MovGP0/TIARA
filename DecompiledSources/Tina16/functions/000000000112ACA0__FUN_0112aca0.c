/* Ghidra address: 0112aca0 */
/* Ghidra symbol: FUN_0112aca0 */


void FUN_0112aca0(longlong param_1,undefined8 param_2,short *param_3,short param_4)

{
  ...
  if (*param_3 == *(short *)(param_1 + 8)) {
    if (param_4 == 8) {
      local_50 = auStack_98;
      local_28 = param_3;
      FUN_0112a430(*(undefined8 *)(param_3 + 4),&local_58);
      ...
      local_50 = auStack_98;
      local_30 = param_3;
      FUN_0112a430(*(undefined8 *)(param_3 + 4),&local_68);
      ...
      local_50 = auStack_98;
      local_38 = param_3;
      FUN_0112a430(*(undefined8 *)(param_3 + 4),&local_78);
      ...
      local_20[0] = 7;
      local_40 = param_3;
      local_18 = FUN_0112a460(*(undefined8 *)(param_3 + 4));
