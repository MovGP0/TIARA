...
```mermaid
flowchart LR
    control["Long inverted clock pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0431_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLDC_Glyph_Data.png`](../../../glyph/0431_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLDC_Glyph_Data.png)
