/* Ghidra address: 017bbd20 */
/* Ghidra symbol: FUN_017bbd20 */


void FUN_017bbd20(longlong param_1,uint param_2)

{
  ...
  if (*(longlong *)(param_1 + 0x18) != 0) {
    ...
    if (-1 < iVar4 + -1) {
      do {
        ...
        uVar2 = FUN_004aeac0(*(undefined8 *)(param_1 + 0x40),iVar3);
  ...
  FUN_017bb6b0(param_1,param_2 & 0xfffffffc);
  if ('\0' < (char)param_2) {
