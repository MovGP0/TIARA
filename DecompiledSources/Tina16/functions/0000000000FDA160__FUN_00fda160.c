/* Ghidra address: 00fda160 */
/* Ghidra symbol: FUN_00fda160 */


void FUN_00fda160(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  iVar1 = FUN_00f794e0(param_1,local_res18,&DAT_00fda47c);
  if (iVar1 != -1) {
