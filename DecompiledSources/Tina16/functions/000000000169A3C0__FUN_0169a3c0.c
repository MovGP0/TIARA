/* Ghidra address: 0169a3c0 */
/* Ghidra symbol: FUN_0169a3c0 */


undefined8 FUN_0169a3c0(longlong param_1)
...
LAB_0169a424:
  ...
  do {
    if (((&DAT_01f865b4)[iVar6] == 0) && (*(int *)(*(longlong *)(param_1 + 0x10) + 8) == -1)) {
    ...
    local_1024 = (&DAT_01f865b4)[iVar6];
    if (local_1024 == 0) {
      cVar3 = FUN_0169a300(local_2048,iVar6,*(undefined4 *)(*(longlong *)(param_1 + 0x10) + 8),
                           &local_1024);
      if (cVar3 != '\0') {
        if (local_1024 < 1) {
          if (-1 < local_1024) {
...
LAB_0169a79f:
      ...
      *(undefined1 *)(*(longlong *)(param_1 + 0x10) + 0x11) = 0;
      FUN_01699120(local_2048,-local_1024);
      local_101c[0] = local_101c[0] - *(int *)(&DAT_01f87330 + (longlong)-local_1024 * 8);
      cVar3 = FUN_0169a360(local_2048,aiStack_2028[local_101c[0]],
                           *(undefined4 *)(&DAT_01f87334 + (longlong)-local_1024 * 8),&local_1024);
      if (cVar3 != '\0') {
        iVar6 = local_1024;
      }
      ...
      if (cVar3 != '\x03') goto LAB_0169a424;
    }
    if (*(int *)(*(longlong *)(param_1 + 0x10) + 0x14) == 0) {
  ...
  *(undefined4 *)(lVar2 + 0x14) = 3;
  while ((0 < local_101c[0] &&
         ((cVar3 = FUN_0169a300(local_2048,aiStack_2028[local_101c[0]],0x100,&local_1024),
