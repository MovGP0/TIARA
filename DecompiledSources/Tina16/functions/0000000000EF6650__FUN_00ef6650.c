/* Ghidra address: 00ef6650 */
/* Ghidra symbol: FUN_00ef6650 */


void FUN_00ef6650(longlong param_1,undefined8 *param_2,undefined8 *param_3,undefined8 *param_4,
...

{
  ...
  *(char *)(param_1 + 0x9e) = *(char *)(param_1 + 0x9e) + '\x01';
  if ((short)local_84 != 0) {
    cVar1 = *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) + -1;
    FUN_00ef4950(param_1,cVar1,cVar1,&local_84,param_7);
  }
  if ((short)local_90 != 0) {
    cVar1 = *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e);
    FUN_00ef4950(param_1,cVar1 + -1,cVar1,&local_90,param_7);
  }
  if ((short)local_9c != 0) {
    cVar1 = *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e);
    FUN_00ef4950(param_1,cVar1,cVar1 + -1,&local_9c,param_7);
  }
  if ((short)local_a8 != 0) {
    cVar1 = *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e);
  ...
  if (-1 < local_78) {
    FUN_00ef4950(param_1,(undefined1)local_78,
                 *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) + -1,local_b4,param_7);
    FUN_00ef4950(param_1,*(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) + -1,
                 (undefined1)local_78,local_c0,param_7);
  }
  if (-1 < local_74) {
    FUN_00ef4950(param_1,(undefined1)local_74,
                 *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) + -1,local_c0,param_7);
    FUN_00ef4950(param_1,*(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e) + -1,
                 (undefined1)local_74,local_b4,param_7);
  }
  if (-1 < local_70) {
