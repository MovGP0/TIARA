/* Ghidra address: 01c434b0 */
/* Ghidra symbol: FUN_01c434b0 */


void FUN_01c434b0(undefined8 param_1,longlong param_2)

{
  ...
  if (*(longlong *)(param_2 + 0x228) != 0) {
    uVar2 = (**(code **)**(undefined8 **)(param_2 + 0x228))(*(undefined8 *)(param_2 + 0x228));
    FUN_00418590(uVar2,&DAT_01984da0);
  }
  FUN_00410f20(*(undefined8 *)(param_2 + 0x220));
  return;
}
