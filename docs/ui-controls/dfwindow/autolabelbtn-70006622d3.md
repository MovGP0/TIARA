...
```mermaid
flowchart LR
    control["Auto label"] -->|OnClick| handler["FUN_01a7bce0"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A7BCE0__FUN_01a7bce0.c](../../../DecompiledSources/Tina16/functions/0000000001A7BCE0__FUN_01a7bce0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFToolPanel.ToolNoteBook.Diagram.AutoLabelBtn.OnClick.
