/* Ghidra address: 01bf7f30 */
/* Ghidra symbol: FUN_01bf7f30 */


void FUN_01bf7f30(longlong param_1,longlong param_2)

{
  ...
  if (lVar2 != 0) {
    FUN_007d7c60(lVar2,*(undefined8 *)(param_1 + 0x100));
  }
  *(longlong *)(param_1 + 0x108) = param_2;
  if (param_2 != 0) {
    FUN_007d7c70(param_2,*(undefined8 *)(param_1 + 0x100));
