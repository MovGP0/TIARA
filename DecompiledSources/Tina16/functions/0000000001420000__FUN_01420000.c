/* Ghidra address: 01420000 */
/* Ghidra symbol: FUN_01420000 */


void FUN_01420000(undefined8 param_1,undefined8 param_2,undefined4 param_3)

{
  ...
  if ((cVar1 == '\x01') || ((byte)(cVar1 - 5U) < 2)) {
    ...
    FUN_016ed320(param_1,2,uVar4,0,0);
    FUN_016ed320(param_1,5,uVar5,0,0);
    FUN_016ed320(param_1,7,uVar7,0,0);
    ...
    FUN_016ed320(param_1,2,uVar4,uVar5,0);
    FUN_016ed320(param_1,5,uVar6,uVar7,0);
    FUN_016ed320(param_1,7,uVar10,uVar11,0);
