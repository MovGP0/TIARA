/* Ghidra address: 00951c60 */
/* Ghidra symbol: FUN_00951c60 */


undefined8 FUN_00951c60(longlong param_1,undefined8 param_2)

{
  ...
  iVar5 = *(int *)(*(longlong *)(param_1 + 0x98) + 0x10);
  uVar4 = 0;
  if (-1 < iVar5 + -1) {
    do {
  ...
  local_40[0] = uVar3;
  FUN_00597e50(*(longlong *)(param_1 + 0x98) + 8,local_40);
  return uVar3;
}
