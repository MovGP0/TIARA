/* Ghidra address: 008fbb00 */
/* Ghidra symbol: FUN_008fbb00 */


undefined1 FUN_008fbb00(undefined2 *param_1)

{
  ...
  if (uVar3 == 0) {
    ...
    cVar1 = FUN_008fc350(*local_res8[0]);
    if (cVar1 != '\0') {
      ...
      if (cVar1 != '\0') {
        ...
        iVar2 = 1;
        do {
          if ((int)uVar3 <= iVar2) goto LAB_008fbba0;
          iVar2 = iVar2 + 1;
