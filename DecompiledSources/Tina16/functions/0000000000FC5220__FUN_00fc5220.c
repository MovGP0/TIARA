/* Ghidra address: 00fc5220 */
/* Ghidra symbol: FUN_00fc5220 */


void FUN_00fc5220(longlong param_1)

{
  ...
  *(undefined4 *)(param_1 + 0xba8) = uVar2;
  ...
  if (local_29 == '\0') {
    ...
    local_a8 = local_60;
    FUN_00416cd0(&local_50,3,local_58,&DAT_00fc5598);
    FUN_00fc51b0(param_1,local_50);
  }
  else {
