/* Ghidra address: 013d87d0 */
/* Ghidra symbol: FUN_013d87d0 */


void FUN_013d87d0(longlong param_1,undefined1 param_2)

{
  ...
  local_40 = 0;
  local_28 = 0;
  if (param_1 == 0) goto LAB_013d8c87;
  FUN_013d2e70();
...
LAB_013d889f:
  ...
  *(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x798) = uVar5;
  FUN_0043f750(&local_40,DAT_01f45448);
  FUN_00416ba0(&local_38,L"AC Time Function result",local_40);
