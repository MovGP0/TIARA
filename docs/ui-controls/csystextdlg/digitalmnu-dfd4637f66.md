...
```mermaid
flowchart LR
    control["Digital"] -->|OnClick| handler["FUN_0146c070"]
...
- Source: [DecompiledSources/Tina16/functions/000000000146C070__FUN_0146c070.c](../../../DecompiledSources/Tina16/functions/000000000146C070__FUN_0146c070.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: CSysTextDlg.DeepLinkPopUpMnu.DigitalMnu.OnClick.
