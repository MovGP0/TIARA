/* Ghidra address: 01374e80 */
/* Ghidra symbol: FUN_01374e80 */


bool FUN_01374e80(longlong *param_1,longlong param_2)

{
  ...
  if (local_29) {
    ...
    FUN_017c52b0(param_1 + 0x24,iVar2);
    param_1[0x2d] = param_1[0x28];
  }
  local_29 = !local_29;
  if (iVar3 != iVar1) {
