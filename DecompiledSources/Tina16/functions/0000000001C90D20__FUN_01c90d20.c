/* Ghidra address: 01c90d20 */
/* Ghidra symbol: FUN_01c90d20 */


void FUN_01c90d20(longlong param_1)

{
  ...
  local_30 = 0;
  local_38 = 0;
  if ((((DAT_01fe8868 != (longlong *)0x0) && (DAT_01fe8870 != 0)) && (*PTR_DAT_020052b8 == '\0')) &&
     (*PTR_DAT_02003b20 == '\0')) {
    iVar2 = FUN_007e2fe0(DAT_01fe8870);
    iVar9 = iVar2 + 1;
    uVar1 = *(undefined8 *)(DAT_01fe8870 + 200);
    while( true ) {
    ...
    if (0 < iVar3) {
      ...
      if (-1 < iVar9 + -1) {
        do {
          ...
          (**(code **)(*DAT_01fe8868 + 0x18))(DAT_01fe8868,&local_58,local_5c);
          uVar7 = FUN_007ffbe0(param_1);
          uVar8 = FUN_007ffbe0(param_1);
          uVar4 = FUN_005fdff0(uVar8,&DAT_01c910ec);
          FUN_00b965d0(&local_50,local_58,uVar7,(ulonglong)uVar4 * 0x19);
          FUN_00416cd0(&local_40,4,&DAT_01c910c8,local_48,&DAT_01c910d8,local_50);
          FUN_007e2c60(plVar6,local_40);
          plVar6[0x23] = param_1;
          plVar6[0x22] = (longlong)FUN_01c90820;
