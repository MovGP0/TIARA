/* Ghidra address: 0110ebf0 */
/* Ghidra symbol: FUN_0110ebf0 */


void FUN_0110ebf0(longlong param_1,undefined1 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((0 < iVar1) && (-1 < *(int *)(param_1 + 0x1c))) {
    ...
    if (*(int *)(param_1 + 0x1c) <= iVar1 + -1) {
      ...
      *(undefined1 *)(lVar3 + 0x110) = param_2;
