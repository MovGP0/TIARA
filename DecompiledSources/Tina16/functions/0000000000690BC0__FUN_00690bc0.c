/* Ghidra address: 00690bc0 */
/* Ghidra symbol: FUN_00690bc0 */


int * FUN_00690bc0(longlong *param_1,int *param_2)
  ...
  if (iVar1 < 1) {
    ...
    *param_2 = param_2[2] - iVar1;
    ...
    if (iVar1 < iVar2 * 2) {
      ...
      *param_2 = *param_2 + (iVar1 * 2 - iVar2) / 2;
    }
    iVar1 = (**(code **)(*param_1 + 0x48))(param_1,10);
    if (param_2[2] - *param_2 < iVar1 / 2) {
      iVar1 = (**(code **)(*param_1 + 0x48))(param_1,10);
      *param_2 = param_2[2] - iVar1 / 2;
    }
  }
  return param_2;
}
