/* Ghidra address: 00b5fc60 */
/* Ghidra symbol: FUN_00b5fc60 */


void FUN_00b5fc60(longlong param_1)

{
  ...
  if (iVar1 == 0) {
    *(undefined1 *)(param_1 + 0x44) = 1;
    ...
    iVar1 = FUN_00417170(&DAT_00b60040,local_30,1);
    if (0 < iVar1) {
      uVar4 = 0;
      if (local_30 != 0) {
      ...
      iVar2 = FUN_00417170(&PTR_DAT_00b6005c,local_38,1);
      iVar1 = FUN_00417170(&DAT_00b60068,local_38,1);
      if (iVar2 < iVar1) {
        iVar1 = iVar2;
      }
      ...
      FUN_00414b90(*(longlong *)(lVar3 + 0x40) + 0x98,local_38);
    }
    iVar1 = FUN_00417170(&PTR_DAT_00b6005c,local_30,1);
    if (0 < iVar1) {
      uVar4 = 0;
      if (local_30 != 0) {
        uVar4 = *(uint *)(local_30 + -4) >> 1;
      ...
      iVar2 = FUN_00417170(&DAT_00b60040,local_38,1);
      iVar1 = FUN_00417170(&DAT_00b60068,local_38,1);
      if (iVar2 < iVar1) {
        iVar1 = iVar2;
      }
      ...
      lVar3 = FUN_00b598d0(*(undefined8 *)(*(longlong *)(param_1 + 0x18) + 8),
                           *(undefined4 *)(param_1 + 0x40));
      FUN_00414b90(*(longlong *)(lVar3 + 0x40) + 0x88,local_38);
    }
    iVar1 = FUN_00417170(&DAT_00b60068,local_30,1);
    if (0 < iVar1) {
      uVar4 = 0;
      if (local_30 != 0) {
        uVar4 = *(uint *)(local_30 + -4) >> 1;
      ...
      iVar2 = FUN_00417170(&PTR_DAT_00b6005c,local_38,1);
      iVar1 = FUN_00417170(&DAT_00b60040,local_38,1);
      if (iVar2 < iVar1) {
        iVar1 = iVar2;
      }
      FUN_00416430(&local_38,local_38,1,iVar1 + -1);
      lVar3 = FUN_00b598d0(*(undefined8 *)(*(longlong *)(param_1 + 0x18) + 8),
                           *(undefined4 *)(param_1 + 0x40));
      FUN_00414b90(*(longlong *)(lVar3 + 0x40) + 0x90,local_38);
    }
    *(undefined1 *)(param_1 + 0x44) = 1;
  }
