/* Ghidra address: 01a37200 */
/* Ghidra symbol: FUN_01a37200 */


void FUN_01a37200(longlong param_1)
    ...
    do {
      ...
      *(uint *)(param_1 + 0xec) = (uint)uVar1;
      if ((*(int *)(param_1 + 0xec) == 0xe) || (*(int *)(param_1 + 0xec) == 0xd)) {
        FUN_01a32310(*(undefined8 *)(param_1 + 0xf8),0,
                     *(undefined8 *)(*(longlong *)(param_1 + 0xe0) + (longlong)iVar4 * 8),1);
        iVar4 = iVar4 + 1;
      }
      iVar3 = iVar3 + 1;
      iVar5 = iVar5 + -1;
