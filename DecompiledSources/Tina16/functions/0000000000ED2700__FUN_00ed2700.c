/* Ghidra address: 00ed2700 */
/* Ghidra symbol: FUN_00ed2700 */


void FUN_00ed2700(longlong param_1)

{
  ...
  (**(code **)(**(longlong **)(param_1 + 0x888) + 0x10))
            (*(longlong **)(param_1 + 0x888),&local_58,*(undefined8 *)(param_1 + 0x8d0),local_60,0);
  FUN_0043ea00(&local_50,local_58);
  FUN_00414ad0(param_1 + 0x8b0,local_50);
  iVar3 = FUN_004170c0(local_30,*(undefined8 *)(param_1 + 0x8b0),1);
  if (0 < iVar3) {
    iVar4 = 0;
    if (local_30 != 0) {
      iVar4 = *(int *)(local_30 + -4);
    }
    FUN_00416e20(param_1 + 0x8b0,iVar3,iVar4 + 1);
  }
  plVar1 = *(longlong **)(param_1 + 0x750);
  uVar2 = (**(code **)(*plVar1 + 0x260))(plVar1);
  (**(code **)(*(longlong *)plVar1[0x94] + 0x18))((longlong *)plVar1[0x94],&local_68,uVar2);
  FUN_00ebb850(&local_20,local_68,*(undefined4 *)(param_1 + 0x90c));
  if (local_20 != 0) {
    FUN_00ea9ef0(&local_70,local_20);
    plVar1 = *(longlong **)(*(longlong *)(param_1 + 0x750) + 0x4a0);
    iVar4 = (**(code **)(*plVar1 + 0xb0))(plVar1,local_70);
    if (iVar4 == -1) {
      FUN_00416ba0(&local_78,local_20,&DAT_00ed2b50);
      FUN_00416ea0(local_78,param_1 + 0x8b0,iVar3);
      iVar3 = FUN_00416db0(local_30,*(undefined8 *)(param_1 + 0x8a8));
      if (iVar3 == 0) {
        FUN_00414ad0(param_1 + 0x8a8,local_20);
      }
