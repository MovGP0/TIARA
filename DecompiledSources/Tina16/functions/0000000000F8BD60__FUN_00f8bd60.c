/* Ghidra address: 00f8bd60 */
/* Ghidra symbol: FUN_00f8bd60 */


undefined1 FUN_00f8bd60(longlong param_1)
    ...
    if (cVar1 == '\0') {
      ...
      if (iVar2 == 6) {
        ...
        *(longlong *)(param_1 + 0x3480) = lVar4;
        (**(code **)(**(longlong **)(lVar4 + 0xe0) + 0x10))
                  (*(longlong **)(lVar4 + 0xe0),*(undefined8 *)(*(longlong *)(param_1 + 8) + 0x510))
        ;
        FUN_006eae90(*(undefined8 *)(param_1 + 8),0);
        local_49 = 0;
        thunk_FUN_0413e052(*(undefined8 *)(param_1 + 0x3500),0x1240,0,0);
