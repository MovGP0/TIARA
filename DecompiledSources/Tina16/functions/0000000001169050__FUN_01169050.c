/* Ghidra address: 01169050 */
/* Ghidra symbol: FUN_01169050 */


int * FUN_01169050(int *param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4,int param_5
  ...
  if (piVar2 != (int *)0xffffffffffffffff) {
    ...
    *piVar2 = *piVar2 + piVar2[0x19];
    ...
    if (DAT_0203a509 == '\0') {
      ...
      FUN_00414ff0(local_130,&LAB_01169210);
