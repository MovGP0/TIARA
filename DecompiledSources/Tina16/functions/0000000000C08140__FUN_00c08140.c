/* Ghidra address: 00c08140 */
/* Ghidra symbol: FUN_00c08140 */


undefined8 FUN_00c08140(longlong *param_1,int *param_2)

{
  ...
  if (0 < iVar4) {
    ...
    if (iVar4 <= iVar2) {
      ...
      if (iVar3 < iVar2) {
        cVar1 = (**(code **)(*param_1 + 0x360))
                          (param_1,*(undefined2 *)(local_38 + -2 + (longlong)iVar3 * 2));
        if (cVar1 != '\0') {
        ...
        if (iVar4 < iVar2) {
          (**(code **)(*(longlong *)param_1[0x9d] + 0x18))
                    ((longlong *)param_1[0x9d],&local_38,iVar4);
          iVar4 = iVar4 + 1;
          local_48 = *(undefined8 *)(*param_1 + 0x360);
          local_40 = param_1;
          iVar3 = FUN_00bcc2f0(local_38,1,&local_48);
          if (iVar3 == 0) {
            iVar3 = 1;
          }
        }
