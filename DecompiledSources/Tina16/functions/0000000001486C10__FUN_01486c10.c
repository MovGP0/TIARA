/* Ghidra address: 01486c10 */
/* Ghidra symbol: FUN_01486c10 */


undefined1 FUN_01486c10(longlong *param_1,undefined8 param_2,undefined4 param_3,undefined1 param_4)

{
  ...
  local_20 = 0;
  iVar1 = FUN_014868f0(param_1,param_2,param_3);
  if (iVar1 < 0) {
    local_29 = 0;
  }
  else {
    ...
    *(undefined4 *)(param_1[1] + lVar3 * 0x18) = 0xffffffff;
    local_29 = *(undefined1 *)(param_1[1] + 0x10 + lVar3 * 0x18);
    ...
    *(undefined1 *)(param_1[1] + 0x10 + lVar3 * 0x18) = 0;
    *(int *)(param_1 + 2) = (int)param_1[2] + -1;
    (**(code **)(*param_1 + 0x10))(param_1,local_20,param_4);
    (**(code **)(*param_1 + 0x18))(param_1,local_29,param_4);
  }
