...
```mermaid
flowchart LR
    control["Time"] -->|OnClick| handler["FUN_0113b2c0"]
...
- Source: [DecompiledSources/Tina16/functions/000000000113B2C0__FUN_0113b2c0.c](../../../DecompiledSources/Tina16/functions/000000000113B2C0__FUN_0113b2c0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: FuncGenWin.ParametersBox.SweepBox.SweepTimeBtn.OnClick.
