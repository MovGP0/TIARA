...
| Component path | SchematicEditor.PopupPower.pmPwrSink |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.PopupPower.pmPwrSink` |
...
```mermaid
flowchart TD
    control["Power sink"] -->|"OnClick"| handler["pmPowerClick (01c89950)"]
