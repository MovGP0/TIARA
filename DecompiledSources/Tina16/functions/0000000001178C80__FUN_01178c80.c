/* Ghidra address: 01178c80 */
/* Ghidra symbol: FUN_01178c80 */


void FUN_01178c80(longlong param_1,undefined8 param_2,short *param_3)

{
  ...
  if (*param_3 == 0xd) {
    uVar2 = *(undefined8 *)(DAT_020412f0 + 0x720);
