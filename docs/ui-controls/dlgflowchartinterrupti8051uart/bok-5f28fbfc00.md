...
| Handler node | `concept:dfm-handler:TdlgflowchartInterrupti8051UART/bOKClick` |
...
- Current graph summary: Unresolved Delphi event handler TdlgflowchartInterrupti8051UART.bOKClick, referenced by 1 UI event.
