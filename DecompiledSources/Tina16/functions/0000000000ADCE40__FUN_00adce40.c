/* Ghidra address: 00adce40 */
/* Ghidra symbol: FUN_00adce40 */


void FUN_00adce40(longlong param_1)

{
  ...
  plVar3 = (longlong *)
           FUN_00ab5680(*(undefined8 *)(*(longlong *)(param_1 + 0x2a0) + 0x60),0xbc,
  ...
  uVar2 = FUN_004113f0(plVar3,&PTR_FUN_00ac7900);
  FUN_00ad9ca0(*(undefined8 *)(param_1 + 0x2a0),uVar2);
  lVar1 = *(longlong *)(*(longlong *)(param_1 + 0x2a0) + 0xe8);
  uVar2 = FUN_004aeac0(lVar1,*(int *)(lVar1 + 0x10) + -1);
