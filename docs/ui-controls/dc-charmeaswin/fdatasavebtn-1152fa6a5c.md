...
```mermaid
flowchart LR
    control["FDataSaveBtn"] -->|OnClick| handler["FUN_01b68d70"]
    handler --> call1["FUN_010f7ea0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001B68D70__FUN_01b68d70.c](../../../DecompiledSources/Tina16/functions/0000000001B68D70__FUN_01b68d70.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DC_CharMeasWin.DataBox.FDataSaveBtn.OnClick.
