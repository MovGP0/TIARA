/* Ghidra address: 01155ce0 */
/* Ghidra symbol: FUN_01155ce0 */


void FUN_01155ce0(undefined8 param_1)

{
  ...
  local_28 = FUN_004b9860(&PTR_FUN_0047c498,1,local_res8[0],0xff00);
  local_88 = 0;
  ...
  (**(code **)(**(longlong **)(*(longlong *)PTR_DAT_02001e00 + 0x7a0) + 0x40))
            (*(longlong **)(*(longlong *)PTR_DAT_02001e00 + 0x7a0),local_20);
