/* Ghidra address: 01cd3b70 */
/* Ghidra symbol: FUN_01cd3b70 */


void FUN_01cd3b70(longlong *param_1,longlong param_2)

{
  ...
  iVar2 = FUN_005fdff0(param_2,&DAT_01cd3ccc);
  iVar3 = FUN_005fdfd0(param_2,&DAT_01cd3ccc);
  ...
  if (uVar4 < 6) {
    if (uVar4 != 5) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
        if (uVar4 < 2) goto LAB_01cd3c60;
        if (uVar4 != 3) {
          return;
        }
      }
LAB_01cd3c09:
      cVar1 = FUN_01cd3950(param_1);
      if (cVar1 == '\0') {
        return;
      }
