/* Ghidra address: 01bb40e0 */
/* Ghidra symbol: FUN_01bb40e0 */


undefined1 FUN_01bb40e0(longlong param_1,longlong *param_2)

{
  ...
  if (cVar1 == '\x04') {
    ...
    if (sVar2 == sVar3) {
      ...
      if ((iVar4 == 0) && (*(int *)((longlong)param_2 + 0x18c) == *(int *)(param_1 + 0x60))) {
        local_29 = 1;
        goto code_r0x01bb4193;
      }
    }
    local_29 = 0;
  }
