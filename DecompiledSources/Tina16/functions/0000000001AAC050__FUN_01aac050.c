/* Ghidra address: 01aac050 */
/* Ghidra symbol: FUN_01aac050 */


void FUN_01aac050(longlong param_1,undefined8 param_2,int param_3)

{
  ...
  uVar2 = FUN_01aac6a0(param_1,param_3,&local_3b,local_39,&local_3a);
