/* Ghidra address: 017464e0 */
/* Ghidra symbol: FUN_017464e0 */


undefined8
FUN_017464e0(longlong param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4,char param_5)

{
  ...
  FUN_00498350(param_2,*(int *)(param_1 + 0x50),*(int *)(param_1 + 0x54),
               *(int *)(param_1 + 0x48) + *(int *)(param_1 + 0x50),
               CONCAT44(uVar2,*(int *)(param_1 + 0x4c) + *(int *)(param_1 + 0x54)));
  return param_2;
}
