...
| --- | --- |
| Form | MCUProjectForm |
| Component path | MCUProjectForm.pmAddToProject.mnNew |
...
| Graph node | `resource:dfm:MCUProjectForm/MCUProjectForm.pmAddToProject.mnNew` |
...
```mermaid
flowchart TD
    control["Create New File"] -->|OnClick| handler["TMCUProjectForm.mnNewClick<br/>FUN_010856d0"]
