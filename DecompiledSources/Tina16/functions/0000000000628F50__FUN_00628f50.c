/* Ghidra address: 00628f50 */
/* Ghidra symbol: FUN_00628f50 */


int FUN_00628f50(longlong param_1,longlong param_2,int param_3,int param_4)

{
  ...
  *(longlong *)(param_1 + 0x40) = local_res10[0] + param_3;
  *(int *)(param_1 + 0x48) = param_4;
  ...
  do {
    if ((*(int *)(param_1 + 0x48) == 0) || (iVar1 == 1)) {
      ...
      local_1c = *(int *)(param_1 + 0x48);
LAB_006290d2:
      local_1c = param_4 - local_1c;
