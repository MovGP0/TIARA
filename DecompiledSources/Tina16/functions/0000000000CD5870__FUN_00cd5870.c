/* Ghidra address: 00cd5870 */
/* Ghidra symbol: FUN_00cd5870 */


void FUN_00cd5870(longlong *param_1,longlong *param_2,longlong *param_3,int param_4,char param_5)
  ...
  if (param_2 != (longlong *)0x0) {
    ...
    if (param_5 == '\x03') {
      while (0 < local_res20) {
        ...
        FUN_00cd7390(param_1,local_30 - local_res20,local_30);
      }
    }
    else {
      while (0 < local_res20) {
