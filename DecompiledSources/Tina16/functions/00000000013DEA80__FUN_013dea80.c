/* Ghidra address: 013dea80 */
/* Ghidra symbol: FUN_013dea80 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_013dea80(undefined8 *param_1,longlong param_2)

{
  ...
  undefined1 local_1ec [41];
  undefined1 local_1c3 [419];
  
  uVar11 = (uint)((ulonglong)in_stack_fffffffffffff9a8 >> 0x20);
  local_4f8 = 0;
  local_2a0 = 0;
  local_298 = 0;
  local_278 = 0;
  ...
  if (param_2 == 0) goto LAB_013df425;
  FUN_013d2e70();
...
LAB_013deb50:
  ...
  if (lVar7 == 0) {
    ...
    FUN_00416ad0(&local_2a0,L"_Ampli");
  ...
  if (local_268._1_1_ == '\0') {
    ...
    FUN_00415110(local_3b8,&DAT_013df4ca,0x30);
    FUN_004169a0(&local_278,local_3b8);
  }
  else {
    FUN_00414ff0(local_2d0,local_215);
    FUN_00415110(local_2d0,&DAT_013df4c2,0x2d);
    FUN_00414ff0(local_328,local_2d0);
    FUN_00415110(local_328,(longlong)&local_268 + 1,0x55);
    FUN_00414ff0(local_380,local_328);
    FUN_00415110(local_380,&DAT_013df4c8,0x56);
    FUN_004169a0(&local_278,local_380);
  }
  if (local_23e[0] == '\0') {
    FUN_00414ff0(local_4b0,local_1ec);
    FUN_00415110(local_4b0,&DAT_013df4dc,0x33);
    FUN_004169a0(&local_280,local_4b0);
  }
  else {
    FUN_00414ff0(local_3b8,local_1ec);
    FUN_00415110(local_3b8,&DAT_013df4d3,0x30);
    FUN_00414ff0(local_418,local_3b8);
    FUN_00415110(local_418,local_23e,0x58);
    FUN_00414ff0(local_478,local_418);
    FUN_00415110(local_478,&DAT_013df4c8,0x59);
    FUN_004169a0(&local_280,local_478);
  }
  ...
  FUN_01a782f0(*(undefined8 *)PTR_DAT_02001e00,local_4c0);
  FUN_01acf9e0(lVar6,local_4c0);
  uVar5 = local_270;
  ...
  lVar7 = FUN_01acd9b0(&PTR_FUN_01ac9770,1,*(undefined8 *)PTR_DAT_02001e00,0,
                       *(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x780),local_290);
  FUN_00414ff0(local_4f0,local_1c3);
  FUN_00415110(local_4f0,&DAT_013df50e,0x2e);
  FUN_004169a0(&local_4f8,local_4f0);
  FUN_01cec150(*(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x7a0),lVar7,local_4f8,
               *(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0xa68));
  uVar5 = FUN_01cc6f70(&PTR_FUN_01cb9528,1,param_2);
  local_270 = 0;
  if (local_268._1_1_ == '\0') {
    FUN_00414ff0(local_528,local_215);
    FUN_00415110(local_528,&DAT_013df515,0x2f);
    FUN_004169a0(&local_278,local_528);
  }
  else {
    FUN_00414ff0(local_2d0,local_215);
    FUN_00415110(local_2d0,&DAT_013df4c2,0x2d);
  ...
  if (local_23e[0] == '\0') {
    FUN_00414ff0(local_5f8,local_1ec);
    FUN_00415110(local_5f8,&DAT_013df527,0x35);
    FUN_004169a0(&local_280,local_5f8);
  }
  else {
    FUN_00414ff0(local_560,local_1ec);
    FUN_00415110(local_560,&DAT_013df51d,0x31);
    FUN_00414ff0(local_478,local_560);
    FUN_00415110(local_478,local_23e,0x59);
    FUN_00414ff0(local_5c0,local_478);
    FUN_00415110(local_5c0,&DAT_013df4c8,0x5a);
    FUN_004169a0(&local_280,local_5c0);
  }
  FUN_00f16900(uVar5,param_2,0,local_278,2,1,uVar10 & 0xffffffff00000000,local_280,1,1,2,&local_270,
               lVar7,1,0);
  (**(code **)(**(longlong **)(lVar7 + 0xd8) + 0x80))
            (*(longlong **)(lVar7 + 0xd8),L"Ipr Result 1",local_270);
  FUN_01a782f0(*(undefined8 *)PTR_DAT_02001e00,local_4c0);
  FUN_01acf9e0(lVar7,local_4c0);
  uVar5 = local_270;
  cVar2 = FUN_01ce8540(local_270);
  if (cVar2 != '\0') {
    uVar3 = FUN_01ce83f0(uVar5);
