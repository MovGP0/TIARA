/* Ghidra address: 016ebfa0 */
/* Ghidra symbol: FUN_016ebfa0 */


void FUN_016ebfa0(longlong param_1,byte param_2,undefined1 param_3,undefined1 param_4,
                 undefined1 param_5)

{
  ...
  if ((param_2 == 0) || (*(byte *)(param_1 + 4) < param_2)) {
    FUN_01b04d70(0x215,&LAB_016ec02c,0);
  }
  else {
    lVar3 = FUN_016e8fd0(4);
