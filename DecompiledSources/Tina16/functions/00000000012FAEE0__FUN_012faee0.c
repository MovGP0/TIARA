/* Ghidra address: 012faee0 */
/* Ghidra symbol: FUN_012faee0 */


longlong FUN_012faee0(longlong param_1,longlong param_2,longlong param_3)

{
  ...
  if (param_2 == 0) {
    local_10 = FUN_006df4b0(*(undefined8 *)
                             (*(longlong *)(*(longlong *)(param_1 + 0x330) + 0x700) + 0x550));
  }
  else {
