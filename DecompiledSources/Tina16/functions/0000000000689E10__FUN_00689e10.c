/* Ghidra address: 00689e10 */
/* Ghidra symbol: FUN_00689e10 */


void FUN_00689e10(longlong param_1,longlong param_2)

{
  ...
  *(uint *)(param_2 + 8) =
       *(uint *)(param_2 + 8) | 5 |
       *(uint *)(&DAT_01dfac20 + (ulonglong)*(byte *)(param_1 + 0x498) * 4 + (uVar2 & 0xff) * 8);
