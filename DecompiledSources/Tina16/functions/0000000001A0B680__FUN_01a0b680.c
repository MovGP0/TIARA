/* Ghidra address: 01a0b680 */
/* Ghidra symbol: FUN_01a0b680 */


void FUN_01a0b680(longlong param_1)

{
  ...
  if (sVar1 == 0x51) {
    ...
    FUN_00416cd0(local_20,4,L".IC V( ",local_28,&DAT_01a0b854,local_30);
    ...
    FUN_00416cd0(&local_38,6,L".IC V( ",local_40,&LAB_01a0b868,local_48,&DAT_01a0b854,local_50);
