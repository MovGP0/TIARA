/* Ghidra address: 00998400 */
/* Ghidra symbol: FUN_00998400 */


longlong * FUN_00998400(longlong param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if ((cVar1 == '\0') ||
     (cVar1 = FUN_004113d0(*(undefined8 *)(param_1 + 0x20),&PTR_FUN_0092bf50), cVar1 == '\0')) {
    cVar1 = FUN_004113d0(plVar3,&PTR_FUN_0092bf50);
    if (cVar1 == '\0') {
