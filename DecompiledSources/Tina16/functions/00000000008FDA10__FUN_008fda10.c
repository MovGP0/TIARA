/* Ghidra address: 008fda10 */
/* Ghidra symbol: FUN_008fda10 */


undefined1 FUN_008fda10(longlong param_1)
  ...
  if ((iVar4 != 0) && (iVar2 = 0, 0 < iVar4)) {
    do {
      ...
      if (*(short *)(local_res8[0] + -2 + (longlong)iVar3 * 2) == 0x25) {
        ...
        iVar2 = iVar3;
        if ((((((cVar1 == '\0') && (*(short *)(local_res8[0] + -2 + lVar5 * 2) != 0x3a)) &&
           ...
           ((*(short *)(local_res8[0] + -2 + lVar5 * 2) != 0x3b &&
            (*(short *)(local_res8[0] + -2 + lVar5 * 2) != 0x2f)))) {
          local_29 = 0;
          break;
        }
      }
