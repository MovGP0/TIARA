...
```mermaid
flowchart LR
    control["bOK"] -->|OnClick| handler["FUN_00f9e510"]
...
- Source: [DecompiledSources/Tina16/functions/0000000000F9E510__FUN_00f9e510.c](../../../DecompiledSources/Tina16/functions/0000000000F9E510__FUN_00f9e510.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: dlgFlowchartInterruptTmr0.bOK.OnClick.
...
- `function:00f9e4a0` — FUN_00f9e4a0
