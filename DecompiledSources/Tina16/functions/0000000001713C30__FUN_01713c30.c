/* Ghidra address: 01713c30 */
/* Ghidra symbol: FUN_01713c30 */


void FUN_01713c30(longlong param_1,longlong param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  *(undefined8 *)(lVar4 + 0x10) = uVar5;
  ...
  if (local_res18 != 0) {
    iVar1 = FUN_004170c0(&DAT_01714320,local_res18,1);
    if (0 < iVar1) {
      uVar2 = FUN_004170c0(&DAT_01714320,local_res18,1);
  ...
  iVar1 = FUN_004170c0(&DAT_01714348,local_78,1);
  if (0 < iVar1) {
    iVar3 = 0;
    if (*(longlong *)(lVar4 + 0x20) != 0) {
  ...
  *(undefined4 *)(lVar4 + 0x50) = 0;
  ...
  if (iVar1 != 0) {
    ...
    if (iVar3 == -1) {
      ...
      (**(code **)(**(longlong **)(param_1 + 0x68) + 0x80))
                (*(longlong **)(param_1 + 0x68),local_88,plVar6);
    }
    else {
      plVar6 = (longlong *)
  ...
  (**(code **)(**(longlong **)(param_1 + 0x18) + 0x80))
            (*(longlong **)(param_1 + 0x18),local_res10,lVar4);
  FUN_00414b50(local_30,*(undefined8 *)(lVar4 + 0x40));
  if (iVar1 != 0) {
    iVar1 = (**(code **)(**(longlong **)(param_1 + 0x40) + 0xb8))
                      (*(longlong **)(param_1 + 0x40),local_30[0]);
    if (iVar1 == -1) {
      FUN_00416880(&local_98,*(undefined8 *)(lVar4 + 0x20));
      FUN_00416cd0(&local_90,3,local_30[0],&DAT_01714358,local_98);
      (**(code **)(**(longlong **)(param_1 + 0x40) + 0x78))(*(longlong **)(param_1 + 0x40),local_90)
      ;
    }
    else {
      FUN_004b5390(*(undefined8 *)(param_1 + 0x40),&local_38,iVar1);
      ...
      if (iVar3 == 0) {
        ...
        FUN_00416cd0(&local_38,3,local_38,&DAT_01714368,local_a8);
        FUN_004b5450(*(undefined8 *)(param_1 + 0x40),iVar1,local_38);
      }
    }
  }
  iVar1 = FUN_004413f0(&DAT_01714378,local_res10);
  if (iVar1 < 1) {
  ...
  iVar1 = (**(code **)(**(longlong **)(param_1 + 0x80) + 0xb0))
                    (*(longlong **)(param_1 + 0x80),local_40);
  if (iVar1 == -1) {
    plVar6 = (longlong *)FUN_004b6930(&PTR_FUN_00478280,1);
    (**(code **)(**(longlong **)(param_1 + 0x80) + 0x80))
              (*(longlong **)(param_1 + 0x80),local_40,plVar6);
  }
  else {
    plVar6 = (longlong *)
             (**(code **)(**(longlong **)(param_1 + 0x80) + 0x30))
                       (*(longlong **)(param_1 + 0x80),iVar1);
  }
  if (local_48 != 0) {
