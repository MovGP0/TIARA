/* Ghidra address: 0138c2a0 */
/* Ghidra symbol: FUN_0138c2a0 */


void FUN_0138c2a0(longlong param_1,char param_2)

{
  ...
  local_20 = (double)FUN_00b90090(*(undefined8 *)(param_1 + 0xc48));
  if (param_2 == '\0') {
  ...
  dVar2 = (double)FUN_00b90090(*(undefined8 *)(param_1 + 0xc50));
  if (local_20 <= dVar2) {
    FUN_0138c800(param_1,param_1);
  }
  else {
    cVar1 = (**(code **)(**(longlong **)(param_1 + 0xc70) + 0xf0))(*(longlong **)(param_1 + 0xc70));
    if ((cVar1 == '\0') || (*(char *)(*(longlong *)(param_1 + 0xc70) + 0x328) == '\0')) {
      *(double *)(*(longlong *)(param_1 + 0xe78) + 0x48) = local_20;
      if ((*(char *)(param_1 + 0x990) == '\x06') || ((byte)(*(char *)(param_1 + 0x990) - 8U) < 2)) {
        FUN_010eae00(*(undefined8 *)(param_1 + 0x9b0),local_20,1,1,1);
      }
      else {
        FUN_010eb220(*(undefined8 *)(param_1 + 0x9b0),local_20,1,0,1,1);
      }
      FUN_00b90440(*(undefined8 *)(param_1 + 0xc48),
                   *(undefined8 *)(*(longlong *)(param_1 + 0xe78) + 0x48));
    }
    else {
      *(double *)(*(longlong *)(*(longlong *)(param_1 + 0xe78) + 0x50) + 0x48) = local_20;
      if ((*(char *)(param_1 + 0x990) == '\x06') || ((byte)(*(char *)(param_1 + 0x990) - 8U) < 2)) {
        FUN_010eb220(*(undefined8 *)(param_1 + 0x9b0),local_20,1,0,1,1);
      }
      else {
        FUN_010eb220(*(undefined8 *)(param_1 + 0x9b0),local_20,1,1,1,1);
      }
      FUN_00b90440(*(undefined8 *)(param_1 + 0xc48),
