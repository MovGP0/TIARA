/* Ghidra address: 0138faf0 */
/* Ghidra symbol: FUN_0138faf0 */


undefined8 FUN_0138faf0(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4)

{
  ...
  if (param_4 == 0) {
    FUN_015f5620(param_1,&DAT_0138fd20,0xffffffff);
  }
  else {
    ...
    if (local_20 == 0) {
      ...
      if (cVar1 == '\0') {
        ...
        if (cVar1 == '\0') {
          ...
          if (cVar1 == '\0') {
            ...
            if (cVar1 != '\0') {
              FUN_00414b50(&local_38,&DAT_0138fd40);
            }
          }
          else {
            FUN_00414b50(&local_38,&DAT_0138fd30);
            FUN_0043fba0(&local_30,uVar2,2);
          }
        }
        else {
          FUN_00414b50(&local_38,&DAT_0138fd20);
          FUN_0043fba0(&local_30,uVar2,2);
        }
      }
      else {
      ...
      FUN_015f4cb0(local_50,&LAB_0138fd50,&DAT_0138fd20);
      FUN_00417c40(param_1,local_50,&DAT_00e021a8);
    }
  }
