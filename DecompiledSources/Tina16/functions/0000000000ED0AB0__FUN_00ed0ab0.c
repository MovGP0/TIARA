/* Ghidra address: 00ed0ab0 */
/* Ghidra symbol: FUN_00ed0ab0 */


void FUN_00ed0ab0(longlong param_1)

{
  ...
  local_28 = 0;
  local_30 = 0;
  FUN_00ebb850(local_20,0,*(undefined4 *)(param_1 + 0x90c));
  if (local_20[0] != 0) {
    ...
    if (iVar2 < 0) {
      ...
      if (*(longlong *)(param_1 + 0x8a8) == 0) {
        ...
        FUN_00414ad0(param_1 + 0x8a8,local_70);
      }
      ...
      (**(code **)(**(longlong **)(param_1 + 0x888) + 0x10))
                (*(longlong **)(param_1 + 0x888),&local_80,*(undefined8 *)(param_1 + 0x8d0),local_88
                 ,0);
      FUN_0043ea00(&local_30,local_80);
      FUN_00416cd0(&local_30,4,local_30,&DAT_00ed0e50,local_20[0],L" ();");
      FUN_0043e130(&local_90,local_28);
      (**(code **)(**(longlong **)(param_1 + 0x888) + 0x18))
                (*(longlong **)(param_1 + 0x888),*(undefined8 *)(param_1 + 0x8d0),local_90,local_30)
      ;
      FUN_00414ad0(param_1 + 0x8b0,local_30);
