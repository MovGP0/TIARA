/* Ghidra address: 012c7620 */
/* Ghidra symbol: FUN_012c7620 */


void FUN_012c7620(longlong param_1,undefined8 param_2,undefined8 param_3,char param_4)

{
  ...
  while (iVar1 == 0) {
    if ((((local_2e1 != '\0') && ((local_288 & 0x10) == 0x10)) &&
        (iVar1 = FUN_00416db0(local_280,&DAT_012c7a18), iVar1 != 0)) &&
       (iVar1 = FUN_00416db0(local_280,&DAT_012c7a28), iVar1 != 0)) {
      FUN_0064dd90(*(undefined8 *)(param_1 + 0x708),&local_2c0);
      FUN_0044f850(&local_2b8,local_2c0);
      local_308 = local_280;
      FUN_00416cd0(&local_2c8,3,local_res18[0],&DAT_012c7a3c);
      FUN_00441d00(&local_2a0,local_2b8,local_2c8);
      lVar2 = FUN_012c7530(auStack_328,0,local_2a0);
      if (lVar2 == 0) {
        uVar3 = FUN_012c28a0(0x10);
        lVar2 = FUN_006dee70(*(undefined8 *)(*(longlong *)(param_1 + 0x748) + 0x550),0,local_2a0,
                             uVar3);
      }
      local_308 = local_280;
      FUN_00416cd0(&local_2d0,3,local_res18[0],&DAT_012c7a3c);
      FUN_012c7620(param_1,lVar2,local_2d0,local_2e1);
    ...
    if ((local_288 & 0x20) == 0x20) {
      ...
      if (bVar5) {
        ...
        lVar2 = FUN_012c7530(auStack_328,local_2f0);
        if (lVar2 == 0) {
          FUN_004414c0(&local_2e0,local_280,0);
          uVar3 = FUN_012c28a0(0x20);
          FUN_006dee70(*(undefined8 *)(*(longlong *)(param_1 + 0x748) + 0x550),local_2f0,local_2e0,
                       uVar3);
        }
      }
    }
