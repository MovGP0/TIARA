/* Ghidra address: 00fbcbe0 */
/* Ghidra symbol: FUN_00fbcbe0 */


void FUN_00fbcbe0(longlong param_1)

{
  ...
  dVar3 = (1.0 / dVar3) * (double)(0x10000 - iVar2) * (double)iVar1;
  ...
  FUN_00f61040(&local_68,0x10000 - (0x10000 - iVar2));
