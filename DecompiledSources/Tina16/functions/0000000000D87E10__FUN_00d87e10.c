/* Ghidra address: 00d87e10 */
/* Ghidra symbol: FUN_00d87e10 */


void FUN_00d87e10(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 *param_4,
                 undefined8 param_5)

{
  ...
  if (lVar3 == 0) {
    lVar3 = *(longlong *)(*(longlong *)(param_1 + 0x58) + 0x48);
  }
  if ((char)local_2c == '\0') {
    plVar4 = (longlong *)FUN_00d77610(lVar3,L"VertFrame");
  }
  else {
    plVar4 = (longlong *)FUN_00d77610(lVar3,L"HorzFrame");
  }
