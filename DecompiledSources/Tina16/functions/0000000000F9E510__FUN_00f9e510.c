/* Ghidra address: 00f9e510 */
/* Ghidra symbol: FUN_00f9e510 */


void FUN_00f9e510(longlong param_1)

{
  ...
  *(undefined4 *)(param_1 + 0x7d8) = *(undefined4 *)(param_1 + 0x758);
  ...
  if (local_29 == '\0') {
    FUN_0064dd90(*(undefined8 *)(param_1 + 0x728),&local_58);
    uVar3 = FUN_00b89270();
    FUN_0041ddd0(&local_68,PTR_PTR_02002978);
    FUN_00b8e650(uVar3,&local_60,L"HDLStrings.Msg_FC_NotValidInt",local_68);
    local_a8 = local_60;
    FUN_00416cd0(&local_50,3,local_58,&DAT_00f9e858);
    FUN_00f9e4a0(param_1,local_50);
  }
  else {
    FUN_0064dd90(*(undefined8 *)(param_1 + 0x728),&local_70);
    uVar2 = FUN_00f60f70(local_70);
    *(undefined4 *)(param_1 + 0x7e0) = uVar2;
  }
