/* Ghidra address: 01d4e320 */
/* Ghidra symbol: FUN_01d4e320 */


void FUN_01d4e320(double *param_1,undefined8 param_2,longlong param_3,char param_4)

{
  ...
  if (((param_4 == '\x01') || (param_4 == '\x06')) || (param_4 == '\b')) {
    ...
    FUN_016ed220(param_2,8,dVar3 * dVar1,0);
    FUN_016ed220(param_2,9,dVar2 * dVar1,0);
  }
  *param_1 = dVar2;
  param_1[1] = dVar3;
  return;
