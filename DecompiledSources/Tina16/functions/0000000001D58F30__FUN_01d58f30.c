/* Ghidra address: 01d58f30 */
/* Ghidra symbol: FUN_01d58f30 */


void FUN_01d58f30(undefined8 param_1,undefined8 param_2,undefined8 *param_3,char param_4)

{
  ...
  FUN_016ebb00(param_1,0xe,local_d0,0x40);
  FUN_016ee260(param_1,&local_d8,0x170,0);
  *(undefined1 *)(local_d8 + 0x98) = 1;
  if (param_4 == '\x01') {
