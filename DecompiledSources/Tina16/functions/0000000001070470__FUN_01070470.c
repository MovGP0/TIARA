/* Ghidra address: 01070470 */
/* Ghidra symbol: FUN_01070470 */


void FUN_01070470(longlong param_1)

{
  ...
  local_30 = 0;
  local_38 = 0;
  iVar3 = (**(code **)(**(longlong **)(param_1 + 0x6b0) + 0x260))(*(longlong **)(param_1 + 0x6b0));
  if (-1 < iVar3) {
    ...
    bVar2 = false;
    iVar3 = (**(code **)(**(longlong **)(*(longlong *)(param_1 + 0x6b8) + 0x4a0) + 0x28))();
    iVar6 = 0;
    if (-1 < iVar3 + -1) {
      do {
