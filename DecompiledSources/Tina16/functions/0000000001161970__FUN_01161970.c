/* Ghidra address: 01161970 */
/* Ghidra symbol: FUN_01161970 */


void FUN_01161970(int param_1,longlong *param_2)

{
  ...
  *(double *)(PTR_DAT_02001ad0 + 0x30) = dVar3;
  if (dVar3 == 0.0) {
    FUN_0116da30(*(undefined8 *)PTR_DAT_020052d8,L"LOWPASSFILTER1",
    ...
    FUN_0116da30(*(undefined8 *)PTR_DAT_020052d8,L"LOWPASSFILTER",
                 *(undefined4 *)(PTR_DAT_02001ad0 + 0x50),*(undefined4 *)(PTR_DAT_02001ad0 + 0x54),
                 PTR_DAT_020011d0);
  }
  else {
