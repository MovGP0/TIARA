/* Ghidra address: 01cc48a0 */
/* Ghidra symbol: FUN_01cc48a0 */


void FUN_01cc48a0(longlong param_1,int param_2,double param_3,double param_4)

{
  ...
  if (local_res18 != 1.0) {
    FUN_01cc1510(lVar2,7,(local_res18 + 1.0) / (1.0 - local_res18));
  }
  if (*(int *)(lVar2 + 0x2c) == 1) {
    *(double *)(lVar2 + 0x178) = local_res20;
    FUN_01cc1510(lVar2,1,local_res20);
    FUN_00c43ad0(&local_res18,&local_res20);
    ...
    *(double *)(lVar2 + 0x178) = local_res20;
    ...
    FUN_01cc1510(lVar2,2,local_res18);
    FUN_01cc1510(lVar2,3,local_res20);
    uVar4 = FUN_00c43b60(*(undefined8 *)(lVar2 + 0x180),*(undefined8 *)(lVar2 + 0x170));
    FUN_01cc1510(lVar2,4,uVar4);
  }
