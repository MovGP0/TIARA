...
```mermaid
flowchart LR
    control["Configuration type"] -->|OnClick| handler["FUN_01236410"]
    handler --> call1["VCL control text setter with change suppression"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001236410__FUN_01236410.c](../../../DecompiledSources/Tina16/functions/0000000001236410__FUN_01236410.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: Analog_form1.GroupBox2.MyRadioGroup1.OnClick.
