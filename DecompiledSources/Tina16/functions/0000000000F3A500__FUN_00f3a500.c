/* Ghidra address: 00f3a500 */
/* Ghidra symbol: FUN_00f3a500 */


undefined8 FUN_00f3a500(longlong param_1,undefined8 param_2)

{
  ...
  FUN_00417c40(local_18,*(longlong *)(*(longlong *)(param_1 + 8) + 8) +
                        (longlong)*(int *)(param_1 + 0x10) * 0x10,&DAT_00f25ec0);
