/* Ghidra address: 0094ea50 */
/* Ghidra symbol: FUN_0094ea50 */


undefined8 FUN_0094ea50(longlong *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  local_20 = 0;
  local_30 = 0;
  plVar3 = (longlong *)(**(code **)(*param_1 + 0x178))(param_1);
  do {
...
LAB_0094eb13:
    ...
    plVar3 = (longlong *)(**(code **)(*plVar3 + 0x178))(plVar3);
  } while( true );
}
