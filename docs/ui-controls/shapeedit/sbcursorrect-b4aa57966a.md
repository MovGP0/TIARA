...
```mermaid
flowchart LR
    control["Add cursor sensing rectangle (interactive area)"] -->|OnClick| handler["FUN_0179f640"]
...
- Extracted glyph: [`0416_ShapeEdit_ShapeEdit_TopToolBar_EditorTools_sbCursorRect_Glyph_Data.png`](../../../glyph/0416_ShapeEdit_ShapeEdit_TopToolBar_EditorTools_sbCursorRect_Glyph_Data.png)
