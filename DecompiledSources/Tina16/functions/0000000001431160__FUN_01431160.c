/* Ghidra address: 01431160 */
/* Ghidra symbol: FUN_01431160 */


void FUN_01431160(longlong param_1,undefined8 param_2)

{
  ...
  if ((local_c < -0x7fff) || (0x8000 < local_c)) {
    uVar2 = FUN_00b89270();
