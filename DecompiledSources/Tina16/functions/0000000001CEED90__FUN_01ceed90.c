/* Ghidra address: 01ceed90 */
/* Ghidra symbol: FUN_01ceed90 */


undefined1 FUN_01ceed90(longlong param_1,int param_2)
...
LAB_01ceeedc:
                    ...
                    if (*(int *)(lVar9 + 0xe8) == param_2) {
                      lVar6 = (**(code **)(**(longlong **)(lVar7 + 0x80) + 0x30))
                                        (*(longlong **)(lVar7 + 0x80),local_34 + -1);
                      return *(undefined1 *)(lVar6 + 0xa8);
                    }
                  }
                  else if (uVar8 == 1) goto LAB_01ceef47;
                }
                else if (uVar8 - 3 < 2) {
LAB_01ceef47:
                  lVar9 = (**(code **)(**(longlong **)(lVar7 + 0x80) + 0x30))
                ...
                else if (uVar8 - 5 < 2) goto LAB_01ceeedc;
                local_34 = local_34 + 1;
                iVar4 = iVar4 + -1;
              } while (iVar4 != 0);
            }
