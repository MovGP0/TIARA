/* Ghidra address: 00d7b0a0 */
/* Ghidra symbol: FUN_00d7b0a0 */


longlong FUN_00d7b0a0(longlong param_1,char param_2,undefined8 param_3)

{
  ...
  local_20 = puVar1;
  FUN_00d78690(local_res8,0,param_3);
