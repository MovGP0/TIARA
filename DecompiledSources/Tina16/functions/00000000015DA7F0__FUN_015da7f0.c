/* Ghidra address: 015da7f0 */
/* Ghidra symbol: FUN_015da7f0 */


void FUN_015da7f0(longlong param_1)
  ...
  *(undefined1 *)(param_1 + 0x111) = 0;
  ...
  if (cVar1 == '\0') {
    ...
    *(undefined1 *)(param_1 + 0x103) = 2;
    FUN_00414b50(&local_28,*(undefined8 *)(param_1 + 0x88));
    FUN_015d9080(param_1,&local_28,0xffffffff,0);
