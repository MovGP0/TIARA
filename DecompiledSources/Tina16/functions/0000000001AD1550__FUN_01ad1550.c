/* Ghidra address: 01ad1550 */
/* Ghidra symbol: FUN_01ad1550 */


void FUN_01ad1550(longlong param_1)

{
  ...
  if (0 < iVar3) {
    do {
      ...
      bVar2 = FUN_01ce63e0(uVar4,*(undefined8 *)(param_1 + 0x80),*(undefined8 *)(param_1 + 0x78));
      bVar6 = bVar6 | bVar2;
      iVar5 = iVar5 + 1;
      iVar3 = iVar3 + -1;
    } while (iVar3 != 0);
