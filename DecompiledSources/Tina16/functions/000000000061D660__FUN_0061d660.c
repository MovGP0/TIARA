/* Ghidra address: 0061d660 */
/* Ghidra symbol: FUN_0061d660 */


undefined8 FUN_0061d660(undefined8 param_1,longlong param_2)
  ...
  if (0 < iVar7) {
    do {
      ...
      if (bVar3 < 0x20 && (1 << (bVar3 & 0x1f) & 0x7fffffeU) != 0) {
        ...
        *(char *)(lVar4 + -1 + lVar6) = *(char *)(param_2 + -1 + lVar6) + -0x20;
      }
      else {
        lVar4 = FUN_00414df0(param_1);
