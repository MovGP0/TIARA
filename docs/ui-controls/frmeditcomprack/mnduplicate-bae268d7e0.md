...
| Component path | frmEditCompRack.pmnuNav.mnDuplicate |
| Control class | TMenuItem |
| Caption | D&uplicate |
| Hint | Create a duplicate copy of the selected component in the same group |
| Text | Not present in the recovered resource. |
| Handler name | btnAddClick |
| Handler address | 01b98160 |
| Graph node | `resource:dfm:frmEditCompRack/frmEditCompRack.pmnuNav.mnDuplicate` |
