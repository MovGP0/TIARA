/* Ghidra address: 00998cf0 */
/* Ghidra symbol: FUN_00998cf0 */


undefined8 FUN_00998cf0(longlong param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4)
    ...
    if (cVar1 == '\0') {
      ...
      if (cVar1 == '\0') {
        ...
        if (cVar1 == '\0') {
          ...
          if (cVar1 == '\0') goto code_r0x0099935a;
        }
      }
