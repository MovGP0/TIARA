...
impl Window {
    ...
    pub fn view(&self) -> Element<'_, Message> {
        ...
        let body: Element<'_, Message> = container(scrollable(
            column![
                row![
                    text("Unit of parameter").width(Length::FillPortion(2)),
                    pick_list(
                        ["SI", "Engineering", "None"],
                        self.selections[0],
                ...
                row![
                    text("Unit of result").width(Length::FillPortion(2)),
                    pick_list(
                        ["SI", "Engineering", "None"],
                        self.selections[1],
                ...
                .align_y(Alignment::Center),
                row![
                    text("Name of parameter").width(Length::FillPortion(2)),
                ...
                .align_y(Alignment::Center),
                row![
                    text("Name of result").width(Length::FillPortion(2)),
                ...
                .align_y(Alignment::Center),
                row![
                    text("Left limit").width(Length::FillPortion(2)),
                ...
                .align_y(Alignment::Center),
                row![
                    text("Right limit").width(Length::FillPortion(2)),
