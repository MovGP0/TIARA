/* Ghidra address: 00ebc700 */
/* Ghidra symbol: FUN_00ebc700 */


void FUN_00ebc700(longlong param_1)

{
  ...
  local_250 = 0;
  local_240 = 0;
  cVar2 = FUN_006838c0(*(undefined8 *)(param_1 + 0x6f0));
  if (cVar2 == '\0') {
    FUN_0065f800(*(undefined8 *)(param_1 + 0x750));
    FUN_00414480(param_1 + 0x770);
  }
  else {
    ...
    if (lVar7 != 0) {
      ...
      if (iVar3 == 0) {
        ...
        if (-1 < iVar3) {
          ...
          if (iVar3 < iVar4) {
            uVar5 = (**(code **)(**(longlong **)(param_1 + 0x6f0) + 0x260))
                              (*(longlong **)(param_1 + 0x6f0));
            FUN_004b3cf0(*(undefined8 *)(param_1 + 0x758),&local_250,uVar5);
            FUN_00eba7f0(&local_240,local_250);
            iVar3 = FUN_00416db0(local_240,*(undefined8 *)(param_1 + 0x770));
            if (iVar3 != 0) {
              ...
              (**(code **)(**(longlong **)(param_1 + 0x750) + 0x290))
                        (*(longlong **)(param_1 + 0x750),local_30,((iVar3 + iVar4) - iVar6) + -0x10,
                         local_240,0);
              FUN_0064e030(*(undefined8 *)(param_1 + 0x750),0xff000018);
              ...
              (**(code **)(**(longlong **)(param_1 + 0x750) + 0x270))
                        (*(longlong **)(param_1 + 0x750),local_30,local_240);
              FUN_00414ad0(param_1 + 0x770,local_240);
            }
          }
        }
      }
