...
| Handler node | `concept:dfm-handler:TdlgflowchartInterruptAVRUART/bOKClick` |
...
- Current graph summary: Unresolved Delphi event handler TdlgflowchartInterruptAVRUART.bOKClick, referenced by 1 UI event.
