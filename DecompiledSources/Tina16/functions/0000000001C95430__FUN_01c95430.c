/* Ghidra address: 01c95430 */
/* Ghidra symbol: FUN_01c95430 */


void FUN_01c95430(longlong param_1)

{
  ...
  FUN_00414ad0(PTR_DAT_02004c08,L"\\TANGO.PCB");
  FUN_00414ad0(PTR_DAT_02004008,L"TANGO");
  ...
  FUN_007e2d20(*(undefined8 *)(param_1 + 0x1018),1);
  (**(code **)(**(longlong **)(param_1 + 0x24b8) + 0x18))
            (*(longlong **)(param_1 + 0x24b8),L"Schematic Editor",L"PCBRootDir",L"TANGO");
  FUN_00ec0300();
  FUN_00ecbc20();
