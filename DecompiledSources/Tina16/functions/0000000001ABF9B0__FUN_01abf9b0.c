/* Ghidra address: 01abf9b0 */
/* Ghidra symbol: FUN_01abf9b0 */


longlong FUN_01abf9b0(longlong param_1,char param_2)

{
  ...
  *(undefined4 *)(local_res8 + 0x48) = 0xf;
  *(undefined8 *)(local_res8 + 0x58) = 0;
  *(undefined1 *)(local_res8 + 0x90) = 1;
  *(undefined1 *)(local_res8 + 0x91) = 1;
