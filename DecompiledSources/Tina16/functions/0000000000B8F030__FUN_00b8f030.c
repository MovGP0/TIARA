/* Ghidra address: 00b8f030 */
/* Ghidra symbol: FUN_00b8f030 */


double FUN_00b8f030(undefined8 param_1)

{
  ...
  if (local_31 == '\0') {
    ...
    uVar2 = FUN_004170c0(&DAT_00b8f2e8,local_18,1);
