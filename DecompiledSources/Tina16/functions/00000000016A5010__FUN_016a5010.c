/* Ghidra address: 016a5010 */
/* Ghidra symbol: FUN_016a5010 */


longlong FUN_016a5010(longlong param_1,char param_2,longlong param_3)

{
  ...
  if (*(longlong *)(param_3 + 0x28) == 0) {
    ...
    FUN_00414ff0(local_118,*(longlong *)(param_3 + 0x28));
  }
