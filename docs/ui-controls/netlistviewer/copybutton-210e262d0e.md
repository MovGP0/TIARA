...
| --- | --- |
| Form | NetlistViewer |
| Component path | NetlistViewer.BtnPanel.CopyButton |
...
| Graph node | `resource:dfm:NetlistViewer/NetlistViewer.BtnPanel.CopyButton` |
...
- Extracted glyph: [`0286_NetlistViewer_NetlistViewer_BtnPanel_CopyButton_Glyph_Data.png`](../../../glyph/0286_NetlistViewer_NetlistViewer_BtnPanel_CopyButton_Glyph_Data.png)
