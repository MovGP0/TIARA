/* Ghidra address: 0110d760 */
/* Ghidra symbol: FUN_0110d760 */


void FUN_0110d760(longlong param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((0 < iVar1) && (-1 < *(int *)(param_1 + 0x1c))) {
    ...
    if (*(int *)(param_1 + 0x1c) <= iVar1 + -1) {
      ...
      *(char *)(lVar3 + 0x110) = (char)param_2;
      FUN_00e191e0(param_2);
      *(undefined8 *)(lVar3 + 0x118) = param_3;
      FUN_00e18600(*(undefined8 *)(lVar3 + 0x118));
      *(undefined8 *)(lVar3 + 0x120) = param_4;
      FUN_00e186e0(*(undefined8 *)(lVar3 + 0x120));
      *(undefined8 *)(lVar3 + 0x128) = param_5;
      FUN_00e187c0(*(undefined8 *)(lVar3 + 0x128));
      *(undefined8 *)(lVar3 + 0x130) = param_6;
