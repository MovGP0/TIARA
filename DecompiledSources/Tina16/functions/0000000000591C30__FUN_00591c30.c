/* Ghidra address: 00591c30 */
/* Ghidra symbol: FUN_00591c30 */


void FUN_00591c30(undefined8 param_1,longlong *param_2,longlong param_3,undefined8 param_4)

{
  ...
  if (((ulonglong)pcVar1 & 0xff00000000000000) == 0xff00000000000000) {
    FUN_00461840((longlong)param_2 + ((ulonglong)pcVar1 & 0xffffffffffffff),param_4);
  }
  else {
