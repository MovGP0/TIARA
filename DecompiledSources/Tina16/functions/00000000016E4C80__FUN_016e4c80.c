/* Ghidra address: 016e4c80 */
/* Ghidra symbol: FUN_016e4c80 */


void FUN_016e4c80(longlong param_1,undefined4 param_2)

{
  ...
  *(undefined8 *)(param_1 + 200) = *(undefined8 *)(param_1 + 0xd0);
  ...
  if (!bVar4) {
    dVar5 = (*(double *)(param_1 + 0x128) / 6.283185307179586) / *(double *)(param_1 + 0x130);
    dVar6 = 1.0 / *(double *)(param_1 + 0x130);
    if (*(char *)(param_1 + 0x138) == '\0') {
      ...
      *(double *)(param_1 + 0x80) =
           *(double *)(param_1 + 0x100) * dVar6 -
           (*(double *)(param_1 + 0x108) + *(double *)(param_1 + 0x110)) / 2.0;
      *(double *)(param_1 + 0x98) =
           dVar6 - (*(double *)(param_1 + 0x80) +
      ...
      *(double *)(param_1 + 0x80) =
           (1.0 - *(double *)(param_1 + 0x100)) * dVar6 -
           (*(double *)(param_1 + 0x108) + *(double *)(param_1 + 0x110)) / 2.0;
      *(double *)(param_1 + 0x98) =
           dVar6 - (*(double *)(param_1 + 0x80) +
                   *(double *)(param_1 + 0x108) + *(double *)(param_1 + 0x110));
    }
    *(double *)(param_1 + 0x78) = *(double *)(param_1 + 0x108) / 2.0;
    *(undefined8 *)(param_1 + 0xa0) = *(undefined8 *)(param_1 + 0x78);
    *(double *)(param_1 + 0x88) = *(double *)(param_1 + 0x110) / 2.0;
    ...
    *(undefined8 *)(param_1 + 0x20) = 0;
    ...
    if ((bVar4) && (1e-30 < *(double *)(param_1 + 0x130))) {
      ...
      uVar2 = FUN_00b90620(uVar2,dVar6 / (dVar1 * 60.0));
      FUN_016ed960(*(undefined8 *)(param_1 + 0x48),*(undefined8 *)(param_1 + 0x58),uVar2,0);
    }
  }
  return;
}
