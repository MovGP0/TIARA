/* Ghidra address: 01ab8f10 */
/* Ghidra symbol: FUN_01ab8f10 */


void FUN_01ab8f10(longlong param_1,undefined8 param_2)

{
  ...
  if (cVar3 != '\0') {
    FUN_01ae9510(*(undefined8 *)(param_1 + 0x60),0,param_1);
    FUN_01ae94a0(*(undefined8 *)(param_1 + 0x60),local_30);
    FUN_01ab6de0(param_1,&local_60);
    FUN_01ce7c10(&local_58,local_60);
    FUN_004168e0(&local_68,local_58);
    FUN_00b0cea0(local_50,local_68,0xfde9);
    FUN_004155b0(local_50,&DAT_01ab9228);
    FUN_00416880(&local_38,local_50[0]);
    FUN_00414480(&local_40);
    plVar5 = (longlong *)FUN_01ae9310(*(undefined8 *)(param_1 + 0x60),local_res10[0],0);
    ...
    (**(code **)(**(longlong **)(param_1 + 0x68) + 0x28))
              (*(longlong **)(param_1 + 0x68),L"main",L"color",uVar4);
    FUN_00410f20(plVar5);
  }
