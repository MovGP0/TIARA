/* Ghidra address: 01653c70 */
/* Ghidra symbol: FUN_01653c70 */


void FUN_01653c70(longlong param_1,longlong param_2)
  ...
  *(undefined2 *)((longlong)local_30 + 0x9a) = uVar3;
  ...
  if ((local_30[1] == 1) && ((short)local_30[2] == 1)) {
    ...
    *(undefined8 *)(local_30 + 0x24) = **(undefined8 **)(local_30 + 8);
    FUN_016ebe60(param_1,(char)*local_30 + '\x01',1,2,1);
    ...
    FUN_016ecf90(param_1,(char)*local_30 + '\x02',uVar8,1,(char)*local_30 + '\x01');
    ...
    *local_30 = uVar4 & 0xff;
    FUN_016ebe60(param_1,(char)*local_30 + '\x01',1,2,in_stack_ffffffffffffff78 & 0xffffff00);
    uVar4 = local_30[1];
    local_58 = 1;
    if (0 < (int)uVar4) {
      do {
        ...
        FUN_016ecf90(param_1,(char)*local_30 + (char)local_58 + '\x01',uVar8,
