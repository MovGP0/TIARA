/* Ghidra address: 00ccf9a0 */
/* Ghidra symbol: FUN_00ccf9a0 */


void FUN_00ccf9a0(longlong *param_1,undefined8 param_2,int param_3,int param_4,undefined8 param_5)

{
  ...
  local_20[0] = 0;
  local_28 = 0;
  (**(code **)(*param_1 + 0x238))(param_1,param_5);
  if (param_1[0x3d] != 0) {
    if (param_3 < 0x2002) {
      if (param_3 == 0x2001) {
    ...
    FUN_00ccf2e0(param_1,param_2,param_3,param_4,local_20[0],local_28);
  }
