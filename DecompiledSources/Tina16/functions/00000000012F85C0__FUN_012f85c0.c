/* Ghidra address: 012f85c0 */
/* Ghidra symbol: FUN_012f85c0 */


void FUN_012f85c0(longlong param_1)

{
  ...
  if (lVar2 != 0) {
    ...
    if ((*(uint *)(*(longlong *)(lVar2 + 0x18) + 4) & 0x20) == 0x20) {
      ...
      iVar1 = FUN_00416db0(*(undefined8 *)(lVar2 + 0x10),&DAT_012f8788);
      if (iVar1 == 0) {
        FUN_0064dd90(*(undefined8 *)(param_1 + 0x7a0),local_30);
        lVar2 = FUN_006e2530(*(undefined8 *)(param_1 + 0x700));
        FUN_00416cd0(local_20,4,local_30[0],&DAT_012f8788,*(undefined8 *)(lVar2 + 0x10),L".TSC");
      }
      else {
        ...
        FUN_00416cd0(local_20,6,local_38,&DAT_012f8788,*(undefined8 *)(lVar2 + 0x10),&DAT_012f8788,
