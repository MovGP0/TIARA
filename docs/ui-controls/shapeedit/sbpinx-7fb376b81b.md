...
```mermaid
flowchart LR
    control["Zero length pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0423_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinX_Glyph_Data.png`](../../../glyph/0423_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinX_Glyph_Data.png)
