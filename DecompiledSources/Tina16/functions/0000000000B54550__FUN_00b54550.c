/* Ghidra address: 00b54550 */
/* Ghidra symbol: FUN_00b54550 */


void FUN_00b54550(longlong param_1,undefined1 param_2,undefined4 param_3)
            ...
            do {
              plVar2 = (longlong *)
                       FUN_00b4fb40(*(undefined8 *)(*(longlong *)(param_1 + 0x10) + 0x10),local_4a,
                                    bVar3);
              (**(code **)(*plVar2 + 0x68))(plVar2,param_2,param_3);
              bVar3 = bVar3 + 1;
              cVar5 = cVar5 + -1;
            } while (cVar5 != '\0');
          }
