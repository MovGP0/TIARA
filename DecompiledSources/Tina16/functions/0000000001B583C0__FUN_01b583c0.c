/* Ghidra address: 01b583c0 */
/* Ghidra symbol: FUN_01b583c0 */


void FUN_01b583c0(longlong param_1,longlong *param_2)

{
  ...
  if ((*(char *)(param_1 + 0x7ed) == '\0') && (*(longlong *)(param_1 + 0x998) != 0)) {
    if (*(char *)(param_1 + 0xd6c) == '\0') {
      ...
      (**(code **)(**(longlong **)(param_1 + 0x9b0) + 8))
                (*(longlong **)(param_1 + 0x9b0),0xc,*(undefined8 *)(param_1 + 0x998));
    }
