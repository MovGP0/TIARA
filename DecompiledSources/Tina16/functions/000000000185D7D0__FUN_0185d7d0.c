/* Ghidra address: 0185d7d0 */
/* Ghidra symbol: FUN_0185d7d0 */


void FUN_0185d7d0(longlong param_1)

{
  ...
  *pcVar4 = local_1d;
  ...
  if (cVar1 == DAT_01fae667) {
    FUN_0185dbf0(param_1,1,pcVar4 + 8);
    if (*(int *)(pcVar4 + 8) != 4) {
      FUN_01860ba0(5);
    }
    FUN_0185dbf0(param_1,1,&local_1c);
    *(uint *)(pcVar4 + 0xc) = local_1c >> 2 & 7;
    pcVar4[0x10] = (local_1c & 2) != 0;
    pcVar4[0x11] = (local_1c & 1) != 0;
    FUN_0185dbf0(param_1,2,pcVar4 + 0x14);
    FUN_0185dbf0(param_1,1,pcVar4 + 0x18);
    FUN_0185dbf0(param_1,1,&local_1c);
    if (local_1c != 0) {
      FUN_01860ba0(7);
    }
    ...
    *(undefined8 *)(pcVar4 + 8) = uVar3;
    ...
    FUN_0185dbf0(param_1,2,pcVar4 + 0xc);
    FUN_0185dbf0(param_1,2,pcVar4 + 0x10);
    FUN_0185dbf0(param_1,2,pcVar4 + 0x14);
    FUN_0185dbf0(param_1,2,pcVar4 + 0x18);
    FUN_0185dbf0(param_1,1,pcVar4 + 0x1c);
    FUN_0185dbf0(param_1,1,pcVar4 + 0x20);
    FUN_0185dbf0(param_1,1,pcVar4 + 0x24);
    FUN_0185dbf0(param_1,1,pcVar4 + 0x28);
    uVar3 = FUN_00410e60(&PTR_FUN_00472dd0,1);
    *(undefined8 *)(pcVar4 + 0x30) = uVar3;
    ...
    if (*(int *)(pcVar4 + 8) == 0xb) {
      ...
      *(undefined8 *)(pcVar4 + 0x18) = uVar3;
      ...
      if (iVar2 == 0) {
        FUN_0185f430(param_1,*(undefined8 *)(pcVar4 + 0x18));
      }
    }
    else {
