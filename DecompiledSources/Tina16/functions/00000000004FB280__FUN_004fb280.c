/* Ghidra address: 004fb280 */
/* Ghidra symbol: FUN_004fb280 */


undefined8 FUN_004fb280(longlong param_1,undefined8 param_2)

{
  ...
  FUN_00417c40(local_18,*(longlong *)(*(longlong *)(param_1 + 8) + 8) +
                        (longlong)*(int *)(param_1 + 0x10) * 0x10,&DAT_004990d8);
