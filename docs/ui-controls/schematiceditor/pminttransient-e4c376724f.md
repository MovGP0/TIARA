...
| Component path | SchematicEditor.PopupInteract.pmIntTransient |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.PopupInteract.pmIntTransient` |
...
```mermaid
flowchart LR
    control["Transient"] -->|OnClick| handler["FUN_01c89820"]
