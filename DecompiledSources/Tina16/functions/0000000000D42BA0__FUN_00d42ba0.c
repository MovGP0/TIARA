/* Ghidra address: 00d42ba0 */
/* Ghidra symbol: FUN_00d42ba0 */


void FUN_00d42ba0(longlong *param_1,longlong *param_2)

{
  ...
  if (cVar3 == '\0') {
    uVar11 = CONCAT71(uVar12,0x13);
  }
  else {
    uVar11 = CONCAT71(uVar12,0x10);
  }
  uVar12 = (undefined7)((ulonglong)uVar11 >> 8);
  if ((char)param_1[0xe] == '\0') {
    if ((char)param_1[0xc] != '\0') {
      uVar11 = CONCAT71(uVar12,0x11);
    }
  }
  else {
    uVar11 = CONCAT71(uVar12,0x12);
  }
  if (cVar2 == '\x01') {
    uVar11 = CONCAT71((int7)((ulonglong)uVar11 >> 8),(char)uVar11 + '\x04');
  }
  uVar4 = (undefined4)uVar11;
  if (cVar2 == '\x02') {
    uVar4 = (undefined4)CONCAT71((int7)((ulonglong)uVar11 >> 8),(char)uVar11 + '\b');
  }
  ...
  if ((uVar10 & 0x20) == 0x20) {
    ...
    iVar6 = (local_3c - iVar6) + -2;
    local_64 = CONCAT44(local_64._4_4_,iVar6);
    local_5c = CONCAT44(local_5c._4_4_,local_3c);
    FUN_004238d0(&local_54,local_44 + 1,local_40,iVar6,CONCAT44(uVar4,local_38));
  }
  else {
    FUN_00429ca0(&local_64,1,0);
    FUN_004238d0(&local_54,(int)local_5c + 2,local_40,local_3c,CONCAT44(uVar4,local_38));
  }
  uVar11 = FUN_00781840();
  uVar10 = 0;
