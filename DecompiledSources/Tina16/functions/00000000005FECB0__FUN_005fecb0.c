/* Ghidra address: 005fecb0 */
/* Ghidra symbol: FUN_005fecb0 */


void FUN_005fecb0(longlong *param_1,int param_2,int param_3,longlong *param_4,undefined1 param_5)

{
  ...
  if (param_4 != (longlong *)0x0) {
    ...
    if (cVar1 == '\0') {
      ...
      (**(code **)(*param_4 + 0x30))(param_4,param_1,local_38,param_5);
