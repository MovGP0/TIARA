/* Ghidra address: 01410d70 */
/* Ghidra symbol: FUN_01410d70 */


void FUN_01410d70(longlong param_1)

{
  ...
  FUN_01d34d40(*(undefined8 *)(param_1 + 0x808));
  uVar3 = FUN_00b89270();
  ...
  *(int *)(param_1 + 0x814) = *(int *)(param_1 + 0x7b0);
  FUN_00848a70(lVar2,*(int *)(lVar2 + 0x4c0) + *(int *)(param_1 + 0x7b0));
  iVar5 = *(int *)(param_1 + 0x814);
  iVar4 = 0;
  if (-1 < iVar5 + -1) {
    do {
      FUN_01408750(&local_f0,*(undefined4 *)(*(longlong *)(param_1 + 0x7b8) + (longlong)iVar4 * 4),
                   *(undefined4 *)(param_1 + 0x7b4),*(undefined4 *)(param_1 + 0x818),0);
      ...
      FUN_01408b50(*(undefined8 *)(param_1 + 0x808),local_250);
      iVar1 = *(int *)(param_1 + 0x818);
      if (iVar1 == 0) {
        uVar3 = FUN_01408ca0(*(undefined8 *)(param_1 + 0x808),iVar4);
      ...
      FUN_01433dc0(local_260,*(undefined4 *)(param_1 + 0x824),*(undefined4 *)(param_1 + 0x828));
