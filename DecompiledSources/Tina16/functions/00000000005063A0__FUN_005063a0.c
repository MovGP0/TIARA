/* Ghidra address: 005063a0 */
/* Ghidra symbol: FUN_005063a0 */


void FUN_005063a0(longlong param_1,undefined4 param_2,longlong *param_3,int param_4,int param_5)
  ...
  if (param_4 < param_5) {
    do {
      ...
      if (param_5 - iVar6 < iVar9 - local_4c) {
        ...
        iVar5 = local_4c;
        if (iVar6 < param_5) {
          FUN_005063a0(param_1,param_2,param_3,iVar6,param_5);
        }
      }
      else {
        iVar7 = param_5;
        iVar5 = iVar6;
        if (local_4c < iVar9) {
          FUN_005063a0(param_1,param_2,param_3,local_4c,iVar9);
        }
      }
      local_4c = iVar5;
      param_5 = iVar7;
