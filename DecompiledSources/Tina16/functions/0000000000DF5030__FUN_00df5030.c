/* Ghidra address: 00df5030 */
/* Ghidra symbol: FUN_00df5030 */


void FUN_00df5030(longlong param_1,longlong param_2,char param_3,ulonglong param_4)

{
  ...
  FUN_017de460(*(undefined8 *)(param_2 + 0xd8),0x3ff0000000000000,*(undefined8 *)(lVar2 + 0x58),
               &local_5c);
  if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
    FUN_01662860(*(longlong *)(param_2 + 0x110),1,*(longlong *)(lVar2 + 0x18) + 0x18,
                 *(undefined8 *)(lVar2 + 0x58),CONCAT44(uVar6,local_5c),0,0);
  }
  FUN_017de390(*(undefined8 *)(param_2 + 0xd8),dVar1,*(undefined8 *)(lVar2 + 0x58),1,&local_5c);
  if (param_3 == '\b') {
    ...
    uVar6 = local_5c;
    FUN_017de390(*(undefined8 *)(param_2 + 0xd8),-local_58,*(undefined8 *)(lVar2 + 0x58),0,&local_5c
                );
    FUN_017de420(*(undefined8 *)(param_2 + 0xd8),-local_50,*(undefined8 *)(lVar2 + 0x58),uVar6);
  }
  else if (*(char *)(param_2 + 0x325) == '\0') {
    if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
      FUN_01662860(*(longlong *)(param_2 + 0x110),0x101,*(undefined8 *)(lVar2 + 0x18),
                   *(undefined8 *)(lVar2 + 0x58),local_5c,param_2 + 0x478,1);
    }
    FUN_017de390(*(undefined8 *)(param_2 + 0xd8),-dVar4,*(undefined8 *)(lVar2 + 0x58),0,&local_5c);
  }
  else {
    if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
      FUN_01662860(*(longlong *)(param_2 + 0x110),0x101,*(undefined8 *)(lVar2 + 0x18),
