/* Ghidra address: 00e09900 */
/* Ghidra symbol: FUN_00e09900 */


undefined8 FUN_00e09900(longlong param_1)
...
LAB_00e0996c:
  ...
  do {
    if (((&DAT_01edb340)[iVar6] == 0) && (*(int *)(*(longlong *)(param_1 + 8) + 8) == -1)) {
      iVar4 = FUN_00e08db0(*(undefined8 *)(param_1 + 0x10),param_1 + 0x18);
      lVar2 = *(longlong *)(param_1 + 8);
      *(int *)(lVar2 + 8) = iVar4;
      if (iVar4 < 0) {
    ...
    local_202c = (&DAT_01edb340)[iVar6];
    if (local_202c == 0) {
      cVar3 = FUN_00e09840(local_3058,iVar6,*(undefined4 *)(*(longlong *)(param_1 + 8) + 8),
                           &local_202c);
      if (cVar3 != '\0') {
        if (local_202c < 1) {
          if (-1 < local_202c) {
...
LAB_00e09ca5:
      ...
      *(undefined1 *)(*(longlong *)(param_1 + 8) + 0x11) = 0;
      FUN_00e092e0(local_3058,-local_202c);
      uStack_2020._4_4_ = uStack_2020._4_4_ - *(int *)(&DAT_01edb540 + (longlong)-local_202c * 8);
      cVar3 = FUN_00e098a0(local_3058,aiStack_3030[uStack_2020._4_4_],
                           *(undefined4 *)(&DAT_01edb544 + (longlong)-local_202c * 8),&local_202c);
      if (cVar3 != '\0') {
        iVar6 = local_202c;
      }
      ...
      if (cVar3 != '\x03') goto LAB_00e0996c;
    }
    if (*(int *)(*(longlong *)(param_1 + 8) + 0x14) == 0) {
  ...
  *(undefined4 *)(lVar2 + 0x14) = 3;
  while ((0 < uStack_2020._4_4_ &&
         ((cVar3 = FUN_00e09840(local_3058,aiStack_3030[uStack_2020._4_4_],0x100,&local_202c),
