/* Ghidra address: 010fcc80 */
/* Ghidra symbol: FUN_010fcc80 */


void FUN_010fcc80(longlong param_1,longlong param_2,undefined8 *param_3)

{
  ...
  if (param_2 != 0) {
    iVar2 = (**(code **)(**(longlong **)(*(longlong *)(param_1 + 0xb38) + 8) + 0x28))();
    iVar5 = 0;
    if (-1 < iVar2 + -1) {
      do {
