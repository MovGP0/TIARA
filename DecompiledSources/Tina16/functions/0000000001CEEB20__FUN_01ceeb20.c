/* Ghidra address: 01ceeb20 */
/* Ghidra symbol: FUN_01ceeb20 */


undefined1 FUN_01ceeb20(longlong param_1,int param_2)
...
LAB_01ceec70:
                  ...
                  else if (uVar8 == 1) goto LAB_01ceecf6;
                }
                else if (uVar8 - 3 < 2) {
LAB_01ceecf6:
                  lVar9 = (**(code **)(**(longlong **)(lVar7 + 0x80) + 0x30))
                ...
                else if (uVar8 - 5 < 2) goto LAB_01ceec70;
                local_34 = local_34 + 1;
                iVar4 = iVar4 + -1;
              } while (iVar4 != 0);
            }
