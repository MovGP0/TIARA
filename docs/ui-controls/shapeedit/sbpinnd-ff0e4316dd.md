...
```mermaid
flowchart LR
    control["Normal inverted pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0429_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinND_Glyph_Data.png`](../../../glyph/0429_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinND_Glyph_Data.png)
