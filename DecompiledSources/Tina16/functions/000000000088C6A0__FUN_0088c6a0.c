/* Ghidra address: 0088c6a0 */
/* Ghidra symbol: FUN_0088c6a0 */


undefined4 FUN_0088c6a0(undefined8 param_1)

{
  ...
  if (DAT_01e21a38 == 0) {
    ...
    local_20 = L"WSAInstallServiceClassW";
    local_18 = 0x11;
    uVar2 = FUN_00883110(&PTR_FUN_00882c78,1,0x276d,local_10,&local_20,0);
    FUN_004134c0(uVar2);
  }
  uVar2 = FUN_00416740(L"WSAInstallServiceClassW");
