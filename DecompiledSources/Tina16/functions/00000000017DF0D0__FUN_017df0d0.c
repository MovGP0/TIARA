/* Ghidra address: 017df0d0 */
/* Ghidra symbol: FUN_017df0d0 */


void FUN_017df0d0(longlong param_1)

{
  ...
  FUN_0064dbe0(*(undefined8 *)(param_1 + 0x6b8),*(undefined1 *)(param_1 + 0x6c9));
  if (*(char *)(param_1 + 0x6c9) == '\0') {
  ...
  *(undefined8 *)(param_1 + 0x6e8) = uVar2;
  ...
  FUN_0064de00(*(undefined8 *)(param_1 + 0x6b0),*(undefined8 *)(param_1 + 0x6f0));
  return;
}
