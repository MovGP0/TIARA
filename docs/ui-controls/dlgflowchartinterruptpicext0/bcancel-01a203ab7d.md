...
| Handler node | `concept:dfm-handler:TdlgflowchartInterruptPicext0/bCancelClick` |
...
- Current graph summary: Unresolved Delphi event handler TdlgflowchartInterruptPicext0.bCancelClick, referenced by 1 UI event.
