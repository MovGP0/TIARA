...
```mermaid
flowchart LR
    control["&All"] -->|OnClick| handler["FUN_01782df0"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001782DF0__FUN_01782df0.c](../../../DecompiledSources/Tina16/functions/0000000001782DF0__FUN_01782df0.c)
