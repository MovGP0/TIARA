/* Ghidra address: 00956ef0 */
/* Ghidra symbol: FUN_00956ef0 */


longlong FUN_00956ef0(longlong param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  iVar4 = *(int *)(*(longlong *)(param_1 + 0x128) + 0x10);
  uVar3 = 0;
  if (-1 < iVar4 + -1) {
    do {
  ...
  local_30 = lVar2;
  FUN_00597e50(*(longlong *)(param_1 + 0x128) + 8,&local_30);
  return lVar2;
}
