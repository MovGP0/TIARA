/* Ghidra address: 007489f0 */
/* Ghidra symbol: FUN_007489f0 */


void FUN_007489f0(longlong param_1,uint param_2)
    ...
    if (local_30 != 0) {
      ...
      if (param_2 < *(uint *)(param_1 + 0x28)) {
        ...
        *(uint *)(param_1 + 0x28) = param_2;
        ...
        if (bVar8) {
          lVar6 = FUN_00747560(param_1);
          local_60 = *(longlong *)(lVar6 + 0x4b8);
          local_40 = *(int *)(*(longlong *)(local_60 + 0x10) + 0x10);
          local_24 = *(int *)(param_1 + 0x20) + *(int *)(param_1 + 0x28) + local_28;
          if (local_24 <= local_40 + -1) {
            iVar7 = ((local_40 + -1) - local_24) + 1;
            do {
              local_38 = FUN_00747010(local_30,local_24,*(undefined4 *)(param_1 + 0x24));
              if (local_38 != 0) {
                cVar2 = FUN_00749780(local_38);
                if (cVar2 == '\0') break;
                local_108 = local_108 & 0xffffff00;
                FUN_00747c30(local_20,local_38,local_24 - local_28,*(undefined4 *)(param_1 + 0x24));
              }
              local_24 = local_24 + 1;
              iVar7 = iVar7 + -1;
            } while (iVar7 != 0);
          ...
          uVar4 = FUN_00747560(param_1);
          iVar7 = FUN_007452f0(uVar4,*(undefined4 *)(param_1 + 0x20),*(undefined4 *)(param_1 + 0x24)
                              );
          uVar4 = FUN_00747560(param_1);
            ...
            do {
              ...
              if (local_38 != 0) {
                ...
                if (cVar2 == '\0') {
                  ...
                  if (0 < local_48) {
                    lVar6 = FUN_00747560(param_1);
                    local_68 = *(longlong *)(lVar6 + 0x4b8);
                    if (*(int *)(*(longlong *)(local_68 + 0x10) + 0x10) <
                        local_48 + *(int *)(local_38 + 0x28)) {
                      lVar6 = FUN_00747560(param_1);
                      local_70 = *(longlong *)(lVar6 + 0x4b8);
                      local_28 = local_28 +
                                 ((local_48 + *(int *)(local_38 + 0x28)) -
        ...
        lVar6 = FUN_00747560(param_1);
        local_78 = *(longlong *)(lVar6 + 0x4b8);
        local_40 = *(int *)(*(longlong *)(local_78 + 0x10) + 0x10);
        local_28 = param_2 - *(int *)(param_1 + 0x28);
        local_7c = *(int *)(param_1 + 0x20) + *(int *)(param_1 + 0x28);
        local_80 = local_40;
        if (local_7c < local_40) {
          local_80 = local_7c;
        }
        local_84 = *(int *)(param_1 + 0x20) + param_2 + -1;
        local_88 = local_40 + -1;
        ...
        if (local_80 <= local_88) {
          ...
          do {
            lVar6 = FUN_00746ff0(local_30,local_24,*(undefined4 *)(param_1 + 0x24));
            if (lVar6 != 0) break;
            local_28 = local_28 + -1;
            local_24 = local_24 + 1;
            iVar7 = iVar7 + -1;
        ...
        if (bVar8) {
          ...
          lVar6 = FUN_00747560(param_1);
          local_90 = *(longlong *)(lVar6 + 0x4b8);
          local_40 = *(int *)(*(longlong *)(local_90 + 0x10) + 0x10);
          local_24 = local_40 + -1;
          if (local_40 - local_28 <= local_24) {
            iVar7 = ((local_40 - local_28) - local_24) + -1;
            do {
              local_38 = FUN_00747010(local_30,local_24 - local_44,*(undefined4 *)(param_1 + 0x24));
              if ((local_38 != 0) && (local_38 != param_1)) {
                local_108 = CONCAT31(local_108._1_3_,1);
                FUN_00747c30(local_20,local_38,local_24,*(undefined4 *)(param_1 + 0x24));
              }
              local_24 = local_24 + -1;
              iVar7 = iVar7 + 1;
            } while (iVar7 != 0);
            ...
            do {
              ...
              if (((local_38 != 0) && (*(int *)(local_38 + 0x20) == local_48)) &&
                ...
                if (local_38 == param_1) {
                  ...
                  local_54 = *(uint *)(local_38 + 0x28);
                  uVar4 = FUN_00747560(param_1);
                  FUN_00744dc0(uVar4,local_24 + local_50,&local_48,&local_4c);
                }
                lVar6 = FUN_00747560(param_1);
                local_a0 = *(longlong *)(lVar6 + 0x4b8);
                if (*(int *)(*(longlong *)(local_a0 + 0x10) + 0x10) < (int)(local_48 + local_54)) {
                  if (local_48 < 1) {
                    if (local_38 == param_1) {
                      if ((local_38 == param_1) && (local_48 == 0)) {
                        FUN_00749640(0,local_d0);
                        FUN_00749660(0,local_d0);
                        puVar1 = local_d0;
                        goto LAB_00749621;
                      }
                    }
                    ...
                    lVar6 = FUN_00747560(param_1);
                    local_a8 = *(longlong *)(lVar6 + 0x4b8);
                    local_50 = local_50 +
                               (*(int *)(*(longlong *)(local_a8 + 0x10) + 0x10) - local_48);
                    uVar4 = FUN_00747560(param_1);
          ...
          if (-1 < iVar7 + -1) {
            do {
              lVar6 = FUN_00747560(param_1);
              local_c0 = *(longlong *)(lVar6 + 0x4b0);
              if (*(int *)(*(longlong *)(local_c0 + 0x10) + 0x10) + -1 <
                  *(int *)(*(longlong *)(local_20 + 8) + 0xc + (longlong)local_24 * 0x18)) {
                uVar4 = FUN_00747560(param_1);
                FUN_00744d90(uVar4);
              }
              local_24 = local_24 + 1;
