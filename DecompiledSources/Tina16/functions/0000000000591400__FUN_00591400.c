/* Ghidra address: 00591400 */
/* Ghidra symbol: FUN_00591400 */


void FUN_00591400(undefined8 param_1,longlong *param_2,longlong param_3,undefined8 param_4)

{
  ...
  if (((ulonglong)pcVar1 & 0xff00000000000000) == 0xff00000000000000) {
    FUN_00414b90((longlong)param_2 + ((ulonglong)pcVar1 & 0xffffffffffffff),param_4);
  }
  else {
