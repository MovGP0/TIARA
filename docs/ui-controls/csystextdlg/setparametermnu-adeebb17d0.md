...
```mermaid
flowchart LR
    control["Set main parameter"] -->|OnClick| handler["FUN_0146a010"]
...
- Source: [DecompiledSources/Tina16/functions/000000000146A010__FUN_0146a010.c](../../../DecompiledSources/Tina16/functions/000000000146A010__FUN_0146a010.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: CSysTextDlg.DeepLinkPopUpMnu.SetParameterMnu.OnClick.
