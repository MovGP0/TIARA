/* Ghidra address: 00df6f60 */
/* Ghidra symbol: FUN_00df6f60 */


void FUN_00df6f60(longlong param_1,longlong param_2,char param_3,ulonglong param_4)

{
  ...
  uVar4 = (undefined4)(in_stack_ffffffffffffff98 >> 0x20);
  lVar1 = *(longlong *)(*(longlong *)(param_1 + 0x40) + -8 + (param_4 & 0xff) * 8);
  uVar3 = *(undefined8 *)(*(longlong *)(lVar1 + 0x18) + 8);
  local_3c[0] = 0;
  ...
  FUN_017de460(*(undefined8 *)(param_2 + 0xd8),uVar3,*(undefined8 *)(lVar1 + 0x58),local_3c);
  if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
    uVar3 = CONCAT44(uVar4,local_3c[0]);
    FUN_01662860(*(longlong *)(param_2 + 0x110),4,0,*(undefined8 *)(lVar1 + 0x58),uVar3,0,0);
  ...
  if (((param_3 != '\b') && (*(char *)(param_2 + 0x325) == '\0')) &&
    ...
    if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
      FUN_01662860(*(longlong *)(param_2 + 0x110),0x101,*(ulonglong **)(lVar1 + 0x18),
                   *(undefined8 *)(lVar1 + 0x58),CONCAT44(uVar4,local_3c[0]),0,1);
    }
