...
| Component path | SchematicEditor.MainMenu.Edit.mnDelete |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Edit.mnDelete` |
...
```mermaid
flowchart LR
    control["&Delete"] -->|OnClick| handler["FUN_01c76c90"]
