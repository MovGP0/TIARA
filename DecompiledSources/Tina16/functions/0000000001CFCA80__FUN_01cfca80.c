/* Ghidra address: 01cfca80 */
/* Ghidra symbol: FUN_01cfca80 */


void FUN_01cfca80(longlong param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4,
                 int *param_5)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (lVar6 == 0) {
      ...
      uVar4 = (uint)*(short *)(lVar6 + 0x12);
      FUN_00b956d0(param_5,(longlong)*(short *)(lVar6 + 0xc),(longlong)*(short *)(lVar6 + 0xe),
                   (longlong)*(short *)(lVar6 + 0x10),uVar4);
    }
  }
  else {
    FUN_0176a200(*(undefined8 *)(param_1 + 0x1a8),&local_3c,param_3,param_4);
