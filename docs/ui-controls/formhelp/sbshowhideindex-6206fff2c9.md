...
```mermaid
flowchart LR
    control["sbShowHideIndex"] -->|OnClick| handler["FUN_00b01980"]
    handler --> call1["FUN_0064dbe0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000000B01980__FUN_00b01980.c](../../../DecompiledSources/Tina16/functions/0000000000B01980__FUN_00b01980.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: FormHelp.FlowPanel1.sbShowHideIndex.OnClick.
