...
| Component path | SchematicEditor.MainMenu.Help.mnDesignSoftontheWeb.wwwtinacom |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Help.mnDesignSoftontheWeb.wwwtinacom` |
...
```mermaid
flowchart TD
    control["www.tina.com"] -->|"OnClick"| handler["OnTheWeb (01c8f060)"]
