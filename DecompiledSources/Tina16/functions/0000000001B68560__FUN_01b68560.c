/* Ghidra address: 01b68560 */
/* Ghidra symbol: FUN_01b68560 */


void FUN_01b68560(longlong param_1)

{
  ...
  if (iVar1 < 1) {
    if (*(longlong *)(lVar2 + 0x40) != 0) {
      FUN_010ec980(uVar3,*(longlong *)(lVar2 + 0x40),(*(double *)(lVar2 + 0x118) * 10.0) / 2.0,
                   (-*(double *)(lVar2 + 0x118) * 10.0) / 2.0,1,1);
    }
  }
  else {
    ...
    if (-1 < iVar1 + -1) {
      do {
        ...
        FUN_010ec980(uVar3,uVar4,(*(double *)(lVar2 + 0x118) * 10.0) / 2.0,
                     (-*(double *)(lVar2 + 0x118) * 10.0) / 2.0,1,1);
        iVar5 = iVar5 + 1;
        iVar1 = iVar1 + -1;
      } while (iVar1 != 0);
