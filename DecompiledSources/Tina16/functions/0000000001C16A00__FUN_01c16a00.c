/* Ghidra address: 01c16a00 */
/* Ghidra symbol: FUN_01c16a00 */


void FUN_01c16a00(longlong param_1,undefined8 *param_2)

{
  ...
  *(undefined8 *)(param_1 + 0x3b8) = param_2[1];
  uVar1 = FUN_00781840();
  ...
  FUN_00778dc0(uVar1,uVar2,local_38,param_1 + 0x3a0,0,0);
  return;
}
