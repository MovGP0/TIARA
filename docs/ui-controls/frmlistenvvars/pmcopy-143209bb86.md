...
```mermaid
flowchart LR
    control["Copy as text"] -->|OnClick| handler["FUN_01b76620"]
    handler --> call1["Delphi UnicodeString clear and finalization helper"]
    handler --> call2["FUN_006a58e0"]
    handler --> call3["FUN_006a6030"]
    handler --> call4["FUN_006efcb0"]
```
...
- `function:006a58e0` — FUN_006a58e0
