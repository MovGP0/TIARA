/* Ghidra address: 00a0c760 */
/* Ghidra symbol: FUN_00a0c760 */


longlong FUN_00a0c760(longlong *param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  lVar6 = param_1[1];
  auVar2._8_8_ = 0;
  auVar2._0_8_ = (longlong)(int)param_3;
  ...
  *(int *)(lVar6 + 0x94) = (int)uVar5;
  ...
  if (param_4 != 0) {
    ...
    do {
      ...
      uVar5 = uVar8;
      lVar7 = FUN_00a0c680(param_1,param_2,uVar5 * param_3);
      if ((int)uVar5 != 0) {
        uVar10 = ~uVar10;
        if (uVar10 < ~param_4 + uVar9) {
