/* Ghidra address: 015adb90 */
/* Ghidra symbol: FUN_015adb90 */


void FUN_015adb90(longlong *param_1,int *param_2)
  ...
  if ((int)param_1[8] < *param_2) {
    if (DAT_01f6c3e0 == '\0') {
      *param_2 = (int)param_1[8];
      ...
      FUN_0041ddd0(&local_28,PTR_PTR_02001cf0);
