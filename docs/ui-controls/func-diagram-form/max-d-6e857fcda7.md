...
```mermaid
flowchart LR
    control["Maxterm"] -->|OnClick| handler["FUN_01220650"]
    handler --> call1["FUN_011d4970"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001220650__FUN_01220650.c](../../../DecompiledSources/Tina16/functions/0000000001220650__FUN_01220650.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: Func_diagram_form.GroupBox1.max_d.OnClick.
