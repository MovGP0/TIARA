/* Ghidra address: 00c1f5f0 */
/* Ghidra symbol: FUN_00c1f5f0 */


void FUN_00c1f5f0(longlong param_1,longlong param_2,int *param_3,int *param_4,int param_5)
