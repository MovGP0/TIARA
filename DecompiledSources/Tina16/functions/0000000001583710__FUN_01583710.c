/* Ghidra address: 01583710 */
/* Ghidra symbol: FUN_01583710 */


uint FUN_01583710(longlong param_1,undefined4 param_2,uint param_3)
    ...
    while (uVar1 = *(uint *)(*(longlong *)(param_1 + 8) + (longlong)(int)uVar5 * 0x18),
      ...
      if ((uVar1 == param_3) &&
         (cVar2 = (**(code **)(**(longlong **)(param_1 + 0x18) + 0x18))
                             ...
                             *(undefined1 *)
                              (*(longlong *)(param_1 + 8) + 4 + (longlong)(int)uVar5 * 0x18),param_2
                            ), cVar2 != '\0')) {
        return uVar5;
      }
      uVar5 = uVar5 + 1;
