/* Ghidra address: 00c1f370 */
/* Ghidra symbol: FUN_00c1f370 */


void FUN_00c1f370(longlong param_1)

{
  ...
  FUN_0040d200(*(undefined8 *)(param_1 + 0x848),(longlong)((*(int *)(param_1 + 0x18) + 4) * 4),0);
  FUN_0040d200(*(undefined8 *)(param_1 + 0x850),(longlong)((*(int *)(param_1 + 0x18) + 4) * 4),0);
  FUN_0040d200(*(undefined8 *)(param_1 + 0x858),(longlong)((*(int *)(param_1 + 0x18) + 4) * 4),0);
