/* Ghidra address: 00949d40 */
/* Ghidra symbol: FUN_00949d40 */


longlong * FUN_00949d40(longlong *param_1,longlong *param_2)
    ...
    if (plVar4 == (longlong *)0x0) {
      ...
      if (lVar6 == 0) {
        ...
        if ((byte)(cVar3 - 1U) == 0xff) {
          ...
          if ((byte)(cVar3 - 1U) < 2) {
            uVar7 = (**(code **)(*param_2 + 0x170))(param_2);
            plVar5 = (longlong *)(**(code **)(*param_1 + 0x30))(param_1,uVar7);
          }
        }
      }
    }
      ...
      if (cVar3 != '\0') {
        if (cVar3 == '\x01') {
          plVar5 = (longlong *)(**(code **)(*param_1 + 0x30))(param_1,plVar4);
        }
        else {
          plVar5 = (longlong *)0x0;
          if ((cVar3 == '\x02') &&
             (plVar5 = (longlong *)(**(code **)(*param_1 + 8))(param_1,plVar4),
             plVar5 == (longlong *)0x0)) {
            plVar5 = (longlong *)(**(code **)(*param_1 + 0x30))(param_1,plVar4);
          }
        }
