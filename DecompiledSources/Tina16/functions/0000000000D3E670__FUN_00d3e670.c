/* Ghidra address: 00d3e670 */
/* Ghidra symbol: FUN_00d3e670 */


ulonglong FUN_00d3e670(longlong param_1,ulonglong param_2)

{
  ...
  if ((uVar4 & 1) != 0) {
    ...
    if (cVar1 == '\0') {
      if ((*(int *)(param_1 + 0xc4) == 0x14) && (*(int *)(param_1 + 200) == 0x14)) {
        uVar7 = (undefined4)CONCAT71(uVar8,0x36);
      }
      else if (*(int *)(param_1 + 200) == 0x14) {
        uVar7 = (undefined4)CONCAT71(uVar8,0x35);
      }
      else if (*(char *)(param_1 + 0xc0) == '\0') {
        uVar7 = (undefined4)CONCAT71(uVar8,0x37);
      }
      else {
        uVar7 = (undefined4)CONCAT71(uVar8,0x34);
      }
    }
    else if ((*(int *)(param_1 + 0xc4) == 0x14) && (*(int *)(param_1 + 200) == 0x14)) {
      uVar7 = (undefined4)CONCAT71(uVar8,0x3a);
    }
    else if (*(int *)(param_1 + 200) == 0x14) {
      uVar7 = (undefined4)CONCAT71(uVar8,0x39);
    }
    else if (*(char *)(param_1 + 0xc0) == '\0') {
      uVar7 = (undefined4)CONCAT71(uVar8,0x3b);
    }
    else {
      uVar7 = (undefined4)CONCAT71(uVar8,0x38);
    }
