/* Ghidra address: 01ce07e0 */
/* Ghidra symbol: FUN_01ce07e0 */


void FUN_01ce07e0(longlong param_1)
  ...
  if (-1 < iVar6 + -1) {
    do {
      ...
      *(undefined4 *)((longlong)plVar4 + 0x94) = uVar2;
      FUN_005fce30(plVar4[0x13],*(undefined4 *)(param_1 + 0x90));
      FUN_005fce30(plVar4[0x14],*(undefined4 *)(param_1 + 0x90));
