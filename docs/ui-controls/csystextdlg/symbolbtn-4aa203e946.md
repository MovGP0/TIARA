...
```mermaid
flowchart LR
    control["Symbol"] -->|OnClick| handler["FUN_01469870"]
    handler --> call1["FUN_014695a0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001469870__FUN_01469870.c](../../../DecompiledSources/Tina16/functions/0000000001469870__FUN_01469870.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: CSysTextDlg.ToolsPanel.ToolsNB.Edit.SymbolBtn.OnClick.
