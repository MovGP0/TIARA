/* Ghidra address: 0102ba20 */
/* Ghidra symbol: FUN_0102ba20 */


void FUN_0102ba20(longlong param_1,undefined8 param_2,char param_3,undefined8 param_4,
                 undefined8 param_5)

{
  ...
  if (param_3 == '\0') {
    ...
    FUN_00416cd0(&local_28,4,L"LDS ",local_30,L"R17, ",param_5);
    ...
    FUN_00416cd0(&local_10,4,L"LDI ",local_18,L"R17, ",local_20);
