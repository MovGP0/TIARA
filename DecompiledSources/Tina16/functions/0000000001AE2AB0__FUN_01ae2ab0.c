/* Ghidra address: 01ae2ab0 */
/* Ghidra symbol: FUN_01ae2ab0 */


void FUN_01ae2ab0(longlong param_1)

{
  ...
  if (cVar1 == '\x01') {
    ...
    if ((byte)uVar3 < 8) {
      bVar6 = ((int)CONCAT71((int7)((ulonglong)uVar3 >> 8),1) << ((byte)uVar3 & 0x1f) & 0x51U) != 0;
    }
    else {
      bVar6 = false;
    }
    if (bVar6) {
      uVar3 = FUN_004aeac0(local_20,0);
      FUN_01cd3ef0(uVar3,*(undefined8 *)(param_1 + 0x80));
    }
    uVar3 = FUN_004aeac0(local_20,0);
    ...
    if (cVar1 != '\0') {
      ...
      if (bVar6) {
        ...
        FUN_01cd3ef0(*(undefined8 *)(lVar4 + 0xf8),*(undefined8 *)(param_1 + 0x80));
        lVar4 = FUN_004aeac0(local_20,0);
        FUN_01a8dee0(*(undefined8 *)(param_1 + 0xe8),*(undefined8 *)(lVar4 + 0xf8));
      }
      else {
        lVar4 = FUN_004aeac0(local_20,0);
        FUN_01cd3ef0(*(undefined8 *)(lVar4 + 0xe8),*(undefined8 *)(param_1 + 0x80));
        lVar4 = FUN_004aeac0(local_20,0);
        FUN_01a8dee0(*(undefined8 *)(param_1 + 0xe8),*(undefined8 *)(lVar4 + 0xe8));
      }
    }
  }
  if (*(int *)(local_20 + 0x10) < 1) {
LAB_01ae2d34:
    if (local_28 == 0) goto LAB_01ae2dd3;
  }
  else {
    uVar3 = FUN_004aeac0(local_20,0);
    cVar1 = FUN_01ad1090(param_1,uVar3,&local_28);
    if (cVar1 == '\0') goto LAB_01ae2d34;
  }
