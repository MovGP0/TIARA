...
| Component path | SchematicEditor.PopupInteract.pmIntTransientSingleShot |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.PopupInteract.pmIntTransientSingleShot` |
