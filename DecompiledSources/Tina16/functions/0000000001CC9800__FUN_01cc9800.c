/* Ghidra address: 01cc9800 */
/* Ghidra symbol: FUN_01cc9800 */


double FUN_01cc9800(longlong *param_1,double param_2)

{
  ...
  while( true ) {
    ...
    cVar1 = FUN_01cc9770(auStack_88);
    if ((cVar1 != '\0') &&
       (dVar5 = (double)FUN_01cc9680(auStack_88), dVar5 <= (dVar3 - dVar4) * 0.05)) break;
    local_40[0] = local_50;
    local_48 = local_58;
  }
  ...
  *(int *)(param_1 + 4) = *(int *)((longlong)param_1 + 0x24) + -2;
  return local_60 + (local_68 - local_60) * dVar3;
}
