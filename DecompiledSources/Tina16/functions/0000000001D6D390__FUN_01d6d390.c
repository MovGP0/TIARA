/* Ghidra address: 01d6d390 */
/* Ghidra symbol: FUN_01d6d390 */


double FUN_01d6d390(char param_1,undefined8 param_2,undefined8 *param_3,undefined1 *param_4,
                   longlong *param_5)

{
  ...
  *(double *)(*param_5 + 8) =
  ...
  return local_58 +
         local_50[0] *
         ((((unaff_XMM6_Qa + unaff_XMM7_Qa) - unaff_XMM6_Qa * 3.0 * unaff_XMM7_Qa) +
