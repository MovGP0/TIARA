/* Ghidra address: 01c48760 */
/* Ghidra symbol: FUN_01c48760 */


void FUN_01c48760(longlong param_1)

{
  ...
  FUN_00848a70(*(longlong *)(param_1 + 0x6b0),*(int *)(*(longlong *)(param_1 + 0x6b0) + 0x4e0) + 1);
