...
> Analysis status: Source reviewed for TIARA-diz.6.7.1523.
...
| --- | --- |
| Form | ShapeEdit |
| Component path | ShapeEdit.MainMenu.Edit.Copy |
| Control class | TMenuItem |
| Caption | &Copy |
| Hint | Not present in the recovered resource. |
| Handler name | CopyClick |
| Handler address | 01798d20 |
| Graph node | `resource:dfm:ShapeEdit/ShapeEdit.MainMenu.Edit.Copy` |
...
This control shares the recovered handler with `ShapeEdit.TopToolBar.GeneralTools.sbCopy`. This article keeps the resource evidence for this control separate.
...
- Resource context: The recovered TMenuItem resource uses caption `&Copy`.
