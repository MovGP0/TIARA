/* Ghidra address: 005056e0 */
/* Ghidra symbol: FUN_005056e0 */


void FUN_005056e0(longlong param_1,undefined4 param_2,longlong *param_3,int param_4,int param_5)

{
  ...
  if (param_4 < param_5) {
    do {
      ...
      if (param_5 - iVar2 < iVar5 - local_3c) {
        ...
        iVar1 = local_3c;
        if (iVar2 < param_5) {
          FUN_005056e0(param_1,param_2,param_3,iVar2,param_5);
        }
      }
      else {
        iVar3 = param_5;
        iVar1 = iVar2;
        if (local_3c < iVar5) {
          FUN_005056e0(param_1,param_2,param_3,local_3c,iVar5);
        }
      }
      local_3c = iVar1;
      param_5 = iVar3;
  ...
  FUN_00417840(&local_38,&DAT_00473ba0,2);
  return;
}
