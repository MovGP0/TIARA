/* Ghidra address: 006598f0 */
/* Ghidra symbol: FUN_006598f0 */


ulonglong FUN_006598f0(longlong param_1,longlong param_2)

{
  ...
  if ((lVar3 != 0) && (lVar3 != param_1)) {
    if (*(char *)(lVar3 + 0x4d4) != '\0') {
      cVar1 = FUN_006598f0(lVar3,param_2);
      if (cVar1 != '\0') goto LAB_006599c0;
    }
    if (*(longlong *)(lVar3 + 0x78) != 0) {
      lVar4 = FUN_007f9b70(lVar3,1);
      if (((lVar4 != 0) && (lVar4 != lVar3)) && (*(char *)(lVar4 + 0x4d4) != '\0')) {
        cVar1 = FUN_006598f0(lVar4,param_2);
        if (cVar1 != '\0') goto LAB_006599c0;
      }
    }
  }
  ...
  if ((*(uint *)(param_1 + 0xa0) & 0x1000) == 0) {
    ...
    pcVar5 = (code *)FUN_00411550(param_1,0xffb6);
    (*pcVar5)(param_1,local_3a,uVar2);
    *(short *)(param_2 + 8) = local_3a[0];
    if (local_3a[0] == 0) goto LAB_006599c0;
  }
  uVar6 = 0;
LAB_006599c0:
