/* Ghidra address: 01772620 */
/* Ghidra symbol: FUN_01772620 */


undefined1 FUN_01772620(undefined8 param_1,undefined8 *param_2)

{
  ...
  *(undefined4 *)puVar4 = *(undefined4 *)param_2;
  ...
  iVar2 = FUN_00416db0(local_4c[0],L"VHDL Macro");
  if (iVar2 == 0) {
