/* Ghidra address: 00b2a640 */
/* Ghidra symbol: FUN_00b2a640 */


undefined1 FUN_00b2a640(undefined8 param_1,longlong param_2,longlong param_3)

{
  ...
  local_51 = 0;
  iVar2 = FUN_00417170(&LAB_00b2a7f0,param_2,1);
  if (0 < iVar2) {
    ...
    if (uVar3 != 0) {
      ...
      cVar1 = FUN_00b29e80(param_1,local_20[0],&local_42,&local_43);
      if (cVar1 != '\0') {
        FUN_00415530(&local_50,local_28,0);
        cVar1 = FUN_00b29df0(param_1,local_50,local_3f);
        if (cVar1 != '\0') {
          FUN_00417c40(param_3,local_3f,&DAT_00b25e50);
          *(undefined2 *)(param_3 + 9) = local_42;
          *(undefined1 *)(param_3 + 8) = 5;
          local_51 = 1;
        }
      }
    }
