/* Ghidra address: 01d4c240 */
/* Ghidra symbol: FUN_01d4c240 */


void FUN_01d4c240(undefined8 param_1,longlong param_2)

{
  ...
  FUN_016ebe60(param_1,1,1,3,in_stack_ffffffffffffffa8 & 0xffffffffffffff00);
  FUN_016ed320(param_1,1,0,1.0 / dVar1,0);
  FUN_016ebe60(param_1,2,4,0,1);
  FUN_016ed320(param_1,2,0,1.0 / dVar1,0);
  FUN_016ebfa0(param_1,3,3,5,1);
  FUN_016ed220(param_1,3,dVar2 / dVar1,0);
  FUN_016ebe60(param_1,4,5,3,1);
  FUN_016ed320(param_1,4,0,*(undefined8 *)(param_2 + 0x430),0);
  FUN_016ec580(param_1,5,4,3,5);
  FUN_016ebe60(param_1,6,5,6,1);
  FUN_016ed320(param_1,6,0,1.0 / dVar1,0);
  FUN_016ebe60(param_1,7,6,2,1);
  FUN_016ed320(param_1,7,0,1.0 / dVar1,0);
  FUN_016ebe60(param_1,8,7,0,1);
  FUN_016ed320(param_1,8,0,1.0 / dVar1,0);
  FUN_016ec580(param_1,9,7,6,2);
