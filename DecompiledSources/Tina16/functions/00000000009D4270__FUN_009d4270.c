/* Ghidra address: 009d4270 */
/* Ghidra symbol: FUN_009d4270 */


short FUN_009d4270(longlong param_1,undefined8 param_2,longlong param_3,int *param_4)

{
  ...
  *(undefined8 *)(*(longlong *)(param_1 + 0x28) + 0x80) = uVar3;
  ...
  local_60 = 0;
  local_58 = 0;
  local_20 = FUN_00960500(&PTR_FUN_00915170,1,param_2,0);
