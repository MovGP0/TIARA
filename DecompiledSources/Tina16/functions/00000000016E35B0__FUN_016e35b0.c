/* Ghidra address: 016e35b0 */
/* Ghidra symbol: FUN_016e35b0 */


longlong FUN_016e35b0(longlong param_1,char param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  *(undefined8 *)(local_res8 + 0x68) = 0x46293e5939a08cea;
  *(undefined8 *)(local_res8 + 0x70) = 0;
  *(undefined8 *)(local_res8 + 0x78) = 0x3ff0000000000000;
  *(undefined8 *)(local_res8 + 0x80) = 0xc6293e5939a08cea;
  *(undefined8 *)(local_res8 + 0x88) = 0x46293e5939a08cea;
  *(undefined8 *)(local_res8 + 0x60) = 0x3eb0c6f7a0b5ed8d;
  *(undefined8 *)(local_res8 + 0x20) = 0;
  *(undefined8 *)(local_res8 + 0x28) = 0;
  *(double *)(local_res8 + 0x30) = -*(double *)(local_res8 + 0x78) / 1.0;
  ...
  *(longlong *)(local_res8 + 0x48) = param_3;
  if (param_3 != 0) {
    ...
    *(short *)(local_res8 + 0x38) = sVar2;
    FUN_016ea2d0(param_3,sVar2 + 2,*(undefined1 *)(local_res8 + 0x44));
