/* Ghidra address: 012b16f0 */
/* Ghidra symbol: FUN_012b16f0 */


void FUN_012b16f0(longlong param_1)

{
  if (*(char *)(param_1 + 0xdd0) != '\0') {
    *(undefined1 *)(param_1 + 0xdd0) = 0;
    ...
    if (*(char *)(param_1 + 0xdd0) == '\0') {
      ...
      *(undefined1 *)(param_1 + 0x990) = 0xb;
      ...
      FUN_0082a6c0(*(undefined8 *)(param_1 + 0xce0),1);
    }
  }
  return;
}
