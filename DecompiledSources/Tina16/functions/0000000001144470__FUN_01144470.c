/* Ghidra address: 01144470 */
/* Ghidra symbol: FUN_01144470 */


void FUN_01144470(longlong param_1,int param_2,undefined8 *param_3)

{
  ...
  cVar1 = FUN_004113d0(param_3,&PTR_FUN_01147758);
  if (cVar1 == '\0') {
    ...
    local_48 = local_50;
    local_40 = param_3;
    FUN_011442e0(param_1,param_2,local_50,local_58 + -1);
  }
