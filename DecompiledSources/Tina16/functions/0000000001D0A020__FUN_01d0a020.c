/* Ghidra address: 01d0a020 */
/* Ghidra symbol: FUN_01d0a020 */


void FUN_01d0a020(undefined8 param_1,char param_2,longlong *param_3)

{
  ...
  if (*(longlong *)PTR_DAT_02001d08 != 0) {
    ...
    if (cVar1 != '\0') {
      ...
      FUN_01352aa0(&local_30,param_1);
      FUN_00416880(&local_20,local_30);
      if (local_20 != 0) {
        FUN_00416cd0(&local_18,4,L"SetParameters(",local_10,&DAT_01d0a314,local_20);
        plVar3 = &local_20;
        puVar5 = &local_24;
        FUN_0135ad60(*(undefined8 *)PTR_DAT_02001f10,&local_38,local_10,L"SetParameters",plVar3,
                     puVar5,&local_28);
        uVar6 = (undefined4)((ulonglong)puVar5 >> 0x20);
        uVar4 = (undefined4)((ulonglong)plVar3 >> 0x20);
