# GlobalParameterEditor scenarios

Window key: `GlobalParameterEditor`.

Implementation: [global_parameter_editor](../../../crates/tiara-ui/src/global_parameter_editor/mod.rs).
