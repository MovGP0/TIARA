/* Ghidra address: 01aa53a0 */
/* Ghidra symbol: FUN_01aa53a0 */


bool FUN_01aa53a0(byte *param_1,undefined8 param_2)

{
  ...
  if (param_1[0x564] == 0) {
    if (1 < *param_1) {
      ...
      do {
        pbVar1 = pbVar1 + 1;
        local_f0[0] = (&DAT_01fce40d)[(ulonglong)*pbVar1 + (ulonglong)local_f0[0] * 4];
        cVar5 = cVar5 + -1;
      } while (cVar5 != '\0');
    }
  ...
  if (1 < *param_1) {
    cVar5 = *param_1 - 1;
    do {
      bVar2 = (&DAT_01fce40d)[(ulonglong)param_1[(ulonglong)bVar3 + 0x567] + (ulonglong)bVar2 * 4];
      bVar3 = bVar3 + 1;
      cVar5 = cVar5 + -1;
    } while (cVar5 != '\0');
  }
  bVar2 = (&DAT_01fce3e8)[bVar2];
  if (bVar2 != local_8c[0]) {
