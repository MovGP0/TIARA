/* Ghidra address: 00f0d310 */
/* Ghidra symbol: FUN_00f0d310 */


void FUN_00f0d310(longlong param_1)

{
  ...
  (**(code **)(*(longlong *)plVar2[0x1a] + 0x10))
            ((longlong *)plVar2[0x1a],*(undefined8 *)(param_1 + 0x708));
  ...
  if (cVar1 == '\0') {
    ...
    (**(code **)(**(longlong **)(param_1 + 0x708) + 0x10))
              (*(longlong **)(param_1 + 0x708),plVar2[0x1a]);
