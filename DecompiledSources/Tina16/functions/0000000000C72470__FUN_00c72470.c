/* Ghidra address: 00c72470 */
/* Ghidra symbol: FUN_00c72470 */


int FUN_00c72470(longlong param_1,byte param_2)

{
  ...
  if (*(longlong *)(param_1 + 0x10) == 0) {
    ...
    uVar5 = FUN_00c72080(DAT_01ea71e0,local_38,local_3c);
  ...
  local_b8 = local_3c;
  FUN_00498350(local_4c,0,0,local_38);
  ...
  local_b8 = local_3c;
  FUN_00498350(local_5c,(uint)local_5d * local_38,0,(local_5d + 1) * local_38);
  if (local_res10 != 0) {
    if (local_res10 == 1) {
      ...
      uVar4 = FUN_00c71ef0(*(undefined8 *)(param_1 + 0x10),local_30,0x20000000);
      *(undefined4 *)(param_1 + 0x1c) = uVar4;
      goto code_r0x00c72dbf;
    }
    if (1 < (byte)(local_res10 - 2)) goto code_r0x00c72dbf;
  }
  uVar5 = FUN_00609e10(local_30);
  uVar7 = FUN_00609e10(*(undefined8 *)(param_1 + 8));
  FUN_005fead0(uVar5,local_4c,uVar7,local_5c);
  if (*(char *)(*(longlong *)(param_1 + 8) + 0x58) == '\x01') {
    uVar4 = FUN_00c71ef0(*(undefined8 *)(param_1 + 0x10),local_30,*(undefined4 *)(param_1 + 0x28));
