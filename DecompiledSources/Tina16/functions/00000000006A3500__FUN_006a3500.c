/* Ghidra address: 006a3500 */
/* Ghidra symbol: FUN_006a3500 */


void FUN_006a3500(undefined8 param_1,uint param_2,uint param_3,code *param_4)
  ...
  do {
    ...
    do {
      ...
      if ((int)uVar2 <= (int)uVar3) {
        FUN_006a3480(param_1,uVar2,uVar3);
        uVar5 = uVar3;
    ...
    if ((int)local_2c < (int)uVar3) {
      FUN_006a3500(param_1,local_2c,uVar3,param_4);
    }
    local_2c = uVar2;
