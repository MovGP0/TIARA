/* Ghidra address: 015a9b30 */
/* Ghidra symbol: FUN_015a9b30 */


longlong *
FUN_015a9b30(longlong *param_1,longlong *param_2,longlong param_3,char param_4,undefined4 param_5)

{
  ...
  if (0 < local_24) {
    ...
    if (param_4 == '\x01') {
      ...
      FUN_015ab8b0(param_2,uVar2,local_28,param_5);
    }
    else {
    ...
    if (param_4 == '\x01') {
      ...
      uVar1 = (**(code **)*local_20)(local_20);
      FUN_015ab6d0(param_2,local_20[1],uVar1,param_5);
    }
