/* Ghidra address: 01956ea0 */
/* Ghidra symbol: FUN_01956ea0 */


void FUN_01956ea0(longlong param_1,char param_2,char param_3,char param_4,undefined4 param_5,
...

{
  ...
  iVar5 = 0;
  do {
    local_44 = thunk_FUN_03f3ed25(iVar5,*(undefined4 *)(param_1 + 0x48),0x100);
    local_44 = local_44 + *(int *)(param_1 + 0x4c);
    local_3c = thunk_FUN_03f3ed25(iVar5 + 1,*(undefined4 *)(param_1 + 0x48),0x100);
