/* Ghidra address: 00e377b0 */
/* Ghidra symbol: FUN_00e377b0 */


/* WARNING: Type propagation algorithm not settling */

void FUN_00e377b0(longlong param_1,undefined8 param_2,int param_3,undefined1 param_4,
...

{
  ...
  local_2e1 = param_4;
  if ((local_250 == '\0') ||
     (iVar3 = FUN_00e37770(auStack_338,&local_f8), *(char *)(param_10 + iVar3) != '\0')) {
    local_f8 = local_2c8[1];
  }
  if ((local_24f == '\0') ||
     (iVar3 = FUN_00e37770(auStack_338,&local_f0), *(char *)(param_10 + iVar3) != '\0')) {
    local_f0 = local_2c8[2];
  }
  *param_11 = param_3;
  iVar3 = FUN_00e37770(auStack_338,&local_110);
  ...
  iVar3 = FUN_00e37770(auStack_338,&local_180);
  if (*(char *)(param_10 + iVar3) != '\0') {
    local_180 = 1e-07;
  }
  *(double *)(param_11 + 0x8c) = 3.45314379969e-11 / local_180;
  iVar3 = FUN_00e37770(auStack_338,&local_170);
  if (*(char *)(param_10 + iVar3) != '\0') {
    local_170 = 600.0;
  }
  iVar3 = FUN_00e37770(auStack_338,local_240 + 1);
  if (*(char *)(param_10 + iVar3) != '\0') {
    local_240[1] = local_170 * *(double *)(param_11 + 0x8c) * 0.0001;
  }
  iVar3 = FUN_00e37770(auStack_338,&local_160);
  if (*(char *)(param_10 + iVar3) == '\0') {
    if (local_160 * 1000000.0 <= 1.45e+16) {
      local_160 = 0.0;
    }
    else {
      iVar3 = FUN_00e37770(auStack_338,local_240 + 3);
      if (*(char *)(param_10 + iVar3) != '\0') {
      ...
      dVar7 = 3.2;
      iVar3 = FUN_00e37770(auStack_338,&local_158);
      if (*(char *)(param_10 + iVar3) != '\0') {
        local_158 = 1.0;
      }
      if (local_158 != 0.0) {
  ...
  iVar3 = FUN_00e37770(auStack_338,&local_1a8);
  if (*(char *)(param_10 + iVar3) != '\0') {
  ...
  *(double *)(param_11 + 0x3c) = local_1d8 * dVar9;
  ...
  iVar3 = FUN_00e37770(auStack_338,&local_1f0);
  if (*(char *)(param_10 + iVar3) == '\0') {
  ...
  iVar3 = FUN_00e37770(auStack_338,&local_198);
  if (*(char *)(param_10 + iVar3) == '\0') {
  ...
  *(double *)(param_11 + 0x7e) =
  ...
  iVar3 = FUN_00e37770(auStack_338,&local_1e8);
  if (*(char *)(param_10 + iVar3) == '\0') {
  ...
  *(undefined8 *)(param_11 + 0xa4) = local_120;
  iVar3 = FUN_00e37770(auStack_338,&local_218);
  if ((*(char *)(param_10 + iVar3) != '\0') &&
     (iVar3 = FUN_00e37770(auStack_338,&local_1b0), *(char *)(param_10 + iVar3) == '\0')) {
    local_218 = local_1b0 * local_290;
  }
  iVar3 = FUN_00e37770(auStack_338,&local_210);
  if ((*(char *)(param_10 + iVar3) != '\0') &&
     (iVar3 = FUN_00e37770(auStack_338,&local_1b0), *(char *)(param_10 + iVar3) == '\0')) {
    local_210 = local_1b0 * local_288;
  }
  iVar3 = FUN_00e37770(auStack_338,&local_208);
  if ((*(char *)(param_10 + iVar3) != '\0') &&
     (iVar3 = FUN_00e37770(auStack_338,&local_1b0), *(char *)(param_10 + iVar3) == '\0')) {
    local_208 = local_1b0 * local_280;
  }
  iVar3 = FUN_00e37770(auStack_338,&local_200);
  if ((*(char *)(param_10 + iVar3) != '\0') &&
     (iVar3 = FUN_00e37770(auStack_338,&local_1b0), *(char *)(param_10 + iVar3) == '\0')) {
  ...
  *(undefined2 *)(param_11 + 0x4a) = uVar2;
  ...
  local_318._0_1_ = *(undefined1 *)((longlong)param_11 + 0xd);
