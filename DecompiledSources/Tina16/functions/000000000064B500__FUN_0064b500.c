/* Ghidra address: 0064b500 */
/* Ghidra symbol: FUN_0064b500 */


undefined1 FUN_0064b500(longlong param_1,longlong *param_2)

{
  ...
  local_20[0] = 0;
  local_48 = 0;
  cVar2 = FUN_004113d0(*(undefined8 *)(param_1 + 0x18),&PTR_FUN_0061c2b8);
  if (cVar2 != '\0') {
