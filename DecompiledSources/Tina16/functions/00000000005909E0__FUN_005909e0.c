/* Ghidra address: 005909e0 */
/* Ghidra symbol: FUN_005909e0 */


void FUN_005909e0(undefined8 param_1,longlong *param_2,longlong param_3,undefined4 param_4)

{
  ...
  if (((ulonglong)pcVar1 & 0xff00000000000000) == 0xff00000000000000) {
    *(undefined4 *)((longlong)param_2 + ((ulonglong)pcVar1 & 0xffffffffffffff)) = param_4;
  }
  else {
