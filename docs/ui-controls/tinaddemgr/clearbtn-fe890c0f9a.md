...
```mermaid
flowchart LR
    control["Clear"] -->|OnClick| handler["FUN_017fe700"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000017FE700__FUN_017fe700.c](../../../DecompiledSources/Tina16/functions/00000000017FE700__FUN_017fe700.c)
