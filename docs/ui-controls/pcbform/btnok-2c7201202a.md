...
```mermaid
flowchart LR
    control["OK"] -->|OnClick| handler["FUN_00ece8b0"]
...
- Source: [DecompiledSources/Tina16/functions/0000000000ECE8B0__FUN_00ece8b0.c](../../../DecompiledSources/Tina16/functions/0000000000ECE8B0__FUN_00ece8b0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: PcbForm.BtnOK.OnClick.
