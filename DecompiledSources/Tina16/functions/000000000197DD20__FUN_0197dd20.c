/* Ghidra address: 0197dd20 */
/* Ghidra symbol: FUN_0197dd20 */


undefined8
FUN_0197dd20(longlong param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if (-1 < iVar4 + -1) {
    do {
      ...
      uVar1 = (**(code **)(*plVar2 + 0x60))(plVar2,param_2,param_3,param_4,param_5,param_6);
      if ((char)uVar1 != '\0') {
        return uVar1;
      }
      iVar3 = iVar3 + 1;
