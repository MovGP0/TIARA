/* Ghidra address: 01796000 */
/* Ghidra symbol: FUN_01796000 */


undefined1 FUN_01796000(undefined8 param_1,undefined8 *param_2)

{
  ...
  *(undefined4 *)puVar4 = *(undefined4 *)param_2;
  ...
  iVar2 = FUN_00416db0(local_4c[0],L"TINA Device Database");
  if (iVar2 == 0) {
