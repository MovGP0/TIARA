/* Ghidra address: 01d71790 */
/* Ghidra symbol: FUN_01d71790 */


void FUN_01d71790(undefined8 param_1,longlong param_2,char param_3)

{
  ...
  if ((!bVar8) && ((*(byte *)(param_2 + 0x88) & 0x20) == 0)) {
    ...
    uVar11 = FUN_016ee810(param_1,*(undefined8 *)(param_2 + 0x118),
                          *(undefined1 *)(*(longlong *)(puVar1 + 0x690) + 2),puVar1[0x10],0);
    uVar12 = FUN_016ee810(param_1,*(undefined8 *)(param_2 + 0x118),
                          *(undefined1 *)(*(longlong *)(puVar1 + 0x8b8) + 2),puVar1[0x10],0);
    ...
    if (sVar4 == 1) {
      ...
      if (cVar2 == '\0') {
        ...
        uVar3 = FUN_01d71770(uVar5,uVar6,puVar1[0xb0a]);
        puVar1[0xb09] = uVar3;
        puVar1[0xb0b] = uVar3;
      }
      else if (cVar2 == '\x02') {
    ...
    cVar2 = FUN_00dd56d0(uVar11,*puVar1);
    if (cVar2 == DAT_01fffc10) {
      puVar1[0xb09] = 1;
      puVar1[0xb0b] = 1;
    }
    cVar2 = FUN_00dd56d0(uVar12,*puVar1);
    if (cVar2 == DAT_01fffc11) {
      puVar1[0xb09] = 0;
      puVar1[0xb0b] = 0;
    }
    dVar13 = local_78;
    ...
    dVar13 = (double)(**(code **)(*(longlong *)(*(longlong *)(puVar1 + 0xb18) + 8) + 0x18))
                               (*(longlong *)(puVar1 + 0xb18),param_1,param_2,dVar13,param_3);
    if (dVar13 == local_70[0]) {
      local_70[0] = local_78;
    }
    (**(code **)(*(longlong *)(*(longlong *)(puVar1 + 0xa7a0) + 8) + 0x10))
              (*(longlong *)(puVar1 + 0xa7a0),param_1,param_2,dVar13,0,param_3,2,2);
