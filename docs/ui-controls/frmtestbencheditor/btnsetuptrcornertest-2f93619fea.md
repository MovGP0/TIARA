...
| Handler | `btnSetupTRCornerTestClick` at `012c5df0` |
...
```mermaid
flowchart TD
    control["Setup transient corner test"] --> handler["btnSetupTRCornerTestClick at 012c5df0"]
...
- [Recovered btnSetupTRCornerTestClick source](../../../DecompiledSources/Tina16/functions/00000000012C5DF0__FUN_012c5df0.c)
