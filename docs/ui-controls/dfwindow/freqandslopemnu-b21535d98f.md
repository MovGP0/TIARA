...
```mermaid
flowchart LR
    control["Freq. and slope"] -->|OnClick| handler["FUN_01a8b0b0"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A8B0B0__FUN_01a8b0b0.c](../../../DecompiledSources/Tina16/functions/0000000001A8B0B0__FUN_01a8b0b0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFMainMenu.DFViewMnu.FreqandslopeMnu.OnClick.
