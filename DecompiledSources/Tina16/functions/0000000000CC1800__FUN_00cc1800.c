/* Ghidra address: 00cc1800 */
/* Ghidra symbol: FUN_00cc1800 */


void FUN_00cc1800(undefined8 param_1,longlong param_2)

{
  *(longlong *)(param_2 + 0x58) = *(longlong *)(param_2 + 0x80) + 0x80;
