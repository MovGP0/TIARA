/* Ghidra address: 01d4f010 */
/* Ghidra symbol: FUN_01d4f010 */


void FUN_01d4f010(double *param_1,undefined8 param_2,longlong param_3,char param_4)

{
  ...
  if (((param_4 == '\x01') || (param_4 == '\x06')) || (param_4 == '\b')) {
    ...
    FUN_016ed220(param_2,4,dVar3 / dVar2,0);
    FUN_016ed220(param_2,5,(-dVar1 * dVar3) / (dVar2 * dVar2),0);
  }
  *param_1 = dVar1;
  param_1[1] = dVar2;
  return;
