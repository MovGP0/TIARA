/* Ghidra address: 0054a1f0 */
/* Ghidra symbol: FUN_0054a1f0 */


longlong * FUN_0054a1f0(longlong param_1,longlong *param_2)

{
  ...
  if (*(longlong *)(param_1 + 0x68) == 0) {
    ...
    if (-1 < iVar4 + -1) {
      do {
        uVar2 = FUN_00545f10(*(undefined8 *)(*(longlong *)(param_1 + 0x80) + 0x18),&PTR_FUN_00549ae8
