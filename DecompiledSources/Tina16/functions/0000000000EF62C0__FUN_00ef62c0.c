/* Ghidra address: 00ef62c0 */
/* Ghidra symbol: FUN_00ef62c0 */


void FUN_00ef62c0(longlong param_1,undefined8 *param_2,undefined8 *param_3,undefined8 *param_4,
  ...
  if ((short)local_90 != 0) {
    if (-1 < (int)local_70) {
      FUN_00ef4950(param_1,*(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e),
                   (undefined1)local_70,&local_90,param_7);
    }
    FUN_00ef5b80(param_1,&local_90);
    if (-1 < (int)local_6c) {
      FUN_00ef4950(param_1,*(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e),
                   (undefined1)local_6c,&local_90,param_7);
    }
  }
  if ((short)local_9c != 0) {
    if (-1 < (int)local_70) {
      FUN_00ef4950(param_1,(undefined1)local_70,
                   *(char *)(param_1 + 0x9f) + *(char *)(param_1 + 0x9e),&local_9c,param_7);
    }
