/* Ghidra address: 01ccb3a0 */
/* Ghidra symbol: FUN_01ccb3a0 */


ulonglong FUN_01ccb3a0(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (bVar1) {
    ...
    (**(code **)(**(longlong **)(param_1 + 0x18) + 0x18))(*(longlong **)(param_1 + 0x18),param_4,8);
    (**(code **)(**(longlong **)(param_1 + 0x18) + 0x48))
