...
```mermaid
flowchart LR
    control["Save As..."] -->|OnClick| handler["FUN_012f62f0"]
    handler --> call1["FUN_012fc960"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000012F62F0__FUN_012f62f0.c](../../../DecompiledSources/Tina16/functions/00000000012F62F0__FUN_012f62f0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: frmModelTestBenchEditor.TestBenchEditorMenu.mnFile.mnSaveAs.OnClick.
