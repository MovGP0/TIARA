...
| Handler node | `concept:dfm-handler:TdlgflowchartInterruptPicUART/bOKClick` |
...
- Current graph summary: Unresolved Delphi event handler TdlgflowchartInterruptPicUART.bOKClick, referenced by 1 UI event.
