/* Ghidra address: 013ca490 */
/* Ghidra symbol: FUN_013ca490 */


void FUN_013ca490(longlong param_1)

{
  ...
  local_30[0] = 0;
  iVar3 = (**(code **)(**(longlong **)(*(longlong *)(param_1 + 0x7e0) + 0x4a0) + 0x28))();
  iVar5 = 0;
  if (-1 < iVar3 + -1) {
    do {
      cVar2 = FUN_0068bca0(*(undefined8 *)(param_1 + 0x7e0),iVar5);
      if (cVar2 != '\0') {
  ...
  iVar3 = 0;
  while (plVar1 = *(longlong **)(*(longlong *)(param_1 + 0x7e0) + 0x4a0),
        iVar5 = (**(code **)(*plVar1 + 0x28))(plVar1), iVar3 <= iVar5 + -1) {
    cVar2 = FUN_0068bca0(*(undefined8 *)(param_1 + 0x7e0),iVar3);
    if (cVar2 == '\0') {
      iVar3 = iVar3 + 1;
    }
    else {
