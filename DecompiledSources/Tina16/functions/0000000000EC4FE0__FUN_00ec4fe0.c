/* Ghidra address: 00ec4fe0 */
/* Ghidra symbol: FUN_00ec4fe0 */


void FUN_00ec4fe0(longlong param_1)

{
  ...
  if (local_28 != 0) {
    ...
    if (cVar2 == '\0') {
      ...
      FUN_0043e130(&local_58,local_20[0]);
      ...
      uVar3 = (**(code **)(*(longlong *)plVar1[0x94] + 0x78))((longlong *)plVar1[0x94],local_60);
