/* Ghidra address: 01aa4900 */
/* Ghidra symbol: FUN_01aa4900 */


bool FUN_01aa4900(byte *param_1,undefined8 param_2)

{
  ...
  if (param_1[0x564] == 0) {
    ...
    if (1 < *param_1) {
      ...
      do {
        pbVar1 = pbVar1 + 1;
        local_8c[0] = (&DAT_01fce40d)[(ulonglong)*pbVar1 + (ulonglong)local_f0[0] * 4];
        cVar5 = cVar5 + -1;
