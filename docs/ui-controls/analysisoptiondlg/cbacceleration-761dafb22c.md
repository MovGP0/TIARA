...
```mermaid
flowchart LR
    control["Acceleration"] -->|OnClick| handler["FUN_014f4200"]
```
...
- Current graph summary: Handles 1 Delphi UI event: AnalysisOptionDlg.pcOptions.tshGeneral.GroupBox1.cbAcceleration.OnClick.
