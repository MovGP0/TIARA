/* Ghidra address: 00ec8620 */
/* Ghidra symbol: FUN_00ec8620 */


void FUN_00ec8620(longlong param_1)

{
  ...
  local_258 = 0;
  local_240 = 0;
  cVar2 = (**(code **)(**(longlong **)(param_1 + 0x810) + 0xf0))(*(longlong **)(param_1 + 0x810));
  if (cVar2 != '\0') {
    FUN_0064dd90(*(undefined8 *)(param_1 + 0x820),&local_258);
  ...
  uVar3 = 0;
LAB_00ec869b:
  (**(code **)(**(longlong **)(param_1 + 0x828) + 0x128))(*(longlong **)(param_1 + 0x828),uVar3);
  cVar2 = FUN_006838c0(*(undefined8 *)(param_1 + 0x818));
  if (cVar2 == '\0') {
    FUN_0065f800(*(undefined8 *)(param_1 + 0x8e0));
      ...
      if (iVar4 == 0) {
        ...
        if (-1 < iVar4) {
          ...
          if (iVar4 < iVar5) {
            ...
            iVar4 = FUN_00416db0(local_240,*(undefined8 *)(param_1 + 0x8b0));
            if (iVar4 != 0) {
              ...
              (**(code **)(**(longlong **)(param_1 + 0x8e0) + 0x290))
                        (*(longlong **)(param_1 + 0x8e0),local_30,((iVar4 + iVar5) - iVar6) + -0x10,
                         local_240,0);
              FUN_0064e030(*(undefined8 *)(param_1 + 0x8e0),0xff000018);
              ...
              (**(code **)(**(longlong **)(param_1 + 0x8e0) + 0x270))
                        (*(longlong **)(param_1 + 0x8e0),local_30,local_240);
              FUN_00414ad0(param_1 + 0x8b0,local_240);
            }
          }
        }
      }
