/* Ghidra address: 005a3530 */
/* Ghidra symbol: FUN_005a3530 */


longlong * FUN_005a3530(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_0059e350,1,(longlong)param_3);
  local_res18 = 0;
