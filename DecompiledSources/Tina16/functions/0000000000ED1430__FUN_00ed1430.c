/* Ghidra address: 00ed1430 */
/* Ghidra symbol: FUN_00ed1430 */


void FUN_00ed1430(longlong param_1)

{
  ...
  if (iVar3 < iVar4) {
    (**(code **)(**(longlong **)(param_1 + 0x748) + 0x268))(*(longlong **)(param_1 + 0x748),iVar3);
  }
  else {
    (**(code **)(**(longlong **)(param_1 + 0x748) + 0x268))
              (*(longlong **)(param_1 + 0x748),iVar3 + -1);
  }
  FUN_0043e130(&local_38,local_20);
  (**(code **)(**(longlong **)(param_1 + 0x888) + 0xc0))
