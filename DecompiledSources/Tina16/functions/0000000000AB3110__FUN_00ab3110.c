/* Ghidra address: 00ab3110 */
/* Ghidra symbol: FUN_00ab3110 */


undefined8 FUN_00ab3110(longlong param_1,undefined4 param_2)
      ...
      if (-1 < iVar8 + -1) {
        do {
          ...
          if (cVar1 != '\0') {
            ...
            uVar3 = FUN_00a9bf40(*(undefined8 *)(lVar4 + 0x80),param_2);
            if (-1 < (int)uVar3) {
              return uVar3;
            }
          }
