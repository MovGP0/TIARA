/* Ghidra address: 00597370 */
/* Ghidra symbol: FUN_00597370 */


void FUN_00597370(longlong *param_1,uint param_2,undefined8 *param_3)

{
  ...
  *(undefined8 *)(lVar1 + (longlong)(int)param_2 * 8) = 0;
  FUN_00414ad0(lVar1 + (longlong)(int)param_2 * 8,*param_3);
