/* Ghidra address: 010d5050 */
/* Ghidra symbol: FUN_010d5050 */


undefined8 FUN_010d5050(longlong param_1)
...
LAB_010d50b4:
  ...
  do {
    if (((&DAT_01f1ea04)[iVar6] == 0) && (*(int *)(*(longlong *)(param_1 + 0x10) + 8) == -1)) {
      iVar4 = FUN_01697c10(*(undefined8 *)(param_1 + 8));
      lVar2 = *(longlong *)(param_1 + 0x10);
      *(int *)(lVar2 + 8) = iVar4;
      if (iVar4 < 0) {
    ...
    local_1024 = (&DAT_01f1ea04)[iVar6];
    if (local_1024 == 0) {
      cVar3 = FUN_010d4f90(local_2048,iVar6,*(undefined4 *)(*(longlong *)(param_1 + 0x10) + 8),
                           &local_1024);
      if (cVar3 != '\0') {
        if (local_1024 < 1) {
          if (-1 < local_1024) {
...
LAB_010d5423:
      ...
      *(undefined1 *)(*(longlong *)(param_1 + 0x10) + 0x11) = 0;
      FUN_010d3c10(local_2048,-local_1024);
      local_101c[0] = local_101c[0] - *(int *)(&DAT_01f1fb2c + (longlong)-local_1024 * 8);
      cVar3 = FUN_010d4ff0(local_2048,aiStack_2028[local_101c[0]],
                           *(undefined4 *)(&DAT_01f1fb30 + (longlong)-local_1024 * 8),&local_1024);
      if (cVar3 != '\0') {
        iVar6 = local_1024;
      }
      ...
      if (cVar3 != '\x03') goto LAB_010d50b4;
    }
    if (*(int *)(*(longlong *)(param_1 + 0x10) + 0x14) == 0) {
  ...
  *(undefined4 *)(lVar2 + 0x14) = 3;
  while ((0 < local_101c[0] &&
         ((cVar3 = FUN_010d4f90(local_2048,aiStack_2028[local_101c[0]],0x100,&local_1024),
