/* Ghidra address: 01d14ed0 */
/* Ghidra symbol: FUN_01d14ed0 */


void FUN_01d14ed0(longlong param_1,longlong param_2)

{
  ...
  local_90 = 0;
  iVar2 = FUN_005fce00(*(undefined8 *)(param_2 + 0x70));
  ...
  if (*(char *)(*(longlong *)(param_1 + 0x120) + 0x88) == '\0') {
    if (*(char *)(*(longlong *)(param_1 + 0x120) + 0x89) != '\0') {
      local_7c = *(undefined4 *)(*(longlong *)(param_1 + 0x120) + 0x8c);
      local_78 = local_7c;
    }
  }
  else {
  ...
  local_6a = 2;
  local_69 = 2;
  FUN_005fccd0(*(undefined8 *)(param_2 + 0x70),&local_90);
  FUN_00442620(local_68,local_90);
  uVar5 = thunk_FUN_041a15ee(&local_84);
  FUN_005fcc40(*(undefined8 *)(param_2 + 0x70),uVar5);
