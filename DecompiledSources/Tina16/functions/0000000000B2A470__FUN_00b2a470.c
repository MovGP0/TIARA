/* Ghidra address: 00b2a470 */
/* Ghidra symbol: FUN_00b2a470 */


undefined1 FUN_00b2a470(undefined8 param_1,longlong param_2,longlong param_3)

{
  ...
  local_51 = 0;
  iVar2 = FUN_00417170(&LAB_00b2a630,param_2,1);
  if (0 < iVar2) {
      ...
      if (cVar1 != '\0') {
        ...
        if (cVar1 != '\0') {
          ...
          *(undefined2 *)(param_3 + 9) = local_42;
          if (local_43 == '\0') {
            *(undefined1 *)(param_3 + 8) = 3;
          }
          else {
            *(undefined1 *)(param_3 + 8) = 4;
          }
          local_51 = 1;
        }
      }
