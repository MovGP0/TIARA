/* Ghidra address: 0174c730 */
/* Ghidra symbol: FUN_0174c730 */


void FUN_0174c730(longlong param_1,longlong *param_2,ulonglong param_3,undefined8 param_4)
...
LAB_0174c799:
    if (local_res18 == 0) goto LAB_0174cba4;
  }
  else {
    cVar3 = FUN_0175ad40(param_1,param_2);
    if (cVar3 == '\0') goto LAB_0174c799;
  }
  ...
  if (*(char *)((longlong)plVar2 + 0xb) == '\0') {
    ...
    if (bVar1 < 0x20) {
      ...
      if (*(char *)(param_1 + 9) == '\0') {
        if ((bVar1 & 1) == 1) {
          FUN_01d048c0(*(undefined8 *)(param_1 + 0x28),DAT_01f9b020 + -0xb,DAT_01f9b024 + -0x11,
                       &local_34,&local_38,local_res18 == 0,1);
          puVar8 = &local_40;
          FUN_01d048c0(*(undefined8 *)(param_1 + 0x28),DAT_01f9b028 + -0xb,DAT_01f9b02c + -0x11,
                       &local_3c,puVar8,local_res18 == 0,1);
          uVar4 = (undefined4)((ulonglong)puVar8 >> 0x20);
          if (param_2 != (longlong *)0x0) {
            uVar5 = FUN_01a99990(param_2);
            uVar9 = CONCAT44(uVar4,local_40);
            (**(code **)(*param_2 + 0x60))(param_2,local_34,local_38,local_3c,uVar9,uVar5);
            uVar4 = (undefined4)((ulonglong)uVar9 >> 0x20);
          }
          if (local_res18 != 0) {
            FUN_01243a40(local_50,local_res18,local_res20,local_34,CONCAT44(uVar4,local_38),local_3c
                         ,local_40,1,0x8000,0x8000);
          }
        }
        bVar1 = (&DAT_01f9b0e0)[(ulonglong)(bVar1 >> 1) * 4];
        if (param_2 != (longlong *)0x0) {
        ...
        do {
          if ((1 << ((byte)iVar6 & 0x1f) & (uint)bVar1) != 0) {
            ...
            if (local_res18 != 0) {
              FUN_01243890(&local_58,local_res18,local_res20,local_34,CONCAT44(uVar4,local_38),
