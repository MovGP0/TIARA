/* Ghidra address: 0116a290 */
/* Ghidra symbol: FUN_0116a290 */


int * FUN_0116a290(int *param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  if (piVar2 != (int *)0xffffffffffffffff) {
    ...
    *(undefined8 *)(piVar2 + 0x14) = uVar3;
    ...
    piVar2[8] = iVar1;
    iVar1 = FUN_0040c770(DAT_0203aeb0 * 5.0);
    piVar2[9] = iVar1;
    ...
    *piVar2 = *piVar2 + piVar2[0x19];
    ...
    if (DAT_0203a509 == '\0') {
      ...
      FUN_00414ff0(local_130,&LAB_0116a450);
