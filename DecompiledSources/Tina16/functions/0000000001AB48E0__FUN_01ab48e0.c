/* Ghidra address: 01ab48e0 */
/* Ghidra symbol: FUN_01ab48e0 */


void FUN_01ab48e0(longlong param_1,undefined8 param_2,undefined8 param_3,longlong *param_4)

{
  ...
  if (cVar3 != '\0') {
    FUN_005dce70(*(undefined8 *)(param_1 + 0xa0));
    ...
    iVar4 = FUN_005fd4d0(*(undefined8 *)(param_1 + 0x60));
    FUN_00416ba0(&local_30,local_res18,L"color");
    uVar5 = FUN_005fd4d0(*(undefined8 *)(param_1 + 0x60));
    ...
    if (iVar4 != iVar6) {
      ...
      uVar5 = FUN_005fd4d0(*(undefined8 *)(param_1 + 0x60));
      (**(code **)(**(longlong **)(param_1 + 0xa0) + 0x28))
                (*(longlong **)(param_1 + 0xa0),L"main",L"color",uVar5);
    }
  }
