/* Ghidra address: 013bfdc0 */
/* Ghidra symbol: FUN_013bfdc0 */


undefined8 FUN_013bfdc0(longlong param_1)
...
LAB_013bfe24:
  ...
  do {
    if (((&DAT_01f41f04)[iVar6] == 0) && (*(int *)(*(longlong *)(param_1 + 0x10) + 8) == -1)) {
    ...
    local_1024 = (&DAT_01f41f04)[iVar6];
    if (local_1024 == 0) {
      cVar3 = FUN_013bfd00(local_2048,iVar6,*(undefined4 *)(*(longlong *)(param_1 + 0x10) + 8),
                           &local_1024);
      if (cVar3 != '\0') {
        if (local_1024 < 1) {
          if (-1 < local_1024) {
...
LAB_013c0193:
      ...
      *(undefined1 *)(*(longlong *)(param_1 + 0x10) + 0x11) = 0;
      FUN_013bdcf0(local_2048,-local_1024);
      local_101c[0] = local_101c[0] - *(int *)(&DAT_01f43734 + (longlong)-local_1024 * 8);
      cVar3 = FUN_013bfd60(local_2048,aiStack_2028[local_101c[0]],
                           *(undefined4 *)(&DAT_01f43738 + (longlong)-local_1024 * 8),&local_1024);
      if (cVar3 != '\0') {
        iVar6 = local_1024;
      }
      ...
      if (cVar3 != '\x03') goto LAB_013bfe24;
    }
    if (*(int *)(*(longlong *)(param_1 + 0x10) + 0x14) == 0) {
  ...
  *(undefined4 *)(lVar2 + 0x14) = 3;
  while ((0 < local_101c[0] &&
         ((cVar3 = FUN_013bfd00(local_2048,aiStack_2028[local_101c[0]],0x100,&local_1024),
