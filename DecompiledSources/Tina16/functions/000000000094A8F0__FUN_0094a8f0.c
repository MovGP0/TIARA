/* Ghidra address: 0094a8f0 */
/* Ghidra symbol: FUN_0094a8f0 */


longlong * FUN_0094a8f0(longlong *param_1,longlong *param_2)

{
  ...
  if ((char)param_1[3] == '\0') {
    ...
    plVar5 = (longlong *)(**(code **)(*param_1 + 0x10))(param_1,param_2);
  }
  else {
    plVar5 = (longlong *)0x0;
  ...
  do {
    ...
    if (plVar5 != (longlong *)0x0) {
      ...
      if (cVar3 != '\0') {
        plVar6 = (longlong *)(**(code **)(*param_1 + 0x10))(param_1,plVar5);
        param_2 = plVar5;
      }
    }
    plVar5 = plVar6;
