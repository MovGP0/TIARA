/* Ghidra address: 01685b60 */
/* Ghidra symbol: FUN_01685b60 */


void FUN_01685b60(undefined8 param_1,undefined1 param_2,undefined1 param_3,undefined1 param_4,
...

{
  ...
  *(double *)(param_7 + 0x78) = (local_78[0] * 1.3806226e-23) / 1.6021917e-19;
  ...
  dVar7 = (double)FUN_0040af80((local_d0 / *(double *)(param_7 + 0x78)) *
                               (local_78[0] / 300.15 - 1.0));
  *(double *)(param_7 + 0x80) = local_78[1] * local_138[2] * dVar6 * dVar7;
  ...
  *(undefined1 *)(param_7 + 6) = param_4;
  if (local_138[3] == 0.0) {
    ...
    *(char *)(param_7 + 8) = cVar2;
    ...
    dVar6 = (double)FUN_00b90620(local_138[3],0x3e112e0be826d695);
  ...
  if (local_4e == '\x03') {
    ...
    if (local_118 != 0.0) {
      ...
      dVar6 = (double)FUN_00b90620(local_118,0x3e112e0be826d695);
