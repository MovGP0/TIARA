...
> Analysis status: Source reviewed for TIARA-diz.6.7.1571.
...
This control shares the recovered handler with `ShapeEdit.MainMenu.mnFile.mnImport`. This article keeps the resource evidence for this control separate.
