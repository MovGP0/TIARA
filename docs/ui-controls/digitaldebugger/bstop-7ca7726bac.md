...
```mermaid
flowchart LR
    control["Stop"] -->|OnClick| handler["bStopClick"]
...
- Current graph summary: Unresolved Delphi event handler TDigitalDebugger.bStopClick, referenced by 1 UI event.
...
- Rank 1: 0 at distance 156.
- Rank 2: Message count:  at distance 259.
