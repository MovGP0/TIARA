/* Ghidra address: 00b57220 */
/* Ghidra symbol: FUN_00b57220 */


void FUN_00b57220(longlong param_1,uint param_2)

{
  ...
  if (-1 < iVar4 + -1) {
    do {
      ...
      if (lVar1 != 0) {
        plVar2 = (longlong *)FUN_004aeac0(*(undefined8 *)(param_1 + 0x10),iVar3);
