...
```mermaid
flowchart LR
    control["Global minimum"] -->|OnClick| handler["FUN_01a8a820"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A8A820__FUN_01a8a820.c](../../../DecompiledSources/Tina16/functions/0000000001A8A820__FUN_01a8a820.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFPopupMnu.SetpositionMnu.DFGlobalminimumMnu.OnClick.
