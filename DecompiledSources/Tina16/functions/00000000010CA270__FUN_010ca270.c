/* Ghidra address: 010ca270 */
/* Ghidra symbol: FUN_010ca270 */


undefined8 FUN_010ca270(longlong param_1,undefined8 param_2,char param_3)
...
LAB_010ca33e:
    if (sVar3 == 0x20) {
LAB_010ca363:
      if (param_3 != '\0') goto LAB_010ca36c;
      bVar1 = false;
    }
    else {
      FUN_00416780(&local_38,sVar3);
      iVar2 = FUN_00416db0(local_38,&LAB_010ca408);
      if (iVar2 == 0) goto LAB_010ca363;
LAB_010ca36c:
      iVar2 = 0;
      if (*(longlong *)(param_1 + 0x18) != 0) {
        iVar2 = *(int *)(*(longlong *)(param_1 + 0x18) + -4);
