/* Ghidra address: 00c763d0 */
/* Ghidra symbol: FUN_00c763d0 */


undefined4 FUN_00c763d0(undefined8 param_1)

{
  ...
  if (((cVar1 == '\x01') && (*(char *)(*(longlong *)(DAT_02019d30 + 0x1d0) + 0x29) == '\x01')) &&
    ...
    local_1c = 0;
    local_b0[0] = 0x98;
    uVar2 = thunk_FUN_0413f92d(local_b0);
    FUN_00409a70(local_b0,param_1,0x98);
  }
  else {
    uVar2 = thunk_FUN_0413f92d(param_1);
  }
  return uVar2;
}
