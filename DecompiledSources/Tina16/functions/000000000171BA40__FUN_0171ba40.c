/* Ghidra address: 0171ba40 */
/* Ghidra symbol: FUN_0171ba40 */


longlong * FUN_0171ba40(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_0170d8f8,1,(longlong)param_3);
  local_res18 = 0;
