/* Ghidra address: 00886ae0 */
/* Ghidra symbol: FUN_00886ae0 */


undefined4 FUN_00886ae0(void)

{
  ...
  if (DAT_01e21a38 == 0) {
    ...
    local_20 = L"WSACancelBlockingCall";
    local_18 = 0x11;
    uVar2 = FUN_00883110(&PTR_FUN_00882c78,1,0x276d,local_10,&local_20,0);
    FUN_004134c0(uVar2);
  }
  uVar2 = FUN_00416740(L"WSACancelBlockingCall");
