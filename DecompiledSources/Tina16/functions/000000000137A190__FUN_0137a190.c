/* Ghidra address: 0137a190 */
/* Ghidra symbol: FUN_0137a190 */


void FUN_0137a190(longlong param_1,undefined4 param_2)

{
  ...
  if (-1 < iVar1) {
    ...
    if (iVar1 <= iVar2 + -1) {
      ...
      *(char *)(lVar4 + 0x2a) = (char)param_2;
    }
  }
  FUN_00e196e0(param_2);
  return;
}
