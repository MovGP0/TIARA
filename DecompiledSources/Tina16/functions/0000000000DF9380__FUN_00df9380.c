/* Ghidra address: 00df9380 */
/* Ghidra symbol: FUN_00df9380 */


void FUN_00df9380(longlong param_1,longlong param_2,char param_3,ulonglong param_4)

{
  ...
  local_2c[0] = 0;
  if (param_3 == '\b') {
    FUN_017de390(*(undefined8 *)(param_2 + 0xd8),**(undefined8 **)(lVar1 + 0x18),
                 *(undefined8 *)(lVar1 + 0x58),0,local_2c);
    FUN_017de420(*(undefined8 *)(param_2 + 0xd8),*(undefined8 *)(*(longlong *)(lVar1 + 0x18) + 8),
                 *(undefined8 *)(lVar1 + 0x58),0);
  }
  else {
    if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
      FUN_01662860(*(longlong *)(param_2 + 0x110),1,*(undefined8 *)(lVar1 + 0x18),
