/* Ghidra address: 00c21af0 */
/* Ghidra symbol: FUN_00c21af0 */


void FUN_00c21af0(undefined8 param_1,longlong *param_2,uint param_3,uint param_4,byte param_5,
...

{
  ...
  if (*param_2 == 0) {
    lVar2 = FUN_00c217e0(&DAT_00c212f8,1,param_7,param_6,param_8,param_9);
    *param_2 = lVar2;
  }
  if (*(char *)(*param_2 + 8) == '\0') {
    bVar3 = 7 - (char)param_7;
    bVar1 = (&DAT_01e9fde0)[param_7];
    FUN_00c21af0(param_1,*param_2 + 0x28 +
                         (longlong)
