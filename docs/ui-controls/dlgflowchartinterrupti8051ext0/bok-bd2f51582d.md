...
| Handler node | `concept:dfm-handler:TdlgflowchartInterrupti8051ext0/bOKClick` |
...
- Current graph summary: Unresolved Delphi event handler TdlgflowchartInterrupti8051ext0.bOKClick, referenced by 1 UI event.
