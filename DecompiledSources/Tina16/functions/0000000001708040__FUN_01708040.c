/* Ghidra address: 01708040 */
/* Ghidra symbol: FUN_01708040 */


undefined4 FUN_01708040(longlong param_1,int param_2,int param_3,undefined8 param_4)
  ...
  if (iVar1 == 1) {
    ...
    if (local_30 != 0) {
      ...
      if (plVar2[0xee] == 0) {
        ...
        FUN_00416cd0(param_1 + 0x28,3,plVar2[0xee],&LAB_017082f8,local_40);
      }
