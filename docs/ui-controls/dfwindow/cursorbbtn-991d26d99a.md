...
```mermaid
flowchart LR
    control["Cursor: b"] -->|OnClick| handler["FUN_01a7bac0"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A7BAC0__FUN_01a7bac0.c](../../../DecompiledSources/Tina16/functions/0000000001A7BAC0__FUN_01a7bac0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFToolPanel.ToolNoteBook.Diagram.CursorBBtn.OnClick.
...
- Extracted glyph: [`0088_DFWindow_DFWindow_DFToolPanel_ToolNoteBook_Diagram_CursorBBtn_Glyph_Data.png`](../../../glyph/0088_DFWindow_DFWindow_DFToolPanel_ToolNoteBook_Diagram_CursorBBtn_Glyph_Data.png)
