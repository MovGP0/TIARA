/* Ghidra address: 00f5a8a0 */
/* Ghidra symbol: FUN_00f5a8a0 */


void FUN_00f5a8a0(undefined8 param_1,longlong param_2,undefined2 param_3)

{
  ...
  if (cVar1 == '\0') {
    ...
    FUN_00f55a10(param_1,param_2,CONCAT11(uVar4,1),2,3,4,uVar2,dVar5,uVar6,local_50[0]);
