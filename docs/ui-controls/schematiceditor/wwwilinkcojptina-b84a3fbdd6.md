...
| Component path | SchematicEditor.MainMenu.Help.mnInterlinkontheWeb.wwwilinkcojptina |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Help.mnInterlinkontheWeb.wwwilinkcojptina` |
...
```mermaid
flowchart TD
    control["www.ilink.co.jp/tina"] -->|"OnClick"| handler["OnTheWeb (01c8f060)"]
