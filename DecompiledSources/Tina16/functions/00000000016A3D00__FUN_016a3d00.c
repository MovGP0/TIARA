/* Ghidra address: 016a3d00 */
/* Ghidra symbol: FUN_016a3d00 */


void FUN_016a3d00(longlong param_1,undefined8 param_2,byte *param_3)

{
  ...
  if (plVar1 != (longlong *)0x0) {
    ...
    if (iVar2 == -1) {
      ...
      FUN_00416cd0(&local_120,4,&DAT_016a3e60,local_130[0],L") Warning: ",local_res10[0]);
