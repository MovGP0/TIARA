/* Ghidra address: 00a0cfe0 */
/* Ghidra symbol: FUN_00a0cfe0 */


longlong FUN_00a0cfe0(longlong *param_1,longlong *param_2,uint param_3,uint param_4,int param_5)

{
    ...
    if (0 < iVar8) {
      ...
      if (0 < iVar8) {
        ...
        do {
          iVar8 = iVar8 * iVar10;
          (*(code *)param_2[7])
                    (param_1,param_2 + 7,*(undefined8 *)(*param_2 + (longlong)iVar12 * 8),iVar6,
                     iVar8);
          iVar7 = (int)param_2[3];
          iVar12 = iVar12 + iVar7;
          iVar5 = *(int *)((longlong)param_2 + 0x14) - iVar12;
  ...
  if (uVar4 <= uVar11) goto LAB_00a0d238;
  if (uVar11 < param_3) {
    uVar11 = param_3;
    if (param_5 == 0) {
      bVar3 = false;
...
LAB_00a0d1dd:
    ...
    if (param_5 != 0) goto LAB_00a0d1dd;
    bVar3 = false;
    iVar8 = *(int *)((longlong)param_2 + 0x24);
  }
  if (iVar8 == 0) {
    ...
    if (uVar11 < uVar4) {
      ...
      do {
        FUN_00a1bd20(*(undefined8 *)(*param_2 + uVar9 * 8),uVar1);
        uVar9 = uVar9 + 1;
      } while (uVar4 != uVar9);
    }
  }
