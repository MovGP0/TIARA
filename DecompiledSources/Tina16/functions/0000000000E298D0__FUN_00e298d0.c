/* Ghidra address: 00e298d0 */
/* Ghidra symbol: FUN_00e298d0 */


void FUN_00e298d0(longlong param_1,undefined4 param_2,longlong *param_3,int param_4,int param_5)
  ...
  if (param_4 < param_5) {
    do {
      ...
      if (param_5 - iVar7 < iVar10 - local_5c) {
        ...
        iVar6 = local_5c;
        if (iVar7 < param_5) {
          FUN_00e298d0(param_1,param_2,param_3,iVar7,param_5);
        }
      }
      else {
        iVar8 = param_5;
        iVar6 = iVar7;
        if (local_5c < iVar10) {
          FUN_00e298d0(param_1,param_2,param_3,local_5c,iVar10);
        }
      }
      local_5c = iVar6;
      param_5 = iVar8;
