/* Ghidra address: 00791370 */
/* Ghidra symbol: FUN_00791370 */


longlong * FUN_00791370(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_00769f08,1,(longlong)param_3);
  local_res18 = 0;
