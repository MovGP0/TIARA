/* Ghidra address: 017b5fe0 */
/* Ghidra symbol: FUN_017b5fe0 */


void FUN_017b5fe0(longlong *param_1,longlong param_2,ulonglong param_3)

{
  ...
  if (param_2 != 0) {
    uVar1 = FUN_017ad600(1);
    FUN_005fd6d0(*(undefined8 *)(param_2 + 0x78),uVar1);
    FUN_005fd4e0(*(undefined8 *)(param_2 + 0x78),*(undefined4 *)((longlong)param_1 + 0x59));
