/* Ghidra address: 00f354b0 */
/* Ghidra symbol: FUN_00f354b0 */


undefined8 *
FUN_00f354b0(longlong *param_1,undefined8 *param_2,undefined4 param_3,undefined4 param_4,
            undefined1 param_5)

{
  ...
  iVar2 = FUN_00f350e0(param_1,param_3,param_4);
  if (iVar2 < 0) {
    ...
    *(undefined4 *)(param_1[1] + lVar6 * 0x10) = 0xffffffff;
    FUN_00414ad0(param_2,*(undefined8 *)(param_1[1] + 8 + lVar6 * 0x10));
    ...
    *(undefined4 *)(param_1[1] + 4 + lVar6 * 0x10) = 0;
    FUN_00414480(param_1[1] + 8 + lVar6 * 0x10);
