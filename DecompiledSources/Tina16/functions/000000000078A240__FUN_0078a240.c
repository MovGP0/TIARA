/* Ghidra address: 0078a240 */
/* Ghidra symbol: FUN_0078a240 */


longlong * FUN_0078a240(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_007609a0,1,(longlong)param_3);
  local_res18 = 0;
