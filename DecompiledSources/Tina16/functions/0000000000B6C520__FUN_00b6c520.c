/* Ghidra address: 00b6c520 */
/* Ghidra symbol: FUN_00b6c520 */


int FUN_00b6c520(longlong *param_1,longlong *param_2,longlong *param_3,ulonglong param_4)

{
  ...
  for (iVar4 = (int)((param_4 & 0xffffffff) / 0x2000); iVar4 != 0; iVar4 = iVar4 + -1) {
    ...
    iVar3 = iVar3 + iVar2;
    (**(code **)(*param_1 + 0xc0))(param_1,local_2038,local_2038,iVar2);
  ...
  if ((int)uVar1 != 0) {
    ...
    iVar3 = iVar3 + iVar4;
    (**(code **)(*param_1 + 0xc0))(param_1,local_2038,local_2038,iVar4);
