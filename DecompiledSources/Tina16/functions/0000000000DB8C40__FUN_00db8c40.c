/* Ghidra address: 00db8c40 */
/* Ghidra symbol: FUN_00db8c40 */


void FUN_00db8c40(longlong param_1,undefined4 param_2,longlong *param_3,int param_4,int param_5)
  ...
  if (param_4 < param_5) {
    do {
      ...
      if (param_5 - iVar6 < iVar9 - local_4c) {
        ...
        iVar5 = local_4c;
        if (iVar6 < param_5) {
          FUN_00db8c40(param_1,param_2,param_3,iVar6,param_5);
        }
      }
      else {
        iVar7 = param_5;
        iVar5 = iVar6;
        if (local_4c < iVar9) {
          FUN_00db8c40(param_1,param_2,param_3,local_4c,iVar9);
        }
      }
      local_4c = iVar5;
      param_5 = iVar7;
