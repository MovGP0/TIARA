/* Ghidra address: 012c3680 */
/* Ghidra symbol: FUN_012c3680 */


void FUN_012c3680(longlong param_1,longlong *param_2,longlong *param_3)

{
  ...
  if (local_res8 != 0) {
    iVar1 = FUN_004170c0(&DAT_012c3d24,local_res8,1);
    if (0 < iVar1) {
      (**(code **)(*local_res10 + 0x148))(local_res10,&local_20,L"action");
      (**(code **)(*local_res18[0] + 0x98))(local_res18[0],&local_30,local_20);
      (**(code **)(*local_20 + 0x108))(local_20,L"mode",&DAT_012c3d24);
      iVar2 = FUN_004170c0(&DAT_012c3d6c,local_res8,iVar1);
    ...
    iVar1 = FUN_004170c0(&LAB_012c3e40,local_res8,1);
    if (0 < iVar1) {
      (**(code **)(*local_res10 + 0x148))(local_res10,&local_20,L"action");
      (**(code **)(*local_res18[0] + 0x98))(local_res18[0],&local_50,local_20);
      (**(code **)(*local_20 + 0x108))(local_20,L"mode",&LAB_012c3e40);
      iVar2 = FUN_004170c0(&DAT_012c3d6c,local_res8,iVar1);
      FUN_00416dc0(&local_28,local_res8,iVar1,iVar2 - iVar1);
      iVar1 = FUN_004170c0(L"Save",local_28,1);
      if (iVar1 < 1) {
        ...
        if (iVar1 < 1) {
          ...
          FUN_00416dc0(&local_28,local_28,iVar2 + 1,(iVar1 - iVar2) + -2);
          iVar1 = FUN_004170c0(&DAT_012c3de0,local_28,1);
          FUN_00416dc0(&local_58,local_28,1,iVar1 + -1);
          (**(code **)(*local_20 + 0x108))(local_20,L"refcurve",local_58);
          iVar1 = FUN_004170c0(&DAT_012c3de0,local_28,1);
          uVar3 = 0;
          if (local_28 != 0) {
            uVar3 = *(undefined4 *)(local_28 + -4);
          }
          FUN_00416dc0(&local_60,local_28,iVar1 + 1,uVar3);
          (**(code **)(*local_20 + 0x108))(local_20,L"tolerance",local_60);
        }
      }
      else {
        (**(code **)(*local_20 + 0x108))(local_20,L"action",L"Save");
