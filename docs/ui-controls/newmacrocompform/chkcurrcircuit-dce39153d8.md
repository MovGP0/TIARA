...
```mermaid
flowchart LR
    control["&Current circuit"] -->|OnClick| handler["chkCurrCircuitClick"]
...
- Current graph summary: Unresolved Delphi event handler TNewMacroCompForm.chkCurrCircuitClick, referenced by 1 UI event.
...
- Rank 1: C&ontent: at distance 211.
- Rank 2: &Shape: at distance 232.
- Rank 3: &Name: at distance 242.
