/* Ghidra address: 011acff0 */
/* Ghidra symbol: FUN_011acff0 */


void FUN_011acff0(longlong param_1)

{
  ...
  *(undefined4 *)(*(longlong *)PTR_DAT_02003af0 + 0x768) = 0;
  ...
  iVar2 = *(int *)(*(longlong *)(param_1 + 0x700) + 0x4e0) + -1;
  iVar1 = 1;
  if (0 < iVar2) {
    do {
  ...
  *(undefined4 *)PTR_DAT_02004708 = 0x960;
  return;
}
