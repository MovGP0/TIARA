/* Ghidra address: 016ec790 */
/* Ghidra symbol: FUN_016ec790 */


void FUN_016ec790(longlong param_1,byte param_2,undefined1 param_3,undefined1 param_4,
...

{
  ...
  if (*PTR_DAT_02002ce0 == '\0') {
    if ((param_2 == 0) || (*(byte *)(param_1 + 4) < param_2)) {
      FUN_01b04d70(0x215,&LAB_016ec844,0);
    }
    else {
      lVar2 = FUN_016e8fd0(0x1c);
      if (*PTR_DAT_02002ce0 == '\0') {
