...
```mermaid
flowchart LR
    control["Cancel"] -->|OnClick| handler["FUN_01a7ce40"]
...
- Extracted glyph: [`0110_DFWindow_DFWindow_DFToolPanel_ToolNoteBook_Print_DFCancelBtn_Glyph_Data.png`](../../../glyph/0110_DFWindow_DFWindow_DFToolPanel_ToolNoteBook_Print_DFCancelBtn_Glyph_Data.png)
