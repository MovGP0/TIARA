/* Ghidra address: 0116b320 */
/* Ghidra symbol: FUN_0116b320 */


int * FUN_0116b320(int *param_1,undefined8 param_2,undefined4 param_3,undefined4 param_4,int param_5
...

{
  ...
  if (piVar2 != (int *)0xffffffffffffffff) {
    ...
    *(undefined8 *)(piVar2 + 0x1e) = uVar3;
    uVar3 = FUN_011680b0(param_9);
    *(undefined8 *)(piVar2 + 0x20) = uVar3;
    piVar2[0x16] = param_10;
    piVar2[0x17] = param_11;
    iVar1 = FUN_0040c770(DAT_0203aeb0 * 15.0);
    piVar2[8] = iVar1;
    iVar1 = FUN_0040c770(DAT_0203aeb0 * 15.0);
    piVar2[9] = iVar1;
    iVar1 = FUN_0040c770(DAT_0203aeb0 * 25.0);
    piVar2[0xb] = iVar1;
    piVar2[10] = param_5;
    piVar2[0xc] = param_12;
    ...
    *piVar2 = *piVar2 + piVar2[0x19];
    ...
    param_1 = piVar2;
    if (DAT_0203a509 == '\0') {
      FUN_0040e840(local_128,param_12);
      FUN_00415020(piVar2 + 0xd,local_128,5);
      FUN_00414ff0(local_130,&LAB_0116b508);
