/* Ghidra address: 00ef7de0 */
/* Ghidra symbol: FUN_00ef7de0 */


void FUN_00ef7de0(longlong *param_1,int param_2,ushort param_3,undefined8 param_4)

{
  ...
  if (*param_1 == 0) {
    ...
    *(undefined8 *)(*param_1 + 0x3f0) = 0;
    iVar3 = 0;
    do {
      *(undefined2 *)(*param_1 + 2 + (longlong)iVar3 * 2) = 9;
      iVar3 = iVar3 + 1;
    } while (iVar3 != 500);
  }
  iVar3 = 1;
