/* Ghidra address: 01a9d3d0 */
/* Ghidra symbol: FUN_01a9d3d0 */


void FUN_01a9d3d0(longlong param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if (*(char *)(param_1 + 0x12d) == '\0') {
    ...
    thunk_FUN_041966b8(*(undefined8 *)(param_1 + 0x148),(int)local_20 - iVar1,local_20._4_4_ - iVar2
