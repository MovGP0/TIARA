/* Ghidra address: 01aed0b0 */
/* Ghidra symbol: FUN_01aed0b0 */


undefined8
FUN_01aed0b0(undefined8 param_1,undefined8 param_2,longlong *param_3,ushort *param_4,
            undefined4 *param_5)

{
  ...
  while( true ) {
    ...
    if (((iVar2 < (int)(uint)*param_4) ||
       ...
       (*(short *)(*param_3 + -2 + (ulonglong)*param_4 * 2) == 0x3b)) break;
