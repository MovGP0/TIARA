/* Ghidra address: 00bd1390 */
/* Ghidra symbol: FUN_00bd1390 */


short * FUN_00bd1390(short *param_1)
  ...
  if (DAT_02019b08 == '\0') {
    ...
    if ((short)((ulonglong)param_1 >> 0x10) == 0) {
      ...
      for (; *local_38 != 0; local_38 = local_38 + 1) {
        sVar2 = FUN_00bd1390(*local_38);
        *local_38 = sVar2;
      }
    }
  }
  else {
    local_30 = (short *)thunk_FUN_03e65ba4(param_1);
  }
