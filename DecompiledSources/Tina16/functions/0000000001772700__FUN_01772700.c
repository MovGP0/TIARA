/* Ghidra address: 01772700 */
/* Ghidra symbol: FUN_01772700 */


void FUN_01772700(longlong *param_1,longlong param_2,undefined1 param_3,undefined8 param_4)
...
LAB_017728d5:
    ...
    if (iVar2 != 0) goto LAB_017728d5;
    FUN_01d317c0(local_20[0],local_5c);
    cVar1 = FUN_01772620(auStack_a8,local_5c);
    if (cVar1 == '\0') {
      FUN_00b047e0(0xfffffffd);
    }
    else {
