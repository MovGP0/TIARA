...
| --- | --- |
| Form | MCUProjectForm |
| Component path | MCUProjectForm.pnToolbar.sbRemoveFromProject |
| Control class | TSpeedButton |
| Caption | Not present in the recovered resource. |
| Hint | Remove File(s) From Project |
| Text | Not present in the recovered resource. |
| Handler name | mnRemoveClick |
| Handler address | 01084920 |
| Graph node | `resource:dfm:MCUProjectForm/MCUProjectForm.pnToolbar.sbRemoveFromProject` |
...
```mermaid
flowchart TD
    control["Remove File(s) From Project"] -->|OnClick| handler["TMCUProjectForm.mnRemoveClick<br/>FUN_01084920"]
...
- Extracted glyph: [`0268_MCUProjectForm_MCUProjectForm_pnToolbar_sbRemoveFromProject_Glyph_Data.png`](../../../glyph/0268_MCUProjectForm_MCUProjectForm_pnToolbar_sbRemoveFromProject_Glyph_Data.png)
