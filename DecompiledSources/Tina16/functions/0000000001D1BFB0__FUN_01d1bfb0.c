/* Ghidra address: 01d1bfb0 */
/* Ghidra symbol: FUN_01d1bfb0 */


int FUN_01d1bfb0(longlong param_1,longlong param_2)
  ...
  if (-1 < local_90) {
    ...
    do {
      ...
      if (local_91 == '\0') {
        ...
        FUN_00414b50(&local_28,&DAT_01d1c9a4);
      }
  ...
  *local_68 = 0;
  ...
  while( true ) {
    ...
    if (local_b1 == '\0') {
      ...
      FUN_00414b50(&local_38,&DAT_01d1c9a4);
    }
    ...
    if (local_b8 < 1) {
      iVar3 = FUN_01d13670(param_1,param_2,&DAT_01d1c9ac);
      local_48 = local_48 + iVar3 + (int)*(short *)(param_1 + 0x38);
    }
    else {
      ...
      iVar3 = FUN_01d13670(param_1,param_2,local_58);
      if (iVar3 != 0) {
        iVar3 = FUN_01d13670(param_1,param_2,local_58);
        local_48 = local_48 + iVar3 + (int)*(short *)(param_1 + 0x38);
      }
  ...
  local_44 = FUN_0040c770((double)(int)*(short *)(param_1 + 0x38) * 0.5);
  local_44 = local_48 + local_44;
  iVar3 = FUN_0040c770((double)(int)*(short *)(param_1 + 0x38) * 0.5);
  *(int *)(param_1 + 0xc0) = local_48 + iVar3;
