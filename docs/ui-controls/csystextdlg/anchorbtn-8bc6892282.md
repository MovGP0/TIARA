...
```mermaid
flowchart LR
    control["Anchor"] -->|OnClick| handler["FUN_014698a0"]
    handler --> call1["FUN_014695a0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000014698A0__FUN_014698a0.c](../../../DecompiledSources/Tina16/functions/00000000014698A0__FUN_014698a0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: CSysTextDlg.ToolsPanel.ToolsNB.Edit.AnchorBtn.OnClick.
