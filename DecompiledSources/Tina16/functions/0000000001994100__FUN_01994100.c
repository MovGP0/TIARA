/* Ghidra address: 01994100 */
/* Ghidra symbol: FUN_01994100 */


void FUN_01994100(longlong param_1,longlong *param_2)
  ...
  if (param_2 != (longlong *)0x0) {
    ...
    if (cVar1 != '\0') {
      ...
      if (cVar1 != '\0') {
        ...
        FUN_00416cd0(local_20,3,L"SelectPart(",local_28,&LAB_0199421c);
