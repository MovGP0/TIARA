...
```mermaid
flowchart LR
    control["Statistics..."] -->|OnClick| handler["FUN_01a7fae0"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A7FAE0__FUN_01a7fae0.c](../../../DecompiledSources/Tina16/functions/0000000001A7FAE0__FUN_01a7fae0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFPopupMnu.StatisticsMnu.OnClick.
