/* Ghidra address: 012c6020 */
/* Ghidra symbol: FUN_012c6020 */


void FUN_012c6020(longlong param_1)

{
  ...
  if (lVar4 != 0) {
    ...
    if ((*(uint *)(*(longlong *)(lVar4 + 0x18) + 0x62c) & 0x20) == 0x20) {
      ...
      local_38[0] = 0;
      local_40[0] = 0;
      FUN_012ca200(param_1,uVar5,0,1,0,uVar1,uVar2,uVar3,local_30,local_38,local_40);
    }
  }
  return;
}
