/* Ghidra address: 004fd830 */
/* Ghidra symbol: FUN_004fd830 */


void FUN_004fd830(longlong param_1,int param_2,undefined8 *param_3)

{
  ...
  cVar1 = FUN_004113d0(param_3,&PTR_FUN_00511b10);
  if (cVar1 == '\0') {
    ...
    local_40 = local_48;
    local_38 = param_3;
    FUN_004fd6a0(param_1,param_2,local_48,local_50 + -1);
  }
