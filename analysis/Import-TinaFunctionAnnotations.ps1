...
SELECT
  ...
  annotation.recoveredRole AS recovered_role,
  annotation.likelyDelphiName AS likely_delphi_name,
  annotation.framework AS framework,
  annotation.apiCategory AS api_category,
  annotation.uiRole AS ui_role,
  annotation.behavior AS behavior,
  annotation.evidence AS evidence,
