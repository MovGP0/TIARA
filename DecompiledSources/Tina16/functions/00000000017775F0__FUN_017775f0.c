/* Ghidra address: 017775f0 */
/* Ghidra symbol: FUN_017775f0 */


undefined1 FUN_017775f0(undefined8 param_1,undefined8 *param_2)

{
  ...
  *(undefined4 *)puVar4 = *(undefined4 *)param_2;
  ...
  iVar2 = FUN_00416db0(local_4c[0],L"VerilogAMS Macro");
  if (iVar2 == 0) {
