/* Ghidra address: 01a976c0 */
/* Ghidra symbol: FUN_01a976c0 */


longlong FUN_01a976c0(longlong param_1,undefined8 param_2,longlong param_3,int *param_4)

{
  ...
  if (lVar2 != -1) {
    ...
    *(undefined1 *)(lVar2 + 0x12e) = 0;
    *(undefined1 *)(lVar2 + 0x12f) = 1;
    ...
    *(undefined8 *)(lVar2 + 0x140) = 0;
    if (param_3 == 0) {
      ...
      *(undefined1 *)(lVar2 + 0x128) = DAT_01fcd6d1;
      ...
      *(undefined8 *)(lVar2 + 0x120) = uVar3;
      FUN_00b956d0(lVar2 + 0x2c,0,0,param_4[2] - *param_4,param_4[3] - param_4[1]);
      *(undefined8 *)(lVar2 + 0x3c) = *(undefined8 *)param_4;
      *(undefined8 *)(lVar2 + 0x44) = *(undefined8 *)(param_4 + 2);
      FUN_01a98230(lVar2);
      param_1 = lVar2;
    }
  }
