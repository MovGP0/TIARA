/* Ghidra address: 01523040 */
/* Ghidra symbol: FUN_01523040 */


undefined8 FUN_01523040(longlong param_1,longlong *param_2)

{
  ...
  (**(code **)(*param_2 + 0x2d0))(param_2,3,&local_38);
