/* Ghidra address: 00f5a700 */
/* Ghidra symbol: FUN_00f5a700 */


void FUN_00f5a700(undefined8 param_1,longlong param_2,undefined2 param_3)

{
  ...
  if (cVar1 == '\0') {
    ...
    FUN_00f558b0(param_1,param_2,CONCAT11(uVar4,1),2,3,4,uVar2,dVar5,uVar6,local_50[0]);
