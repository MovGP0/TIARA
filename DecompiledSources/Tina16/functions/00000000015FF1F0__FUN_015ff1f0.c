/* Ghidra address: 015ff1f0 */
/* Ghidra symbol: FUN_015ff1f0 */


char FUN_015ff1f0(undefined8 param_1)

{
  ...
  FUN_015fecc0(&local_30,L"\\Software",L"\\Microchip\\MPLAB XC16 C Compiler",local_10);
