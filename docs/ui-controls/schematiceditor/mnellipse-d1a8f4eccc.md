...
| Component path | SchematicEditor.MainMenu.Insert.mnShape.mnEllipse |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Insert.mnShape.mnEllipse` |
...
```mermaid
flowchart TD
    control["&Ellipse"] -->|"OnClick"| handler["InsertShape (01c97500)"]
