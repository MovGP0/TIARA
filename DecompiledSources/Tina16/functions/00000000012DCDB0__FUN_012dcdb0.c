/* Ghidra address: 012dcdb0 */
/* Ghidra symbol: FUN_012dcdb0 */


void FUN_012dcdb0(longlong param_1,undefined8 *param_2,int param_3)

{
  ...
  local_30 = puVar7;
  *(undefined8 *)((longlong)auStack_70 + lVar2) = 0x12dce38;
  FUN_00417a80(puVar7,&DAT_00401390,(longlong)param_3 + 1);
  lVar5 = alStack_48[1] + 0x38;
  *(undefined8 *)((longlong)auStack_70 + lVar2) = 0x12dce5f;
  ...
  if (-1 < param_3) {
    ...
    puVar7 = local_30;
    do {
      lVar5 = *(longlong *)(alStack_48[1] + 0x38);
      uVar1 = *puVar7;
      *(undefined8 *)((longlong)auStack_70 + lVar2) = 0x12dce8c;
  ...
  puVar7 = local_30;
  *(undefined8 *)((longlong)auStack_70 + lVar2) = 0x12dceb7;
