/* Ghidra address: 005dfeb0 */
/* Ghidra symbol: FUN_005dfeb0 */


undefined8 FUN_005dfeb0(longlong param_1,undefined8 param_2)

{
  ...
  FUN_00417c40(local_18,*(longlong *)(*(longlong *)(param_1 + 8) + 8) +
                        (longlong)*(int *)(param_1 + 0x10) * 0x10,&DAT_005d3e40);
