/* Ghidra address: 0167cb20 */
/* Ghidra symbol: FUN_0167cb20 */


void FUN_0167cb20(undefined8 param_1,longlong param_2,undefined4 param_3)

{
  ...
  FUN_016ebb00(param_1,1,local_4e8,0x438);
  uVar2 = FUN_01b05c20(param_1,1);
  FUN_016ee260(param_1,&local_4f0,0x710,0);
  if (local_30 == '\0') {
    cVar1 = FUN_016e9de0(param_1,4);
    if (cVar1 == '\0') {
      FUN_00dcd230(param_1,param_3,1,2,3,3,&local_b0,local_4e8,uVar2,local_4f0);
    }
    else {
      FUN_00dcd230(param_1,param_3,1,2,3,4,&local_b0,local_4e8,uVar2,local_4f0);
    }
    FUN_016e9f40(param_1,FUN_0167cac0);
    FUN_016e9f60(param_1,FUN_016728f0);
    FUN_016e9f70(param_1,FUN_01672b90);
    FUN_016e9fa0(param_1,FUN_00dbca90);
    FUN_016e9ff0(param_1,FUN_01672150);
    FUN_016ea040(param_1,FUN_01672670);
    FUN_016e9fd0(param_1,FUN_00dbee80);
    FUN_016ea010(param_1,FUN_00dbf900);
    FUN_016ea020(param_1,FUN_00dbf980);
    FUN_016ea030(param_1,FUN_00dbfa00);
    FUN_016e9fc0(param_1,FUN_00dbd450);
  }
  return;
}
