/* Ghidra address: 01b485f0 */
/* Ghidra symbol: FUN_01b485f0 */


longlong FUN_01b485f0(longlong param_1,char param_2,undefined4 param_3,undefined4 param_4,
                     undefined8 param_5)
  ...
  *(undefined4 *)(local_res8 + 0x24) = 0;
  ...
  do {
    ...
    if (((int)(uint)local_1a < -*(int *)(local_res8 + 0x18)) ||
       (-*(int *)(local_res8 + 0x18) + 0x1c1 < (int)(uint)local_1a)) {
      local_1d = '\0';
    }
    else {
      local_1d = '\x01';
