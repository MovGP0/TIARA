/* Ghidra address: 00c21ca0 */
/* Ghidra symbol: FUN_00c21ca0 */


void FUN_00c21ca0(undefined8 param_1,longlong param_2,longlong param_3,int *param_4)

{
  ...
  if (*(char *)(param_2 + 8) == '\0') {
    ...
    do {
      ...
      if (lVar2 != 0) {
        FUN_00c21ca0(param_1,lVar2,param_3,param_4);
      }
      iVar3 = iVar3 + 1;
    } while (iVar3 != 8);
  }
