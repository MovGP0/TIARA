...
| --- | --- |
| Form | LocalLLMForm |
| Component path | LocalLLMForm.MainMenu1.File1.mnSaveLog |
| Control class | TMenuItem |
| Caption | Save Log... |
| Hint | Not present in the recovered resource. |
| Text | Not present in the recovered resource. |
| Handler name | mnSaveLogClick |
| Handler address | 01a54ae0 |
| Graph node | `resource:dfm:LocalLLMForm/LocalLLMForm.MainMenu1.File1.mnSaveLog` |
| Handler node | `function:01a54ae0` |
| Graph layer | UI |
