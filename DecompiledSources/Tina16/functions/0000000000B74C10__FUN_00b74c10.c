/* Ghidra address: 00b74c10 */
/* Ghidra symbol: FUN_00b74c10 */


int FUN_00b74c10(int param_1,undefined8 param_2,int param_3)

{
  ...
  return (*(int *)(&DAT_01e8c970 + (ulonglong)(uVar1 >> 0x18) * 4) +
         ...
         *(uint *)(&DAT_01e8d170 + (ulonglong)(uVar1 >> 8 & 0xff) * 4)) -
