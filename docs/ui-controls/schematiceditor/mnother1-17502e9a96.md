...
| Component path | SchematicEditor.MainMenu.View.mnLanguage.mnOther1 |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.View.mnLanguage.mnOther1` |
...
```mermaid
flowchart TD
    control["Other"] -->|"OnClick"| handler["ChangeLanguageClick (01ca3c00)"]
