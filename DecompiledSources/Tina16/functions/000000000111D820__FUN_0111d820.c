/* Ghidra address: 0111d820 */
/* Ghidra symbol: FUN_0111d820 */


ulonglong FUN_0111d820(longlong param_1)

{
  ...
  if (uVar2 < 0x100) {
    bVar6 = ((byte)(&DAT_0111d914)[(longlong)(ulonglong)uVar2 >> 3] >> ((ulonglong)uVar2 & 7) & 1)
            != 0;
  }
  else {
    bVar6 = false;
  ...
  if (bVar6) {
    ...
    uVar2 = *(ushort *)(param_1 + 0x2e);
    if (uVar2 < 0x100) {
      bVar6 = ((byte)(&DAT_0111d934)[(longlong)(ulonglong)uVar2 >> 3] >> ((ulonglong)uVar2 & 7) & 1)
              != 0;
    }
    else {
      bVar6 = false;
    ...
    if (bVar6) {
      ...
      uVar2 = *(ushort *)(param_1 + 0x2e);
      if (uVar2 < 0x100) {
        bVar6 = ((byte)(&DAT_0111d954)[(longlong)(ulonglong)uVar2 >> 3] >> ((ulonglong)uVar2 & 7) &
                1) != 0;
      }
      else {
        bVar6 = false;
