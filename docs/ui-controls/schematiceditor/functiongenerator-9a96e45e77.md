...
| Component path | SchematicEditor.MainMenu.mnTM.FunctionGenerator |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.mnTM.FunctionGenerator` |
...
```mermaid
flowchart TD
    Control["Click &Function Generator"] --> Handler["mnFGVirtualClick<br/>01c90410"]
