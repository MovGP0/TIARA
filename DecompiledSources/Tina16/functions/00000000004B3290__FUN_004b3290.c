/* Ghidra address: 004b3290 */
/* Ghidra symbol: FUN_004b3290 */


ulonglong FUN_004b3290(longlong param_1)

{
  ...
  if (lVar1 == 0) {
    ...
    cVar2 = FUN_004113d0(lVar1,&PTR_FUN_00476820);
    if (cVar2 != '\0') {
      cVar2 = FUN_004b33d0(*(undefined8 *)(param_1 + 0x70),lVar1);
