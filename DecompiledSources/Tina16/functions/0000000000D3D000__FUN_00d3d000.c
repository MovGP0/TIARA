/* Ghidra address: 00d3d000 */
/* Ghidra symbol: FUN_00d3d000 */


void FUN_00d3d000(longlong *param_1)

{
  char cVar1;
  
  if ((*(char *)((longlong)param_1 + 0x7c) != '\0') && (*(char *)((longlong)param_1 + 0xb5) == '\0')
     ) {
  ...
  if ((*(char *)((longlong)param_1 + 0x7d) != '\0') && (*(char *)((longlong)param_1 + 0xb5) == '\0')
     ) {
