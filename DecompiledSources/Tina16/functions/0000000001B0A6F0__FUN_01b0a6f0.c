/* Ghidra address: 01b0a6f0 */
/* Ghidra symbol: FUN_01b0a6f0 */


undefined8
FUN_01b0a6f0(longlong param_1,undefined8 param_2,double param_3,undefined1 param_4,
            undefined1 param_5)

{
  ...
  if (*(char *)(param_1 + 0x98) == '\x06') {
    ...
    local_58 = L"  /Run-Time = ";
    local_50 = local_30;
    local_48 = &DAT_01b0a984;
    local_40 = L"  /Transient Points = ";
    FUN_00416cd0(&local_10,6,local_28,&DAT_01b0a948);
