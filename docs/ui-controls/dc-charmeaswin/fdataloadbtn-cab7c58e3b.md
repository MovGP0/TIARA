...
```mermaid
flowchart LR
    control["FDataLoadBtn"] -->|OnClick| handler["FUN_01b68d60"]
    handler --> call1["FUN_010f7e80"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/0000000001B68D60__FUN_01b68d60.c](../../../DecompiledSources/Tina16/functions/0000000001B68D60__FUN_01b68d60.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DC_CharMeasWin.DataBox.FDataLoadBtn.OnClick.
