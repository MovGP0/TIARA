...
```mermaid
flowchart LR
    control["Local minimum"] -->|OnClick| handler["FUN_01a8a960"]
...
- Source: [DecompiledSources/Tina16/functions/0000000001A8A960__FUN_01a8a960.c](../../../DecompiledSources/Tina16/functions/0000000001A8A960__FUN_01a8a960.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: DFWindow.DFPopupMnu.SetpositionMnu.DFLocalminimumMnu.OnClick.
