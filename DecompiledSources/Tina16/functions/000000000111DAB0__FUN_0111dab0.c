/* Ghidra address: 0111dab0 */
/* Ghidra symbol: FUN_0111dab0 */


ulonglong FUN_0111dab0(longlong param_1)

{
  ...
  if (uVar2 < 0x100) {
    bVar6 = ((byte)(&DAT_0111db70)[(longlong)(ulonglong)uVar2 >> 3] >> ((ulonglong)uVar2 & 7) & 1)
            != 0;
  }
  else {
    bVar6 = false;
  ...
  if (bVar6) {
    ...
    uVar2 = *(ushort *)(param_1 + 0x2e);
    if (uVar2 < 0x100) {
      bVar6 = ((byte)(&DAT_0111db90)[(longlong)(ulonglong)uVar2 >> 3] >> ((ulonglong)uVar2 & 7) & 1)
              != 0;
    }
    else {
      bVar6 = false;
