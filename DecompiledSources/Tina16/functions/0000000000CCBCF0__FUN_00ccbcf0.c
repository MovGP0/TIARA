/* Ghidra address: 00ccbcf0 */
/* Ghidra symbol: FUN_00ccbcf0 */


undefined4 FUN_00ccbcf0(longlong param_1,undefined8 param_2)

{
  ...
  if (local_48 == 0) {
    ...
    FUN_00419260(&local_60,&DAT_00ccbcb0,1,0x81);
    *(undefined1 *)(local_60 + 0x80) = 0;
    ...
    if (local_40 == 0) {
      ...
      if (iVar3 == 1) {
        local_54 = (**(code **)PTR_DAT_02004248)(param_1,local_38);
      ...
      FUN_00ccbfe0(0,local_70);
    }
    FUN_00ccc000(0,local_70);
  }
  FUN_00ccc020(0,local_70);
LAB_00ccbf62:
  FUN_00419430(&local_60,&DAT_00ccbcb0);
  return local_54;
}
