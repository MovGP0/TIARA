/* Ghidra address: 00a74430 */
/* Ghidra symbol: FUN_00a74430 */


int FUN_00a74430(longlong param_1,int *param_2,int param_3)

{
  ...
  *param_2 = iVar1;
  ...
  iVar1 = iVar1 - param_3;
  iVar2 = FUN_00a73e00(param_1,*param_2);
  if (iVar1 < iVar2) {
    iVar2 = *param_2;
    iVar8 = *(int *)(param_1 + 0xc) - param_3;
    local_34 = *param_2;
