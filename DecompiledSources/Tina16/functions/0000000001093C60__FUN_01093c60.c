/* Ghidra address: 01093c60 */
/* Ghidra symbol: FUN_01093c60 */


longlong FUN_01093c60(longlong param_1,char param_2,undefined8 param_3)

{
  ...
  *(undefined8 *)(local_res8 + 0x1958) = uVar2;
  FUN_00bc0bf0(uVar2,2);
  FUN_00bc0bd0(*(undefined8 *)(local_res8 + 0x1958),0x8000);
  FUN_00bc1c10(local_res8,*(undefined8 *)(local_res8 + 0x1958));
  FUN_0041ddd0(&local_30,PTR_PTR_02004540);
  uVar2 = FUN_00bbfc10(&PTR_FUN_00bbd348,1,L"Identifier",local_30);
  *(undefined8 *)(local_res8 + 0x1960) = uVar2;
