/* Ghidra address: 01113990 */
/* Ghidra symbol: FUN_01113990 */


void FUN_01113990(longlong param_1,undefined4 param_2)

{
  ...
  *(uint *)(param_1 + 0x618) = *(uint *)(param_1 + 0x618) | 8;
  ...
  local_1c = param_2;
  uVar1 = thunk_FUN_0418b35e(*(undefined2 *)(param_1 + 0x622),0x807,
