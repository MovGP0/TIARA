/* Ghidra address: 00df4230 */
/* Ghidra symbol: FUN_00df4230 */


void FUN_00df4230(longlong param_1,longlong param_2,undefined8 param_3,ulonglong param_4)

{
  ...
  *(undefined4 *)(lVar1 + 0x68) = 0;
  ...
  FUN_017ddc70(*(undefined8 *)(param_2 + 0xd8),uVar5,uVar6,uVar8,lVar1 + 0x58,lVar1 + 0x60,
               lVar1 + 0x68);
  FUN_017ddb80(*(undefined8 *)(param_2 + 0xd8),uVar7,uVar7,lVar1 + 0x58,lVar1 + 0x60,lVar1 + 0x68);
  FUN_017ddb80(*(undefined8 *)(param_2 + 0xd8),uVar8,uVar8,lVar1 + 0x58,lVar1 + 0x60,lVar1 + 0x68);
  FUN_017ddb80(*(undefined8 *)(param_2 + 0xd8),uVar7,uVar8,lVar1 + 0x58,lVar1 + 0x60,lVar1 + 0x68);
