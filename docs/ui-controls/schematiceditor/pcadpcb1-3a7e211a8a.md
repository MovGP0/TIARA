...
| Component path | SchematicEditor.MainMenu.mnFile.pcbdirectory1.PCADPCB1 |
| Control class | TMenuItem |
| Caption | PCAD |
| Hint | Not present in the recovered resource. |
| Text | Not present in the recovered resource. |
| Handler name | PCADPCB1Click |
| Handler address | 01c94e90 |
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.mnFile.pcbdirectory1.PCADPCB1` |
| Handler node | `function:01c94e90` |
| Graph layer | UI |
...
```mermaid
flowchart LR
    control["PCAD"] -->|OnClick| handler["FUN_01c94e90"]
