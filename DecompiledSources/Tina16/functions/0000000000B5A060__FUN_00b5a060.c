/* Ghidra address: 00b5a060 */
/* Ghidra symbol: FUN_00b5a060 */


void FUN_00b5a060(longlong param_1,uint param_2)

{
  ...
  (**(code **)(**(longlong **)(param_1 + 0x58) + -0x20))(*(longlong **)(param_1 + 0x58),1);
