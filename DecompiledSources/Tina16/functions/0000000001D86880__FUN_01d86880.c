/* Ghidra address: 01d86880 */
/* Ghidra symbol: FUN_01d86880 */


undefined8
FUN_01d86880(longlong param_1,undefined4 param_2,undefined8 param_3,undefined4 param_4,
...

{
  ...
  *param_6 = '\0';
  ...
  if (lVar1 != 0) {
    ...
    cVar2 = FUN_01b6ee40(*(undefined8 *)(param_1 + 0x68),param_2,param_3,param_4,&local_30);
    *param_6 = cVar2;
    if (*param_6 == '\x01') {
