/* Ghidra address: 00f0c9b0 */
/* Ghidra symbol: FUN_00f0c9b0 */


void FUN_00f0c9b0(longlong param_1)

{
  ...
  if (dVar4 < dVar3) {
    ...
    FUN_00b90440(*(undefined8 *)(param_1 + 0x710),uVar5);
  }
  uVar2 = (**(code **)(**(longlong **)(param_1 + 0x6e8) + 0x260))(*(longlong **)(param_1 + 0x6e8));
  uVar1 = FUN_01a8dc20(1);
  if (uVar2 == uVar1) {
    FUN_00b90090(*(undefined8 *)(param_1 + 0x710));
    uVar5 = FUN_00c43d30();
    *(undefined8 *)(param_1 + 0x7b0) = uVar5;
  }
  else {
