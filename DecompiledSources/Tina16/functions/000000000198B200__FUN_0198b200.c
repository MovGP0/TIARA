/* Ghidra address: 0198b200 */
/* Ghidra symbol: FUN_0198b200 */


undefined8 *
FUN_0198b200(undefined8 *param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  if (puVar2 != (undefined8 *)0xffffffffffffffff) {
    FUN_00b95480(puVar2,0,1000,1000);
    cVar1 = FUN_0198acc0(puVar2,param_3);
    if (cVar1 == '\0') {
      lVar3 = FUN_01a97050(0,&PTR_FUN_01a96ef0,param_4);
      puVar2[0x42] = lVar3;
      param_1 = puVar2;
      if (lVar3 != 0) {
