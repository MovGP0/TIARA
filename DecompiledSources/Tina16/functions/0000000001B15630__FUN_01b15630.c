/* Ghidra address: 01b15630 */
/* Ghidra symbol: FUN_01b15630 */


undefined8 *
FUN_01b15630(longlong *param_1,undefined8 *param_2,undefined8 param_3,undefined4 param_4,
            undefined1 param_5)

{
  ...
  local_30[0] = 0;
  iVar2 = FUN_01b15290(param_1,param_3,param_4);
  if (iVar2 < 0) {
    *param_2 = 0;
    param_2[1] = 0;
  }
