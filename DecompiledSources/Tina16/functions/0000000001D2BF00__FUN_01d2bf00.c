/* Ghidra address: 01d2bf00 */
/* Ghidra symbol: FUN_01d2bf00 */


void FUN_01d2bf00(longlong *param_1,longlong *param_2)

{
  ...
  if (1 < (int)param_1[9]) {
    ...
    if (cVar1 != '\0') {
      ...
      (**(code **)(*param_2 + 200))
                (param_2,*(undefined4 *)param_1[10],((undefined4 *)param_1[10])[1]);
      iVar4 = 2;
      if (1 < (int)param_1[9]) {
