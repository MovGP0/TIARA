/* Ghidra address: 0141fbe0 */
/* Ghidra symbol: FUN_0141fbe0 */


void FUN_0141fbe0(undefined8 param_1,undefined8 param_2,undefined4 param_3)

{
  ...
  if ((cVar1 == '\x01') || ((byte)(cVar1 - 5U) < 2)) {
    ...
    FUN_016ed320(param_1,5,uVar7,0,0);
    FUN_016ed320(param_1,7,uVar6,0,0);
    FUN_016ed320(param_1,9,uVar5,0,0);
  }
    ...
    FUN_016ed320(param_1,5,uVar10,uVar11,0);
    FUN_016ed320(param_1,7,uVar8,uVar9,0);
    FUN_016ed320(param_1,9,uVar6,uVar7,0);
  }
  return;
}
