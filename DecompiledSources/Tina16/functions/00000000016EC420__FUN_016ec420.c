/* Ghidra address: 016ec420 */
/* Ghidra symbol: FUN_016ec420 */


void FUN_016ec420(longlong param_1,byte param_2,undefined1 param_3,undefined1 param_4,
...

{
  ...
  if ((param_2 == 0) || (*(byte *)(param_1 + 4) < param_2)) {
    FUN_01b04d70(0x215,&LAB_016ec4bc,0);
  }
  else {
    lVar2 = FUN_016e8fd0(0xb);
