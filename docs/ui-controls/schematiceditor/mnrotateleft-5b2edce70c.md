...
| Component path | SchematicEditor.MainMenu.Edit.mnRotateLeft |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.Edit.mnRotateLeft` |
...
```mermaid
flowchart LR
    control["Rotate &Left"] -->|OnClick| handler["FUN_01c76ff0"]
