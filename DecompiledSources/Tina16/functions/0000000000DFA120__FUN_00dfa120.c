/* Ghidra address: 00dfa120 */
/* Ghidra symbol: FUN_00dfa120 */


void FUN_00dfa120(longlong param_1,longlong param_2,char param_3,ulonglong param_4)

{
  ...
  local_3c[0] = 0;
  if (param_3 == '\b') {
    FUN_017de540(*(undefined8 *)(param_2 + 0xd8),**(undefined8 **)(lVar3 + 0x18),
                 *(undefined8 *)(lVar3 + 0x58),1,local_3c);
    FUN_017de5f0(*(undefined8 *)(param_2 + 0xd8),*(undefined8 *)(*(longlong *)(lVar3 + 0x18) + 8),
