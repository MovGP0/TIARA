/* Ghidra address: 0062d8b0 */
/* Ghidra symbol: FUN_0062d8b0 */


int FUN_0062d8b0(longlong param_1,undefined4 param_2,char *param_3,int param_4)

{
  ...
  iVar2 = -6;
  if (((param_3 != (char *)0x0) && (param_4 == 0x58)) && (*param_3 == '1')) {
    if (param_1 == 0) {
      iVar2 = -2;
    }
    else {
      *(undefined8 *)(param_1 + 0x20) = 0;
      ...
      if (plVar3 == (longlong *)0x0) {
        ...
        *(undefined4 *)(plVar3 + 1) = 0x3f34;
        iVar2 = FUN_0062d710(param_1,param_2);
        if (iVar2 == 0) {
          iVar2 = 0;
        }
        else {
