/* Ghidra address: 0043f990 */
/* Ghidra symbol: FUN_0043f990 */


undefined8
FUN_0043f990(undefined8 param_1,ulonglong param_2,int param_3,int param_4,undefined2 param_5)

{
  ...
  for (; 1 < param_4; param_4 = param_4 + -2) {
    puVar3 = puVar3 + -1;
    *puVar3 = *(undefined4 *)(u_000102030405060708090A0B0C0D0E0F_01dbfed4 + (param_2 & 0xff) * 2);
    param_2 = param_2 >> 8;
  }
  if (param_4 == 1) {
    *(wchar_t *)(local_10 + (longlong)param_3 * 2) =
         u_000102030405060708090A0B0C0D0E0F_01dbfed4[(param_2 & 0xf) + 0x200];
  }
  lVar2 = 0;
  if (local_10 != 0) {
