/* Ghidra address: 00df60f0 */
/* Ghidra symbol: FUN_00df60f0 */


void FUN_00df60f0(longlong param_1,longlong param_2,char param_3,ulonglong param_4)

{
  ...
  FUN_017dc990(*(undefined8 *)(param_2 + 0xd8),0,dVar1 * dVar2,uVar6,uVar7,uVar8);
  if (((param_3 != '\b') && (*(char *)(param_2 + 0x325) == '\0')) &&
     (*(char *)(lVar3 + 0x39) == '\0')) {
    FUN_017dc990(*(undefined8 *)(param_2 + 0xd8),0,
                 **(double **)(lVar3 + 0x18) * *(double *)(param_2 + 0x480),uVar7,uVar6,
