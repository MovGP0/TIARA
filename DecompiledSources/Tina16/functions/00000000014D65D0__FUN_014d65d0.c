/* Ghidra address: 014d65d0 */
/* Ghidra symbol: FUN_014d65d0 */


void FUN_014d65d0(longlong param_1,undefined8 param_2,longlong param_3)

{
  ...
  if (dVar2 * dVar5 + dVar1 < dVar6) {
    FUN_016e9f80(param_2,param_3,1,0x14);
  }
  return;
}
