/* Ghidra address: 017efab0 */
/* Ghidra symbol: FUN_017efab0 */


void FUN_017efab0(longlong param_1)

{
  ...
  if (*(char *)(*(longlong *)(param_1 + 0xb48) + 0x62b) == '\0') {
  ...
  FUN_01476a00(plVar2,*(undefined8 *)(param_1 + 0xb48));
  ...
  FUN_013b37d0(*(undefined8 *)(*(longlong *)(param_1 + 0xb48) + 0x4e8),uVar4 & 0xffffffff,uVar1);
  if (*(longlong *)(param_1 + 0xb48) != 0) {
    plVar2 = *(longlong **)(*(longlong *)(param_1 + 0xb48) + 0x890);
