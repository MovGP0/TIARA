/* Ghidra address: 0184c360 */
/* Ghidra symbol: FUN_0184c360 */


undefined8 FUN_0184c360(longlong param_1,undefined8 param_2)

{
  ...
  *(undefined8 *)(*(longlong *)(param_1 + 0xa0) + 0x88) = *(undefined8 *)(param_1 + 0x30);
  ...
  (**(code **)(**(longlong **)(param_1 + 0xa0) + 0x10))(*(longlong **)(param_1 + 0xa0),param_2);
