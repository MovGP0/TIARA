/* Ghidra address: 016ae5b0 */
/* Ghidra symbol: FUN_016ae5b0 */


void FUN_016ae5b0(longlong param_1,longlong *param_2,undefined4 *param_3)

{
  ...
  *param_3 = uVar1;
  ...
  (**(code **)(**(longlong **)(param_1 + 0x38) + 0x20))(*(longlong **)(param_1 + 0x38),&local_2a,2);
  sVar4 = 0;
  sVar5 = local_2a;
  if (-1 < (short)(local_2a + -1)) {
    do {
      ...
      FUN_016ae530(param_1,local_140,*puVar2,*(undefined4 *)(lVar3 + 4));
      sVar4 = sVar4 + 1;
      sVar5 = sVar5 + -1;
    } while (sVar5 != 0);
  }
