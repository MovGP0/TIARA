...
> Analysis status: Source reviewed for TIARA-diz.6.7.1576.
...
| --- | --- |
| Form | ShapeEdit |
| Component path | ShapeEdit.PartsPanel.PinPanel.sbPinLN |
| Control class | TSpeedButton |
| Caption | Long pin |
| Hint | Long pin |
| Handler name | sbPinNDClick |
| Handler address | 01797fc0 |
| Graph node | `resource:dfm:ShapeEdit/ShapeEdit.PartsPanel.PinPanel.sbPinLN` |
...
This control shares the recovered handler with `ShapeEdit.PartsPanel.PinPanel.sbPinLC`, `ShapeEdit.PartsPanel.PinPanel.sbPinLD`, `ShapeEdit.PartsPanel.PinPanel.sbPinLDC`, `ShapeEdit.PartsPanel.PinPanel.sbPinMini`, `ShapeEdit.PartsPanel.PinPanel.sbPinNC`, `ShapeEdit.PartsPanel.PinPanel.sbPinND`, `ShapeEdit.PartsPanel.PinPanel.sbPinNDC`, `ShapeEdit.PartsPanel.PinPanel.sbPinNN`, `ShapeEdit.PartsPanel.PinPanel.sbPinX`. This article keeps the resource evidence for this control separate.

## Click flow

```mermaid
flowchart TD
    control["Long pin"] --> handler["sbPinNDClick at 01797fc0"]
...
- Extracted glyph 1: [0425_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLN_Glyph_Data.png](../../../glyph/0425_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinLN_Glyph_Data.png)
...
- Resource context: The recovered TSpeedButton resource uses caption `Long pin` and hint `Long pin`. The extracted glyph was visually inspected. It agrees with the recovered resource intent, but the source path remains the behavior proof.
