/* Ghidra address: 01d30f00 */
/* Ghidra symbol: FUN_01d30f00 */


void FUN_01d30f00(longlong param_1,undefined8 param_2,int param_3)
  ...
  if (*(char *)(param_1 + 8) == '\0') {
    ...
    if (iVar1 == 0) {
      if (*(int *)(param_1 + 0x34) < *(int *)(param_1 + 0x38) + param_3) {
        ...
        FUN_004b84c0(*(undefined8 *)(param_1 + 0x10),param_2,(longlong)param_3);
