/* Ghidra address: 01b35d30 */
/* Ghidra symbol: FUN_01b35d30 */


void FUN_01b35d30(longlong param_1)

{
  ...
  local_20[0] = 0;
  local_28 = 0;
  *(undefined4 *)PTR_DAT_02004708 = 0x514;
  if (*(int *)(param_1 + 0x764) < 2) {
    ...
    *(undefined1 *)(param_1 + 0x7c0) = 0;
    ...
    FUN_008059a0(*(undefined8 *)PTR_DAT_020048c8);
    *PTR_DAT_02004418 = 0;
    FUN_008059a0(*(undefined8 *)PTR_DAT_020048c8);
  }
