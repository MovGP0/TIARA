...
```mermaid
flowchart LR
    control["Minterm"] -->|OnClick| handler["FUN_012205d0"]
    handler --> call1["FUN_011d4970"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000012205D0__FUN_012205d0.c](../../../DecompiledSources/Tina16/functions/00000000012205D0__FUN_012205d0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: Func_diagram_form.GroupBox1.min_d.OnClick.
