/* Ghidra address: 01533eb0 */
/* Ghidra symbol: FUN_01533eb0 */


void FUN_01533eb0(longlong param_1,undefined8 param_2)

{
  ...
  iVar1 = FUN_00c09100(*(undefined8 *)(param_1 + 0x958),local_20,0,uVar4);
  if (iVar1 == 0) {
    uVar3 = FUN_00b89270();
    FUN_00b8e520(uVar3,&local_30,0x3ea);
    FUN_007267a0(lVar2,&local_38);
    FUN_00416cd0(&local_28,4,local_30,&DAT_0153400c,local_38,&LAB_01534020);
