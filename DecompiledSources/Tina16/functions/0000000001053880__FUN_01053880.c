/* Ghidra address: 01053880 */
/* Ghidra symbol: FUN_01053880 */


void FUN_01053880(longlong param_1)

{
  ...
  local_30[0] = 0;
  local_20 = 0;
  FUN_00414ad0(*(longlong *)(param_1 + 0x840) + 0x100,&DAT_01053a40);
  FUN_00414ad0(*(longlong *)(param_1 + 0x840) + 0xe0,L"Hex File|*.hex");
  ...
  FUN_00416cd0(&local_20,3,local_38,local_40,L".hex");
