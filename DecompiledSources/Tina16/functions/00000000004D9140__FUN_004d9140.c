/* Ghidra address: 004d9140 */
/* Ghidra symbol: FUN_004d9140 */


void FUN_004d9140(longlong param_1,undefined8 param_2,longlong *param_3,int param_4)

{
  ...
  local_20 = plVar2;
  auStack_70[lVar1 * -2] = 0x4d91d4;
  FUN_00442f70(local_48 + 2,lVar5,plVar2,param_4);
  uVar3 = *(undefined8 *)(local_48[0] + 0x18);
  auStack_70[lVar1 * -2] = 0x4d91e5;
  FUN_00416ad0(local_48 + 2,uVar3);
  lVar6 = local_48[2];
  uVar3 = *(undefined8 *)(local_48[0] + 0x10);
  auStack_70[lVar1 * -2] = 0x4d91fa;
  FUN_00459ca0(uVar3,local_48 + 3,lVar6);
  lVar5 = local_48[3];
  lVar6 = local_48[0];
  auStack_70[lVar1 * -2] = 0x4d9207;
  FUN_004d8330(lVar6,lVar5);
  auStack_70[lVar1 * -2] = 0x4d9211;
  FUN_00414480(local_48 + 2);
  auStack_70[lVar1 * -2] = 0x4d9221;
