/* Ghidra address: 01a61c20 */
/* Ghidra symbol: FUN_01a61c20 */


longlong * FUN_01a61c20(undefined8 param_1,undefined8 param_2)

{
  ...
  if (-1 < local_8c) {
    do {
      ...
      iVar1 = FUN_004170c0(&DAT_01a61fb0,local_58,1);
      if (0 < iVar1) {
        (**(code **)(*local_28 + 0x18))(local_28,&local_60,local_3c);
        local_40 = FUN_004170c0(&DAT_01a61fb0,local_60,1);
        local_40 = local_40 + 3;
        local_44 = 0;
        ...
        local_20 = FUN_01cee3e0(*(undefined8 *)(*(longlong *)PTR_DAT_02001e00 + 0x7a0),uVar2);
        if (local_20 != 0) {
          (**(code **)(*local_28 + 0x18))(local_28,&local_38,local_3c);
          local_a8 = &DAT_01a61fc4;
          FUN_00416cd0(&local_78,3,&DAT_01a61fb0,local_30);
          FUN_0043f750(&local_88,*(undefined4 *)(local_20 + 0x40));
          local_a8 = &DAT_01a61fc4;
          FUN_00416cd0(&local_80,3,L"\\l#(",local_88);
