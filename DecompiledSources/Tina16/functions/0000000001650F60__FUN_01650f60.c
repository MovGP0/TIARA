/* Ghidra address: 01650f60 */
/* Ghidra symbol: FUN_01650f60 */


double * FUN_01650f60(longlong param_1,double *param_2,undefined8 param_3,longlong param_4)

{
  ...
  dVar4 = (double)FUN_016586b0(*(undefined8 *)(param_1 + 0x30),param_4,
                               *(undefined8 *)(param_1 + 0x40),0,local_2040,0,0,0);
