/* Ghidra address: 019cdde0 */
/* Ghidra symbol: FUN_019cdde0 */


void FUN_019cdde0(longlong param_1,undefined8 param_2,longlong param_3,undefined8 param_4)

{
  ...
  if (*(char *)(param_1 + 0x3b) == '\0') {
    ...
    FUN_00f30ec0(uVar1,&DAT_019cdf28,local_res10);
    ...
    if (local_res18 != 0) {
      FUN_00f30ec0(uVar1,L"file_object",local_res18);
      FUN_00f30ec0(uVar1,L"file_object_expected",local_res20);
    }
