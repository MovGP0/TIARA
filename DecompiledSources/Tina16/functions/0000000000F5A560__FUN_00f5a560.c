/* Ghidra address: 00f5a560 */
/* Ghidra symbol: FUN_00f5a560 */


void FUN_00f5a560(undefined8 param_1,longlong param_2,undefined2 param_3)

{
  ...
  if (cVar1 == '\0') {
    uVar4 = 0;
    FUN_016ee260(param_1,local_50,0x20,0);
    FUN_00f557e0(param_1,param_2,CONCAT11(uVar4,1),2,3,uVar2,dVar5,uVar6,local_50[0]);
    FUN_016e9f40(param_1,FUN_00f5a510);
  }
  else if (cVar1 == '\x01') {
    FUN_016e9e20(param_1,2);
    FUN_016ebe60(param_1,1,CONCAT11(uVar4,1),2,1);
    FUN_016ebe60(param_1,2,1,3,1);
