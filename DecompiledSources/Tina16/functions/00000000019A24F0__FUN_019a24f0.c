/* Ghidra address: 019a24f0 */
/* Ghidra symbol: FUN_019a24f0 */


undefined8 FUN_019a24f0(undefined8 param_1,longlong param_2,double param_3,char param_4)

{
  ...
  local_28a = 0;
  local_289 = 0;
  FUN_00442620(local_288,PTR_u_Arial_01fbee20);
