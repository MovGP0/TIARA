/* Ghidra address: 01051710 */
/* Ghidra symbol: FUN_01051710 */


void FUN_01051710(longlong param_1,undefined8 param_2)

{
  ...
  *(undefined4 *)(param_1 + 0x91c) = 2;
  FUN_010504b0(param_1,*(undefined4 *)(param_1 + 0x918),2);
  FUN_01050370(param_1,*(undefined8 *)(param_1 + 0x858),0);
  FUN_01050340(param_1,*(undefined8 *)(param_1 + 0x870),0);
