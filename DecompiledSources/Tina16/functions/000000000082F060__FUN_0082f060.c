/* Ghidra address: 0082f060 */
/* Ghidra symbol: FUN_0082f060 */


void FUN_0082f060(longlong param_1,undefined4 param_2,longlong *param_3,int param_4,int param_5)
  ...
  if (param_4 < param_5) {
    do {
      ...
      if (param_5 - iVar6 < iVar3 - param_4) {
        ...
        iVar2 = iVar3;
        if (iVar6 < param_5) {
          FUN_0082f060(param_1,param_2,param_3,iVar6,param_5);
        }
      }
      else {
        iVar4 = iVar6;
        iVar2 = param_5;
        if (param_4 < iVar3) {
          FUN_0082f060(param_1,param_2,param_3,param_4,iVar3);
        }
      }
      param_5 = iVar2;
      param_4 = iVar4;
