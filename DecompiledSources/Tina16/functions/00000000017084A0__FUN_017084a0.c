/* Ghidra address: 017084a0 */
/* Ghidra symbol: FUN_017084a0 */


undefined4 FUN_017084a0(longlong param_1,int param_2,int param_3,undefined8 param_4)
  ...
  if (iVar1 == 1) {
    ...
    if (local_30 != 0) {
      ...
      if (plVar2[0xee] == 0) {
        ...
        FUN_00416cd0(param_1 + 0x28,3,plVar2[0xee],&LAB_01708758,local_40);
      }
      uVar3 = FUN_01703c50(plVar2);
      *(undefined8 *)(param_1 + 0x38) = uVar3;
      local_4c = FUN_017088a0(param_1,*(undefined8 *)(param_1 + 0x30));
      goto LAB_017086cf;
    }
  }
  local_4c = 0xffffffff;
