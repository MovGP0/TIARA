/* Ghidra address: 00cc5a10 */
/* Ghidra symbol: FUN_00cc5a10 */


undefined8 * FUN_00cc5a10(undefined8 param_1,undefined8 *param_2,longlong param_3,longlong *param_4)
      ...
      if (((cVar2 == '\0') && (0x20 < uVar1)) && (uVar1 < 0x80)) {
        ...
        if (-1 < iVar5 + -1) {
          do {
            ...
            FUN_00416cd0(param_2,3,*param_2,&LAB_00cc5c88,local_40[0]);
            iVar6 = iVar6 + 1;
            iVar5 = iVar5 + -1;
          } while (iVar5 != 0);
        }
