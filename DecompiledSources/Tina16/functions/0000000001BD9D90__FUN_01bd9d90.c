/* Ghidra address: 01bd9d90 */
/* Ghidra symbol: FUN_01bd9d90 */


undefined4 FUN_01bd9d90(longlong param_1,undefined8 *param_2,undefined8 *param_3)
  ...
  *param_3 = 0;
  ...
  if (cVar2 == '\0') {
    ...
    if (cVar2 == '\0') {
      ...
      lVar4 = FUN_01bd9c90(&DAT_01bd91e0,1,uVar1,uVar5);
      if (lVar4 == 0) {
        lVar4 = 0;
      }
      else {
