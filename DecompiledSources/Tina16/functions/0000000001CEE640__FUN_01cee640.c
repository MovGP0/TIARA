/* Ghidra address: 01cee640 */
/* Ghidra symbol: FUN_01cee640 */


undefined4 FUN_01cee640(longlong param_1,int param_2)
              ...
              do {
                ...
                if (uVar8 < 3) {
                  if (uVar8 == 2) {
                    ...
                    if (*(int *)(lVar9 + 0x40) == param_2) {
                      lVar6 = (**(code **)(**(longlong **)(lVar7 + 0x80) + 0x30))
                                        (*(longlong **)(lVar7 + 0x80),local_34 + -1);
                      return *(undefined4 *)(lVar6 + 0xa0);
                    }
                  }
                  else if (uVar8 == 0) {
LAB_01cee790:
                    ...
                    if (*(int *)(lVar9 + 0x40) == param_2) {
                      lVar6 = (**(code **)(**(longlong **)(lVar7 + 0x80) + 0x30))
                                        (*(longlong **)(lVar7 + 0x80),local_34 + -1);
                      return *(undefined4 *)(lVar6 + 0xe8);
                    }
                  }
                  else if (uVar8 == 1) goto LAB_01cee812;
                }
                else if (uVar8 - 3 < 2) {
LAB_01cee812:
                  lVar9 = (**(code **)(**(longlong **)(lVar7 + 0x80) + 0x30))
                ...
                else if (uVar8 - 5 < 2) goto LAB_01cee790;
                local_34 = local_34 + 1;
                iVar4 = iVar4 + -1;
              } while (iVar4 != 0);
            }
