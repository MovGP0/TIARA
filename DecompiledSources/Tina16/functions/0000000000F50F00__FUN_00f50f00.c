/* Ghidra address: 00f50f00 */
/* Ghidra symbol: FUN_00f50f00 */


void FUN_00f50f00(longlong param_1,undefined8 param_2)

{
  ...
  local_38 = 0;
  local_40 = 0;
  *(undefined1 *)(param_1 + 0x6e1) = 1;
  *(undefined8 *)(param_1 + 0x6e8) = param_2;
  FUN_00f4daf0(local_30,*(undefined8 *)(param_1 + 0x700),param_2,*(undefined1 *)(param_1 + 0x6d8),
               &local_42);
  if (local_30[0] == 0) {
