/* Ghidra address: 00e23030 */
/* Ghidra symbol: FUN_00e23030 */


void FUN_00e23030(int *param_1,longlong param_2,longlong param_3,undefined4 param_4)
  ...
  if (bVar9) {
    if ((char)param_4 == '\f') {
      if (*(double *)(param_1 + 0x8a) == 0.0) {
        dVar14 = 0.000345314379969;
      }
      else {
        dVar14 = *(double *)(param_1 + 0x8a);
      }
      dVar10 = (double)FUN_0040c850(*(undefined8 *)(param_1 + 0x22));
      FUN_016ed7f0(param_3,param_4);
      uVar4 = FUN_0040c850();
      FUN_00b90620(uVar4,0x380b38fb9daa78e4);
      dVar16 = (double)FUN_0040c2f0();
      dVar16 = (double)FUN_0040af80(*(double *)(param_1 + 0x98) * dVar16);
      uVar4 = FUN_0040c760((*(double *)(param_1 + 0x4e) * 1.10449808e-22 * dVar10) / 3.0 +
                           (*(double *)(param_1 + 0x9a) * *(double *)(param_1 + 0x22) *
                           *(double *)(param_1 + 0x22)) /
                           (dVar16 * *(double *)(param_1 + 0xa0) * *(double *)(param_1 + 100) *
                            *(double *)(param_1 + 0x9e) * dVar14));
    ...
    if ((*(char *)(param_3 + 0x327) == '\0') &&
      ...
      *(undefined8 *)(param_1 + 0x12) = *(undefined8 *)(*(longlong *)(param_3 + 0x1b8) + lVar5 * 8);
      dVar14 = (dVar10 + 1.0) * *(double *)(*(longlong *)(param_3 + 0x1c0) + lVar5 * 8) -
      ...
      *(undefined8 *)(param_1 + 0xe) = *(undefined8 *)(*(longlong *)(param_3 + 0x1b8) + lVar7 * 8);
      dVar16 = (dVar10 + 1.0) * *(double *)(*(longlong *)(param_3 + 0x1c0) + lVar7 * 8) -
    ...
    *(double *)(param_1 + 0x2a) =
         *(double *)(param_1 + 0x2a) + (double)param_1[1] * *(double *)(param_3 + 0x430) * dVar10;
    *(double *)(param_1 + 0x24) = *(double *)(param_1 + 0x24) + *(double *)(param_3 + 0x430);
    ...
    *(double *)(*(longlong *)(param_3 + 0x1b8) + (longlong)(iVar8 + 0xf) * 8) = dVar14;
    *(double *)(param_1 + 0x12) = dVar14;
    *(double *)(*(longlong *)(param_3 + 0x1b8) + (longlong)(iVar8 + 0x11) * 8) = dVar13;
    *(double *)(param_1 + 0x14) = dVar13;
    *(double *)(*(longlong *)(param_3 + 0x1b8) + (longlong)(iVar8 + 0xe) * 8) = dVar16;
    *(double *)(param_1 + 0xe) = dVar16;
    ...
    *(double *)(lVar5 + (longlong)(iVar8 + 0x12) * 8) =
    ...
    lVar5 = *(longlong *)(param_3 + 0x1b8);
    *(undefined8 *)(lVar5 + (longlong)(iVar8 + 0x14) * 8) = *(undefined8 *)(param_1 + 0x90);
    *(undefined8 *)(lVar5 + (longlong)(iVar8 + 0x15) * 8) = *(undefined8 *)(param_1 + 0x92);
    if (param_1[1] < 0) {
      param_1[0x108] = 0;
      param_1[0x109] = 1;
      *(double *)(param_1 + 0xf6) =
            ...
            *(double *)(param_1 + 0x22) * dVar15) - *(double *)(param_1 + 0x26) * dVar13);
    }
    else {
      param_1[0x108] = 1;
      param_1[0x109] = 0;
      *(double *)(param_1 + 0xf6) =
           (double)*param_1 *
           (((*(double *)(param_1 + 0x2a) - *(double *)(param_1 + 0x24) * dVar10) -
            *(double *)(param_1 + 0x22) * dVar16) - *(double *)(param_1 + 0x26) * dVar14);
    }
