/* Ghidra address: 008eb300 */
/* Ghidra symbol: FUN_008eb300 */


void FUN_008eb300(longlong param_1,undefined2 *param_2,int param_3,ushort *param_4,int param_5,
...

{
  ...
  if ((((param_2 == (undefined2 *)0x0) || (param_3 < 1)) || (param_4 == (ushort *)0x0)) ||
     (param_5 / 2 < 1)) {
    *param_6 = 0;
    *param_7 = 0;
  }
