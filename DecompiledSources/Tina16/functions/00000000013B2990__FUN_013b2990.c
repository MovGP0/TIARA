/* Ghidra address: 013b2990 */
/* Ghidra symbol: FUN_013b2990 */


void FUN_013b2990(longlong param_1,byte *param_2,undefined8 *param_3)

{
  ...
  if (-1 < iVar1 + -1) {
    do {
      ...
      if (iVar2 == 0) {
        FUN_00daee10(*(undefined8 *)(param_1 + 0x278),iVar4,*param_3);
        break;
      }
      iVar4 = iVar4 + 1;
      iVar1 = iVar1 + -1;
