/* Ghidra address: 0078d2b0 */
/* Ghidra symbol: FUN_0078d2b0 */


longlong * FUN_0078d2b0(undefined8 *param_1,longlong *param_2,int param_3)

{
  ...
  local_50 = auStack_78;
  FUN_00419260(param_2,&DAT_00764b00,1,(longlong)param_3);
  local_res18 = 0;
