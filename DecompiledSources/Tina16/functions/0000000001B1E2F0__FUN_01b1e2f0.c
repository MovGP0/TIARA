/* Ghidra address: 01b1e2f0 */
/* Ghidra symbol: FUN_01b1e2f0 */


void FUN_01b1e2f0(undefined8 param_1)

{
  ...
  FUN_00416ba0(&local_290,local_res8[0],L"\\*.*");
  iVar1 = FUN_00441230(local_290,0x20,local_288);
  while (iVar1 == 0) {
    FUN_00416cd0(&local_298,3,local_res8[0],&LAB_01b1e444,local_270);
