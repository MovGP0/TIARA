/* Ghidra address: 01ae2e30 */
/* Ghidra symbol: FUN_01ae2e30 */


void FUN_01ae2e30(longlong param_1)
  ...
  if (cVar1 == '\x01') {
    ...
    if (cVar1 != '\0') {
      ...
      if (bVar6) {
        ...
        FUN_01cd3b70(*(undefined8 *)(lVar4 + 0xf8),*(undefined8 *)(param_1 + 0x80));
        lVar4 = FUN_004aeac0(local_20,0);
        FUN_01a8dee0(*(undefined8 *)(param_1 + 0xe8),*(undefined8 *)(lVar4 + 0xf8));
      }
      else {
        lVar4 = FUN_004aeac0(local_20,0);
        FUN_01cd3b70(*(undefined8 *)(lVar4 + 0xe8),*(undefined8 *)(param_1 + 0x80));
        lVar4 = FUN_004aeac0(local_20,0);
...
LAB_01ae30b4:
    if (local_28 == 0) goto LAB_01ae3153;
  }
  else {
    uVar3 = FUN_004aeac0(local_20,0);
    cVar1 = FUN_01ad1090(param_1,uVar3,&local_28);
    if (cVar1 == '\0') goto LAB_01ae30b4;
  }
