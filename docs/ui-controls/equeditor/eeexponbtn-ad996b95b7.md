...
```mermaid
flowchart LR
    control["Exponent"] -->|OnClick| handler["FUN_014643b0"]
    handler --> call1["FUN_014641a0"]
```

## Handler evidence

- Source: [DecompiledSources/Tina16/functions/00000000014643B0__FUN_014643b0.c](../../../DecompiledSources/Tina16/functions/00000000014643B0__FUN_014643b0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: EquEditor.EETPanel.EEExponBtn.OnClick.
