/* Ghidra address: 00df9920 */
/* Ghidra symbol: FUN_00df9920 */


void FUN_00df9920(longlong param_1,longlong param_2,char param_3,ulonglong param_4)

{
  ...
  if (param_3 == '\b') {
    ...
    if (*(char *)(*(longlong *)(param_2 + 0x110) + 10) != '\0') {
      FUN_01662860(*(longlong *)(param_2 + 0x110),2,*(double **)(lVar3 + 0x18),
