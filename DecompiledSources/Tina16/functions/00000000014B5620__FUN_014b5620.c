/* Ghidra address: 014b5620 */
/* Ghidra symbol: FUN_014b5620 */


void FUN_014b5620(longlong param_1)

{
  ...
  local_330[0] = 0;
  cVar2 = (**(code **)(**(longlong **)(param_1 + 0x7d8) + 0xa8))(*(longlong **)(param_1 + 0x7d8));
  if (cVar2 != '\0') {
    ...
    uVar5 = FUN_00bf2c10(*(undefined8 *)(param_1 + 0x860));
    FUN_005ff880(uVar4,uVar5);
    iVar3 = (**(code **)(**(longlong **)(*(longlong *)(param_1 + 0x860) + 0x4e8) + 0x28))();
    iVar6 = 0;
    if (-1 < iVar3 + -1) {
      do {
