/* Ghidra address: 0185fa70 */
/* Ghidra symbol: FUN_0185fa70 */


longlong * FUN_0185fa70(longlong param_1)

{
  ...
  local_a0 = (char *)0x0;
  local_98 = 0;
  iVar2 = FUN_0185d0b0(param_1);
  iVar3 = FUN_0185f2d0(param_1);
  local_54 = iVar2 * 3 * iVar3;
  if ((local_54 & 3) != 0) {
    local_54 = (local_54 & 0xfffffffc) + 4;
  }
  local_58 = FUN_0185d0a0(param_1);
  local_58 = local_54 * local_58;
  local_5c = local_58 + 0x36;
  if ((200000000 < local_5c) ||
     ((cVar1 = FUN_0185d0c0(param_1), cVar1 != '\0' && (100000000 < local_5c)))) {
    FUN_01860ba0(0x19);
  }
  ...
  *(undefined2 *)((longlong)local_d0 + 0xe) = 0x18;
  ...
  if (-1 < iVar2 + -1) {
    do {
      ...
      if (local_48 != 0) {
        ...
        local_bc = FUN_0185f3f0(param_1,local_ac);
        local_b8 = 0;
        iVar3 = FUN_0185d0a0(param_1);
        iVar5 = FUN_0185d0a0(param_1);
        uVar4 = FUN_0185f490(param_1,local_ac);
        iVar5 = FUN_00527000(iVar5 - *(int *)(local_e0 + 0x10),uVar4);
        local_b4 = iVar3 + -1;
        if (iVar5 <= local_b4) {
          iVar3 = (iVar5 - local_b4) + -1;
          do {
            iVar5 = FUN_0185f490(param_1,local_ac);
            iVar6 = FUN_0185d0b0(param_1);
            iVar7 = FUN_0185f470(param_1,local_ac);
            local_90 = (undefined1 *)
                       ((longlong)local_88 +
                       (longlong)(int)(local_ac * iVar6 * 3) +
                       (longlong)(iVar7 * 3) + (longlong)(int)((local_b4 - iVar5) * local_54));
            iVar5 = FUN_0185d0b0(param_1);
      ...
      if ((int)local_ac < *(int *)(*(longlong *)(param_1 + 0x30) + 0x10) + -1) {
        local_b4 = FUN_0185d0a0(param_1);
        local_b4 = local_b4 + -1;
        if (-1 < local_b4) {
          do {
            iVar5 = local_b4 * local_54;
            iVar3 = FUN_0185d0b0(param_1);
            local_90 = (undefined1 *)
        ...
        if (local_be != '\0') {
          ...
          uVar8 = FUN_0185f3d0(param_1,uVar11);
          if (uVar8 < 8) {
          ...
          if (bVar12) {
            ...
            iVar5 = FUN_0185d0a0(param_1);
            uVar4 = FUN_0185f490(param_1,local_ac);
            iVar5 = FUN_00527000(iVar5 - *(int *)(local_f0 + 0x10),uVar4);
            local_b4 = iVar3 + -1;
            if (iVar5 <= local_b4) {
              iVar3 = (iVar5 - local_b4) + -1;
              do {
  ...
  local_40 = (longlong *)FUN_01860570(&PTR_FUN_0185b3d8,1,local_be);
  (**(code **)(*local_40 + 0xf8))(local_40,0);
  (**(code **)(*local_40 + 0xc0))(local_40,local_30);
  if (local_be != '\0') {
    (**(code **)(*local_40 + 0xf8))(local_40,0);
    plVar9 = (longlong *)FUN_01860500(local_40);
    (**(code **)(*plVar9 + 0xc0))(plVar9,local_38);
    uVar10 = FUN_01860500(local_40);
