/* Ghidra address: 008e5c60 */
/* Ghidra symbol: FUN_008e5c60 */


char FUN_008e5c60(ushort param_1,ushort *param_2,undefined8 param_3)

{
  ...
  if (param_1 < 0xa0) {
    ...
    cVar1 = -0x60;
    do {
      if (*param_2 == param_1) goto LAB_008e5d75;
      param_2 = param_2 + 1;
      cVar1 = cVar1 + '\x01';
    } while (cVar1 != '\0');
