...
| Component path | SchematicEditor.MainMenu.mnInteractive.mnIntDigital |
...
| Graph node | `resource:dfm:SchematicEditor/SchematicEditor.MainMenu.mnInteractive.mnIntDigital` |
...
```mermaid
flowchart TD
    control["Digital"] -->|"OnClick"| handler["pmIntDigitalClick (01c89820)"]
