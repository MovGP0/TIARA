/* Ghidra address: 01b3d530 */
/* Ghidra symbol: FUN_01b3d530 */


void FUN_01b3d530(undefined8 param_1,longlong *param_2,undefined8 param_3,longlong param_4,
...

{
  ...
  *(undefined4 *)(param_4 + 0x38) = 0xd;
  ...
  FUN_01cfde70(param_2,uVar1,0,&local_21,&local_22,&local_23);
  iVar5 = FUN_01cfd2d0(param_2);
  lVar3 = FUN_01cfde70(param_2,(iVar5 - (uint)(local_21 == '\x0e')) + -1,0,&local_21,&local_22,
                       &local_23);
  ...
  iVar5 = FUN_01cfd2d0(param_2);
  lVar3 = FUN_01cfde70(param_2,iVar5 - (uint)(local_21 == '\x0e'),0,&local_21,&local_22,&local_23);
  if (*(short *)(lVar3 + 0x1f) < 0) {
