/* Ghidra address: 019dc870 */
/* Ghidra symbol: FUN_019dc870 */


undefined8 FUN_019dc870(undefined8 param_1,longlong param_2,int *param_3)

{
  ...
  do {
    local_1c = FUN_004564b0(&local_res10,&LAB_019dcaa0,*local_res18);
    if (local_1c < 0) {
