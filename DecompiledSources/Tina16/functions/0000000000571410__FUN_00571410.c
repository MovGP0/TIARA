/* Ghidra address: 00571410 */
/* Ghidra symbol: FUN_00571410 */


void FUN_00571410(longlong param_1,int param_2,undefined8 *param_3)

{
  ...
  cVar1 = FUN_004113d0(param_3,&PTR_FUN_0057d0c8);
  if (cVar1 == '\0') {
    ...
    local_40 = local_48;
    local_38 = param_3;
    FUN_00571280(param_1,param_2,local_48,local_50 + -1);
  }
