/* Ghidra address: 01a8a960 */
/* Ghidra symbol: FUN_01a8a960 */


void FUN_01a8a960(longlong param_1)

{
  ...
  if (cVar1 == '\x04') {
    ...
    if (*(longlong *)(lVar2 + 0x58) != 0) {
      FUN_01ab5810(*(longlong *)(lVar2 + 0x58),*(undefined8 *)(lVar2 + 0x78),FUN_01abde70,&local_28,
                   local_30);
