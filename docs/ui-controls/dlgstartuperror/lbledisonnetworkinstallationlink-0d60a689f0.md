...
```mermaid
flowchart LR
    control["http://www.edisonlab.com/enetwins.htm"] -->|OnClick| handler["lblNetworkInstallationLinkClick"]
...
- Rank 1: http://www.edisonlab.com/enetwins.htm at distance 0.
- Rank 2: http://www.tina.com/netwins.htm at distance 14.
- Rank 3: This is a network version installed on a local drive. Please follow the steps of network version installation in the manual or visit: at distance 88.
