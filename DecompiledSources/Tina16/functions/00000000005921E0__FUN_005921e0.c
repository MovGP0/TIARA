/* Ghidra address: 005921e0 */
/* Ghidra symbol: FUN_005921e0 */


void FUN_005921e0(undefined8 param_1,longlong *param_2,longlong param_3,undefined8 param_4)

{
  ...
  if (((ulonglong)pcVar1 & 0xff00000000000000) == 0xff00000000000000) {
    FUN_004194b0((longlong)param_2 + ((ulonglong)pcVar1 & 0xffffffffffffff),param_4,&DAT_0058fe20);
  }
  else {
