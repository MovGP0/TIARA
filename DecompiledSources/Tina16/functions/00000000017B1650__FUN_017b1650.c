/* Ghidra address: 017b1650 */
/* Ghidra symbol: FUN_017b1650 */


void FUN_017b1650(longlong param_1,int *param_2)

{
  ...
  uVar2 = FUN_017ad6c0(param_1 + 0x18,param_2);
  uVar3 = FUN_017ad6c0(param_1 + 0x48,param_2);
