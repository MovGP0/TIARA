/* Ghidra address: 01c18dd0 */
/* Ghidra symbol: FUN_01c18dd0 */


void FUN_01c18dd0(longlong *param_1,undefined8 param_2,undefined4 *param_3,undefined8 param_4)

{
  ...
  uVar9 = (uint)((ulonglong)in_stack_ffffffffffffff88 >> 0x20);
  local_20 = (short *)0x0;
  local_res20 = param_4;
...
LAB_01c18e70:
        if (param_1[100] != 0) {
          ...
          (**(code **)(*plVar4 + 0x200))(plVar4,local_30,(&DAT_01fe48d0)[lVar5]);
          if (*(char *)((longlong)param_1 + 0x363) == '\0') {
            plVar4 = (longlong *)FUN_00781840();
  ...
  (**(code **)(*plVar4 + 0x200))(plVar4,local_30,(&DAT_01fe48ce)[uVar6 & 0xff]);
LAB_01c18f46:
  uVar7 = FUN_00781840();
  ...
  if (((uVar3 & 2) != 0) &&
    ...
    FUN_00416ad0(&local_20,&LAB_01c190c4);
  }
  if ((*(uint *)((longlong)param_1 + 0xa4) & 0x8000) == 0) {
    ...
    FUN_00778820(uVar7,local_res20,param_2,*param_3,(ulonglong)uVar9 << 0x20,
                 *(undefined4 *)(*(longlong *)(param_1[0x62] + 0x70) + 0x28));
  }
