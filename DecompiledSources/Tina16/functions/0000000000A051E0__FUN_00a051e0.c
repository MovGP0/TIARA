/* Ghidra address: 00a051e0 */
/* Ghidra symbol: FUN_00a051e0 */


void FUN_00a051e0(longlong param_1)

{
  ...
  *puVar3 = uVar1;
  ...
  FUN_00a05950(param_1,2,puVar3 + 1);
  FUN_00a05950(param_1,2,puVar3 + 2);
  FUN_00a05950(param_1,2,puVar3 + 3);
  FUN_00a05950(param_1,2,puVar3 + 4);
  iVar2 = FUN_00a04e00(param_1);
  if (iVar2 < (int)puVar3[4]) {
    uVar1 = FUN_00a04e00(param_1);
    puVar3[4] = uVar1;
  }
  FUN_00a05950(param_1,1,local_2c);
  ...
  *(bool *)((longlong)puVar3 + 0x16) = (local_2c[0] & 0x20) != 0;
  ...
  if (*(char *)(puVar3 + 5) == '\0') {
    ...
    FUN_00a050d0(param_1,puVar3[6],puVar3 + 7);
  }
  if ((int)puVar3[7] < 0) {
    FUN_00a074d0(2);
  }
  FUN_00a05950(param_1,1,puVar3 + 8);
  FUN_00a05950(param_1,1,&local_130);
  while (0 < local_130) {
