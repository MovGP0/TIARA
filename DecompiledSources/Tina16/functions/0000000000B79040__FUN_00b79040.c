/* Ghidra address: 00b79040 */
/* Ghidra symbol: FUN_00b79040 */


void FUN_00b79040(longlong param_1,undefined4 *param_2,undefined4 *param_3)

{
  ...
  do {
    uVar2 = iVar5 * 6;
    FUN_00b78d50(&local_40,*(undefined2 *)(param_1 + 0x100 + (ulonglong)uVar2 * 2));
    local_3c._0_2_ = (ushort)local_3c + *(short *)(param_1 + 0x100 + (ulonglong)(uVar2 + 2) * 2);
    local_40._2_2_ = local_40._2_2_ + *(short *)(param_1 + 0x100 + (ulonglong)(uVar2 + 1) * 2);
    FUN_00b78d50((longlong)&local_3c + 2,
                 *(undefined2 *)(param_1 + 0x100 + (ulonglong)(uVar2 + 3) * 2));
    uVar6 = (ushort)local_3c;
    local_3c._0_2_ = (ushort)local_3c ^ (ushort)local_40;
    FUN_00b78d50(&local_3c,*(undefined2 *)(param_1 + 0x100 + (ulonglong)(uVar2 + 4) * 2));
    uVar1 = local_40._2_2_;
    local_40._2_2_ = (local_40._2_2_ ^ local_3c._2_2_) + (ushort)local_3c;
    FUN_00b78d50((longlong)&local_40 + 2,
                 *(undefined2 *)(param_1 + 0x100 + (ulonglong)(uVar2 + 5) * 2));
  ...
  FUN_00b78d50(&local_40,*(undefined2 *)(param_1 + 0x160));
  local_40._2_2_ = local_40._2_2_ + *(short *)(param_1 + 0x164);
  local_3c._0_2_ = (ushort)local_3c + *(short *)(param_1 + 0x162);
  FUN_00b78d50((longlong)&local_3c + 2,*(undefined2 *)(param_1 + 0x166));
