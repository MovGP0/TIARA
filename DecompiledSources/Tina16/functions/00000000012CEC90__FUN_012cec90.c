/* Ghidra address: 012cec90 */
/* Ghidra symbol: FUN_012cec90 */


void FUN_012cec90(char param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                 longlong param_5)

{
  ...
  if (cVar1 != '\0') {
    ...
    if (local_88 != 0) {
      ...
      local_6c = FUN_012ce890(auStack_138);
      ...
      if ((param_1 == '\x02') || (param_1 == '\x03')) {
        if (local_6d == '\0') {
          ...
          if (param_1 == '\x02') {
            FUN_00414b50(&local_30,L"*** NOT FOUND file");
          }
          else {
        ...
        (**(code **)(*local_68 + 0x108))(local_68,L"index",local_d0);
        (**(code **)(*local_68 + 0x108))(local_68,L"mode",0);
        (**(code **)(*local_68 + 0x108))(local_68,L"status",local_48);
        (**(code **)(*local_68 + 0x108))(local_68,L"circuit",local_40);
        FUN_00440030(&local_d8,0,1);
        (**(code **)(*local_68 + 0x108))(local_68,L"addpicture",local_d8);
        FUN_00440030(&local_e0,0,1);
        (**(code **)(*local_68 + 0x108))(local_68,L"addrefpicture",local_e0);
        FUN_00440030(&local_e8,0,1);
        (**(code **)(*local_68 + 0x108))(local_68,L"success",local_e8);
      }
      cVar1 = FUN_00440b00(local_58,1);
      if (cVar1 != '\0') {
        FUN_0043f750(&local_f8,local_6c);
        local_118 = local_res18;
        local_110 = &DAT_012cf71c;
        local_108 = local_f8;
        local_100 = L".xml";
