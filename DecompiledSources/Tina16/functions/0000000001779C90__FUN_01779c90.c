/* Ghidra address: 01779c90 */
/* Ghidra symbol: FUN_01779c90 */


undefined8 FUN_01779c90(longlong *param_1,undefined8 param_2,undefined4 param_3,undefined1 param_4)

{
  ...
  local_20 = 0;
  iVar1 = FUN_01779940(param_1,param_2,param_3);
  if (iVar1 < 0) {
    local_30 = 0;
  }
  else {
    ...
    *(undefined4 *)(param_1[1] + lVar3 * 0x18) = 0xffffffff;
    ...
    FUN_00414c70(&local_20,*(undefined8 *)(param_1[1] + 8 + lVar3 * 0x18));
    iVar2 = iVar1;
    while( true ) {
      iVar1 = iVar1 + 1;
      lVar3 = 0;
    ...
    *(undefined4 *)(param_1[1] + lVar3 * 0x18) = 0xffffffff;
    FUN_004144d0(param_1[1] + 8 + lVar3 * 0x18);
