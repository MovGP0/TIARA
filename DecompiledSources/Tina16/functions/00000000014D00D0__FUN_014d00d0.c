/* Ghidra address: 014d00d0 */
/* Ghidra symbol: FUN_014d00d0 */


double FUN_014d00d0(char param_1,double param_2,double param_3,double param_4,char param_5,
...

{
  ...
  if (param_1 == '\0') {
    ...
    if (param_5 != '\0') {
      ...
      do {
        ...
        dVar7 = (double)FUN_00dd1520(*(undefined8 *)(param_6 + -8 + uVar2 * 8),
    ...
    do {
      uVar2 = (ulonglong)bVar4;
      dVar7 = (double)FUN_00dd1490(*(undefined8 *)(param_6 + -8 + uVar2 * 8),
  ...
  return param_3 + (1.0 - dVar7) * param_4;
}
