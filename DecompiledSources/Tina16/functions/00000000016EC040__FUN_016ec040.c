/* Ghidra address: 016ec040 */
/* Ghidra symbol: FUN_016ec040 */


void FUN_016ec040(longlong param_1,byte param_2,undefined1 param_3,undefined1 param_4,
...

{
  ...
  if ((param_2 == 0) || (*(byte *)(param_1 + 4) < param_2)) {
    FUN_01b04d70(0x215,&LAB_016ec0e8,0);
  }
  else {
    lVar2 = FUN_016e8fd0(5);
