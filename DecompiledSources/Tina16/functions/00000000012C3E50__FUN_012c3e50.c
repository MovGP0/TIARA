/* Ghidra address: 012c3e50 */
/* Ghidra symbol: FUN_012c3e50 */


void FUN_012c3e50(undefined8 param_1)

{
  ...
  (**(code **)(*local_30 + 0x158))
            (local_30,&local_58,&DAT_012c4458,L"version=\"1.0\" encoding=\"UTF-8\"");
    ...
    do {
      ...
      if (-1 < iVar2 + -1) {
        do {
          ...
          FUN_012c3680(local_90,local_30,local_40);
