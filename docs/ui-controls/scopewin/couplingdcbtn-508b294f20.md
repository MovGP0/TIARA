...
| --- | --- |
| Form | ScopeWin |
| Component path | ScopeWin.ChannelGroupBox.CouplingGroupBox.CouplingDCBtn |
| Control class | TSpeedButton |
| Caption | DC |
| Hint | Not present in the recovered resource. |
| Text | Not present in the recovered resource. |
| Handler name | CouplingDCBtnClick |
| Handler address | 012af6c0 |
| Graph node | `resource:dfm:ScopeWin/ScopeWin.ChannelGroupBox.CouplingGroupBox.CouplingDCBtn` |
| Handler node | `function:012af6c0` |
| Graph layer | UI |
...
- Source: [DecompiledSources/Tina16/functions/00000000012AF6C0__FUN_012af6c0.c](../../../DecompiledSources/Tina16/functions/00000000012AF6C0__FUN_012af6c0.c)
- Recovered role: Not present in the recovered resource.
- Current graph summary: Handles 1 Delphi UI event: ScopeWin.ChannelGroupBox.CouplingGroupBox.CouplingDCBtn.OnClick.
