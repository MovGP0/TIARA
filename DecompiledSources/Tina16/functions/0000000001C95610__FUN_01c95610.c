/* Ghidra address: 01c95610 */
/* Ghidra symbol: FUN_01c95610 */


void FUN_01c95610(longlong param_1)

{
  ...
  FUN_00414ad0(PTR_DAT_02004c08,L"\\EDS.PCB");
  FUN_00414ad0(PTR_DAT_02004008,&DAT_01c95788);
  ...
  FUN_007e2d20(*(undefined8 *)(param_1 + 0x1020),1);
  (**(code **)(**(longlong **)(param_1 + 0x24b8) + 0x18))
            (*(longlong **)(param_1 + 0x24b8),L"Schematic Editor",L"PCBRootDir",&DAT_01c95788);
  FUN_00ec0300();
  FUN_00ecbc20();
