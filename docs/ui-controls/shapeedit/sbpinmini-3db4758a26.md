...
```mermaid
flowchart LR
    control["Short pin"] -->|OnClick| handler["FUN_01797fc0"]
...
- Extracted glyph: [`0424_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinMini_Glyph_Data.png`](../../../glyph/0424_ShapeEdit_ShapeEdit_PartsPanel_PinPanel_sbPinMini_Glyph_Data.png)
